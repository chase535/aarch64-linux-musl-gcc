...
enum opt_code
{
  ...
  OPT__param_max_combine_search_insns_ = 202,/* --param=max-combine-search-insns= */
  OPT__param_max_completely_peel_loop_nest_depth_ = 203,/* --param=max-completely-peel-loop-nest-depth= */
  OPT__param_max_completely_peel_times_ = 204,/* --param=max-completely-peel-times= */
  OPT__param_max_completely_peeled_insns_ = 205,/* --param=max-completely-peeled-insns= */
  OPT__param_max_crossjump_edges_ = 206,     /* --param=max-crossjump-edges= */
  OPT__param_max_cse_insns_ = 207,           /* --param=max-cse-insns= */
  OPT__param_max_cse_path_length_ = 208,     /* --param=max-cse-path-length= */
  OPT__param_max_cselib_memory_locations_ = 209,/* --param=max-cselib-memory-locations= */
  OPT__param_max_debug_marker_count_ = 210,  /* --param=max-debug-marker-count= */
  OPT__param_max_delay_slot_insn_search_ = 211,/* --param=max-delay-slot-insn-search= */
  OPT__param_max_delay_slot_live_search_ = 212,/* --param=max-delay-slot-live-search= */
  OPT__param_max_dse_active_local_stores_ = 213,/* --param=max-dse-active-local-stores= */
  OPT__param_max_early_inliner_iterations_ = 214,/* --param=max-early-inliner-iterations= */
  OPT__param_max_fields_for_field_sensitive_ = 215,/* --param=max-fields-for-field-sensitive= */
  OPT__param_max_find_base_term_values_ = 216,/* --param=max-find-base-term-values= */
  OPT__param_max_fsm_thread_path_insns_ = 217,/* --param=max-fsm-thread-path-insns= */
  OPT__param_max_gcse_insertion_ratio_ = 218,/* --param=max-gcse-insertion-ratio= */
  OPT__param_max_gcse_memory_ = 219,         /* --param=max-gcse-memory= */
  OPT__param_max_goto_duplication_insns_ = 220,/* --param=max-goto-duplication-insns= */
  OPT__param_max_grow_copy_bb_insns_ = 221,  /* --param=max-grow-copy-bb-insns= */
  OPT__param_max_hoist_depth_ = 222,         /* --param=max-hoist-depth= */
  OPT__param_max_inline_functions_called_once_insns_ = 223,/* --param=max-inline-functions-called-once-insns= */
  OPT__param_max_inline_functions_called_once_loop_depth_ = 224,/* --param=max-inline-functions-called-once-loop-depth= */
  OPT__param_max_inline_insns_auto_ = 225,   /* --param=max-inline-insns-auto= */
  OPT__param_max_inline_insns_recursive_auto_ = 226,/* --param=max-inline-insns-recursive-auto= */
  OPT__param_max_inline_insns_recursive_ = 227,/* --param=max-inline-insns-recursive= */
  OPT__param_max_inline_insns_single_ = 228, /* --param=max-inline-insns-single= */
  OPT__param_max_inline_insns_size_ = 229,   /* --param=max-inline-insns-size= */
  OPT__param_max_inline_insns_small_ = 230,  /* --param=max-inline-insns-small= */
  OPT__param_max_inline_recursive_depth_auto_ = 231,/* --param=max-inline-recursive-depth-auto= */
  OPT__param_max_inline_recursive_depth_ = 232,/* --param=max-inline-recursive-depth= */
  OPT__param_max_isl_operations_ = 233,      /* --param=max-isl-operations= */
  OPT__param_max_iterations_computation_cost_ = 234,/* --param=max-iterations-computation-cost= */
  OPT__param_max_iterations_to_track_ = 235, /* --param=max-iterations-to-track= */
  OPT__param_max_jump_thread_duplication_stmts_ = 236,/* --param=max-jump-thread-duplication-stmts= */
  OPT__param_max_jump_thread_paths_ = 237,   /* --param=max-jump-thread-paths= */
  OPT__param_max_last_value_rtl_ = 238,      /* --param=max-last-value-rtl= */
  OPT__param_max_loop_header_insns_ = 239,   /* --param=max-loop-header-insns= */
  OPT__param_max_modulo_backtrack_attempts_ = 240,/* --param=max-modulo-backtrack-attempts= */
  ...
  OPT__param_switch_lower_slow_alg_max_cases_ = 340,/* --param=switch-lower-slow-alg-max-cases= */
  ...
  OPT_Wexperimental_fmv_target = 656,        /* -Wexperimental-fmv-target */
  OPT_Wexternal_argument_mismatch = 657,     /* -Wexternal-argument-mismatch */
  ...
  OPT_Wleading_whitespace_ = 723,            /* -Wleading-whitespace= */
  OPT_Wline_truncation = 724,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 725,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 726,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 727,                     /* -Wlogical-op */
  OPT_Wlong_long = 728,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 729,              /* -Wlto-type-mismatch */
  OPT_Wmain = 730,                           /* -Wmain */
  OPT_Wmaybe_musttail_local_addr = 731,      /* -Wmaybe-musttail-local-addr */
  OPT_Wmaybe_uninitialized = 732,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 733,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 734,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 735,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 736,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 737,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 738,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 739,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 740,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 741,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 742,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 743,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 744, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 745,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 746, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_name = 747,         /* -Wmissing-parameter-name */
  OPT_Wmissing_parameter_type = 748,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 749,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 750,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 751,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 752,       /* -Wmissing-template-keyword */
  OPT_Wmissing_variable_declarations = 753,  /* -Wmissing-variable-declarations */
  OPT_Wmudflap = 754,                        /* -Wmudflap */
  OPT_Wmultichar = 755,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 756,           /* -Wmultiple-inheritance */
  ...
  OPT_Wunused_but_set_variable = 923,        /* -Wunused-but-set-variable */
  ...
  OPT_fmax_errors = 1521,                    /* -fmax-errors */
  OPT_fmax_errors_ = 1522,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1523,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1524,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1525,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1526,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1527,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1528,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1529,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1530,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1531,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1532,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1533,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1534,                          /* -fmod= */
  OPT_fmodule_file_ = 1535,                  /* -fmodule-file= */
  OPT_fmodule_header = 1536,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1537,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1538,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1539,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1540,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1541,                   /* -fmodule-only */
  OPT_fmodule_private = 1542,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1543,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1544,                    /* -fmoduleinfo */
  OPT_fmodules = 1545,                       /* -fmodules */
  /* OPT_fmodules_ts = 1546, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1547,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1548,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1549,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1550,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1551,                 /* -fms-extensions */
  OPT_fmudflap = 1552,                       /* -fmudflap */
  OPT_fmudflapir = 1553,                     /* -fmudflapir */
  OPT_fmudflapth = 1554,                     /* -fmudflapth */
  OPT_fmultiflags = 1555,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1556,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1557,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1558,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1559,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1560,                  /* -fnext-runtime */
  OPT_fnil = 1561,                           /* -fnil */
  OPT_fnil_receivers = 1562,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1563,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1564,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1565,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1566,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1567,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1568,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1569,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1570,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1571,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1572,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1573,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1574,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1575,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1576,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1577,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1578,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1579,              /* -foffload-options= */
  OPT_foffload_ = 1580,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1581,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1582,                         /* -fonly= */
  OPT_fopenacc = 1583,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1584,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1585,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1586,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1587,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1588, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1589,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1590,                /* -foperator-names */
  OPT_fopt_info = 1591,                      /* -fopt-info */
  OPT_fopt_info_ = 1592,                     /* -fopt-info- */
  OPT_foptimize_crc = 1593,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1594, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1595,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1596,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1597, */          /* -foptional-diags */
  OPT_fpack_derived = 1598,                  /* -fpack-derived */
  OPT_fpack_struct = 1599,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1600,                  /* -fpack-struct= */
  OPT_fpad_source = 1601,                    /* -fpad-source */
  OPT_fpartial_inlining = 1602,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1603,     /* -fpatchable-function-entry= */
  OPT_fpath_coverage = 1604,                 /* -fpath-coverage */
  OPT_fpath_coverage_limit_ = 1605,          /* -fpath-coverage-limit= */
  OPT_fpcc_struct_return = 1606,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1607,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1608,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1609,                    /* -fpeel-loops */
  OPT_fpeephole = 1610,                      /* -fpeephole */
  OPT_fpeephole2 = 1611,                     /* -fpeephole2 */
  OPT_fpermissive = 1612,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1613,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1614,                           /* -fpic */
  OPT_fpie = 1615,                           /* -fpie */
  OPT_fpim = 1616,                           /* -fpim */
  OPT_fpim2 = 1617,                          /* -fpim2 */
  OPT_fpim3 = 1618,                          /* -fpim3 */
  OPT_fpim4 = 1619,                          /* -fpim4 */
  OPT_fplan9_extensions = 1620,              /* -fplan9-extensions */
  OPT_fplt = 1621,                           /* -fplt */
  OPT_fplugin_arg_ = 1622,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1623,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1624,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1625,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1626,                /* -fpostconditions */
  OPT_fpre_include_ = 1627,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1628,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1629,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1630,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1631,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1632,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1633,              /* -fpretty-templates */
  OPT_fpreview_all = 1634,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1635,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1636,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1637,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1638,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1639,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1640,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1641,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1642,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1643,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1644,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1645,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1646,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_safer = 1647,                 /* -fpreview=safer */
  OPT_fpreview_systemvariables = 1648,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1649,           /* -fprintf-return-value */
  OPT_fprofile = 1650,                       /* -fprofile */
  OPT_fprofile_abs_path = 1651,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1652,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1653,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1654,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1655,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1656,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1657,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1658,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1659,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1660,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1661,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1662,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1663,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1664,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1665,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1666,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1667,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1668,               /* -fprofile-update= */
  OPT_fprofile_use = 1669,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1670,                  /* -fprofile-use= */
  OPT_fprofile_values = 1671,                /* -fprofile-values */
  OPT_fprotect_parens = 1672,                /* -fprotect-parens */
  OPT_fpthread = 1673,                       /* -fpthread */
  OPT_fq = 1674,                             /* -fq */
  OPT_frandom_seed = 1675,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1676,                  /* -frandom-seed= */
  OPT_frange = 1677,                         /* -frange */
  OPT_frange_check = 1678,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1679,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1680,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1681,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1682,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1683,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1684,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1685,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1686,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1687,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1688,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1689,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1690,               /* -frecord-marker=8 */
  OPT_frecursive = 1691,                     /* -frecursive */
  OPT_free = 1692,                           /* -free */
  /* OPT_freg_struct_return = 1693, */       /* -freg-struct-return */
  /* OPT_fregmove = 1694, */                 /* -fregmove */
  OPT_frelease = 1695,                       /* -frelease */
  OPT_frename_registers = 1696,              /* -frename-registers */
  OPT_freorder_blocks = 1697,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1698,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1699,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1700,             /* -freorder-functions */
  OPT_frepack_arrays = 1701,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1702,          /* -freplace-objc-classes */
  OPT_frepo = 1703,                          /* -frepo */
  OPT_freport_bug = 1704,                    /* -freport-bug */
  OPT_frequire_return_statement = 1705,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1706,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1707, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1708,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1709,                   /* -fresolution= */
  OPT_freturn = 1710,                        /* -freturn */
  OPT_frevert_all = 1711,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1712,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1713,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1714,             /* -frevert=intpromote */
  OPT_frounding_math = 1715,                 /* -frounding-math */
  OPT_frtti = 1716,                          /* -frtti */
  OPT_fruntime_modules_ = 1717,              /* -fruntime-modules= */
  OPT_frust_borrowcheck = 1718,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1719,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1720,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1721,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1722,                   /* -frust-crate= */
  OPT_frust_debug = 1723,                    /* -frust-debug */
  OPT_frust_dump_ = 1724,                    /* -frust-dump- */
  OPT_frust_edition_ = 1725,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1726,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1727,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1728,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1729,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1730,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1731,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1732,      /* -frust-name-resolution-2.0 */
  OPT_frust_overflow_checks = 1733,          /* -frust-overflow-checks */
  OPT_frust_panic_ = 1734,                   /* -frust-panic= */
  OPT_fsanitize_address_use_after_scope = 1735,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1736,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1737,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1738,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1739,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1740,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1741,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1742, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1743,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1744,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1745,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1746,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1747,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1748,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1749,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1750,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1751, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1752,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1753,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1754,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1755,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1756,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1757,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1758,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1759,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1760,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1761,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1762,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1763,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1764,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1765,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1766,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1767,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1768, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1769,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1770,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1771,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1772,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1773,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1774,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1775,               /* -fsection-anchors */
  /* OPT_fsee = 1776, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1777,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1778,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1779,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1780,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1781,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1782,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1783,        /* -fsemantic-interposition */
  OPT_fshared = 1784,                        /* -fshared */
  OPT_fshort_enums = 1785,                   /* -fshort-enums */
  OPT_fshort_wchar = 1786,                   /* -fshort-wchar */
  OPT_fshow_column = 1787,                   /* -fshow-column */
  OPT_fshrink_wrap = 1788,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1789,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1790,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1791,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1792,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1793,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1794,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1795,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1796,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1797,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1798,                /* -fsoft-check-all */
  OPT_fsources = 1799,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1800,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1801,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1802,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1803,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1804,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1805,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1806,                      /* -fsquangle */
  OPT_fssa_backprop = 1807,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1808,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1809,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1810,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1811, */             /* -fstack-check */
  OPT_fstack_check_ = 1812,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1813,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1814,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1815,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1816,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1817,               /* -fstack-protector */
  OPT_fstack_protector_all = 1818,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1819,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1820,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1821,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1822,                   /* -fstack-usage */
  OPT_fstatic_call = 1823,                   /* -fstatic-call */
  OPT_fstats = 1824,                         /* -fstats */
  OPT_fstdarg_opt = 1825,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1826,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1827, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1828,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1829,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1830, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1831,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1832,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1833,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1834,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1835, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1836,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1837,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1838,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1839,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1840,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1841,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1842,                  /* -fstrub=strict */
  OPT_fswig = 1843,                          /* -fswig */
  OPT_fswitch_errors = 1844,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1845,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1846,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1847,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1848, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1849,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1850, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1851,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1852, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1853,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1854,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1855,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1856,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1857,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1858,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1859,                   /* -ftime-report */
  OPT_ftime_report_details = 1860,           /* -ftime-report-details */
  OPT_ftls_model_ = 1861,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1862,              /* -ftoplevel-reorder */
  OPT_ftrace_debug = 1863,                   /* -ftrace-debug */
  OPT_ftracer = 1864,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1865,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1866,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1867,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1868,                   /* -ftrampolines */
  OPT_ftransition_all = 1869,                /* -ftransition=all */
  OPT_ftransition_field = 1870,              /* -ftransition=field */
  OPT_ftransition_in = 1871,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1872,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1873,          /* -ftransition=templates */
  OPT_ftransition_tls = 1874,                /* -ftransition=tls */
  OPT_ftrapping_math = 1875,                 /* -ftrapping-math */
  OPT_ftrapv = 1876,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1877,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1878,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1879,                      /* -ftree-ccp */
  OPT_ftree_ch = 1880,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1881, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1882,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1883,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1884, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1885,                   /* -ftree-cselim */
  OPT_ftree_dce = 1886,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1887,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1888,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1889,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1890,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1891, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1892,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1893,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1894, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1895,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1896,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1897, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1898,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1899,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1900,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1901,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1902,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1903,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1904,                      /* -ftree-pre */
  OPT_ftree_pta = 1905,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1906,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1907, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1908,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1909,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1910,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1911,                     /* -ftree-slsr */
  OPT_ftree_sra = 1912,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1913, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1914, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1915,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1916,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1917,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1918, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1919,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1920, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1921,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1922,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1923,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1924,         /* -funconstrained-commons */
  OPT_funderscoring = 1925,                  /* -funderscoring */
  OPT_funit_at_a_time = 1926,                /* -funit-at-a-time */
  OPT_funittest = 1927,                      /* -funittest */
  OPT_funreachable_traps = 1928,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1929,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1930,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1931,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1932, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1933,     /* -funsafe-math-optimizations */
  OPT_funsigned = 1934,                      /* -funsigned */
  OPT_funsigned_bitfields = 1935,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1936,                 /* -funsigned-char */
  OPT_funswitch_loops = 1937,                /* -funswitch-loops */
  OPT_funwind_tables = 1938,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1939,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1940,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1941,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1942,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1943,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1944,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1945,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1946,                     /* -fuse-list= */
  OPT_fvar_tracking = 1947,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1948,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1949,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1950,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1951,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1952, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1953,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1954,                   /* -fverbose-asm */
  /* OPT_fversion = 1955, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1956,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1957,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1958,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1959,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1960,                   /* -fvisibility= */
  OPT_fvpt = 1961,                           /* -fvpt */
  OPT_fvtable_gc = 1962,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1963,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1964,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1965,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1966,                     /* -fvtv-debug */
  OPT_fweak = 1967,                          /* -fweak */
  OPT_fweak_templates = 1968,                /* -fweak-templates */
  OPT_fweb = 1969,                           /* -fweb */
  /* OPT_fwhole_file = 1970, */              /* -fwhole-file */
  OPT_fwhole_program = 1971,                 /* -fwhole-program */
  OPT_fwholediv = 1972,                      /* -fwholediv */
  OPT_fwholevalue = 1973,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1974,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1975,             /* -fworking-directory */
  OPT_fwpa = 1976,                           /* -fwpa */
  OPT_fwpa_ = 1977,                          /* -fwpa= */
  OPT_fwrapv = 1978,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1979,                 /* -fwrapv-pointer */
  OPT_fxref = 1980,                          /* -fxref */
  OPT_fyacc_debug = 1981,                    /* -fyacc-debug */
  /* OPT_fzee = 1982, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1983,          /* -fzero-call-used-regs= */
  OPT_fzero_init_padding_bits_ = 1984,       /* -fzero-init-padding-bits= */
  OPT_fzero_initialized_in_bss = 1985,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1986,                     /* -fzero-link */
  OPT_g = 1987,                              /* -g */
  OPT_gant = 1988,                           /* -gant */
  OPT_gas_loc_support = 1989,                /* -gas-loc-support */
  OPT_gas_locview_support = 1990,            /* -gas-locview-support */
  OPT_gbtf = 1991,                           /* -gbtf */
  OPT_gcodeview = 1992,                      /* -gcodeview */
  OPT_gcoff = 1993,                          /* -gcoff */
  OPT_gcoff1 = 1994,                         /* -gcoff1 */
  OPT_gcoff2 = 1995,                         /* -gcoff2 */
  OPT_gcoff3 = 1996,                         /* -gcoff3 */
  OPT_gcolumn_info = 1997,                   /* -gcolumn-info */
  OPT_gctf = 1998,                           /* -gctf */
  OPT_gdescribe_dies = 1999,                 /* -gdescribe-dies */
  OPT_gdwarf = 2000,                         /* -gdwarf */
  OPT_gdwarf_ = 2001,                        /* -gdwarf- */
  OPT_gdwarf32 = 2002,                       /* -gdwarf32 */
  OPT_gdwarf64 = 2003,                       /* -gdwarf64 */
  OPT_gen_decls = 2004,                      /* -gen-decls */
  OPT_ggdb = 2005,                           /* -ggdb */
  OPT_ggnu_pubnames = 2006,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 2007,                   /* -gimple-stats */
  OPT_ginline_points = 2008,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 2009, /* -ginternal-reset-location-views */
  OPT_gnat = 2010,                           /* -gnat */
  OPT_gnatO = 2011,                          /* -gnatO */
  OPT_gno_ = 2012,                           /* -gno- */
  OPT_gno_pubnames = 2013,                   /* -gno-pubnames */
  OPT_gprune_btf = 2014,                     /* -gprune-btf */
  OPT_gpubnames = 2015,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 2016,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 2017,                   /* -gsplit-dwarf */
  OPT_gstabs = 2018,                         /* -gstabs */
  OPT_gstabs_ = 2019,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 2020,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 2021,                  /* -gstrict-dwarf */
  OPT_gtoggle = 2022,                        /* -gtoggle */
  OPT_gvariable_location_views = 2023,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 2024,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 2025,                           /* -gvms */
  OPT_gxcoff = 2026,                         /* -gxcoff */
  OPT_gxcoff_ = 2027,                        /* -gxcoff+ */
  OPT_gz = 2028,                             /* -gz */
  OPT_gz_ = 2029,                            /* -gz= */
  OPT_h = 2030,                              /* -h */
  OPT_help = 2031,                           /* -help */
  OPT_idirafter = 2032,                      /* -idirafter */
  OPT_imacros = 2033,                        /* -imacros */
  OPT_imultiarch = 2034,                     /* -imultiarch */
  OPT_imultilib = 2035,                      /* -imultilib */
  OPT_include = 2036,                        /* -include */
  OPT_iplugindir_ = 2037,                    /* -iplugindir= */
  OPT_iprefix = 2038,                        /* -iprefix */
  OPT_iquote = 2039,                         /* -iquote */
  OPT_isysroot = 2040,                       /* -isysroot */
  OPT_isystem = 2041,                        /* -isystem */
  OPT_iwithprefix = 2042,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 2043,              /* -iwithprefixbefore */
  OPT_k8 = 2044,                             /* -k8 */
  OPT_l = 2045,                              /* -l */
  OPT_lang_asm = 2046,                       /* -lang-asm */
  OPT_list = 2047,                           /* -list */
  OPT_mabi_ = 2048,                          /* -mabi= */
  OPT_main = 2049,                           /* -main */
  OPT_main_ = 2050,                          /* -main= */
  ...
  OPT_mcpu_ = 2056,                          /* -mcpu= */
  OPT_mearly_ldp_fusion = 2057,              /* -mearly-ldp-fusion */
  OPT_mearly_ra_ = 2058,                     /* -mearly-ra= */
  OPT_mfix_cortex_a53_835769 = 2059,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 2060,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 2061,             /* -mgeneral-regs-only */
  OPT_mglibc = 2062,                         /* -mglibc */
  OPT_mharden_sls_ = 2063,                   /* -mharden-sls= */
  OPT_mlate_ldp_fusion = 2064,               /* -mlate-ldp-fusion */
  OPT_mlittle_endian = 2065,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 2066,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 2067,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 2068,            /* -mlow-precision-sqrt */
  OPT_mmusl = 2069,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 2070,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 2071,               /* -moutline-atomics */
  OPT_moverride_ = 2072,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 2073,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 2074,          /* -msign-return-address= */
  ...
  OPT_mstrict_align = 2078,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 2079,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 2080,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 2081,                     /* -mtls-size= */
  OPT_mtp_ = 2082,                           /* -mtp= */
  OPT_mtrack_speculation = 2083,             /* -mtrack-speculation */
  ...
  OPT_profile = 2125,                        /* -profile */
  OPT_pthread = 2126,                        /* -pthread */
  OPT_quiet = 2127,                          /* -quiet */
  OPT_r = 2128,                              /* -r */
  OPT_rdynamic = 2129,                       /* -rdynamic */
  OPT_remap = 2130,                          /* -remap */
  OPT_reverse_sort = 2131,                   /* -reverse-sort */
  OPT_s = 2132,                              /* -s */
  OPT_save_temps = 2133,                     /* -save-temps */
  OPT_save_temps_ = 2134,                    /* -save-temps= */
  OPT_shared = 2135,                         /* -shared */
  OPT_shared_libgcc = 2136,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2137,               /* -shared-libphobos */
  OPT_size_sort = 2138,                      /* -size-sort */
  /* OPT_specs = 2139, */                    /* -specs */
  OPT_specs_ = 2140,                         /* -specs= */
  OPT_static = 2141,                         /* -static */
  OPT_static_libasan = 2142,                 /* -static-libasan */
  OPT_static_libgcc = 2143,                  /* -static-libgcc */
  OPT_static_libgcobol = 2144,               /* -static-libgcobol */
  OPT_static_libgfortran = 2145,             /* -static-libgfortran */
  OPT_static_libgm2 = 2146,                  /* -static-libgm2 */
  OPT_static_libgo = 2147,                   /* -static-libgo */
  OPT_static_libhwasan = 2148,               /* -static-libhwasan */
  OPT_static_liblsan = 2149,                 /* -static-liblsan */
  OPT_static_libmpx = 2150,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2151,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2152,               /* -static-libphobos */
  OPT_static_libquadmath = 2153,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2154,               /* -static-libstdc++ */
  OPT_static_libtsan = 2155,                 /* -static-libtsan */
  OPT_static_libubsan = 2156,                /* -static-libubsan */
  OPT_static_pie = 2157,                     /* -static-pie */
  /* OPT_std_c__03 = 2158, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2159, */                /* -std=c++0x */
  OPT_std_c__11 = 2160,                      /* -std=c++11 */
  OPT_std_c__14 = 2161,                      /* -std=c++14 */
  OPT_std_c__17 = 2162,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2163, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2164, */                /* -std=c++1z */
  OPT_std_c__20 = 2165,                      /* -std=c++20 */
  OPT_std_c__23 = 2166,                      /* -std=c++23 */
  OPT_std_c__26 = 2167,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2168, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2169, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2170, */                /* -std=c++2c */
  OPT_std_c__98 = 2171,                      /* -std=c++98 */
  OPT_std_c11 = 2172,                        /* -std=c11 */
  OPT_std_c17 = 2173,                        /* -std=c17 */
  /* OPT_std_c18 = 2174, */                  /* -std=c18 */
  /* OPT_std_c1x = 2175, */                  /* -std=c1x */
  OPT_std_c23 = 2176,                        /* -std=c23 */
  /* OPT_std_c2x = 2177, */                  /* -std=c2x */
  OPT_std_c2y = 2178,                        /* -std=c2y */
  /* OPT_std_c89 = 2179, */                  /* -std=c89 */
  OPT_std_c90 = 2180,                        /* -std=c90 */
  OPT_std_c99 = 2181,                        /* -std=c99 */
  /* OPT_std_c9x = 2182, */                  /* -std=c9x */
  OPT_std_f2003 = 2183,                      /* -std=f2003 */
  OPT_std_f2008 = 2184,                      /* -std=f2008 */
  OPT_std_f2008ts = 2185,                    /* -std=f2008ts */
  OPT_std_f2018 = 2186,                      /* -std=f2018 */
  OPT_std_f2023 = 2187,                      /* -std=f2023 */
  OPT_std_f202y = 2188,                      /* -std=f202y */
  ...
  OPT_std_gnu__26 = 2200,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2201, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2202, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2203, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2204,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2205,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2206,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2207, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2208, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2209,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2210, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2211,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2212, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2213,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2214,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2215, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2216, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2217,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2218, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2219, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2220, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2221, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2222, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2223, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2224,                     /* -std=legacy */
  OPT_stdlib_ = 2225,                        /* -stdlib= */
  OPT_symbol_ = 2226,                        /* -symbol= */
  OPT_symbolic = 2227,                       /* -symbolic */
  OPT_t = 2228,                              /* -t */
  OPT_time = 2229,                           /* -time */
  OPT_time_ = 2230,                          /* -time= */
  OPT_traditional = 2231,                    /* -traditional */
  OPT_traditional_cpp = 2232,                /* -traditional-cpp */
  OPT_tree_stats = 2233,                     /* -tree-stats */
  OPT_trigraphs = 2234,                      /* -trigraphs */
  OPT_truncate = 2235,                       /* -truncate */
  OPT_type_stats = 2236,                     /* -type-stats */
  OPT_u = 2237,                              /* -u */
  OPT_undef = 2238,                          /* -undef */
  OPT_v = 2239,                              /* -v */
  OPT_version = 2240,                        /* -version */
  OPT_w = 2241,                              /* -w */
  OPT_wrapper = 2242,                        /* -wrapper */
  OPT_x = 2243,                              /* -x */
  OPT_z = 2244,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
