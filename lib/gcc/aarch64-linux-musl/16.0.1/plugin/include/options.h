...
enum opt_code
{
  ...
  OPT_fanalyzer_call_summaries = 1106,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1107,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1108,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1109,          /* -fanalyzer-feasibility */
  /* OPT_fanalyzer_fine_grained = 1110, */   /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1111, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1112,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_simplify_supergraph = 1113,  /* -fanalyzer-simplify-supergraph */
  OPT_fanalyzer_state_merge = 1114,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1115,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1116,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1117,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1118,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1119,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1120,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1121,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1122, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1123, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1124, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1125, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1126,           /* -fasan-shadow-offset= */
  OPT_fasm = 1127,                           /* -fasm */
  OPT_fassert = 1128,                        /* -fassert */
  OPT_fassociative_math = 1129,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1130,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1131,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1132,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1133,                     /* -fauto-init */
  OPT_fauto_profile = 1134,                  /* -fauto-profile */
  OPT_fauto_profile_inlining = 1135,         /* -fauto-profile-inlining */
  OPT_fauto_profile_ = 1136,                 /* -fauto-profile= */
  OPT_fautomatic = 1137,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1138,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1139,                     /* -fbackslash */
  OPT_fbacktrace = 1140,                     /* -fbacktrace */
  OPT_fbit_tests = 1141,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1142,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1143,                        /* -fbounds */
  OPT_fbounds_check = 1144,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1145,                 /* -fbounds-check= */
  OPT_fbrackets = 1146,                      /* -fbrackets */
  OPT_fbranch_count_reg = 1147,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1148,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1149, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1150, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1151, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1152,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1153,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1154,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1155,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1156,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1157,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1158,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1159,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1160,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1161,                    /* -fcall-used- */
  OPT_fcaller_saves = 1162,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1163,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1164,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1165,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1166,      /* -fcanonical-system-headers */
  OPT_fcase = 1167,                          /* -fcase */
  /* OPT_fcf_protection = 1168, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1169,                /* -fcf-protection= */
  OPT_fchar8_t = 1170,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1171,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1172, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1173,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1174,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1175,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1176, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1177, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1178, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1179, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1180, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1181, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1182,                  /* -fcheckaction= */
  OPT_fchecking = 1183,                      /* -fchecking */
  OPT_fchecking_ = 1184,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1185,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1186,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1187,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1188,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1189,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1190,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1191,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1192,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1193,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1194,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1195,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1196,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1197,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1198,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1199,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1200,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1201,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1202,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1203, */                /* -fcilkplus */
  OPT_fcoarray_ = 1204,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1205,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1206,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1207,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1208,                        /* -fcommon */
  OPT_fcompare_debug = 1209,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1210,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1211,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1212,                  /* -fcompare-elim */
  OPT_fconcepts = 1213,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1214,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1215,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1216,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1217,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1218, */          /* -fconserve-space */
  OPT_fconserve_stack = 1219,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1220,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1221,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1222,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1223,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1224,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1225,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1226,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1227,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1228,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1229,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1230,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1231,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1232, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1233,                     /* -fcontracts */
