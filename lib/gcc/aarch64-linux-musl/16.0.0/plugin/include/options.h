...
enum opt_code
{
  ...
  OPT_Wmultistatement_macros = 767,          /* -Wmultistatement-macros */
  OPT_Wmusttail_local_addr = 768,            /* -Wmusttail-local-addr */
  OPT_Wnamespaces = 769,                     /* -Wnamespaces */
  OPT_Wnarrowing = 770,                      /* -Wnarrowing */
  OPT_Wnested_externs = 771,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 772, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 773, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 774, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 775, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 776, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 777, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 778,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 779,                  /* -Wnoexcept-type */
  OPT_Wnon_c_typedef_for_linkage = 780,      /* -Wnon-c-typedef-for-linkage */
  OPT_Wnon_template_friend = 781,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 782,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 783,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 784,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 785, */               /* -Wnormalized */
  OPT_Wnormalized_ = 786,                    /* -Wnormalized= */
  OPT_Wnrvo = 787,                           /* -Wnrvo */
  OPT_Wnull_dereference = 788,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 789,                /* -Wobjc-root-class */
  OPT_Wodr = 790,                            /* -Wodr */
  OPT_Wold_style_cast = 791,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 792,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 793,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 794,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 795,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 796,                    /* -Wopenmp-simd */
  OPT_Woverflow = 797,                       /* -Woverflow */
  OPT_Woverlength_strings = 798,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 799, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 800,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 801,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 802,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 803,            /* -Woverwrite-recursive */
  OPT_Wp_ = 804,                             /* -Wp, */
  OPT_Wpacked = 805,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 806,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 807,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 808,                         /* -Wpadded */
  OPT_Wparentheses = 809,                    /* -Wparentheses */
  OPT_Wpedantic = 810,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 811,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 812,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 813,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 814, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 815,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 816,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 817,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 818,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 819,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 820,            /* -Wpointer-to-int-cast */
  OPT_Wpragma_once_outside_header = 821,     /* -Wpragma-once-outside-header */
  OPT_Wpragmas = 822,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 823,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 824,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 825,                       /* -Wprotocol */
  OPT_Wpsabi = 826,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 827,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 828,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 829,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 830,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 831,                /* -Wredundant-decls */
  OPT_Wredundant_move = 832,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 833,                 /* -Wredundant-tags */
  OPT_Wregister = 834,                       /* -Wregister */
  OPT_Wreorder = 835,                        /* -Wreorder */
  OPT_Wrestrict = 836,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 837,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 838,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 839,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 840,           /* -Wscalar-storage-order */
  OPT_Wselector = 841,                       /* -Wselector */
  OPT_Wself_move = 842,                      /* -Wself-move */
  OPT_Wsequence_point = 843,                 /* -Wsequence-point */
  /* OPT_Wsfinae_incomplete = 844, */        /* -Wsfinae-incomplete */
  OPT_Wsfinae_incomplete_ = 845,             /* -Wsfinae-incomplete= */
  OPT_Wshadow = 846,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 847, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 848,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 849, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 850,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 851, */            /* -Wshadow=global */
  OPT_Wshadow_local = 852,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 853,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 854,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 855,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 856, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 857,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 858,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 859,                /* -Wsign-conversion */
  OPT_Wsign_promo = 860,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 861,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 862,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 863,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 864,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 865,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 866,                    /* -Wspeculative */
  OPT_Wstack_protector = 867,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 868,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 869,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 870,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 871,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 872,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 873,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 874,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 875,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 876,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 877,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 878, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 879,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 880,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 881,            /* -Wstringop-truncation */
  OPT_Wstyle = 882,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 883,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 884,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 885,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 886,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 887,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 888,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 889,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 890,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 891,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 892,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 893,               /* -Wsuggest-override */
  OPT_Wsurprising = 894,                     /* -Wsurprising */
  OPT_Wswitch = 895,                         /* -Wswitch */
  OPT_Wswitch_bool = 896,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 897,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 898,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 899,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 900,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 901,                      /* -Wsync-nand */
  OPT_Wsynth = 902,                          /* -Wsynth */
  OPT_Wsystem_headers = 903,                 /* -Wsystem-headers */
  OPT_Wtabs = 904,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 905,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 906,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 907,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 908,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplate_names_tu_local = 909,        /* -Wtemplate-names-tu-local */
  OPT_Wtemplates = 910,                      /* -Wtemplates */
  OPT_Wterminate = 911,                      /* -Wterminate */
  OPT_Wtraditional = 912,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 913,         /* -Wtraditional-conversion */
  /* OPT_Wtrailing_whitespace = 914, */      /* -Wtrailing-whitespace */
  OPT_Wtrailing_whitespace_ = 915,           /* -Wtrailing-whitespace= */
  OPT_Wtrampolines = 916,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 917,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 918,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 919,                           /* -Wtsan */
  OPT_Wtype_limits = 920,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 921,            /* -Wundeclared-selector */
  OPT_Wundef = 922,                          /* -Wundef */
  OPT_Wundefined_do_loop = 923,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 924,                      /* -Wunderflow */
  OPT_Wunicode = 925,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 926,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 927,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 928,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 929,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 930, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 931, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 932,     /* -Wunsuffixed-float-constants */
  OPT_Wunterminated_string_initialization = 933,/* -Wunterminated-string-initialization */
  OPT_Wunused = 934,                         /* -Wunused */
  /* OPT_Wunused_but_set_parameter = 935, */ /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_parameter_ = 936,      /* -Wunused-but-set-parameter= */
  /* OPT_Wunused_but_set_variable = 937, */  /* -Wunused-but-set-variable */
  OPT_Wunused_but_set_variable_ = 938,       /* -Wunused-but-set-variable= */
  /* OPT_Wunused_const_variable = 939, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 940,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 941,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 942,                /* -Wunused-function */
  OPT_Wunused_label = 943,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 944,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 945,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 946,               /* -Wunused-parameter */
  OPT_Wunused_result = 947,                  /* -Wunused-result */
  OPT_Wunused_value = 948,                   /* -Wunused-value */
  OPT_Wunused_variable = 949,                /* -Wunused-variable */
  OPT_Wuse_after_free = 950,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 951,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 952,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 953,                   /* -Wuseless-cast */
  OPT_Wvarargs = 954,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 955,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 956,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 957,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 958,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 959,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 960,            /* -Wvirtual-move-assign */
  OPT_Wvla = 961,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 962,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 963,                  /* -Wvla-parameter */
  OPT_Wvolatile = 964,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 965,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 966,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 967,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 968,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 969,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 970,                       /* -Wzerotrip */
  OPT_X = 971,                               /* -X */
  OPT_Xassembler = 972,                      /* -Xassembler */
  OPT_Xf = 973,                              /* -Xf */
  OPT_Xlinker = 974,                         /* -Xlinker */
  OPT_Xpreprocessor = 975,                   /* -Xpreprocessor */
  OPT_Z = 976,                               /* -Z */
  OPT_ansi = 977,                            /* -ansi */
  OPT_aux_info = 978,                        /* -aux-info */
  /* OPT_aux_info_ = 979, */                 /* -aux-info= */
  OPT_c = 980,                               /* -c */
  OPT_callgraph = 981,                       /* -callgraph */
  OPT_copyext = 982,                         /* -copyext */
  OPT_coverage = 983,                        /* -coverage */
  OPT_cpp = 984,                             /* -cpp */
  OPT_cpp_ = 985,                            /* -cpp= */
  OPT_d = 986,                               /* -d */
  OPT_debuglib_ = 987,                       /* -debuglib= */
  OPT_defaultlib_ = 988,                     /* -defaultlib= */
  OPT_defined_only = 989,                    /* -defined-only */
  OPT_demangle = 990,                        /* -demangle */
  OPT_dialect = 991,                         /* -dialect */
  OPT_dstartfiles = 992,                     /* -dstartfiles */
  OPT_dump_body_ = 993,                      /* -dump-body= */
  OPT_dump_level_ = 994,                     /* -dump-level= */
  OPT_dumpbase = 995,                        /* -dumpbase */
  OPT_dumpbase_ext = 996,                    /* -dumpbase-ext */
  OPT_dumpdir = 997,                         /* -dumpdir */
  OPT_dumpfullversion = 998,                 /* -dumpfullversion */
  OPT_dumpmachine = 999,                     /* -dumpmachine */
  OPT_dumpspecs = 1000,                      /* -dumpspecs */
  OPT_dumpversion = 1001,                    /* -dumpversion */
  OPT_e = 1002,                              /* -e */
  OPT_export_dynamic = 1003,                 /* -export-dynamic */
  OPT_fPIC = 1004,                           /* -fPIC */
  OPT_fPIE = 1005,                           /* -fPIE */
  OPT_fRTS_ = 1006,                          /* -fRTS= */
  OPT_fabi_compat_version_ = 1007,           /* -fabi-compat-version= */
  OPT_fabi_version_ = 1008,                  /* -fabi-version= */
  OPT_faccess_control = 1009,                /* -faccess-control */
  OPT_fada_spec_parent_ = 1010,              /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 1011,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 1012, /* -faggressive-loop-optimizations */
  OPT_falign_commons = 1013,                 /* -falign-commons */
  OPT_falign_functions = 1014,               /* -falign-functions */
  OPT_falign_functions_ = 1015,              /* -falign-functions= */
  OPT_falign_jumps = 1016,                   /* -falign-jumps */
  OPT_falign_jumps_ = 1017,                  /* -falign-jumps= */
  OPT_falign_labels = 1018,                  /* -falign-labels */
  OPT_falign_labels_ = 1019,                 /* -falign-labels= */
  OPT_falign_loops = 1020,                   /* -falign-loops */
  OPT_falign_loops_ = 1021,                  /* -falign-loops= */
  /* OPT_faligned_new = 1022, */             /* -faligned-new */
  OPT_faligned_new_ = 1023,                  /* -faligned-new= */
  OPT_fall_instantiations = 1024,            /* -fall-instantiations */
  OPT_fall_intrinsics = 1025,                /* -fall-intrinsics */
  OPT_fall_virtual = 1026,                   /* -fall-virtual */
  OPT_fallocation_dce = 1027,                /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 1028,       /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1029,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1030,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1031, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1032,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1033,        /* -falt-external-templates */
  OPT_fanalyzer = 1034,                      /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 1035,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1036,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1037,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1038,          /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 1039,         /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1040, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1041,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 1042,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1043,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1044,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1045,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1046,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1047,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1048,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1049,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1050, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1051, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1052, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1053, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1054,           /* -fasan-shadow-offset= */
  OPT_fasm = 1055,                           /* -fasm */
  OPT_fassert = 1056,                        /* -fassert */
  OPT_fassociative_math = 1057,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1058,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1059,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1060,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1061,                     /* -fauto-init */
  OPT_fauto_profile = 1062,                  /* -fauto-profile */
  OPT_fauto_profile_inlining = 1063,         /* -fauto-profile-inlining */
  OPT_fauto_profile_ = 1064,                 /* -fauto-profile= */
  OPT_fautomatic = 1065,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1066,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1067,                     /* -fbackslash */
  OPT_fbacktrace = 1068,                     /* -fbacktrace */
  OPT_fbit_tests = 1069,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1070,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1071,                        /* -fbounds */
  OPT_fbounds_check = 1072,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1073,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1074,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1075,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1076, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1077, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1078, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1079,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1080,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1081,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1082,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1083,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1084,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1085,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1086,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1087,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1088,                    /* -fcall-used- */
  OPT_fcaller_saves = 1089,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1090,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1091,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1092,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1093,      /* -fcanonical-system-headers */
  OPT_fcase = 1094,                          /* -fcase */
  /* OPT_fcf_protection = 1095, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1096,                /* -fcf-protection= */
  OPT_fchar8_t = 1097,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1098,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1099, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1100,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1101,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1102,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1103, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1104, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1105, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1106, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1107, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1108, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1109,                  /* -fcheckaction= */
  OPT_fchecking = 1110,                      /* -fchecking */
  OPT_fchecking_ = 1111,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1112,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1113,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1114,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1115,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1116,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1117,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1118,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1119,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1120,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1121,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1122,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1123,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1124,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1125,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1126,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1127,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1128,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1129,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1130, */                /* -fcilkplus */
  OPT_fcoarray_ = 1131,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1132,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1133,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1134,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1135,                        /* -fcommon */
  OPT_fcompare_debug = 1136,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1137,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1138,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1139,                  /* -fcompare-elim */
  OPT_fconcepts = 1140,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1141,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1142,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1143,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1144,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1145, */          /* -fconserve-space */
  OPT_fconserve_stack = 1146,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1147,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1148,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1149,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1150,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1151,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1152,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1153,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1154,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1155,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1156,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1157,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1158,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1159, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1160,                     /* -fcontracts */
  OPT_fconvert_ = 1161,                      /* -fconvert= */
  OPT_fcoroutines = 1162,                    /* -fcoroutines */
  OPT_fcpp = 1163,                           /* -fcpp */
  OPT_fcpp_begin = 1164,                     /* -fcpp-begin */
  OPT_fcpp_end = 1165,                       /* -fcpp-end */
  OPT_fcprop_registers = 1166,               /* -fcprop-registers */
  OPT_fcray_pointer = 1167,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1168,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1169,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1170, */         /* -fcse-skip-blocks */
  /* OPT_fcx_fortran_rules = 1171, */        /* -fcx-fortran-rules */
  /* OPT_fcx_limited_range = 1172, */        /* -fcx-limited-range */
  OPT_fcx_method_ = 1173,                    /* -fcx-method= */
  OPT_fd = 1174,                             /* -fd */
  OPT_fd_lines_as_code = 1175,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1176,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1177,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1178,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1179,                      /* -fdbg-cnt= */
  OPT_fdce = 1180,                           /* -fdce */
  OPT_fdebug = 1181,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1182,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1183,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1184,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1185,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1186,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1187,           /* -fdebug-types-section */
  OPT_fdebug_ = 1188,                        /* -fdebug= */
  OPT_fdec = 1189,                           /* -fdec */
  OPT_fdec_blank_format_item = 1190,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1191,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1192,           /* -fdec-format-defaults */
  OPT_fdec_include = 1193,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1194,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1195,                      /* -fdec-math */
  OPT_fdec_static = 1196,                    /* -fdec-static */
  OPT_fdec_structure = 1197,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1198,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1199, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1200,                          /* -fdef= */
  OPT_fdefault_double_8 = 1201,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1202, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1203,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1204,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1205,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1206,                /* -fdefault-real-8 */
  OPT_fdefaultbyte = 1207,                   /* -fdefaultbyte */
  OPT_fdefer_pop = 1208,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1209,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1210,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1211,    /* -fdelete-null-pointer-checks */
  OPT_fdep_fusion = 1212,                    /* -fdep-fusion */
  OPT_fdeps_file_ = 1213,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1214,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1215,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1216,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1217,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1218,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_add_output_ = 1219,       /* -fdiagnostics-add-output= */
  OPT_fdiagnostics_all_candidates = 1220,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1221, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1222,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1223,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1224,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1225,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1226,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1227,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1228,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1229,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1230,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1231,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1232,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_set_output_ = 1233,       /* -fdiagnostics-set-output= */
  OPT_fdiagnostics_show_caret = 1234,        /* -fdiagnostics-show-caret */
  /* OPT_fdiagnostics_show_context = 1235, *//* -fdiagnostics-show-context */
  OPT_fdiagnostics_show_context_ = 1236,     /* -fdiagnostics-show-context= */
  OPT_fdiagnostics_show_cwe = 1237,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_event_links = 1238,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1239,/* -fdiagnostics-show-highlight-colors */
  OPT_fdiagnostics_show_labels = 1240,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1241, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1242,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_nesting = 1243,      /* -fdiagnostics-show-nesting */
  OPT_fdiagnostics_show_nesting_levels = 1244,/* -fdiagnostics-show-nesting-levels */
  OPT_fdiagnostics_show_nesting_locations = 1245,/* -fdiagnostics-show-nesting-locations */
  OPT_fdiagnostics_show_option = 1246,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1247,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1248,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1249,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1250, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1251,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1252,               /* -fdirectives-only */
  OPT_fdisable_ = 1253,                      /* -fdisable- */
  OPT_fdoc = 1254,                           /* -fdoc */
  OPT_fdoc_dir_ = 1255,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1256,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1257,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1258,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1259,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1260,                      /* -fdruntime */
  OPT_fdse = 1261,                           /* -fdse */
  OPT_fdump_ = 1262,                         /* -fdump- */
  OPT_fdump_ada_spec = 1263,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1264,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1265,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1266,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1267,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1268,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1269,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1270,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1271,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1272,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1273,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1274,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1275,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1276,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1277,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1278,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1279,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1280,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1281, */               /* -fdump-core */
  OPT_fdump_d_original = 1282,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1283,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1284,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1285,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1286,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1287,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1288,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1289,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1290,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1291, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1292,                   /* -fdump-passes */
  OPT_fdump_scos = 1293,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1294,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1295,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1296,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1297,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1298,                /* -fearly-inlining */
  OPT_felide_constructors = 1299,            /* -felide-constructors */
  OPT_felide_type = 1300,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1301, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1302,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1303,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1304,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1305,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1306,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1307,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1308,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1309,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1310,                /* -fenum-int-equiv */
  OPT_fexceptions = 1311,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1312,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1313,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1314,       /* -fexpensive-optimizations */
  OPT_fext_dce = 1315,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1316,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1317,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1318,               /* -fextended-opaque */
  OPT_fextern_std_ = 1319,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1320,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1321,                 /* -fexternal-blas */
  OPT_fexternal_blas64 = 1322,               /* -fexternal-blas64 */
  OPT_fexternal_templates = 1323,            /* -fexternal-templates */
  OPT_ff2c = 1324,                           /* -ff2c */
  OPT_ffast_math = 1325,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1326,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1327,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1328,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1329,              /* -ffinite-math-only */
  OPT_ffixed_ = 1330,                        /* -ffixed- */
  OPT_ffixed_form = 1331,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1332,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1333,        /* -ffixed-line-length-none */
  OPT_fflex_debug = 1334,                    /* -fflex-debug */
  OPT_ffloat_store = 1335,                   /* -ffloat-store */
  OPT_ffloatvalue = 1336,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1337,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1338,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1339,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1340, */              /* -fforce-addr */
  OPT_fforward_propagate = 1341,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1342,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1343,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1344,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1345,                     /* -ffpe-trap= */
  OPT_ffree_form = 1346,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1347,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1348,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1349,                  /* -ffreestanding */
  OPT_ffriend_injection = 1350,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1351,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1352,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1353,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1354,             /* -ffunction-sections */
  OPT_fgcse = 1355,                          /* -fgcse */
  OPT_fgcse_after_reload = 1356,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1357,                      /* -fgcse-las */
  OPT_fgcse_lm = 1358,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1359,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1360,              /* -fgen-module-list= */
  OPT_fgimple = 1361,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1362,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1363,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1364,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1365,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1366,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1367,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1368,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1369,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1370,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1371,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1372,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1373,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1374,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1375,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1376,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1377,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1378,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1379,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1380,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1381,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1382,                      /* -fgraphite */
  OPT_fgraphite_identity = 1383,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1384,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1385,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1386, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1387,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1388, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1389, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1390,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1391,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1392,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1393,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1394,                      /* -fhardened */
  /* OPT_fhelp = 1395, */                    /* -fhelp */
  /* OPT_fhelp_ = 1396, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1397,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1398,                     /* -fhonor-std */
  OPT_fhosted = 1399,                        /* -fhosted */
  OPT_fhuge_objects = 1400,                  /* -fhuge-objects */
  OPT_fident = 1401,                         /* -fident */
  OPT_fif_conversion = 1402,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1403,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1404,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1405,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1406,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1407,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1408,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1409,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1410,            /* -fimplicit-templates */
  OPT_finclude_imports = 1411,               /* -finclude-imports */
  OPT_findex = 1412,                         /* -findex */
  OPT_findicator_column = 1413,              /* -findicator-column */
  OPT_findirect_inlining = 1414,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1415,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1416,               /* -finit-character= */
  OPT_finit_derived = 1417,                  /* -finit-derived */
  OPT_finit_integer_ = 1418,                 /* -finit-integer= */
  OPT_finit_local_zero = 1419,               /* -finit-local-zero */
  OPT_finit_logical_ = 1420,                 /* -finit-logical= */
  OPT_finit_real_ = 1421,                    /* -finit-real= */
  OPT_finline = 1422,                        /* -finline */
  OPT_finline_arg_packing = 1423,            /* -finline-arg-packing */
  OPT_finline_atomics = 1424,                /* -finline-atomics */
  OPT_finline_functions = 1425,              /* -finline-functions */
  OPT_finline_functions_called_once = 1426,  /* -finline-functions-called-once */
  OPT_finline_intrinsics = 1427,             /* -finline-intrinsics */
  OPT_finline_intrinsics_ = 1428,            /* -finline-intrinsics= */
  /* OPT_finline_limit_ = 1429, */           /* -finline-limit- */
  OPT_finline_limit_ = 1430,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1431,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1432,        /* -finline-small-functions */
  OPT_finline_stringops = 1433,              /* -finline-stringops */
  OPT_finline_stringops_ = 1434,             /* -finline-stringops= */
  OPT_finput_charset_ = 1435,                /* -finput-charset= */
  OPT_finstrument_functions = 1436,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1437,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1438,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1439,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1440,           /* -finteger-4-integer-8 */
  OPT_finternal_ebcdic = 1441,               /* -finternal-ebcdic */
  OPT_fintrinsic_modules_path = 1442,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1443,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1444,                    /* -finvariants */
  OPT_fipa_bit_cp = 1445,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1446,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1447, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1448,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1449,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1450,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1451,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1452, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1453,                    /* -fipa-modref */
  OPT_fipa_profile = 1454,                   /* -fipa-profile */
  OPT_fipa_pta = 1455,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1456,                /* -fipa-pure-const */
  OPT_fipa_ra = 1457,                        /* -fipa-ra */
  OPT_fipa_reference = 1458,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1459,     /* -fipa-reference-addressable */
  OPT_fipa_reorder_for_locality = 1460,      /* -fipa-reorder-for-locality */
  OPT_fipa_sra = 1461,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1462,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1463,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1464, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1465,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1466,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1467,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1468,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1469,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1470,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1471,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1472,                  /* -fira-verbose= */
  OPT_fiso = 1473,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1474,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1475,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1476,              /* -fivar-visibility= */
  OPT_fivopts = 1477,                        /* -fivopts */
  OPT_fjump_tables = 1478,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1479,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1480,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1481,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1482,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1483,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1484,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1485,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1486,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1487,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1488,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1489,         /* -flang-info-module-cmi= */
  /* OPT_flarge_source_files = 1490, */      /* -flarge-source-files */
  OPT_flate_combine_instructions = 1491,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1492,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1493,            /* -fleading-underscore */
  OPT_flibs_ = 1494,                         /* -flibs= */
  OPT_flifetime_dse = 1495,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1496,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1497,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1498,                /* -flinker-output= */
  /* OPT_flive_patching = 1499, */           /* -flive-patching */
  OPT_flive_patching_ = 1500,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1501,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1502,                   /* -flocal-ivars */
  OPT_flocation_ = 1503,                     /* -flocation= */
  /* OPT_floop_block = 1504, */              /* -floop-block */
  /* OPT_floop_flatten = 1505, */            /* -floop-flatten */
  OPT_floop_interchange = 1506,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1507,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1508, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1509,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1510, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1511,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1512,                     /* -flra-remat */
  OPT_flto = 1513,                           /* -flto */
  OPT_flto_compression_level_ = 1514,        /* -flto-compression-level= */
  OPT_flto_incremental_cache_size_ = 1515,   /* -flto-incremental-cache-size= */
  OPT_flto_incremental_ = 1516,              /* -flto-incremental= */
  /* OPT_flto_odr_type_merging = 1517, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1518,                /* -flto-partition= */
  OPT_flto_report = 1519,                    /* -flto-report */
  OPT_flto_report_wpa = 1520,                /* -flto-report-wpa */
  OPT_flto_ = 1521,                          /* -flto= */
  OPT_fltrans = 1522,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1523,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1524,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1525,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1526,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1527,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1528,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1529,                      /* -fm2-dump= */
  OPT_fm2_file_offset_bits_ = 1530,          /* -fm2-file-offset-bits= */
  OPT_fm2_g = 1531,                          /* -fm2-g */
  OPT_fm2_lower_case = 1532,                 /* -fm2-lower-case */
  OPT_fm2_pathname_root_ = 1533,             /* -fm2-pathname-root= */
  OPT_fm2_pathname_rootI_ = 1534,            /* -fm2-pathname-rootI= */
  OPT_fm2_pathname_ = 1535,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1536,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1537,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1538,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1539,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1540,                /* -fm2-strict-type */
  OPT_fm2_strict_type_reason = 1541,         /* -fm2-strict-type-reason */
  OPT_fm2_whole_program = 1542,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1543,             /* -fmacro-prefix-map= */
  OPT_fmain = 1544,                          /* -fmain */
  OPT_fmalloc_dce = 1545,                    /* -fmalloc-dce */
  OPT_fmalloc_dce_ = 1546,                   /* -fmalloc-dce= */
  OPT_fmath_errno = 1547,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1548,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1549,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1550,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1551,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1552,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1553,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1554,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1555,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1556,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1557,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1558,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1559,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1560,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1561,                          /* -fmod= */
  OPT_fmodule_file_ = 1562,                  /* -fmodule-file= */
  OPT_fmodule_header = 1563,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1564,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1565,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1566,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1567,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1568,                   /* -fmodule-only */
  OPT_fmodule_private = 1569,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1570,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1571,                    /* -fmoduleinfo */
  OPT_fmodules = 1572,                       /* -fmodules */
  /* OPT_fmodules_ts = 1573, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1574,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1575,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1576,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1577,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1578,                 /* -fms-extensions */
  OPT_fmudflap = 1579,                       /* -fmudflap */
  OPT_fmudflapir = 1580,                     /* -fmudflapir */
  OPT_fmudflapth = 1581,                     /* -fmudflapth */
  OPT_fmultiflags = 1582,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1583,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1584,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1585,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1586,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1587,                  /* -fnext-runtime */
  OPT_fnil = 1588,                           /* -fnil */
  OPT_fnil_receivers = 1589,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1590,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1591,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1592,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1593,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1594,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1595,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1596,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1597,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1598,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1599,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1600,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1601,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1602,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1603,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1604,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1605,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1606,              /* -foffload-options= */
  OPT_foffload_ = 1607,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1608,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1609,                         /* -fonly= */
  OPT_fopenacc = 1610,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1611,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1612,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1613,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1614,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1615, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1616,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1617,                /* -foperator-names */
  OPT_fopt_info = 1618,                      /* -fopt-info */
  OPT_fopt_info_ = 1619,                     /* -fopt-info- */
  OPT_foptimize_crc = 1620,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1621, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1622,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1623,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1624, */          /* -foptional-diags */
  OPT_fpack_derived = 1625,                  /* -fpack-derived */
  OPT_fpack_struct = 1626,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1627,                  /* -fpack-struct= */
  OPT_fpad_source = 1628,                    /* -fpad-source */
  OPT_fpartial_inlining = 1629,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1630,     /* -fpatchable-function-entry= */
  OPT_fpath_coverage = 1631,                 /* -fpath-coverage */
  OPT_fpath_coverage_limit_ = 1632,          /* -fpath-coverage-limit= */
  OPT_fpcc_struct_return = 1633,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1634,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1635,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1636,                    /* -fpeel-loops */
  OPT_fpeephole = 1637,                      /* -fpeephole */
  OPT_fpeephole2 = 1638,                     /* -fpeephole2 */
  OPT_fpermissive = 1639,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1640,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1641,                           /* -fpic */
  OPT_fpie = 1642,                           /* -fpie */
  OPT_fpim = 1643,                           /* -fpim */
  OPT_fpim2 = 1644,                          /* -fpim2 */
  OPT_fpim3 = 1645,                          /* -fpim3 */
  OPT_fpim4 = 1646,                          /* -fpim4 */
  OPT_fplan9_extensions = 1647,              /* -fplan9-extensions */
  OPT_fplt = 1648,                           /* -fplt */
  OPT_fplugin_arg_ = 1649,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1650,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1651,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1652,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1653,                /* -fpostconditions */
  OPT_fpre_include_ = 1654,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1655,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1656,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1657,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1658,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1659,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1660,              /* -fpretty-templates */
  OPT_fpreview_all = 1661,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1662,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1663,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1664,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1665,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1666,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1667,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1668,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1669,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1670,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1671,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1672,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1673,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_safer = 1674,                 /* -fpreview=safer */
  OPT_fpreview_systemvariables = 1675,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1676,           /* -fprintf-return-value */
  OPT_fprofile = 1677,                       /* -fprofile */
  OPT_fprofile_abs_path = 1678,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1679,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1680,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1681,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1682,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1683,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1684,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1685,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1686,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1687,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1688,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1689,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1690,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1691,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1692,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1693,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1694,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1695,               /* -fprofile-update= */
  OPT_fprofile_use = 1696,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1697,                  /* -fprofile-use= */
  OPT_fprofile_values = 1698,                /* -fprofile-values */
  OPT_fprotect_parens = 1699,                /* -fprotect-parens */
  OPT_fpthread = 1700,                       /* -fpthread */
  OPT_fq = 1701,                             /* -fq */
  OPT_frandom_seed = 1702,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1703,                  /* -frandom-seed= */
  OPT_frange = 1704,                         /* -frange */
  OPT_frange_check = 1705,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1706,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1707,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1708,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1709,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1710,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1711,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1712,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1713,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1714,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1715,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1716,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1717,               /* -frecord-marker=8 */
  OPT_frecursive = 1718,                     /* -frecursive */
  OPT_free = 1719,                           /* -free */
  /* OPT_freg_struct_return = 1720, */       /* -freg-struct-return */
  /* OPT_fregmove = 1721, */                 /* -fregmove */
  OPT_frelease = 1722,                       /* -frelease */
  OPT_frename_registers = 1723,              /* -frename-registers */
  OPT_freorder_blocks = 1724,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1725,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1726,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1727,             /* -freorder-functions */
  OPT_frepack_arrays = 1728,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1729,          /* -freplace-objc-classes */
  OPT_frepo = 1730,                          /* -frepo */
  OPT_freport_bug = 1731,                    /* -freport-bug */
  OPT_frequire_return_statement = 1732,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1733,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1734, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1735,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1736,                   /* -fresolution= */
  OPT_freturn = 1737,                        /* -freturn */
  OPT_frevert_all = 1738,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1739,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1740,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1741,             /* -frevert=intpromote */
  OPT_frounding_math = 1742,                 /* -frounding-math */
  OPT_frtti = 1743,                          /* -frtti */
  OPT_fruntime_modules_ = 1744,              /* -fruntime-modules= */
  OPT_frust_assume_builtin_offset_of = 1745, /* -frust-assume-builtin-offset-of */
  OPT_frust_borrowcheck = 1746,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1747,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1748,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1749,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1750,                   /* -frust-crate= */
  OPT_frust_debug = 1751,                    /* -frust-debug */
  OPT_frust_dump_ = 1752,                    /* -frust-dump- */
  OPT_frust_edition_ = 1753,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1754,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1755,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1756,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1757,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1758,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1759,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1760,      /* -frust-name-resolution-2.0 */
  OPT_frust_overflow_checks = 1761,          /* -frust-overflow-checks */
  OPT_frust_panic_ = 1762,                   /* -frust-panic= */
  OPT_fsanitize_address_use_after_scope = 1763,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1764,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1765,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1766,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1767,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1768,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1769,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1770, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1771,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1772,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1773,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1774,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1775,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1776,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1777,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1778,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1779, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1780,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1781,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1782,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1783,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1784,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1785,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1786,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1787,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1788,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1789,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1790,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1791,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1792,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1793,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1794,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1795,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1796, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1797,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1798,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1799,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1800,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1801,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1802,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1803,               /* -fsection-anchors */
  /* OPT_fsee = 1804, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1805,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1806,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1807,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1808,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1809,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1810,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1811,        /* -fsemantic-interposition */
  OPT_fshared = 1812,                        /* -fshared */
  OPT_fshort_enums = 1813,                   /* -fshort-enums */
  OPT_fshort_wchar = 1814,                   /* -fshort-wchar */
  OPT_fshow_column = 1815,                   /* -fshow-column */
  OPT_fshrink_wrap = 1816,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1817,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1818,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1819,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1820,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1821,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1822,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1823,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1824,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1825,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1826,                /* -fsoft-check-all */
  OPT_fsources = 1827,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1828,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1829,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1830,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1831,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1832,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1833,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1834,                      /* -fsquangle */
  OPT_fssa_backprop = 1835,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1836,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1837,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1838,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1839, */             /* -fstack-check */
  OPT_fstack_check_ = 1840,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1841,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1842,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1843,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1844,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1845,               /* -fstack-protector */
  OPT_fstack_protector_all = 1846,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1847,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1848,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1849,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1850,                   /* -fstack-usage */
  OPT_fstatic_call = 1851,                   /* -fstatic-call */
  OPT_fstats = 1852,                         /* -fstats */
  OPT_fstdarg_opt = 1853,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1854,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1855, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1856,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1857,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1858, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1859,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1860,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1861,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1862,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1863, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1864,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1865,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1866,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1867,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1868,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1869,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1870,                  /* -fstrub=strict */
  OPT_fswig = 1871,                          /* -fswig */
  OPT_fswitch_errors = 1872,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1873,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1874,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1875,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1876, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1877,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1878, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1879,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1880, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1881,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1882,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1883,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1884,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1885,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1886,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1887,                   /* -ftime-report */
  OPT_ftime_report_details = 1888,           /* -ftime-report-details */
  OPT_ftls_model_ = 1889,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1890,              /* -ftoplevel-reorder */
  OPT_ftrace_debug = 1891,                   /* -ftrace-debug */
  OPT_ftracer = 1892,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1893,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1894,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1895,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1896,                   /* -ftrampolines */
  OPT_ftransition_all = 1897,                /* -ftransition=all */
  OPT_ftransition_field = 1898,              /* -ftransition=field */
  OPT_ftransition_in = 1899,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1900,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1901,          /* -ftransition=templates */
  OPT_ftransition_tls = 1902,                /* -ftransition=tls */
  OPT_ftrapping_math = 1903,                 /* -ftrapping-math */
  OPT_ftrapv = 1904,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1905,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1906,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1907,                      /* -ftree-ccp */
  OPT_ftree_ch = 1908,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1909, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1910,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1911,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1912, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1913,                   /* -ftree-cselim */
  OPT_ftree_dce = 1914,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1915,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1916,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1917,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1918,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1919, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1920,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1921,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1922, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1923,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1924,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1925, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1926,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1927,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1928,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1929,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1930,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1931,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1932,                      /* -ftree-pre */
  OPT_ftree_pta = 1933,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1934,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1935, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1936,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1937,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1938,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1939,                     /* -ftree-slsr */
  OPT_ftree_sra = 1940,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1941, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1942, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1943,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1944,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1945,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1946, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1947,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1948, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1949,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1950,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1951,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1952,         /* -funconstrained-commons */
  OPT_funderscoring = 1953,                  /* -funderscoring */
  OPT_funit_at_a_time = 1954,                /* -funit-at-a-time */
  OPT_funittest = 1955,                      /* -funittest */
  OPT_funreachable_traps = 1956,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1957,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1958,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1959,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1960, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1961,     /* -funsafe-math-optimizations */
  OPT_funsigned = 1962,                      /* -funsigned */
  OPT_funsigned_bitfields = 1963,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1964,                 /* -funsigned-char */
  OPT_funswitch_loops = 1965,                /* -funswitch-loops */
  OPT_funwind_tables = 1966,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1967,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1968,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1969,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1970,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1971,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1972,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1973,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1974,                     /* -fuse-list= */
  OPT_fvar_tracking = 1975,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1976,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1977,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1978,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1979,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1980, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1981,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1982,                   /* -fverbose-asm */
  /* OPT_fversion = 1983, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1984,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1985,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1986,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1987,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1988,                   /* -fvisibility= */
  OPT_fvpt = 1989,                           /* -fvpt */
  OPT_fvtable_gc = 1990,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1991,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1992,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1993,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1994,                     /* -fvtv-debug */
  OPT_fweak = 1995,                          /* -fweak */
  OPT_fweak_templates = 1996,                /* -fweak-templates */
  OPT_fweb = 1997,                           /* -fweb */
  /* OPT_fwhole_file = 1998, */              /* -fwhole-file */
  OPT_fwhole_program = 1999,                 /* -fwhole-program */
  OPT_fwholediv = 2000,                      /* -fwholediv */
  OPT_fwholevalue = 2001,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 2002,            /* -fwide-exec-charset= */
  OPT_fwideset = 2003,                       /* -fwideset */
  OPT_fworking_directory = 2004,             /* -fworking-directory */
  OPT_fwpa = 2005,                           /* -fwpa */
  OPT_fwpa_ = 2006,                          /* -fwpa= */
  OPT_fwrapv = 2007,                         /* -fwrapv */
  OPT_fwrapv_pointer = 2008,                 /* -fwrapv-pointer */
  OPT_fxref = 2009,                          /* -fxref */
  OPT_fyacc_debug = 2010,                    /* -fyacc-debug */
  /* OPT_fzee = 2011, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 2012,          /* -fzero-call-used-regs= */
  OPT_fzero_init_padding_bits_ = 2013,       /* -fzero-init-padding-bits= */
  OPT_fzero_initialized_in_bss = 2014,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 2015,                     /* -fzero-link */
  OPT_g = 2016,                              /* -g */
  OPT_gant = 2017,                           /* -gant */
  OPT_gas_loc_support = 2018,                /* -gas-loc-support */
  OPT_gas_locview_support = 2019,            /* -gas-locview-support */
  OPT_gbtf = 2020,                           /* -gbtf */
  OPT_gcodeview = 2021,                      /* -gcodeview */
  OPT_gcoff = 2022,                          /* -gcoff */
  OPT_gcoff1 = 2023,                         /* -gcoff1 */
  OPT_gcoff2 = 2024,                         /* -gcoff2 */
  OPT_gcoff3 = 2025,                         /* -gcoff3 */
  OPT_gcolumn_info = 2026,                   /* -gcolumn-info */
  OPT_gctf = 2027,                           /* -gctf */
  OPT_gdescribe_dies = 2028,                 /* -gdescribe-dies */
  OPT_gdwarf = 2029,                         /* -gdwarf */
  OPT_gdwarf_ = 2030,                        /* -gdwarf- */
  OPT_gdwarf32 = 2031,                       /* -gdwarf32 */
  OPT_gdwarf64 = 2032,                       /* -gdwarf64 */
  OPT_gen_decls = 2033,                      /* -gen-decls */
  OPT_ggdb = 2034,                           /* -ggdb */
  OPT_ggnu_pubnames = 2035,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 2036,                   /* -gimple-stats */
  OPT_ginline_points = 2037,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 2038, /* -ginternal-reset-location-views */
  OPT_gnat = 2039,                           /* -gnat */
  OPT_gnatO = 2040,                          /* -gnatO */
  OPT_gno_ = 2041,                           /* -gno- */
  OPT_gno_pubnames = 2042,                   /* -gno-pubnames */
  OPT_gprune_btf = 2043,                     /* -gprune-btf */
  OPT_gpubnames = 2044,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 2045,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 2046,                   /* -gsplit-dwarf */
  OPT_gstabs = 2047,                         /* -gstabs */
  OPT_gstabs_ = 2048,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 2049,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 2050,                  /* -gstrict-dwarf */
  OPT_gtoggle = 2051,                        /* -gtoggle */
  OPT_gvariable_location_views = 2052,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 2053,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 2054,                           /* -gvms */
  OPT_gxcoff = 2055,                         /* -gxcoff */
  OPT_gxcoff_ = 2056,                        /* -gxcoff+ */
  OPT_gz = 2057,                             /* -gz */
  OPT_gz_ = 2058,                            /* -gz= */
  OPT_h = 2059,                              /* -h */
  OPT_help = 2060,                           /* -help */
  OPT_idirafter = 2061,                      /* -idirafter */
  OPT_imacros = 2062,                        /* -imacros */
  OPT_imultiarch = 2063,                     /* -imultiarch */
  OPT_imultilib = 2064,                      /* -imultilib */
  OPT_include = 2065,                        /* -include */
  OPT_iplugindir_ = 2066,                    /* -iplugindir= */
  OPT_iprefix = 2067,                        /* -iprefix */
  OPT_iquote = 2068,                         /* -iquote */
  OPT_isysroot = 2069,                       /* -isysroot */
  OPT_isystem = 2070,                        /* -isystem */
  OPT_iwithprefix = 2071,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 2072,              /* -iwithprefixbefore */
  OPT_k8 = 2073,                             /* -k8 */
  OPT_l = 2074,                              /* -l */
  OPT_lang_asm = 2075,                       /* -lang-asm */
  OPT_list = 2076,                           /* -list */
  OPT_mabi_ = 2077,                          /* -mabi= */
  OPT_main = 2078,                           /* -main */
  OPT_main_ = 2079,                          /* -main= */
  OPT_march_ = 2080,                         /* -march= */
  OPT_mautovec_preference_ = 2081,           /* -mautovec-preference= */
  OPT_mbig_endian = 2082,                    /* -mbig-endian */
  OPT_mbionic = 2083,                        /* -mbionic */
  OPT_mbranch_protection_ = 2084,            /* -mbranch-protection= */
  OPT_mcmodel_ = 2085,                       /* -mcmodel= */
  OPT_mcpu_ = 2086,                          /* -mcpu= */
  OPT_mearly_ldp_fusion = 2087,              /* -mearly-ldp-fusion */
  OPT_mearly_ra_ = 2088,                     /* -mearly-ra= */
  OPT_mfix_cortex_a53_835769 = 2089,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 2090,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 2091,             /* -mgeneral-regs-only */
  OPT_mglibc = 2092,                         /* -mglibc */
  OPT_mharden_sls_ = 2093,                   /* -mharden-sls= */
  OPT_mlate_ldp_fusion = 2094,               /* -mlate-ldp-fusion */
  OPT_mlittle_endian = 2095,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 2096,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 2097,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 2098,            /* -mlow-precision-sqrt */
  OPT_mmax_vectorization = 2099,             /* -mmax-vectorization */
  OPT_mmusl = 2100,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 2101,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 2102,               /* -moutline-atomics */
  OPT_moverride_ = 2103,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 2104,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 2105,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 2106, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2107,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 2108,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 2109,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 2110,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 2111,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 2112,                     /* -mtls-size= */
  OPT_mtp_ = 2113,                           /* -mtp= */
  OPT_mtrack_speculation = 2114,             /* -mtrack-speculation */
  OPT_mtune_ = 2115,                         /* -mtune= */
  OPT_muclibc = 2116,                        /* -muclibc */
  OPT_mverbose_cost_dump = 2117,             /* -mverbose-cost-dump */
  OPT_n = 2118,                              /* -n */
  OPT_name_sort = 2119,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2120,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2121,              /* -no-integrated-cpp */
  OPT_no_pie = 2122,                         /* -no-pie */
  OPT_nocpp = 2123,                          /* -nocpp */
  OPT_nodefaultlibs = 2124,                  /* -nodefaultlibs */
  OPT_nolibc = 2125,                         /* -nolibc */
  OPT_nomain = 2126,                         /* -nomain */
  OPT_nophoboslib = 2127,                    /* -nophoboslib */
  OPT_nostartfiles = 2128,                   /* -nostartfiles */
  OPT_nostdinc = 2129,                       /* -nostdinc */
  OPT_nostdinc__ = 2130,                     /* -nostdinc++ */
  OPT_nostdlib = 2131,                       /* -nostdlib */
  OPT_nostdlib__ = 2132,                     /* -nostdlib++ */
  OPT_o = 2133,                              /* -o */
  OPT_objects = 2134,                        /* -objects */
  OPT_p = 2135,                              /* -p */
  OPT_pass_exit_codes = 2136,                /* -pass-exit-codes */
  /* OPT_pedantic = 2137, */                 /* -pedantic */
  OPT_pedantic_errors = 2138,                /* -pedantic-errors */
  OPT_pg = 2139,                             /* -pg */
  OPT_pie = 2140,                            /* -pie */
  OPT_pipe = 2141,                           /* -pipe */
  OPT_posix = 2142,                          /* -posix */
  OPT_preprocess = 2143,                     /* -preprocess */
  OPT_print_file_name_ = 2144,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2145,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2146,          /* -print-multi-directory */
  OPT_print_multi_lib = 2147,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2148,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2149,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2150,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2151,               /* -print-prog-name= */
  OPT_print_search_dirs = 2152,              /* -print-search-dirs */
  OPT_print_sysroot = 2153,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2154,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2155,                    /* -print-value */
  OPT_profile = 2156,                        /* -profile */
  OPT_pthread = 2157,                        /* -pthread */
  OPT_quiet = 2158,                          /* -quiet */
  OPT_r = 2159,                              /* -r */
  OPT_rdynamic = 2160,                       /* -rdynamic */
  OPT_remap = 2161,                          /* -remap */
  OPT_reverse_sort = 2162,                   /* -reverse-sort */
  OPT_s = 2163,                              /* -s */
  OPT_save_temps = 2164,                     /* -save-temps */
  OPT_save_temps_ = 2165,                    /* -save-temps= */
  OPT_shared = 2166,                         /* -shared */
  OPT_shared_libgcc = 2167,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2168,               /* -shared-libphobos */
  OPT_size_sort = 2169,                      /* -size-sort */
  /* OPT_specs = 2170, */                    /* -specs */
  OPT_specs_ = 2171,                         /* -specs= */
  OPT_static = 2172,                         /* -static */
  OPT_static_libasan = 2173,                 /* -static-libasan */
  OPT_static_libgcc = 2174,                  /* -static-libgcc */
  OPT_static_libgcobol = 2175,               /* -static-libgcobol */
  OPT_static_libgfortran = 2176,             /* -static-libgfortran */
  OPT_static_libgm2 = 2177,                  /* -static-libgm2 */
  OPT_static_libgo = 2178,                   /* -static-libgo */
  OPT_static_libhwasan = 2179,               /* -static-libhwasan */
  OPT_static_liblsan = 2180,                 /* -static-liblsan */
  OPT_static_libmpx = 2181,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2182,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2183,               /* -static-libphobos */
  OPT_static_libquadmath = 2184,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2185,               /* -static-libstdc++ */
  OPT_static_libtsan = 2186,                 /* -static-libtsan */
  OPT_static_libubsan = 2187,                /* -static-libubsan */
  OPT_static_pie = 2188,                     /* -static-pie */
  /* OPT_std_c__03 = 2189, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2190, */                /* -std=c++0x */
  OPT_std_c__11 = 2191,                      /* -std=c++11 */
  OPT_std_c__14 = 2192,                      /* -std=c++14 */
  OPT_std_c__17 = 2193,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2194, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2195, */                /* -std=c++1z */
  OPT_std_c__20 = 2196,                      /* -std=c++20 */
  OPT_std_c__23 = 2197,                      /* -std=c++23 */
  OPT_std_c__26 = 2198,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2199, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2200, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2201, */                /* -std=c++2c */
  OPT_std_c__98 = 2202,                      /* -std=c++98 */
  OPT_std_c11 = 2203,                        /* -std=c11 */
  OPT_std_c17 = 2204,                        /* -std=c17 */
  /* OPT_std_c18 = 2205, */                  /* -std=c18 */
  /* OPT_std_c1x = 2206, */                  /* -std=c1x */
  OPT_std_c23 = 2207,                        /* -std=c23 */
  /* OPT_std_c2x = 2208, */                  /* -std=c2x */
  OPT_std_c2y = 2209,                        /* -std=c2y */
  /* OPT_std_c89 = 2210, */                  /* -std=c89 */
  OPT_std_c90 = 2211,                        /* -std=c90 */
  OPT_std_c99 = 2212,                        /* -std=c99 */
  /* OPT_std_c9x = 2213, */                  /* -std=c9x */
  OPT_std_f2003 = 2214,                      /* -std=f2003 */
  OPT_std_f2008 = 2215,                      /* -std=f2008 */
  OPT_std_f2008ts = 2216,                    /* -std=f2008ts */
  OPT_std_f2018 = 2217,                      /* -std=f2018 */
  OPT_std_f2023 = 2218,                      /* -std=f2023 */
  OPT_std_f202y = 2219,                      /* -std=f202y */
  OPT_std_f95 = 2220,                        /* -std=f95 */
  OPT_std_gnu = 2221,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2222, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2223, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2224,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2225,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2226,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2227, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2228, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2229,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2230,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2231,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2232, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2233, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2234, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2235,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2236,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2237,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2238, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2239, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2240,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2241, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2242,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2243, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2244,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2245,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2246, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2247, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2248,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2249, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2250, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2251, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2252, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2253, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2254, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2255,                     /* -std=legacy */
  OPT_stdlib_ = 2256,                        /* -stdlib= */
  OPT_symbol_ = 2257,                        /* -symbol= */
  OPT_symbolic = 2258,                       /* -symbolic */
  OPT_t = 2259,                              /* -t */
  OPT_time = 2260,                           /* -time */
  OPT_time_ = 2261,                          /* -time= */
  OPT_traditional = 2262,                    /* -traditional */
  OPT_traditional_cpp = 2263,                /* -traditional-cpp */
  OPT_tree_stats = 2264,                     /* -tree-stats */
  OPT_trigraphs = 2265,                      /* -trigraphs */
  OPT_truncate = 2266,                       /* -truncate */
  OPT_type_stats = 2267,                     /* -type-stats */
  OPT_u = 2268,                              /* -u */
  OPT_undef = 2269,                          /* -undef */
  OPT_v = 2270,                              /* -v */
  OPT_version = 2271,                        /* -version */
  OPT_w = 2272,                              /* -w */
  OPT_wrapper = 2273,                        /* -wrapper */
  OPT_x = 2274,                              /* -x */
  OPT_z = 2275,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
