...
enum opt_code
{
  ...
  OPT__param_avg_loop_niter_ = 105,          /* --param=avg-loop-niter= */
  OPT__param_avoid_fma_max_bits_ = 106,      /* --param=avoid-fma-max-bits= */
  OPT__param_builtin_expect_probability_ = 107,/* --param=builtin-expect-probability= */
  OPT__param_builtin_string_cmp_inline_length_ = 108,/* --param=builtin-string-cmp-inline-length= */
  OPT__param_case_values_threshold_ = 109,   /* --param=case-values-threshold= */
  OPT__param_comdat_sharing_probability_ = 110,/* --param=comdat-sharing-probability= */
  OPT__param_constructive_interference_size_ = 111,/* --param=constructive-interference-size= */
  OPT__param_cxx_max_namespaces_for_diagnostic_help_ = 112,/* --param=cxx-max-namespaces-for-diagnostic-help= */
  OPT__param_cycle_accurate_model_ = 113,    /* --param=cycle-accurate-model= */
  OPT__param_destructive_interference_size_ = 114,/* --param=destructive-interference-size= */
  OPT__param_dse_max_alias_queries_per_store_ = 115,/* --param=dse-max-alias-queries-per-store= */
  OPT__param_dse_max_object_size_ = 116,     /* --param=dse-max-object-size= */
  OPT__param_early_inlining_insns_ = 117,    /* --param=early-inlining-insns= */
  OPT__param_file_cache_files_ = 118,        /* --param=file-cache-files= */
  OPT__param_file_cache_lines_ = 119,        /* --param=file-cache-lines= */
  OPT__param_fsm_scale_path_stmts_ = 120,    /* --param=fsm-scale-path-stmts= */
  OPT__param_fully_pipelined_fma_ = 121,     /* --param=fully-pipelined-fma= */
  OPT__param_gcse_after_reload_critical_fraction_ = 122,/* --param=gcse-after-reload-critical-fraction= */
  OPT__param_gcse_after_reload_partial_fraction_ = 123,/* --param=gcse-after-reload-partial-fraction= */
  OPT__param_gcse_cost_distance_ratio_ = 124,/* --param=gcse-cost-distance-ratio= */
  OPT__param_gcse_unrestricted_cost_ = 125,  /* --param=gcse-unrestricted-cost= */
  OPT__param_ggc_min_expand_ = 126,          /* --param=ggc-min-expand= */
  OPT__param_ggc_min_heapsize_ = 127,        /* --param=ggc-min-heapsize= */
  OPT__param_gimple_fe_computed_hot_bb_threshold_ = 128,/* --param=gimple-fe-computed-hot-bb-threshold= */
  OPT__param_graphite_allow_codegen_errors_ = 129,/* --param=graphite-allow-codegen-errors= */
  OPT__param_graphite_max_arrays_per_scop_ = 130,/* --param=graphite-max-arrays-per-scop= */
  OPT__param_graphite_max_nb_scop_params_ = 131,/* --param=graphite-max-nb-scop-params= */
  OPT__param_hardcfr_max_blocks_ = 132,      /* --param=hardcfr-max-blocks= */
  OPT__param_hardcfr_max_inline_blocks_ = 133,/* --param=hardcfr-max-inline-blocks= */
  OPT__param_hash_table_verification_limit_ = 134,/* --param=hash-table-verification-limit= */
  OPT__param_hot_bb_count_fraction_ = 135,   /* --param=hot-bb-count-fraction= */
  OPT__param_hot_bb_count_ws_permille_ = 136,/* --param=hot-bb-count-ws-permille= */
  OPT__param_hot_bb_frequency_fraction_ = 137,/* --param=hot-bb-frequency-fraction= */
  OPT__param_hwasan_instrument_allocas_ = 138,/* --param=hwasan-instrument-allocas= */
  OPT__param_hwasan_instrument_mem_intrinsics_ = 139,/* --param=hwasan-instrument-mem-intrinsics= */
  OPT__param_hwasan_instrument_reads_ = 140, /* --param=hwasan-instrument-reads= */
  OPT__param_hwasan_instrument_stack_ = 141, /* --param=hwasan-instrument-stack= */
  OPT__param_hwasan_instrument_writes_ = 142,/* --param=hwasan-instrument-writes= */
  OPT__param_hwasan_random_frame_tag_ = 143, /* --param=hwasan-random-frame-tag= */
  OPT__param_inline_heuristics_hint_percent_ = 144,/* --param=inline-heuristics-hint-percent= */
  OPT__param_inline_min_speedup_ = 145,      /* --param=inline-min-speedup= */
  OPT__param_inline_unit_growth_ = 146,      /* --param=inline-unit-growth= */
  OPT__param_integer_share_limit_ = 147,     /* --param=integer-share-limit= */
  OPT__param_ipa_cp_eval_threshold_ = 148,   /* --param=ipa-cp-eval-threshold= */
  OPT__param_ipa_cp_large_unit_insns_ = 149, /* --param=ipa-cp-large-unit-insns= */
  OPT__param_ipa_cp_loop_hint_bonus_ = 150,  /* --param=ipa-cp-loop-hint-bonus= */
  OPT__param_ipa_cp_max_recursive_depth_ = 151,/* --param=ipa-cp-max-recursive-depth= */
  OPT__param_ipa_cp_min_recursive_probability_ = 152,/* --param=ipa-cp-min-recursive-probability= */
  OPT__param_ipa_cp_recursion_penalty_ = 153,/* --param=ipa-cp-recursion-penalty= */
  OPT__param_ipa_cp_recursive_freq_factor_ = 154,/* --param=ipa-cp-recursive-freq-factor= */
  OPT__param_ipa_cp_single_call_penalty_ = 155,/* --param=ipa-cp-single-call-penalty= */
  OPT__param_ipa_cp_unit_growth_ = 156,      /* --param=ipa-cp-unit-growth= */
  OPT__param_ipa_cp_value_list_size_ = 157,  /* --param=ipa-cp-value-list-size= */
  OPT__param_ipa_jump_function_lookups_ = 158,/* --param=ipa-jump-function-lookups= */
  OPT__param_ipa_max_aa_steps_ = 159,        /* --param=ipa-max-aa-steps= */
  OPT__param_ipa_max_agg_items_ = 160,       /* --param=ipa-max-agg-items= */
  OPT__param_ipa_max_loop_predicates_ = 161, /* --param=ipa-max-loop-predicates= */
  OPT__param_ipa_max_param_expr_ops_ = 162,  /* --param=ipa-max-param-expr-ops= */
  OPT__param_ipa_max_switch_predicate_bounds_ = 163,/* --param=ipa-max-switch-predicate-bounds= */
  OPT__param_ipa_sra_deref_prob_threshold_ = 164,/* --param=ipa-sra-deref-prob-threshold= */
  OPT__param_ipa_sra_max_replacements_ = 165,/* --param=ipa-sra-max-replacements= */
  OPT__param_ipa_sra_ptr_growth_factor_ = 166,/* --param=ipa-sra-ptr-growth-factor= */
  OPT__param_ipa_sra_ptrwrap_growth_factor_ = 167,/* --param=ipa-sra-ptrwrap-growth-factor= */
  OPT__param_ira_consider_dup_in_all_alts_ = 168,/* --param=ira-consider-dup-in-all-alts= */
  OPT__param_ira_loop_reserved_regs_ = 169,  /* --param=ira-loop-reserved-regs= */
  OPT__param_ira_max_conflict_table_size_ = 170,/* --param=ira-max-conflict-table-size= */
  OPT__param_ira_max_loops_num_ = 171,       /* --param=ira-max-loops-num= */
  OPT__param_ira_simple_lra_insn_threshold_ = 172,/* --param=ira-simple-lra-insn-threshold= */
  OPT__param_iv_always_prune_cand_set_bound_ = 173,/* --param=iv-always-prune-cand-set-bound= */
  OPT__param_iv_consider_all_candidates_bound_ = 174,/* --param=iv-consider-all-candidates-bound= */
  OPT__param_iv_max_considered_uses_ = 175,  /* --param=iv-max-considered-uses= */
  OPT__param_jump_table_max_growth_ratio_for_size_ = 176,/* --param=jump-table-max-growth-ratio-for-size= */
  OPT__param_jump_table_max_growth_ratio_for_speed_ = 177,/* --param=jump-table-max-growth-ratio-for-speed= */
  OPT__param_l1_cache_line_size_ = 178,      /* --param=l1-cache-line-size= */
  OPT__param_l1_cache_size_ = 179,           /* --param=l1-cache-size= */
  OPT__param_l2_cache_size_ = 180,           /* --param=l2-cache-size= */
  OPT__param_large_function_growth_ = 181,   /* --param=large-function-growth= */
  OPT__param_large_function_insns_ = 182,    /* --param=large-function-insns= */
  OPT__param_large_stack_frame_growth_ = 183,/* --param=large-stack-frame-growth= */
  OPT__param_large_stack_frame_ = 184,       /* --param=large-stack-frame= */
  OPT__param_large_unit_insns_ = 185,        /* --param=large-unit-insns= */
  OPT__param_lazy_modules_ = 186,            /* --param=lazy-modules= */
  OPT__param_lim_expensive_ = 187,           /* --param=lim-expensive= */
  OPT__param_logical_op_non_short_circuit_ = 188,/* --param=logical-op-non-short-circuit= */
  OPT__param_loop_block_tile_size_ = 189,    /* --param=loop-block-tile-size= */
  OPT__param_loop_interchange_max_num_stmts_ = 190,/* --param=loop-interchange-max-num-stmts= */
  OPT__param_loop_interchange_stride_ratio_ = 191,/* --param=loop-interchange-stride-ratio= */
  OPT__param_loop_invariant_max_bbs_in_loop_ = 192,/* --param=loop-invariant-max-bbs-in-loop= */
  OPT__param_loop_max_datarefs_for_datadeps_ = 193,/* --param=loop-max-datarefs-for-datadeps= */
  OPT__param_loop_versioning_max_inner_insns_ = 194,/* --param=loop-versioning-max-inner-insns= */
  OPT__param_loop_versioning_max_outer_insns_ = 195,/* --param=loop-versioning-max-outer-insns= */
  OPT__param_lra_inheritance_ebb_probability_cutoff_ = 196,/* --param=lra-inheritance-ebb-probability-cutoff= */
  OPT__param_lra_max_considered_reload_pseudos_ = 197,/* --param=lra-max-considered-reload-pseudos= */
  OPT__param_lra_max_pseudos_points_log2_considered_for_preferences_ = 198,/* --param=lra-max-pseudos-points-log2-considered-for-preferences= */
  OPT__param_lto_max_locality_partition_ = 199,/* --param=lto-max-locality-partition= */
  OPT__param_lto_max_partition_ = 200,       /* --param=lto-max-partition= */
  OPT__param_lto_max_streaming_parallelism_ = 201,/* --param=lto-max-streaming-parallelism= */
  OPT__param_lto_min_partition_ = 202,       /* --param=lto-min-partition= */
  OPT__param_lto_partition_locality_cloning_ = 203,/* --param=lto-partition-locality-cloning= */
  OPT__param_lto_partition_locality_frequency_cutoff_ = 204,/* --param=lto-partition-locality-frequency-cutoff= */
  OPT__param_lto_partition_locality_size_cutoff_ = 205,/* --param=lto-partition-locality-size-cutoff= */
  OPT__param_lto_partitions_ = 206,          /* --param=lto-partitions= */
  OPT__param_max_average_unrolled_insns_ = 207,/* --param=max-average-unrolled-insns= */
  OPT__param_max_combine_insns_ = 208,       /* --param=max-combine-insns= */
  OPT__param_max_combine_search_insns_ = 209,/* --param=max-combine-search-insns= */
  OPT__param_max_completely_peel_loop_nest_depth_ = 210,/* --param=max-completely-peel-loop-nest-depth= */
  OPT__param_max_completely_peel_times_ = 211,/* --param=max-completely-peel-times= */
  OPT__param_max_completely_peeled_insns_ = 212,/* --param=max-completely-peeled-insns= */
  OPT__param_max_crossjump_edges_ = 213,     /* --param=max-crossjump-edges= */
  OPT__param_max_cse_insns_ = 214,           /* --param=max-cse-insns= */
  OPT__param_max_cse_path_length_ = 215,     /* --param=max-cse-path-length= */
  OPT__param_max_cselib_memory_locations_ = 216,/* --param=max-cselib-memory-locations= */
  OPT__param_max_debug_marker_count_ = 217,  /* --param=max-debug-marker-count= */
  OPT__param_max_delay_slot_insn_search_ = 218,/* --param=max-delay-slot-insn-search= */
  OPT__param_max_delay_slot_live_search_ = 219,/* --param=max-delay-slot-live-search= */
  OPT__param_max_devirt_targets_ = 220,      /* --param=max-devirt-targets= */
  OPT__param_max_dse_active_local_stores_ = 221,/* --param=max-dse-active-local-stores= */
  OPT__param_max_early_inliner_iterations_ = 222,/* --param=max-early-inliner-iterations= */
  OPT__param_max_fields_for_field_sensitive_ = 223,/* --param=max-fields-for-field-sensitive= */
  OPT__param_max_find_base_term_values_ = 224,/* --param=max-find-base-term-values= */
  OPT__param_max_fsm_thread_path_insns_ = 225,/* --param=max-fsm-thread-path-insns= */
  OPT__param_max_gcse_insertion_ratio_ = 226,/* --param=max-gcse-insertion-ratio= */
  OPT__param_max_gcse_memory_ = 227,         /* --param=max-gcse-memory= */
  OPT__param_max_goto_duplication_insns_ = 228,/* --param=max-goto-duplication-insns= */
  OPT__param_max_grow_copy_bb_insns_ = 229,  /* --param=max-grow-copy-bb-insns= */
  OPT__param_max_hoist_depth_ = 230,         /* --param=max-hoist-depth= */
  OPT__param_max_inline_functions_called_once_insns_ = 231,/* --param=max-inline-functions-called-once-insns= */
  OPT__param_max_inline_functions_called_once_loop_depth_ = 232,/* --param=max-inline-functions-called-once-loop-depth= */
  OPT__param_max_inline_insns_auto_ = 233,   /* --param=max-inline-insns-auto= */
  OPT__param_max_inline_insns_recursive_auto_ = 234,/* --param=max-inline-insns-recursive-auto= */
  OPT__param_max_inline_insns_recursive_ = 235,/* --param=max-inline-insns-recursive= */
  OPT__param_max_inline_insns_single_ = 236, /* --param=max-inline-insns-single= */
  OPT__param_max_inline_insns_size_ = 237,   /* --param=max-inline-insns-size= */
  OPT__param_max_inline_insns_small_ = 238,  /* --param=max-inline-insns-small= */
  OPT__param_max_inline_recursive_depth_auto_ = 239,/* --param=max-inline-recursive-depth-auto= */
  OPT__param_max_inline_recursive_depth_ = 240,/* --param=max-inline-recursive-depth= */
  OPT__param_max_isl_operations_ = 241,      /* --param=max-isl-operations= */
  OPT__param_max_iterations_computation_cost_ = 242,/* --param=max-iterations-computation-cost= */
  OPT__param_max_iterations_to_track_ = 243, /* --param=max-iterations-to-track= */
  OPT__param_max_jump_thread_duplication_stmts_ = 244,/* --param=max-jump-thread-duplication-stmts= */
  OPT__param_max_jump_thread_paths_ = 245,   /* --param=max-jump-thread-paths= */
  OPT__param_max_last_value_rtl_ = 246,      /* --param=max-last-value-rtl= */
  OPT__param_max_loop_header_insns_ = 247,   /* --param=max-loop-header-insns= */
  OPT__param_max_modulo_backtrack_attempts_ = 248,/* --param=max-modulo-backtrack-attempts= */
  OPT__param_max_partial_antic_length_ = 249,/* --param=max-partial-antic-length= */
  OPT__param_max_peel_branches_ = 250,       /* --param=max-peel-branches= */
  OPT__param_max_peel_times_ = 251,          /* --param=max-peel-times= */
  OPT__param_max_peeled_insns_ = 252,        /* --param=max-peeled-insns= */
  OPT__param_max_pending_list_length_ = 253, /* --param=max-pending-list-length= */
  OPT__param_max_pipeline_region_blocks_ = 254,/* --param=max-pipeline-region-blocks= */
  OPT__param_max_pipeline_region_insns_ = 255,/* --param=max-pipeline-region-insns= */
  OPT__param_max_pow_sqrt_depth_ = 256,      /* --param=max-pow-sqrt-depth= */
  OPT__param_max_predicted_iterations_ = 257,/* --param=max-predicted-iterations= */
  OPT__param_max_reload_search_insns_ = 258, /* --param=max-reload-search-insns= */
  OPT__param_max_rtl_if_conversion_insns_ = 259,/* --param=max-rtl-if-conversion-insns= */
  OPT__param_max_rtl_if_conversion_predictable_cost_ = 260,/* --param=max-rtl-if-conversion-predictable-cost= */
  OPT__param_max_rtl_if_conversion_unpredictable_cost_ = 261,/* --param=max-rtl-if-conversion-unpredictable-cost= */
  OPT__param_max_sched_extend_regions_iters_ = 262,/* --param=max-sched-extend-regions-iters= */
  OPT__param_max_sched_insn_conflict_delay_ = 263,/* --param=max-sched-insn-conflict-delay= */
  OPT__param_max_sched_ready_insns_ = 264,   /* --param=max-sched-ready-insns= */
  OPT__param_max_sched_region_blocks_ = 265, /* --param=max-sched-region-blocks= */
  OPT__param_max_sched_region_insns_ = 266,  /* --param=max-sched-region-insns= */
  OPT__param_max_slsr_cand_scan_ = 267,      /* --param=max-slsr-cand-scan= */
  OPT__param_max_speculative_devirt_maydefs_ = 268,/* --param=max-speculative-devirt-maydefs= */
  OPT__param_max_ssa_name_query_depth_ = 269,/* --param=max-ssa-name-query-depth= */
  OPT__param_max_store_chains_to_track_ = 270,/* --param=max-store-chains-to-track= */
  OPT__param_max_stores_to_merge_ = 271,     /* --param=max-stores-to-merge= */
  OPT__param_max_stores_to_sink_ = 272,      /* --param=max-stores-to-sink= */
  OPT__param_max_stores_to_track_ = 273,     /* --param=max-stores-to-track= */
  OPT__param_max_tail_merge_comparisons_ = 274,/* --param=max-tail-merge-comparisons= */
  OPT__param_max_tail_merge_iterations_ = 275,/* --param=max-tail-merge-iterations= */
  OPT__param_max_tracked_strlens_ = 276,     /* --param=max-tracked-strlens= */
  OPT__param_max_tree_if_conversion_phi_args_ = 277,/* --param=max-tree-if-conversion-phi-args= */
  OPT__param_max_unroll_times_ = 278,        /* --param=max-unroll-times= */
  OPT__param_max_unrolled_insns_ = 279,      /* --param=max-unrolled-insns= */
  OPT__param_max_unswitch_depth_ = 280,      /* --param=max-unswitch-depth= */
  OPT__param_max_unswitch_insns_ = 281,      /* --param=max-unswitch-insns= */
  OPT__param_max_variable_expansions_in_unroller_ = 282,/* --param=max-variable-expansions-in-unroller= */
  OPT__param_max_vartrack_expr_depth_ = 283, /* --param=max-vartrack-expr-depth= */
  OPT__param_max_vartrack_reverse_op_size_ = 284,/* --param=max-vartrack-reverse-op-size= */
  OPT__param_max_vartrack_size_ = 285,       /* --param=max-vartrack-size= */
  OPT__param_memtag_instrument_allocas_ = 286,/* --param=memtag-instrument-allocas= */
  OPT__param_memtag_instrument_mem_intrinsics_ = 287,/* --param=memtag-instrument-mem-intrinsics= */
  OPT__param_min_crossjump_insns_ = 288,     /* --param=min-crossjump-insns= */
  OPT__param_min_inline_recursive_probability_ = 289,/* --param=min-inline-recursive-probability= */
  OPT__param_min_insn_to_prefetch_ratio_ = 290,/* --param=min-insn-to-prefetch-ratio= */
  OPT__param_min_loop_cond_split_prob_ = 291,/* --param=min-loop-cond-split-prob= */
  OPT__param_min_nondebug_insn_uid_ = 292,   /* --param=min-nondebug-insn-uid= */
  OPT__param_min_pagesize_ = 293,            /* --param=min-pagesize= */
  OPT__param_min_size_for_stack_sharing_ = 294,/* --param=min-size-for-stack-sharing= */
  OPT__param_min_spec_prob_ = 295,           /* --param=min-spec-prob= */
  OPT__param_min_vect_loop_bound_ = 296,     /* --param=min-vect-loop-bound= */
  OPT__param_modref_max_accesses_ = 297,     /* --param=modref-max-accesses= */
  OPT__param_modref_max_adjustments_ = 298,  /* --param=modref-max-adjustments= */
  OPT__param_modref_max_bases_ = 299,        /* --param=modref-max-bases= */
  OPT__param_modref_max_depth_ = 300,        /* --param=modref-max-depth= */
  OPT__param_modref_max_escape_points_ = 301,/* --param=modref-max-escape-points= */
  OPT__param_modref_max_refs_ = 302,         /* --param=modref-max-refs= */
  OPT__param_modref_max_tests_ = 303,        /* --param=modref-max-tests= */
  OPT__param_openacc_kernels_ = 304,         /* --param=openacc-kernels= */
  OPT__param_openacc_privatization_ = 305,   /* --param=openacc-privatization= */
  OPT__param_parloops_chunk_size_ = 306,     /* --param=parloops-chunk-size= */
  OPT__param_parloops_min_per_thread_ = 307, /* --param=parloops-min-per-thread= */
  OPT__param_parloops_schedule_ = 308,       /* --param=parloops-schedule= */
  OPT__param_partial_inlining_entry_probability_ = 309,/* --param=partial-inlining-entry-probability= */
  OPT__param_phiopt_factor_max_stmts_live_ = 310,/* --param=phiopt-factor-max-stmts-live= */
  OPT__param_predictable_branch_outcome_ = 311,/* --param=predictable-branch-outcome= */
  OPT__param_prefetch_dynamic_strides_ = 312,/* --param=prefetch-dynamic-strides= */
  OPT__param_prefetch_latency_ = 313,        /* --param=prefetch-latency= */
  OPT__param_prefetch_min_insn_to_mem_ratio_ = 314,/* --param=prefetch-min-insn-to-mem-ratio= */
  OPT__param_prefetch_minimum_stride_ = 315, /* --param=prefetch-minimum-stride= */
  OPT__param_profile_func_internal_id_ = 316,/* --param=profile-func-internal-id= */
  OPT__param_ranger_debug_ = 317,            /* --param=ranger-debug= */
  OPT__param_ranger_logical_depth_ = 318,    /* --param=ranger-logical-depth= */
  OPT__param_ranger_recompute_depth_ = 319,  /* --param=ranger-recompute-depth= */
  OPT__param_relation_block_limit_ = 320,    /* --param=relation-block-limit= */
  OPT__param_rpo_vn_max_loop_depth_ = 321,   /* --param=rpo-vn-max-loop-depth= */
  OPT__param_sccvn_max_alias_queries_per_access_ = 322,/* --param=sccvn-max-alias-queries-per-access= */
  OPT__param_scev_max_expr_complexity_ = 323,/* --param=scev-max-expr-complexity= */
  OPT__param_scev_max_expr_size_ = 324,      /* --param=scev-max-expr-size= */
  OPT__param_sched_autopref_queue_depth_ = 325,/* --param=sched-autopref-queue-depth= */
  OPT__param_sched_mem_true_dep_cost_ = 326, /* --param=sched-mem-true-dep-cost= */
  OPT__param_sched_pressure_algorithm_ = 327,/* --param=sched-pressure-algorithm= */
  OPT__param_sched_spec_prob_cutoff_ = 328,  /* --param=sched-spec-prob-cutoff= */
  OPT__param_sched_state_edge_prob_cutoff_ = 329,/* --param=sched-state-edge-prob-cutoff= */
  OPT__param_selsched_insns_to_rename_ = 330,/* --param=selsched-insns-to-rename= */
  OPT__param_selsched_max_lookahead_ = 331,  /* --param=selsched-max-lookahead= */
  OPT__param_selsched_max_sched_times_ = 332,/* --param=selsched-max-sched-times= */
  OPT__param_simultaneous_prefetches_ = 333, /* --param=simultaneous-prefetches= */
  OPT__param_sink_frequency_threshold_ = 334,/* --param=sink-frequency-threshold= */
  OPT__param_sms_dfa_history_ = 335,         /* --param=sms-dfa-history= */
  OPT__param_sms_loop_average_count_threshold_ = 336,/* --param=sms-loop-average-count-threshold= */
  OPT__param_sms_max_ii_factor_ = 337,       /* --param=sms-max-ii-factor= */
  OPT__param_sms_min_sc_ = 338,              /* --param=sms-min-sc= */
  OPT__param_sra_max_propagations_ = 339,    /* --param=sra-max-propagations= */
  OPT__param_sra_max_scalarization_size_Osize_ = 340,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 341,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 342,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 343,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 344,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 345,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_forwarding_max_distance_ = 346,/* --param=store-forwarding-max-distance= */
  OPT__param_store_merging_allow_unaligned_ = 347,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 348,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 349,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_threader_debug_ = 350,          /* --param=threader-debug= */
  OPT__param_tm_max_aggregate_size_ = 351,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 352,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 353, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 354,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 355,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 356,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 357, /* --param=tracer-min-branch-ratio= */
  OPT__param_transitive_relations_work_bound_ = 358,/* --param=transitive-relations-work-bound= */
  OPT__param_tree_reassoc_width_ = 359,      /* --param=tree-reassoc-width= */
  OPT__param_tsan_distinguish_volatile_ = 360,/* --param=tsan-distinguish-volatile= */
  OPT__param_tsan_instrument_func_entry_exit_ = 361,/* --param=tsan-instrument-func-entry-exit= */
  OPT__param_uninit_control_dep_attempts_ = 362,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninit_max_chain_len_ = 363,    /* --param=uninit-max-chain-len= */
  OPT__param_uninit_max_num_chains_ = 364,   /* --param=uninit-max-num-chains= */
  OPT__param_uninit_max_prune_work_ = 365,   /* --param=uninit-max-prune-work= */
  OPT__param_uninlined_function_insns_ = 366,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 367, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 368,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 369,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 370,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 371,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 372,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 373,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 374,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 375,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_induction_float_ = 376,    /* --param=vect-induction-float= */
  OPT__param_vect_inner_loop_cost_factor_ = 377,/* --param=vect-inner-loop-cost-factor= */
  OPT__param_vect_max_layout_candidates_ = 378,/* --param=vect-max-layout-candidates= */
  OPT__param_vect_max_peeling_for_alignment_ = 379,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 380,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 381,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 382,/* --param=vect-partial-vector-usage= */
  OPT__param_vect_scalar_cost_multiplier_ = 383,/* --param=vect-scalar-cost-multiplier= */
  ...
  /* OPT__pass_exit_codes = 389, */          /* --pass-exit-codes */
  /* OPT__pedantic = 390, */                 /* --pedantic */
  /* OPT__pedantic_errors = 391, */          /* --pedantic-errors */
  /* OPT__pie = 392, */                      /* --pie */
  /* OPT__pipe = 393, */                     /* --pipe */
  /* OPT__prefix = 394, */                   /* --prefix */
  /* OPT__prefix_ = 395, */                  /* --prefix= */
  /* OPT__preprocess = 396, */               /* --preprocess */
  /* OPT__print_file_name = 397, */          /* --print-file-name */
  /* OPT__print_file_name_ = 398, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 399, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 400, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 401, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 402, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 403, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 404, */          /* --print-multiarch */
  /* OPT__print_prog_name = 405, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 406, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 407, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 408, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 409, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 410, */                  /* --profile */
  /* OPT__save_temps = 411, */               /* --save-temps */
  /* OPT__shared = 412, */                   /* --shared */
  /* OPT__specs = 413, */                    /* --specs */
  /* OPT__specs_ = 414, */                   /* --specs= */
  /* OPT__static = 415, */                   /* --static */
  /* OPT__static_pie = 416, */               /* --static-pie */
  /* OPT__symbolic = 417, */                 /* --symbolic */
  /* OPT__sysroot = 418, */                  /* --sysroot */
  OPT__sysroot_ = 419,                       /* --sysroot= */
  OPT__target_help = 420,                    /* --target-help */
  /* OPT__time = 421, */                     /* --time */
  /* OPT__trace_includes = 422, */           /* --trace-includes */
  /* OPT__traditional = 423, */              /* --traditional */
  /* OPT__traditional_cpp = 424, */          /* --traditional-cpp */
  /* OPT__trigraphs = 425, */                /* --trigraphs */
  /* OPT__undefine_macro = 426, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 427, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 428, */        /* --user-dependencies */
  /* OPT__verbose = 429, */                  /* --verbose */
  OPT__version = 430,                        /* --version */
  /* OPT__write_dependencies = 431, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 432, */  /* --write-user-dependencies */
  OPT_A = 433,                               /* -A */
  OPT_B = 434,                               /* -B */
  OPT_C = 435,                               /* -C */
  OPT_CC = 436,                              /* -CC */
  ...
  OPT_MQ = 453,                              /* -MQ */
  OPT_MT = 454,                              /* -MT */
  OPT_Mmodules = 455,                        /* -Mmodules */
  OPT_Mno_modules = 456,                     /* -Mno-modules */
  OPT_N = 457,                               /* -N */
  OPT_O = 458,                               /* -O */
  OPT_Ofast = 459,                           /* -Ofast */
  OPT_Og = 460,                              /* -Og */
  ...
  OPT_Tbss_ = 471,                           /* -Tbss= */
  OPT_Tdata = 472,                           /* -Tdata */
  OPT_Tdata_ = 473,                          /* -Tdata= */
  OPT_Ttext = 474,                           /* -Ttext */
  OPT_Ttext_ = 475,                          /* -Ttext= */
  OPT_U = 476,                               /* -U */
  /* OPT_W = 477, */                         /* -W */
  OPT_WNSObject_attribute = 478,             /* -WNSObject-attribute */
  OPT_Wa_ = 479,                             /* -Wa, */
  OPT_Wabbreviated_auto_in_template_arg = 480,/* -Wabbreviated-auto-in-template-arg */
  OPT_Wabi = 481,                            /* -Wabi */
  OPT_Wabi_tag = 482,                        /* -Wabi-tag */
  OPT_Wabi_ = 483,                           /* -Wabi= */
  OPT_Wabsolute_value = 484,                 /* -Wabsolute-value */
  OPT_Waddress = 485,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 486,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 487,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 488,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 489,                       /* -Waliasing */
  OPT_Walign_commons = 490,                  /* -Walign-commons */
  /* OPT_Waligned_new = 491, */              /* -Waligned-new */
  OPT_Waligned_new_ = 492,                   /* -Waligned-new= */
  OPT_Wall = 493,                            /* -Wall */
  OPT_Walloc_size = 494,                     /* -Walloc-size */
  OPT_Walloc_size_larger_than_ = 495,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 496,                     /* -Walloc-zero */
  OPT_Walloca = 497,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 498,            /* -Walloca-larger-than= */
  OPT_Wampersand = 499,                      /* -Wampersand */
  OPT_Wanalyzer_allocation_size = 500,       /* -Wanalyzer-allocation-size */
  OPT_Wanalyzer_deref_before_check = 501,    /* -Wanalyzer-deref-before-check */
  OPT_Wanalyzer_double_fclose = 502,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 503,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 504,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_exposure_through_uninit_copy = 505,/* -Wanalyzer-exposure-through-uninit-copy */
  OPT_Wanalyzer_fd_access_mode_mismatch = 506,/* -Wanalyzer-fd-access-mode-mismatch */
  OPT_Wanalyzer_fd_double_close = 507,       /* -Wanalyzer-fd-double-close */
  OPT_Wanalyzer_fd_leak = 508,               /* -Wanalyzer-fd-leak */
  OPT_Wanalyzer_fd_phase_mismatch = 509,     /* -Wanalyzer-fd-phase-mismatch */
  OPT_Wanalyzer_fd_type_mismatch = 510,      /* -Wanalyzer-fd-type-mismatch */
  OPT_Wanalyzer_fd_use_after_close = 511,    /* -Wanalyzer-fd-use-after-close */
  OPT_Wanalyzer_fd_use_without_check = 512,  /* -Wanalyzer-fd-use-without-check */
  OPT_Wanalyzer_file_leak = 513,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 514,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_imprecise_fp_arithmetic = 515,/* -Wanalyzer-imprecise-fp-arithmetic */
  OPT_Wanalyzer_infinite_loop = 516,         /* -Wanalyzer-infinite-loop */
  OPT_Wanalyzer_infinite_recursion = 517,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 518,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 519,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 520,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 521,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 522,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 523,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_overlapping_buffers = 524,   /* -Wanalyzer-overlapping-buffers */
  OPT_Wanalyzer_possible_null_argument = 525,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 526,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 527,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 528,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 529,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 530,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_symbol_too_complex = 531,    /* -Wanalyzer-symbol-too-complex */
  OPT_Wanalyzer_tainted_allocation_size = 532,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 533,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_assertion = 534,     /* -Wanalyzer-tainted-assertion */
  OPT_Wanalyzer_tainted_divisor = 535,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 536,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 537,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_throw_of_unexpected_type = 538,/* -Wanalyzer-throw-of-unexpected-type */
  OPT_Wanalyzer_too_complex = 539,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_undefined_behavior_ptrdiff = 540,/* -Wanalyzer-undefined-behavior-ptrdiff */
  OPT_Wanalyzer_undefined_behavior_strtok = 541,/* -Wanalyzer-undefined-behavior-strtok */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 542,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 543,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 544,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 545,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 546,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 547,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 548,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 549,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 550,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 551,/* -Wanalyzer-write-to-string-literal */
  OPT_Wapply_commit = 552,                   /* -Wapply-commit */
  OPT_Wargument_mismatch = 553,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 554,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 555, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 556,                  /* -Warray-bounds= */
  OPT_Warray_compare = 557,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 558, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 559,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 560,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 561,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 562, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 563,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 564,              /* -Wattribute-warning */
  OPT_Wattributes = 565,                     /* -Wattributes */
  OPT_Wattributes_ = 566,                    /* -Wattributes= */
  OPT_Wauto_profile = 567,                   /* -Wauto-profile */
  OPT_Wbad_function_cast = 568,              /* -Wbad-function-cast */
  OPT_Wbad_line_directive = 569,             /* -Wbad-line-directive */
  OPT_Wbad_numeric = 570,                    /* -Wbad-numeric */
  /* OPT_Wbidi_chars = 571, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 572,                    /* -Wbidi-chars= */
  OPT_Wbinary_long_long = 573,               /* -Wbinary-long-long */
  OPT_Wbool_compare = 574,                   /* -Wbool-compare */
  OPT_Wbool_operation = 575,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 576,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 577,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 578,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 579, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 580,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 581,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 582,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 583,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 584,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 585,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 586, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 587,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 588,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 589,               /* -Wc++23-extensions */
  OPT_Wc__26_compat = 590,                   /* -Wc++26-compat */
  OPT_Wc__26_extensions = 591,               /* -Wc++26-extensions */
  /* OPT_Wc__2a_compat = 592, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 593,                 /* -Wc-binding-type */
  OPT_Wc11_c23_compat = 594,                 /* -Wc11-c23-compat */
  /* OPT_Wc11_c2x_compat = 595, */           /* -Wc11-c2x-compat */
  OPT_Wc23_c2y_compat = 596,                 /* -Wc23-c2y-compat */
  OPT_Wc90_c99_compat = 597,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 598,                 /* -Wc99-c11-compat */
  OPT_Wcall_giving = 599,                    /* -Wcall-giving */
  OPT_Wcalloc_transposed_args = 600,         /* -Wcalloc-transposed-args */
  OPT_Wcannot_profile = 601,                 /* -Wcannot-profile */
  OPT_Wcase_enum = 602,                      /* -Wcase-enum */
  OPT_Wcast_align = 603,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 604,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 605,             /* -Wcast-function-type */
  OPT_Wcast_qual = 606,                      /* -Wcast-qual */
  OPT_Wcast_result = 607,                    /* -Wcast-result */
  OPT_Wcast_user_defined = 608,              /* -Wcast-user-defined */
  /* OPT_Wcatch_value = 609, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 610,                   /* -Wcatch-value= */
  OPT_Wcdf_dollar = 611,                     /* -Wcdf-dollar */
  OPT_Wcdf_invalid_parameter = 612,          /* -Wcdf-invalid-parameter */
  OPT_Wcdf_name_not_found = 613,             /* -Wcdf-name-not-found */
  OPT_Wchanges_meaning = 614,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 615,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 616,           /* -Wcharacter-truncation */
  OPT_Wchkp = 617,                           /* -Wchkp */
  OPT_Wclass_conversion = 618,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 619,                /* -Wclass-memaccess */
  OPT_Wclobbered = 620,                      /* -Wclobbered */
  OPT_Wcobol_eject = 621,                    /* -Wcobol-eject */
  OPT_Wcobol_resume = 622,                   /* -Wcobol-resume */
  OPT_Wcobol_volatile = 623,                 /* -Wcobol-volatile */
  OPT_Wcomma_subscript = 624,                /* -Wcomma-subscript */
  OPT_Wcomment = 625,                        /* -Wcomment */
  /* OPT_Wcomments = 626, */                 /* -Wcomments */
  OPT_Wcomp_6 = 627,                         /* -Wcomp-6 */
  OPT_Wcomp_x = 628,                         /* -Wcomp-x */
  OPT_Wcompare_distinct_pointer_types = 629, /* -Wcompare-distinct-pointer-types */
  OPT_Wcompare_reals = 630,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 631,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 632,        /* -Wconditionally-supported */
  OPT_Wconversion = 633,                     /* -Wconversion */
  OPT_Wconversion_extra = 634,               /* -Wconversion-extra */
  OPT_Wconversion_null = 635,                /* -Wconversion-null */
  OPT_Wcopybook_found = 636,                 /* -Wcopybook-found */
  OPT_Wcoverage_invalid_line_number = 637,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 638,              /* -Wcoverage-mismatch */
  OPT_Wcoverage_too_many_conditions = 639,   /* -Wcoverage-too-many-conditions */
  OPT_Wcoverage_too_many_paths = 640,        /* -Wcoverage-too-many-paths */
  OPT_Wcpp = 641,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 642,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 643,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 644,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 645, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 646,              /* -Wdangling-pointer= */
  OPT_Wdangling_reference = 647,             /* -Wdangling-reference */
  OPT_Wdate_time = 648,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 649,    /* -Wdeclaration-after-statement */
  OPT_Wdeclaration_missing_parameter_type = 650,/* -Wdeclaration-missing-parameter-type */
  OPT_Wdefaulted_function_deleted = 651,     /* -Wdefaulted-function-deleted */
  OPT_Wdelete_incomplete = 652,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 653,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 654,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 655,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 656,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 657,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 658,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 659,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdeprecated_literal_operator = 660,    /* -Wdeprecated-literal-operator */
  OPT_Wdeprecated_non_prototype = 661,       /* -Wdeprecated-non-prototype */
  OPT_Wdeprecated_openmp = 662,              /* -Wdeprecated-openmp */
  OPT_Wdeprecated_variadic_comma_omission = 663,/* -Wdeprecated-variadic-comma-omission */
  OPT_Wdesignated_init = 664,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 665,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 666,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 667,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 668,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 669,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 670,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 671,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 672,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 673,                /* -Wduplicated-cond */
  OPT_Wec_unknown = 674,                     /* -Wec-unknown */
  OPT_Weffc__ = 675,                         /* -Weffc++ */
  OPT_Welaborated_enum_base = 676,           /* -Welaborated-enum-base */
  OPT_Wempty_body = 677,                     /* -Wempty-body */
  OPT_Wendif_labels = 678,                   /* -Wendif-labels */
  OPT_Wentry_convention = 679,               /* -Wentry-convention */
  OPT_Wenum_compare = 680,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 681,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 682,              /* -Wenum-int-mismatch */
  OPT_Wequal_assign = 683,                   /* -Wequal-assign */
  OPT_Werror = 684,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 685, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 686,                         /* -Werror= */
  OPT_Wexceptions = 687,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 688,           /* -Wexpansion-to-defined */
  OPT_Wexperimental_fmv_target = 689,        /* -Wexperimental-fmv-target */
  OPT_Wexpose_global_module_tu_local = 690,  /* -Wexpose-global-module-tu-local */
  OPT_Wextensions = 691,                     /* -Wextensions */
  OPT_Wexternal_argument_mismatch = 692,     /* -Wexternal-argument-mismatch */
  OPT_Wexternal_tu_local = 693,              /* -Wexternal-tu-local */
  OPT_Wextra = 694,                          /* -Wextra */
  OPT_Wextra_semi = 695,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 696,                   /* -Wfatal-errors */
  OPT_Wfile_code_set = 697,                  /* -Wfile-code-set */
  OPT_Wflex_array_member_not_at_end = 698,   /* -Wflex-array-member-not-at-end */
  OPT_Wfloat_conversion = 699,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 700,                    /* -Wfloat-equal */
  /* OPT_Wformat = 701, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 702,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 703,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 704,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 705,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 706, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 707,               /* -Wformat-overflow= */
  OPT_Wformat_security = 708,                /* -Wformat-security */
  OPT_Wformat_signedness = 709,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 710, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 711,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 712,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 713,             /* -Wformat-zero-length */
  OPT_Wformat_ = 714,                        /* -Wformat= */
  OPT_Wframe_address = 715,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 716,             /* -Wframe-larger-than= */
  OPT_Wfree_labels = 717,                    /* -Wfree-labels */
  OPT_Wfree_nonheap_object = 718,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 719,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 720,           /* -Wfunction-elimination */
  OPT_Wglobal_module = 721,                  /* -Wglobal-module */
  OPT_Whardened = 722,                       /* -Whardened */
  OPT_Wheader_guard = 723,                   /* -Wheader-guard */
  /* OPT_Whidden_declarations = 724, */      /* -Whidden-declarations */
  OPT_Whidden_declarations_ = 725,           /* -Whidden-declarations= */
  OPT_Whigh_order_bit = 726,                 /* -Whigh-order-bit */
  /* OPT_Whsa = 727, */                      /* -Whsa */
  OPT_Wiconv_error = 728,                    /* -Wiconv-error */
  OPT_Wif_not_aligned = 729,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 730,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 731,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 732,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 733, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 734,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 735,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 736,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 737,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 738,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 739, */                   /* -Wimport */
  OPT_Winaccessible_base = 740,              /* -Winaccessible-base */
  OPT_Winclude_file_found = 741,             /* -Winclude-file-found */
  OPT_Winclude_file_not_found = 742,         /* -Winclude-file-not-found */
  OPT_Wincompatible_pointer_types = 743,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 744,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 745,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 746,             /* -Winit-list-lifetime */
  OPT_Winit_self = 747,                      /* -Winit-self */
  OPT_Winline = 748,                         /* -Winline */
  OPT_Winspect_trailing = 749,               /* -Winspect-trailing */
  OPT_Wint_conversion = 750,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 751,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 752,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 753,               /* -Winteger-division */
  OPT_Winterference_size = 754,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 755,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 756,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 757,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 758,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 759,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 760,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 761,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 762,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 763,               /* -Wjump-misses-init */
  OPT_Wkeyword_macro = 764,                  /* -Wkeyword-macro */
  OPT_Wl_ = 765,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 766, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 767,                   /* -Wlarger-than= */
  OPT_Wleading_whitespace_ = 768,            /* -Wleading-whitespace= */
  OPT_Wlength_of = 769,                      /* -Wlength-of */
  OPT_Wlevel_1_occurs = 770,                 /* -Wlevel-1-occurs */
  OPT_Wlevel_78 = 771,                       /* -Wlevel-78 */
  OPT_Wlevel_78_defined = 772,               /* -Wlevel-78-defined */
  OPT_Wline_truncation = 773,                /* -Wline-truncation */
  OPT_Wliteral_concat = 774,                 /* -Wliteral-concat */
  OPT_Wliteral_suffix = 775,                 /* -Wliteral-suffix */
  OPT_Wlocale_error = 776,                   /* -Wlocale-error */
  OPT_Wlogical_not_parentheses = 777,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 778,                     /* -Wlogical-op */
  OPT_Wlong_long = 779,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 780,              /* -Wlto-type-mismatch */
  OPT_Wmain = 781,                           /* -Wmain */
  OPT_Wmaybe_musttail_local_addr = 782,      /* -Wmaybe-musttail-local-addr */
  OPT_Wmaybe_uninitialized = 783,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 784,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 785,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 786,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 787,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 788,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 789,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 790,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 791,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 792,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 793,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 794,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 795, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 796,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 797, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_name = 798,         /* -Wmissing-parameter-name */
  OPT_Wmissing_parameter_type = 799,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 800,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 801,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 802,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 803,       /* -Wmissing-template-keyword */
  OPT_Wmissing_variable_declarations = 804,  /* -Wmissing-variable-declarations */
  OPT_Wmove_corresponding = 805,             /* -Wmove-corresponding */
  OPT_Wmove_pointer = 806,                   /* -Wmove-pointer */
  OPT_Wmudflap = 807,                        /* -Wmudflap */
  OPT_Wmultichar = 808,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 809,           /* -Wmultiple-inheritance */
  OPT_Wmultiple_parameter_fwd_decl_lists = 810,/* -Wmultiple-parameter-fwd-decl-lists */
  OPT_Wmultistatement_macros = 811,          /* -Wmultistatement-macros */
  OPT_Wmusttail_local_addr = 812,            /* -Wmusttail-local-addr */
  OPT_Wnamespaces = 813,                     /* -Wnamespaces */
  OPT_Wnarrowing = 814,                      /* -Wnarrowing */
  OPT_Wnested_externs = 815,                 /* -Wnested-externs */
  OPT_Wnllanginfo_error = 816,               /* -Wnllanginfo-error */
  /* OPT_Wno_alloc_size_larger_than = 817, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 818, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 819, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 820, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 821, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 822, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 823,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 824,                  /* -Wnoexcept-type */
  OPT_Wnon_c_typedef_for_linkage = 825,      /* -Wnon-c-typedef-for-linkage */
  OPT_Wnon_template_friend = 826,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 827,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 828,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 829,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 830, */               /* -Wnormalized */
  OPT_Wnormalized_ = 831,                    /* -Wnormalized= */
  OPT_Wnrvo = 832,                           /* -Wnrvo */
  OPT_Wnull_dereference = 833,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 834,                /* -Wobjc-root-class */
  OPT_Wodr = 835,                            /* -Wodr */
  OPT_Wold_style_cast = 836,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 837,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 838,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 839,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 840,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 841,                    /* -Wopenmp-simd */
  OPT_Woperator_space = 842,                 /* -Woperator-space */
  OPT_Woverflow = 843,                       /* -Woverflow */
  OPT_Woverlength_strings = 844,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 845, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 846,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 847,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 848,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 849,            /* -Woverwrite-recursive */
  OPT_Wp_ = 850,                             /* -Wp, */
  OPT_Wpacked = 851,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 852,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 853,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 854,                         /* -Wpadded */
  OPT_Wparentheses = 855,                    /* -Wparentheses */
  OPT_Wpedantic = 856,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 857,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 858,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 859,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 860, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 861,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 862,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 863,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 864,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 865,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 866,            /* -Wpointer-to-int-cast */
  OPT_Wpragma_once_outside_header = 867,     /* -Wpragma-once-outside-header */
  OPT_Wpragmas = 868,                        /* -Wpragmas */
  OPT_Wpreprocessor_error = 869,             /* -Wpreprocessor-error */
  OPT_Wprio_ctor_dtor = 870,                 /* -Wprio-ctor-dtor */
  OPT_Wprocedure_not_found = 871,            /* -Wprocedure-not-found */
  OPT_Wprocedure_pointer = 872,              /* -Wprocedure-pointer */
  OPT_Wproperty_assign_default = 873,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 874,                       /* -Wprotocol */
  OPT_Wpsabi = 875,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 876,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 877,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 878,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 879,                /* -Wrealloc-lhs-all */
  OPT_Wrecording_mode = 880,                 /* -Wrecording-mode */
  OPT_Wredundant_decls = 881,                /* -Wredundant-decls */
  OPT_Wredundant_move = 882,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 883,                 /* -Wredundant-tags */
  OPT_Wregister = 884,                       /* -Wregister */
  OPT_Wreorder = 885,                        /* -Wreorder */
  OPT_Wreplace_error = 886,                  /* -Wreplace-error */
  OPT_Wrestrict = 887,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 888,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 889,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 890,                    /* -Wreturn-type */
  OPT_Wreturning_number = 891,               /* -Wreturning-number */
  OPT_Wscalar_storage_order = 892,           /* -Wscalar-storage-order */
  OPT_Wscope = 893,                          /* -Wscope */
  OPT_Wsegment = 894,                        /* -Wsegment */
  OPT_Wsegment_error = 895,                  /* -Wsegment-error */
  OPT_Wsegment_negative = 896,               /* -Wsegment-negative */
  OPT_Wselector = 897,                       /* -Wselector */
  OPT_Wself_move = 898,                      /* -Wself-move */
  OPT_Wsequence_point = 899,                 /* -Wsequence-point */
  OPT_Wset_locale_to = 900,                  /* -Wset-locale-to */
  OPT_Wset_to_locale = 901,                  /* -Wset-to-locale */
  /* OPT_Wsfinae_incomplete = 902, */        /* -Wsfinae-incomplete */
  OPT_Wsfinae_incomplete_ = 903,             /* -Wsfinae-incomplete= */
  OPT_Wshadow = 904,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 905, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 906,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 907, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 908,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 909, */            /* -Wshadow=global */
  OPT_Wshadow_local = 910,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 911,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 912,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 913,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 914, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 915,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 916,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 917,                /* -Wsign-conversion */
  OPT_Wsign_promo = 918,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 919,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 920,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 921,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 922,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 923,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 924,                    /* -Wspeculative */
  OPT_Wstack_protector = 925,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 926,                   /* -Wstack-usage= */
  OPT_Wstop_number = 927,                    /* -Wstop-number */
  OPT_Wstray_indicator = 928,                /* -Wstray-indicator */
  OPT_Wstrict_aliasing = 929,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 930,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 931,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 932,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 933,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 934,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 935,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 936,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 937,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 938, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 939,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 940,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 941,            /* -Wstringop-truncation */
  OPT_Wstyle = 942,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 943,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 944,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 945,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 946,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 947,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 948,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 949,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 950,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 951,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 952,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 953,               /* -Wsuggest-override */
  OPT_Wsurprising = 954,                     /* -Wsurprising */
  OPT_Wswitch = 955,                         /* -Wswitch */
  OPT_Wswitch_bool = 956,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 957,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 958,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 959,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 960,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 961,                      /* -Wsync-nand */
  /* OPT_Wsynth = 962, */                    /* -Wsynth */
  OPT_Wsystem_headers = 963,                 /* -Wsystem-headers */
  OPT_Wtabs = 964,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 965,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 966,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 967,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 968,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplate_names_tu_local = 969,        /* -Wtemplate-names-tu-local */
  OPT_Wtemplates = 970,                      /* -Wtemplates */
  OPT_Wterminate = 971,                      /* -Wterminate */
  OPT_Wtraditional = 972,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 973,         /* -Wtraditional-conversion */
  /* OPT_Wtrailing_whitespace = 974, */      /* -Wtrailing-whitespace */
  OPT_Wtrailing_whitespace_ = 975,           /* -Wtrailing-whitespace= */
  OPT_Wtrampolines = 976,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 977,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 978,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 979,                           /* -Wtsan */
  OPT_Wtype_limits = 980,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 981,            /* -Wundeclared-selector */
  OPT_Wundef = 982,                          /* -Wundef */
  OPT_Wundefined_do_loop = 983,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 984,                      /* -Wunderflow */
  OPT_Wunicode = 985,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 986,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 987,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 988,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 989,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 990, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 991, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 992,     /* -Wunsuffixed-float-constants */
  OPT_Wunterminated_string_initialization = 993,/* -Wunterminated-string-initialization */
  OPT_Wunused = 994,                         /* -Wunused */
  /* OPT_Wunused_but_set_parameter = 995, */ /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_parameter_ = 996,      /* -Wunused-but-set-parameter= */
  /* OPT_Wunused_but_set_variable = 997, */  /* -Wunused-but-set-variable */
  OPT_Wunused_but_set_variable_ = 998,       /* -Wunused-but-set-variable= */
  /* OPT_Wunused_const_variable = 999, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 1000,        /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 1001,         /* -Wunused-dummy-argument */
  OPT_Wunused_function = 1002,               /* -Wunused-function */
  OPT_Wunused_label = 1003,                  /* -Wunused-label */
  OPT_Wunused_local_typedefs = 1004,         /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 1005,                 /* -Wunused-macros */
  OPT_Wunused_parameter = 1006,              /* -Wunused-parameter */
  OPT_Wunused_result = 1007,                 /* -Wunused-result */
  OPT_Wunused_value = 1008,                  /* -Wunused-value */
  OPT_Wunused_variable = 1009,               /* -Wunused-variable */
  OPT_Wusage_typename = 1010,                /* -Wusage-typename */
  OPT_Wuse_after_free = 1011,                /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 1012,               /* -Wuse-after-free= */
  OPT_Wuse_without_only = 1013,              /* -Wuse-without-only */
  OPT_Wuseless_cast = 1014,                  /* -Wuseless-cast */
  OPT_Wvarargs = 1015,                       /* -Wvarargs */
  OPT_Wvariadic_macros = 1016,               /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 1017,  /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 1018,             /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 1019,                  /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 1020,           /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 1021,           /* -Wvirtual-move-assign */
  OPT_Wvla = 1022,                           /* -Wvla */
  OPT_Wvla_larger_than_ = 1023,              /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 1024,                 /* -Wvla-parameter */
  OPT_Wvoiding = 1025,                       /* -Wvoiding */
  OPT_Wvolatile = 1026,                      /* -Wvolatile */
  OPT_Wvolatile_register_var = 1027,         /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 1028,                 /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 1029,               /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 1030, /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 1031,            /* -Wzero-length-bounds */
  OPT_Wzerotrip = 1032,                      /* -Wzerotrip */
  OPT_X = 1033,                              /* -X */
  OPT_Xassembler = 1034,                     /* -Xassembler */
  OPT_Xf = 1035,                             /* -Xf */
  OPT_Xlinker = 1036,                        /* -Xlinker */
  OPT_Xpreprocessor = 1037,                  /* -Xpreprocessor */
  OPT_Z = 1038,                              /* -Z */
  OPT_ansi = 1039,                           /* -ansi */
  OPT_aux_info = 1040,                       /* -aux-info */
  /* OPT_aux_info_ = 1041, */                /* -aux-info= */
  OPT_c = 1042,                              /* -c */
  OPT_callgraph = 1043,                      /* -callgraph */
  OPT_copyext = 1044,                        /* -copyext */
  OPT_coverage = 1045,                       /* -coverage */
  OPT_cpp = 1046,                            /* -cpp */
  OPT_cpp_ = 1047,                           /* -cpp= */
  OPT_d = 1048,                              /* -d */
  OPT_debuglib_ = 1049,                      /* -debuglib= */
  OPT_defaultlib_ = 1050,                    /* -defaultlib= */
  OPT_defined_only = 1051,                   /* -defined-only */
  OPT_demangle = 1052,                       /* -demangle */
  OPT_dialect = 1053,                        /* -dialect */
  OPT_dstartfiles = 1054,                    /* -dstartfiles */
  OPT_dump_body_ = 1055,                     /* -dump-body= */
  OPT_dump_level_ = 1056,                    /* -dump-level= */
  OPT_dumpbase = 1057,                       /* -dumpbase */
  OPT_dumpbase_ext = 1058,                   /* -dumpbase-ext */
  OPT_dumpdir = 1059,                        /* -dumpdir */
  OPT_dumpfullversion = 1060,                /* -dumpfullversion */
  OPT_dumpmachine = 1061,                    /* -dumpmachine */
  OPT_dumpspecs = 1062,                      /* -dumpspecs */
  OPT_dumpversion = 1063,                    /* -dumpversion */
  OPT_e = 1064,                              /* -e */
  OPT_export_dynamic = 1065,                 /* -export-dynamic */
  OPT_fPIC = 1066,                           /* -fPIC */
  OPT_fPIE = 1067,                           /* -fPIE */
  OPT_fRTS_ = 1068,                          /* -fRTS= */
  OPT_fa68_dump_ast = 1069,                  /* -fa68-dump-ast */
  OPT_fa68_dump_modes = 1070,                /* -fa68-dump-modes */
  OPT_fa68_dump_module_interfaces = 1071,    /* -fa68-dump-module-interfaces */
  OPT_fabi_compat_version_ = 1072,           /* -fabi-compat-version= */
  OPT_fabi_version_ = 1073,                  /* -fabi-version= */
  OPT_faccess_control = 1074,                /* -faccess-control */
  OPT_fada_spec_parent_ = 1075,              /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 1076,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 1077, /* -faggressive-loop-optimizations */
  OPT_falign_commons = 1078,                 /* -falign-commons */
  OPT_falign_functions = 1079,               /* -falign-functions */
  OPT_falign_functions_ = 1080,              /* -falign-functions= */
  OPT_falign_jumps = 1081,                   /* -falign-jumps */
  OPT_falign_jumps_ = 1082,                  /* -falign-jumps= */
  OPT_falign_labels = 1083,                  /* -falign-labels */
  OPT_falign_labels_ = 1084,                 /* -falign-labels= */
  OPT_falign_loops = 1085,                   /* -falign-loops */
  OPT_falign_loops_ = 1086,                  /* -falign-loops= */
  /* OPT_faligned_new = 1087, */             /* -faligned-new */
  OPT_faligned_new_ = 1088,                  /* -faligned-new= */
  OPT_fall_instantiations = 1089,            /* -fall-instantiations */
  OPT_fall_intrinsics = 1090,                /* -fall-intrinsics */
  OPT_fall_virtual = 1091,                   /* -fall-virtual */
  OPT_fallocation_dce = 1092,                /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 1093,       /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1094,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1095,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1096, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1097,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1098,        /* -falt-external-templates */
  OPT_fanalyzer = 1099,                      /* -fanalyzer */
  ...
  OPT_fbuilding_libgcc = 1146,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1147,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1148,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1149,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1150,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1151,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1152,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1153,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1154,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1155,                    /* -fcall-used- */
  OPT_fcaller_saves = 1156,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1157,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1158,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1159,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1160,      /* -fcanonical-system-headers */
  OPT_fcase = 1161,                          /* -fcase */
  /* OPT_fcf_protection = 1162, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1163,                /* -fcf-protection= */
  OPT_fchar8_t = 1164,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1165,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1166, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1167,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1168,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1169,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1170, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1171, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1172, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1173, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1174, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1175, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1176,                  /* -fcheckaction= */
  OPT_fchecking = 1177,                      /* -fchecking */
  OPT_fchecking_ = 1178,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1179,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1180,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1181,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1182,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1183,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1184,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1185,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1186,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1187,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1188,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1189,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1190,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1191,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1192,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1193,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1194,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1195,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1196,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1197, */                /* -fcilkplus */
  OPT_fcoarray_ = 1198,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1199,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1200,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1201,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1202,                        /* -fcommon */
  OPT_fcompare_debug = 1203,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1204,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1205,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1206,                  /* -fcompare-elim */
  OPT_fconcepts = 1207,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1208,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1209,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1210,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1211,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1212, */          /* -fconserve-space */
  OPT_fconserve_stack = 1213,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1214,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1215,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1216,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1217,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1218,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1219,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1220,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1221,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1222,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1223,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1224,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1225,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1226, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1227,                     /* -fcontracts */
  ...
  OPT_fdump_tuning_model_ = 1362,            /* -fdump-tuning-model= */
  OPT_fdump_unnumbered = 1363,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1364,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1365,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1366,                /* -fearly-inlining */
  OPT_felide_constructors = 1367,            /* -felide-constructors */
  OPT_felide_type = 1368,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1369, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1370,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1371,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1372,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1373,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1374,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1375,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1376,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1377,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1378,                /* -fenum-int-equiv */
  OPT_fexceptions = 1379,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1380,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1381,                 /* -fexec-charset= */
  ...
  OPT_finternal_ebcdic = 1510,               /* -finternal-ebcdic */
  OPT_fintrinsic_modules_path = 1511,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1512,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1513,                    /* -finvariants */
  OPT_fipa_bit_cp = 1514,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1515,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1516, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1517,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1518,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1519,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1520,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1521, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1522,                    /* -fipa-modref */
  OPT_fipa_profile = 1523,                   /* -fipa-profile */
  OPT_fipa_pta = 1524,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1525,                /* -fipa-pure-const */
  OPT_fipa_ra = 1526,                        /* -fipa-ra */
  OPT_fipa_reference = 1527,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1528,     /* -fipa-reference-addressable */
  OPT_fipa_reorder_for_locality = 1529,      /* -fipa-reorder-for-locality */
  OPT_fipa_sra = 1530,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1531,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1532,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1533, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1534,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1535,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1536,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1537,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1538,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1539,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1540,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1541,                  /* -fira-verbose= */
  OPT_fiso = 1542,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1543,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1544,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1545,              /* -fivar-visibility= */
  OPT_fivopts = 1546,                        /* -fivopts */
  OPT_fjump_tables = 1547,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1548,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1549,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1550,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1551,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1552,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1553,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1554,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1555,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1556,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1557,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1558,         /* -flang-info-module-cmi= */
  /* OPT_flarge_source_files = 1559, */      /* -flarge-source-files */
  OPT_flate_combine_instructions = 1560,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1561,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1562,            /* -fleading-underscore */
  OPT_flibs_ = 1563,                         /* -flibs= */
  OPT_flifetime_dse = 1564,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1565,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1566,      /* -flimit-function-alignment */
  OPT_flink_libatomic = 1567,                /* -flink-libatomic */
  OPT_flinker_output_ = 1568,                /* -flinker-output= */
  /* OPT_flive_patching = 1569, */           /* -flive-patching */
  OPT_flive_patching_ = 1570,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1571,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1572,                   /* -flocal-ivars */
  OPT_flocation_ = 1573,                     /* -flocation= */
  /* OPT_floop_block = 1574, */              /* -floop-block */
  /* OPT_floop_flatten = 1575, */            /* -floop-flatten */
  OPT_floop_interchange = 1576,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1577,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1578, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1579,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1580, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1581,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1582,                     /* -flra-remat */
  OPT_flto = 1583,                           /* -flto */
  OPT_flto_compression_level_ = 1584,        /* -flto-compression-level= */
  OPT_flto_incremental_cache_size_ = 1585,   /* -flto-incremental-cache-size= */
  OPT_flto_incremental_ = 1586,              /* -flto-incremental= */
  /* OPT_flto_odr_type_merging = 1587, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1588,                /* -flto-partition= */
  OPT_flto_report = 1589,                    /* -flto-report */
  OPT_flto_report_wpa = 1590,                /* -flto-report-wpa */
  OPT_flto_ = 1591,                          /* -flto= */
  ...
  OPT_free = 1793,                           /* -free */
  /* OPT_freg_struct_return = 1794, */       /* -freg-struct-return */
  /* OPT_fregmove = 1795, */                 /* -fregmove */
  OPT_frelease = 1796,                       /* -frelease */
  OPT_frename_registers = 1797,              /* -frename-registers */
  OPT_freorder_blocks = 1798,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1799,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1800,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1801,             /* -freorder-functions */
  OPT_frepack_arrays = 1802,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1803,          /* -freplace-objc-classes */
  OPT_frepo = 1804,                          /* -frepo */
  OPT_freport_bug = 1805,                    /* -freport-bug */
  OPT_frequire_return_statement = 1806,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1807,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1808, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1809,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1810,                   /* -fresolution= */
  OPT_freturn = 1811,                        /* -freturn */
  OPT_frevert_all = 1812,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1813,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1814,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1815,             /* -frevert=intpromote */
  OPT_frounding_math = 1816,                 /* -frounding-math */
  OPT_frtti = 1817,                          /* -frtti */
  OPT_fruntime_modules_ = 1818,              /* -fruntime-modules= */
  OPT_frust_assume_builtin_offset_of = 1819, /* -frust-assume-builtin-offset-of */
  OPT_frust_borrowcheck = 1820,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1821,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1822,           /* -frust-compile-until= */
  ...
  OPT_mautovec_preference_ = 2159,           /* -mautovec-preference= */
  OPT_mbig_endian = 2160,                    /* -mbig-endian */
  OPT_mbionic = 2161,                        /* -mbionic */
  OPT_mbranch_protection_ = 2162,            /* -mbranch-protection= */
  OPT_mcmodel_ = 2163,                       /* -mcmodel= */
  OPT_mcpu_ = 2164,                          /* -mcpu= */
  OPT_mearly_ldp_fusion = 2165,              /* -mearly-ldp-fusion */
  OPT_mearly_ra_ = 2166,                     /* -mearly-ra= */
  OPT_menable_sysreg_checking = 2167,        /* -menable-sysreg-checking */
  OPT_mfix_cortex_a53_835769 = 2168,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 2169,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 2170,             /* -mgeneral-regs-only */
  OPT_mglibc = 2171,                         /* -mglibc */
  OPT_mharden_sls_ = 2172,                   /* -mharden-sls= */
  OPT_mlate_ldp_fusion = 2173,               /* -mlate-ldp-fusion */
  OPT_mlittle_endian = 2174,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 2175,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 2176,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 2177,            /* -mlow-precision-sqrt */
  OPT_mmax_vectorization = 2178,             /* -mmax-vectorization */
  OPT_mmusl = 2179,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 2180,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 2181,               /* -moutline-atomics */
  OPT_moverride_ = 2182,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 2183,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 2184,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 2185, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2186,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 2187,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 2188,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 2189,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 2190,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 2191,                     /* -mtls-size= */
  OPT_mtp_ = 2192,                           /* -mtp= */
  OPT_mtrack_speculation = 2193,             /* -mtrack-speculation */
  OPT_mtune_ = 2194,                         /* -mtune= */
  OPT_muclibc = 2195,                        /* -muclibc */
  OPT_muser_provided_CPU_ = 2196,            /* -muser-provided-CPU= */
  OPT_mverbose_cost_dump = 2197,             /* -mverbose-cost-dump */
  OPT_n = 2198,                              /* -n */
  OPT_name_sort = 2199,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2200,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2201,              /* -no-integrated-cpp */
  OPT_no_pie = 2202,                         /* -no-pie */
  OPT_nocpp = 2203,                          /* -nocpp */
  OPT_nodefaultlibs = 2204,                  /* -nodefaultlibs */
  OPT_nolibc = 2205,                         /* -nolibc */
  OPT_nomain = 2206,                         /* -nomain */
  OPT_nophoboslib = 2207,                    /* -nophoboslib */
  OPT_nostartfiles = 2208,                   /* -nostartfiles */
  OPT_nostdinc = 2209,                       /* -nostdinc */
  OPT_nostdinc__ = 2210,                     /* -nostdinc++ */
  OPT_nostdlib = 2211,                       /* -nostdlib */
  OPT_nostdlib__ = 2212,                     /* -nostdlib++ */
  OPT_o = 2213,                              /* -o */
  OPT_objects = 2214,                        /* -objects */
  OPT_p = 2215,                              /* -p */
  OPT_pass_exit_codes = 2216,                /* -pass-exit-codes */
  /* OPT_pedantic = 2217, */                 /* -pedantic */
  OPT_pedantic_errors = 2218,                /* -pedantic-errors */
  OPT_pg = 2219,                             /* -pg */
  OPT_pie = 2220,                            /* -pie */
  OPT_pipe = 2221,                           /* -pipe */
  OPT_posix = 2222,                          /* -posix */
  OPT_preprocess = 2223,                     /* -preprocess */
  ...
  OPT_profile = 2236,                        /* -profile */
  OPT_pthread = 2237,                        /* -pthread */
  OPT_quiet = 2238,                          /* -quiet */
  OPT_r = 2239,                              /* -r */
  OPT_rdynamic = 2240,                       /* -rdynamic */
  ...
  OPT_shared_libga68 = 2247,                 /* -shared-libga68 */
  OPT_shared_libgcc = 2248,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2249,               /* -shared-libphobos */
  OPT_size_sort = 2250,                      /* -size-sort */
  /* OPT_specs = 2251, */                    /* -specs */
  OPT_specs_ = 2252,                         /* -specs= */
  OPT_static = 2253,                         /* -static */
  OPT_static_libasan = 2254,                 /* -static-libasan */
  OPT_static_libga68 = 2255,                 /* -static-libga68 */
  OPT_static_libgcc = 2256,                  /* -static-libgcc */
  OPT_static_libgcobol = 2257,               /* -static-libgcobol */
  OPT_static_libgfortran = 2258,             /* -static-libgfortran */
  OPT_static_libgm2 = 2259,                  /* -static-libgm2 */
  OPT_static_libgo = 2260,                   /* -static-libgo */
  OPT_static_libhwasan = 2261,               /* -static-libhwasan */
  OPT_static_liblsan = 2262,                 /* -static-liblsan */
  OPT_static_libmpx = 2263,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2264,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2265,               /* -static-libphobos */
  OPT_static_libquadmath = 2266,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2267,               /* -static-libstdc++ */
  OPT_static_libtsan = 2268,                 /* -static-libtsan */
  OPT_static_libubsan = 2269,                /* -static-libubsan */
  OPT_static_pie = 2270,                     /* -static-pie */
  OPT_std_algol68 = 2271,                    /* -std=algol68 */
  /* OPT_std_c__03 = 2272, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2273, */                /* -std=c++0x */
  OPT_std_c__11 = 2274,                      /* -std=c++11 */
  OPT_std_c__14 = 2275,                      /* -std=c++14 */
  OPT_std_c__17 = 2276,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2277, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2278, */                /* -std=c++1z */
  OPT_std_c__20 = 2279,                      /* -std=c++20 */
  OPT_std_c__23 = 2280,                      /* -std=c++23 */
  OPT_std_c__26 = 2281,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2282, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2283, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2284, */                /* -std=c++2c */
  OPT_std_c__98 = 2285,                      /* -std=c++98 */
  OPT_std_c11 = 2286,                        /* -std=c11 */
  OPT_std_c17 = 2287,                        /* -std=c17 */
  /* OPT_std_c18 = 2288, */                  /* -std=c18 */
  /* OPT_std_c1x = 2289, */                  /* -std=c1x */
  OPT_std_c23 = 2290,                        /* -std=c23 */
  /* OPT_std_c2x = 2291, */                  /* -std=c2x */
  OPT_std_c2y = 2292,                        /* -std=c2y */
  /* OPT_std_c89 = 2293, */                  /* -std=c89 */
  OPT_std_c90 = 2294,                        /* -std=c90 */
  OPT_std_c99 = 2295,                        /* -std=c99 */
  /* OPT_std_c9x = 2296, */                  /* -std=c9x */
  OPT_std_f2003 = 2297,                      /* -std=f2003 */
  OPT_std_f2008 = 2298,                      /* -std=f2008 */
  OPT_std_f2008ts = 2299,                    /* -std=f2008ts */
  OPT_std_f2018 = 2300,                      /* -std=f2018 */
  OPT_std_f2023 = 2301,                      /* -std=f2023 */
  OPT_std_f202y = 2302,                      /* -std=f202y */
  OPT_std_f95 = 2303,                        /* -std=f95 */
  OPT_std_gnu = 2304,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2305, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2306, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2307,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2308,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2309,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2310, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2311, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2312,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2313,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2314,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2315, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2316, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2317, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2318,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2319,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2320,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2321, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2322, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2323,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2324, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2325,                      /* -std=gnu2y */
  OPT_std_gnu68 = 2326,                      /* -std=gnu68 */
  /* OPT_std_gnu89 = 2327, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2328,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2329,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2330, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2331, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2332,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2333, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2334, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2335, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2336, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2337, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2338, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2339,                     /* -std=legacy */
  OPT_stdlib_ = 2340,                        /* -stdlib= */
  OPT_symbol_ = 2341,                        /* -symbol= */
  OPT_symbolic = 2342,                       /* -symbolic */
  OPT_t = 2343,                              /* -t */
  OPT_time = 2344,                           /* -time */
  OPT_time_ = 2345,                          /* -time= */
  OPT_traditional = 2346,                    /* -traditional */
  OPT_traditional_cpp = 2347,                /* -traditional-cpp */
  OPT_tree_stats = 2348,                     /* -tree-stats */
  OPT_trigraphs = 2349,                      /* -trigraphs */
  OPT_truncate = 2350,                       /* -truncate */
  OPT_type_stats = 2351,                     /* -type-stats */
  OPT_u = 2352,                              /* -u */
  OPT_undef = 2353,                          /* -undef */
  OPT_v = 2354,                              /* -v */
  OPT_version = 2355,                        /* -version */
  OPT_w = 2356,                              /* -w */
  OPT_wrapper = 2357,                        /* -wrapper */
  OPT_x = 2358,                              /* -x */
  OPT_z = 2359,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
