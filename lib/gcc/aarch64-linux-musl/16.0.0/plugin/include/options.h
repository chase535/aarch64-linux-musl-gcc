...
enum opt_code
{
  ...
  OPT__param_ipa_cp_recursion_penalty_ = 150,/* --param=ipa-cp-recursion-penalty= */
  OPT__param_ipa_cp_recursive_freq_factor_ = 151,/* --param=ipa-cp-recursive-freq-factor= */
  OPT__param_ipa_cp_single_call_penalty_ = 152,/* --param=ipa-cp-single-call-penalty= */
  OPT__param_ipa_cp_unit_growth_ = 153,      /* --param=ipa-cp-unit-growth= */
  OPT__param_ipa_cp_value_list_size_ = 154,  /* --param=ipa-cp-value-list-size= */
  OPT__param_ipa_jump_function_lookups_ = 155,/* --param=ipa-jump-function-lookups= */
  OPT__param_ipa_max_aa_steps_ = 156,        /* --param=ipa-max-aa-steps= */
  OPT__param_ipa_max_agg_items_ = 157,       /* --param=ipa-max-agg-items= */
  OPT__param_ipa_max_loop_predicates_ = 158, /* --param=ipa-max-loop-predicates= */
  OPT__param_ipa_max_param_expr_ops_ = 159,  /* --param=ipa-max-param-expr-ops= */
  OPT__param_ipa_max_switch_predicate_bounds_ = 160,/* --param=ipa-max-switch-predicate-bounds= */
  OPT__param_ipa_sra_deref_prob_threshold_ = 161,/* --param=ipa-sra-deref-prob-threshold= */
  OPT__param_ipa_sra_max_replacements_ = 162,/* --param=ipa-sra-max-replacements= */
  OPT__param_ipa_sra_ptr_growth_factor_ = 163,/* --param=ipa-sra-ptr-growth-factor= */
  OPT__param_ipa_sra_ptrwrap_growth_factor_ = 164,/* --param=ipa-sra-ptrwrap-growth-factor= */
  OPT__param_ira_consider_dup_in_all_alts_ = 165,/* --param=ira-consider-dup-in-all-alts= */
  OPT__param_ira_loop_reserved_regs_ = 166,  /* --param=ira-loop-reserved-regs= */
  OPT__param_ira_max_conflict_table_size_ = 167,/* --param=ira-max-conflict-table-size= */
  OPT__param_ira_max_loops_num_ = 168,       /* --param=ira-max-loops-num= */
  OPT__param_ira_simple_lra_insn_threshold_ = 169,/* --param=ira-simple-lra-insn-threshold= */
  OPT__param_iv_always_prune_cand_set_bound_ = 170,/* --param=iv-always-prune-cand-set-bound= */
  OPT__param_iv_consider_all_candidates_bound_ = 171,/* --param=iv-consider-all-candidates-bound= */
  OPT__param_iv_max_considered_uses_ = 172,  /* --param=iv-max-considered-uses= */
  OPT__param_jump_table_max_growth_ratio_for_size_ = 173,/* --param=jump-table-max-growth-ratio-for-size= */
  OPT__param_jump_table_max_growth_ratio_for_speed_ = 174,/* --param=jump-table-max-growth-ratio-for-speed= */
  OPT__param_l1_cache_line_size_ = 175,      /* --param=l1-cache-line-size= */
  OPT__param_l1_cache_size_ = 176,           /* --param=l1-cache-size= */
  OPT__param_l2_cache_size_ = 177,           /* --param=l2-cache-size= */
  OPT__param_large_function_growth_ = 178,   /* --param=large-function-growth= */
  OPT__param_large_function_insns_ = 179,    /* --param=large-function-insns= */
  OPT__param_large_stack_frame_growth_ = 180,/* --param=large-stack-frame-growth= */
  OPT__param_large_stack_frame_ = 181,       /* --param=large-stack-frame= */
  OPT__param_large_unit_insns_ = 182,        /* --param=large-unit-insns= */
  OPT__param_lazy_modules_ = 183,            /* --param=lazy-modules= */
  OPT__param_lim_expensive_ = 184,           /* --param=lim-expensive= */
  OPT__param_logical_op_non_short_circuit_ = 185,/* --param=logical-op-non-short-circuit= */
  OPT__param_loop_block_tile_size_ = 186,    /* --param=loop-block-tile-size= */
  OPT__param_loop_interchange_max_num_stmts_ = 187,/* --param=loop-interchange-max-num-stmts= */
  OPT__param_loop_interchange_stride_ratio_ = 188,/* --param=loop-interchange-stride-ratio= */
  OPT__param_loop_invariant_max_bbs_in_loop_ = 189,/* --param=loop-invariant-max-bbs-in-loop= */
  OPT__param_loop_max_datarefs_for_datadeps_ = 190,/* --param=loop-max-datarefs-for-datadeps= */
  OPT__param_loop_versioning_max_inner_insns_ = 191,/* --param=loop-versioning-max-inner-insns= */
  OPT__param_loop_versioning_max_outer_insns_ = 192,/* --param=loop-versioning-max-outer-insns= */
  OPT__param_lra_inheritance_ebb_probability_cutoff_ = 193,/* --param=lra-inheritance-ebb-probability-cutoff= */
  OPT__param_lra_max_considered_reload_pseudos_ = 194,/* --param=lra-max-considered-reload-pseudos= */
  OPT__param_lto_max_locality_partition_ = 195,/* --param=lto-max-locality-partition= */
  ...
  OPT__param_lto_partition_locality_cloning_ = 199,/* --param=lto-partition-locality-cloning= */
  OPT__param_lto_partition_locality_frequency_cutoff_ = 200,/* --param=lto-partition-locality-frequency-cutoff= */
  OPT__param_lto_partition_locality_size_cutoff_ = 201,/* --param=lto-partition-locality-size-cutoff= */
  OPT__param_lto_partitions_ = 202,          /* --param=lto-partitions= */
  OPT__param_max_average_unrolled_insns_ = 203,/* --param=max-average-unrolled-insns= */
  OPT__param_max_combine_insns_ = 204,       /* --param=max-combine-insns= */
  OPT__param_max_combine_search_insns_ = 205,/* --param=max-combine-search-insns= */
  OPT__param_max_completely_peel_loop_nest_depth_ = 206,/* --param=max-completely-peel-loop-nest-depth= */
  OPT__param_max_completely_peel_times_ = 207,/* --param=max-completely-peel-times= */
  OPT__param_max_completely_peeled_insns_ = 208,/* --param=max-completely-peeled-insns= */
  OPT__param_max_crossjump_edges_ = 209,     /* --param=max-crossjump-edges= */
  OPT__param_max_cse_insns_ = 210,           /* --param=max-cse-insns= */
  OPT__param_max_cse_path_length_ = 211,     /* --param=max-cse-path-length= */
  OPT__param_max_cselib_memory_locations_ = 212,/* --param=max-cselib-memory-locations= */
  OPT__param_max_debug_marker_count_ = 213,  /* --param=max-debug-marker-count= */
  OPT__param_max_delay_slot_insn_search_ = 214,/* --param=max-delay-slot-insn-search= */
  OPT__param_max_delay_slot_live_search_ = 215,/* --param=max-delay-slot-live-search= */
  OPT__param_max_dse_active_local_stores_ = 216,/* --param=max-dse-active-local-stores= */
  OPT__param_max_early_inliner_iterations_ = 217,/* --param=max-early-inliner-iterations= */
  OPT__param_max_fields_for_field_sensitive_ = 218,/* --param=max-fields-for-field-sensitive= */
  OPT__param_max_find_base_term_values_ = 219,/* --param=max-find-base-term-values= */
  OPT__param_max_fsm_thread_path_insns_ = 220,/* --param=max-fsm-thread-path-insns= */
  OPT__param_max_gcse_insertion_ratio_ = 221,/* --param=max-gcse-insertion-ratio= */
  OPT__param_max_gcse_memory_ = 222,         /* --param=max-gcse-memory= */
  OPT__param_max_goto_duplication_insns_ = 223,/* --param=max-goto-duplication-insns= */
  OPT__param_max_grow_copy_bb_insns_ = 224,  /* --param=max-grow-copy-bb-insns= */
  OPT__param_max_hoist_depth_ = 225,         /* --param=max-hoist-depth= */
  OPT__param_max_inline_functions_called_once_insns_ = 226,/* --param=max-inline-functions-called-once-insns= */
  OPT__param_max_inline_functions_called_once_loop_depth_ = 227,/* --param=max-inline-functions-called-once-loop-depth= */
  OPT__param_max_inline_insns_auto_ = 228,   /* --param=max-inline-insns-auto= */
  OPT__param_max_inline_insns_recursive_auto_ = 229,/* --param=max-inline-insns-recursive-auto= */
  OPT__param_max_inline_insns_recursive_ = 230,/* --param=max-inline-insns-recursive= */
  OPT__param_max_inline_insns_single_ = 231, /* --param=max-inline-insns-single= */
  OPT__param_max_inline_insns_size_ = 232,   /* --param=max-inline-insns-size= */
  OPT__param_max_inline_insns_small_ = 233,  /* --param=max-inline-insns-small= */
  OPT__param_max_inline_recursive_depth_auto_ = 234,/* --param=max-inline-recursive-depth-auto= */
  OPT__param_max_inline_recursive_depth_ = 235,/* --param=max-inline-recursive-depth= */
  OPT__param_max_isl_operations_ = 236,      /* --param=max-isl-operations= */
  OPT__param_max_iterations_computation_cost_ = 237,/* --param=max-iterations-computation-cost= */
  OPT__param_max_iterations_to_track_ = 238, /* --param=max-iterations-to-track= */
  OPT__param_max_jump_thread_duplication_stmts_ = 239,/* --param=max-jump-thread-duplication-stmts= */
  OPT__param_max_jump_thread_paths_ = 240,   /* --param=max-jump-thread-paths= */
  OPT__param_max_last_value_rtl_ = 241,      /* --param=max-last-value-rtl= */
  OPT__param_max_loop_header_insns_ = 242,   /* --param=max-loop-header-insns= */
  OPT__param_max_modulo_backtrack_attempts_ = 243,/* --param=max-modulo-backtrack-attempts= */
  OPT__param_max_partial_antic_length_ = 244,/* --param=max-partial-antic-length= */
  OPT__param_max_peel_branches_ = 245,       /* --param=max-peel-branches= */
  OPT__param_max_peel_times_ = 246,          /* --param=max-peel-times= */
  OPT__param_max_peeled_insns_ = 247,        /* --param=max-peeled-insns= */
  OPT__param_max_pending_list_length_ = 248, /* --param=max-pending-list-length= */
  OPT__param_max_pipeline_region_blocks_ = 249,/* --param=max-pipeline-region-blocks= */
  OPT__param_max_pipeline_region_insns_ = 250,/* --param=max-pipeline-region-insns= */
  OPT__param_max_pow_sqrt_depth_ = 251,      /* --param=max-pow-sqrt-depth= */
  OPT__param_max_predicted_iterations_ = 252,/* --param=max-predicted-iterations= */
  OPT__param_max_reload_search_insns_ = 253, /* --param=max-reload-search-insns= */
  OPT__param_max_rtl_if_conversion_insns_ = 254,/* --param=max-rtl-if-conversion-insns= */
  OPT__param_max_rtl_if_conversion_predictable_cost_ = 255,/* --param=max-rtl-if-conversion-predictable-cost= */
  OPT__param_max_rtl_if_conversion_unpredictable_cost_ = 256,/* --param=max-rtl-if-conversion-unpredictable-cost= */
  OPT__param_max_sched_extend_regions_iters_ = 257,/* --param=max-sched-extend-regions-iters= */
  OPT__param_max_sched_insn_conflict_delay_ = 258,/* --param=max-sched-insn-conflict-delay= */
  OPT__param_max_sched_ready_insns_ = 259,   /* --param=max-sched-ready-insns= */
  OPT__param_max_sched_region_blocks_ = 260, /* --param=max-sched-region-blocks= */
  OPT__param_max_sched_region_insns_ = 261,  /* --param=max-sched-region-insns= */
  OPT__param_max_slsr_cand_scan_ = 262,      /* --param=max-slsr-cand-scan= */
  OPT__param_max_speculative_devirt_maydefs_ = 263,/* --param=max-speculative-devirt-maydefs= */
  OPT__param_max_ssa_name_query_depth_ = 264,/* --param=max-ssa-name-query-depth= */
  OPT__param_max_store_chains_to_track_ = 265,/* --param=max-store-chains-to-track= */
  OPT__param_max_stores_to_merge_ = 266,     /* --param=max-stores-to-merge= */
  OPT__param_max_stores_to_sink_ = 267,      /* --param=max-stores-to-sink= */
  OPT__param_max_stores_to_track_ = 268,     /* --param=max-stores-to-track= */
  OPT__param_max_tail_merge_comparisons_ = 269,/* --param=max-tail-merge-comparisons= */
  OPT__param_max_tail_merge_iterations_ = 270,/* --param=max-tail-merge-iterations= */
  OPT__param_max_tracked_strlens_ = 271,     /* --param=max-tracked-strlens= */
  OPT__param_max_tree_if_conversion_phi_args_ = 272,/* --param=max-tree-if-conversion-phi-args= */
  OPT__param_max_unroll_times_ = 273,        /* --param=max-unroll-times= */
  OPT__param_max_unrolled_insns_ = 274,      /* --param=max-unrolled-insns= */
  OPT__param_max_unswitch_depth_ = 275,      /* --param=max-unswitch-depth= */
  OPT__param_max_unswitch_insns_ = 276,      /* --param=max-unswitch-insns= */
  OPT__param_max_variable_expansions_in_unroller_ = 277,/* --param=max-variable-expansions-in-unroller= */
  OPT__param_max_vartrack_expr_depth_ = 278, /* --param=max-vartrack-expr-depth= */
  OPT__param_max_vartrack_reverse_op_size_ = 279,/* --param=max-vartrack-reverse-op-size= */
  OPT__param_max_vartrack_size_ = 280,       /* --param=max-vartrack-size= */
  OPT__param_min_crossjump_insns_ = 281,     /* --param=min-crossjump-insns= */
  OPT__param_min_inline_recursive_probability_ = 282,/* --param=min-inline-recursive-probability= */
  OPT__param_min_insn_to_prefetch_ratio_ = 283,/* --param=min-insn-to-prefetch-ratio= */
  OPT__param_min_loop_cond_split_prob_ = 284,/* --param=min-loop-cond-split-prob= */
  OPT__param_min_nondebug_insn_uid_ = 285,   /* --param=min-nondebug-insn-uid= */
  OPT__param_min_pagesize_ = 286,            /* --param=min-pagesize= */
  OPT__param_min_size_for_stack_sharing_ = 287,/* --param=min-size-for-stack-sharing= */
  OPT__param_min_spec_prob_ = 288,           /* --param=min-spec-prob= */
  OPT__param_min_vect_loop_bound_ = 289,     /* --param=min-vect-loop-bound= */
  OPT__param_modref_max_accesses_ = 290,     /* --param=modref-max-accesses= */
  OPT__param_modref_max_adjustments_ = 291,  /* --param=modref-max-adjustments= */
  OPT__param_modref_max_bases_ = 292,        /* --param=modref-max-bases= */
  OPT__param_modref_max_depth_ = 293,        /* --param=modref-max-depth= */
  OPT__param_modref_max_escape_points_ = 294,/* --param=modref-max-escape-points= */
  OPT__param_modref_max_refs_ = 295,         /* --param=modref-max-refs= */
  OPT__param_modref_max_tests_ = 296,        /* --param=modref-max-tests= */
  OPT__param_openacc_kernels_ = 297,         /* --param=openacc-kernels= */
  OPT__param_openacc_privatization_ = 298,   /* --param=openacc-privatization= */
  OPT__param_parloops_chunk_size_ = 299,     /* --param=parloops-chunk-size= */
  OPT__param_parloops_min_per_thread_ = 300, /* --param=parloops-min-per-thread= */
  OPT__param_parloops_schedule_ = 301,       /* --param=parloops-schedule= */
  OPT__param_partial_inlining_entry_probability_ = 302,/* --param=partial-inlining-entry-probability= */
  OPT__param_phiopt_factor_max_stmts_live_ = 303,/* --param=phiopt-factor-max-stmts-live= */
  OPT__param_predictable_branch_outcome_ = 304,/* --param=predictable-branch-outcome= */
  OPT__param_prefetch_dynamic_strides_ = 305,/* --param=prefetch-dynamic-strides= */
  OPT__param_prefetch_latency_ = 306,        /* --param=prefetch-latency= */
  OPT__param_prefetch_min_insn_to_mem_ratio_ = 307,/* --param=prefetch-min-insn-to-mem-ratio= */
  OPT__param_prefetch_minimum_stride_ = 308, /* --param=prefetch-minimum-stride= */
  OPT__param_profile_func_internal_id_ = 309,/* --param=profile-func-internal-id= */
  OPT__param_ranger_debug_ = 310,            /* --param=ranger-debug= */
  OPT__param_ranger_logical_depth_ = 311,    /* --param=ranger-logical-depth= */
  OPT__param_ranger_recompute_depth_ = 312,  /* --param=ranger-recompute-depth= */
  OPT__param_relation_block_limit_ = 313,    /* --param=relation-block-limit= */
  OPT__param_rpo_vn_max_loop_depth_ = 314,   /* --param=rpo-vn-max-loop-depth= */
  OPT__param_sccvn_max_alias_queries_per_access_ = 315,/* --param=sccvn-max-alias-queries-per-access= */
  OPT__param_scev_max_expr_complexity_ = 316,/* --param=scev-max-expr-complexity= */
  OPT__param_scev_max_expr_size_ = 317,      /* --param=scev-max-expr-size= */
  OPT__param_sched_autopref_queue_depth_ = 318,/* --param=sched-autopref-queue-depth= */
  OPT__param_sched_mem_true_dep_cost_ = 319, /* --param=sched-mem-true-dep-cost= */
  OPT__param_sched_pressure_algorithm_ = 320,/* --param=sched-pressure-algorithm= */
  OPT__param_sched_spec_prob_cutoff_ = 321,  /* --param=sched-spec-prob-cutoff= */
  OPT__param_sched_state_edge_prob_cutoff_ = 322,/* --param=sched-state-edge-prob-cutoff= */
  OPT__param_selsched_insns_to_rename_ = 323,/* --param=selsched-insns-to-rename= */
  OPT__param_selsched_max_lookahead_ = 324,  /* --param=selsched-max-lookahead= */
  OPT__param_selsched_max_sched_times_ = 325,/* --param=selsched-max-sched-times= */
  OPT__param_simultaneous_prefetches_ = 326, /* --param=simultaneous-prefetches= */
  OPT__param_sink_frequency_threshold_ = 327,/* --param=sink-frequency-threshold= */
  OPT__param_sms_dfa_history_ = 328,         /* --param=sms-dfa-history= */
  OPT__param_sms_loop_average_count_threshold_ = 329,/* --param=sms-loop-average-count-threshold= */
  OPT__param_sms_max_ii_factor_ = 330,       /* --param=sms-max-ii-factor= */
  OPT__param_sms_min_sc_ = 331,              /* --param=sms-min-sc= */
  OPT__param_sra_max_propagations_ = 332,    /* --param=sra-max-propagations= */
  OPT__param_sra_max_scalarization_size_Osize_ = 333,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 334,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 335,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 336,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 337,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 338,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_forwarding_max_distance_ = 339,/* --param=store-forwarding-max-distance= */
  OPT__param_store_merging_allow_unaligned_ = 340,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 341,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 342,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_switch_lower_slow_alg_max_cases_ = 343,/* --param=switch-lower-slow-alg-max-cases= */
  OPT__param_threader_debug_ = 344,          /* --param=threader-debug= */
  OPT__param_tm_max_aggregate_size_ = 345,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 346,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 347, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 348,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 349,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 350,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 351, /* --param=tracer-min-branch-ratio= */
  OPT__param_transitive_relations_work_bound_ = 352,/* --param=transitive-relations-work-bound= */
  OPT__param_tree_reassoc_width_ = 353,      /* --param=tree-reassoc-width= */
  OPT__param_tsan_distinguish_volatile_ = 354,/* --param=tsan-distinguish-volatile= */
  OPT__param_tsan_instrument_func_entry_exit_ = 355,/* --param=tsan-instrument-func-entry-exit= */
  OPT__param_uninit_control_dep_attempts_ = 356,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninit_max_chain_len_ = 357,    /* --param=uninit-max-chain-len= */
  OPT__param_uninit_max_num_chains_ = 358,   /* --param=uninit-max-num-chains= */
  OPT__param_uninit_max_prune_work_ = 359,   /* --param=uninit-max-prune-work= */
  ...
  OPT__param_vect_induction_float_ = 370,    /* --param=vect-induction-float= */
  OPT__param_vect_inner_loop_cost_factor_ = 371,/* --param=vect-inner-loop-cost-factor= */
  OPT__param_vect_max_layout_candidates_ = 372,/* --param=vect-max-layout-candidates= */
  OPT__param_vect_max_peeling_for_alignment_ = 373,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 374,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 375,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 376,/* --param=vect-partial-vector-usage= */
  OPT__param_vect_scalar_cost_multiplier_ = 377,/* --param=vect-scalar-cost-multiplier= */
  ...
  OPT_Wa_ = 472,                             /* -Wa, */
  OPT_Wabbreviated_auto_in_template_arg = 473,/* -Wabbreviated-auto-in-template-arg */
  OPT_Wabi = 474,                            /* -Wabi */
  ...
  OPT_Wanalyzer_throw_of_unexpected_type = 531,/* -Wanalyzer-throw-of-unexpected-type */
  OPT_Wanalyzer_too_complex = 532,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_undefined_behavior_ptrdiff = 533,/* -Wanalyzer-undefined-behavior-ptrdiff */
  OPT_Wanalyzer_undefined_behavior_strtok = 534,/* -Wanalyzer-undefined-behavior-strtok */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 535,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 536,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 537,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 538,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 539,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 540,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 541,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 542,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 543,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 544,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 545,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 546,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 547, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 548,                  /* -Warray-bounds= */
  OPT_Warray_compare = 549,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 550, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 551,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 552,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 553,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 554, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 555,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 556,              /* -Wattribute-warning */
  OPT_Wattributes = 557,                     /* -Wattributes */
  OPT_Wattributes_ = 558,                    /* -Wattributes= */
  OPT_Wauto_profile = 559,                   /* -Wauto-profile */
  OPT_Wbad_function_cast = 560,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 561, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 562,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 563,                   /* -Wbool-compare */
  OPT_Wbool_operation = 564,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 565,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 566,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 567,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 568, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 569,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 570,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 571,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 572,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 573,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 574,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 575, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 576,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 577,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 578,               /* -Wc++23-extensions */
  OPT_Wc__26_compat = 579,                   /* -Wc++26-compat */
  OPT_Wc__26_extensions = 580,               /* -Wc++26-extensions */
  /* OPT_Wc__2a_compat = 581, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 582,                 /* -Wc-binding-type */
  OPT_Wc11_c23_compat = 583,                 /* -Wc11-c23-compat */
  /* OPT_Wc11_c2x_compat = 584, */           /* -Wc11-c2x-compat */
  OPT_Wc23_c2y_compat = 585,                 /* -Wc23-c2y-compat */
  OPT_Wc90_c99_compat = 586,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 587,                 /* -Wc99-c11-compat */
  OPT_Wcalloc_transposed_args = 588,         /* -Wcalloc-transposed-args */
  OPT_Wcannot_profile = 589,                 /* -Wcannot-profile */
  OPT_Wcase_enum = 590,                      /* -Wcase-enum */
  OPT_Wcast_align = 591,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 592,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 593,             /* -Wcast-function-type */
  OPT_Wcast_qual = 594,                      /* -Wcast-qual */
  OPT_Wcast_result = 595,                    /* -Wcast-result */
  OPT_Wcast_user_defined = 596,              /* -Wcast-user-defined */
  /* OPT_Wcatch_value = 597, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 598,                   /* -Wcatch-value= */
  OPT_Wchanges_meaning = 599,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 600,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 601,           /* -Wcharacter-truncation */
  OPT_Wchkp = 602,                           /* -Wchkp */
  OPT_Wclass_conversion = 603,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 604,                /* -Wclass-memaccess */
  OPT_Wclobbered = 605,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 606,                /* -Wcomma-subscript */
  OPT_Wcomment = 607,                        /* -Wcomment */
  /* OPT_Wcomments = 608, */                 /* -Wcomments */
  OPT_Wcompare_distinct_pointer_types = 609, /* -Wcompare-distinct-pointer-types */
  OPT_Wcompare_reals = 610,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 611,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 612,        /* -Wconditionally-supported */
  OPT_Wconversion = 613,                     /* -Wconversion */
  OPT_Wconversion_extra = 614,               /* -Wconversion-extra */
  OPT_Wconversion_null = 615,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 616,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 617,              /* -Wcoverage-mismatch */
  OPT_Wcoverage_too_many_conditions = 618,   /* -Wcoverage-too-many-conditions */
  OPT_Wcoverage_too_many_paths = 619,        /* -Wcoverage-too-many-paths */
  OPT_Wcpp = 620,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 621,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 622,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 623,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 624, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 625,              /* -Wdangling-pointer= */
  OPT_Wdangling_reference = 626,             /* -Wdangling-reference */
  OPT_Wdate_time = 627,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 628,    /* -Wdeclaration-after-statement */
  OPT_Wdeclaration_missing_parameter_type = 629,/* -Wdeclaration-missing-parameter-type */
  OPT_Wdefaulted_function_deleted = 630,     /* -Wdefaulted-function-deleted */
  OPT_Wdelete_incomplete = 631,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 632,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 633,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 634,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 635,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 636,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 637,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 638,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdeprecated_literal_operator = 639,    /* -Wdeprecated-literal-operator */
  OPT_Wdeprecated_non_prototype = 640,       /* -Wdeprecated-non-prototype */
  OPT_Wdeprecated_variadic_comma_omission = 641,/* -Wdeprecated-variadic-comma-omission */
  OPT_Wdesignated_init = 642,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 643,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 644,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 645,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 646,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 647,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 648,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 649,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 650,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 651,                /* -Wduplicated-cond */
  OPT_Weffc__ = 652,                         /* -Weffc++ */
  OPT_Welaborated_enum_base = 653,           /* -Welaborated-enum-base */
  OPT_Wempty_body = 654,                     /* -Wempty-body */
  OPT_Wendif_labels = 655,                   /* -Wendif-labels */
  OPT_Wenum_compare = 656,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 657,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 658,              /* -Wenum-int-mismatch */
  OPT_Werror = 659,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 660, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 661,                         /* -Werror= */
  OPT_Wexceptions = 662,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 663,           /* -Wexpansion-to-defined */
  OPT_Wexperimental_fmv_target = 664,        /* -Wexperimental-fmv-target */
  OPT_Wexternal_argument_mismatch = 665,     /* -Wexternal-argument-mismatch */
  OPT_Wextra = 666,                          /* -Wextra */
  OPT_Wextra_semi = 667,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 668,                   /* -Wfatal-errors */
  OPT_Wflex_array_member_not_at_end = 669,   /* -Wflex-array-member-not-at-end */
  OPT_Wfloat_conversion = 670,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 671,                    /* -Wfloat-equal */
  /* OPT_Wformat = 672, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 673,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 674,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 675,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 676,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 677, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 678,               /* -Wformat-overflow= */
  OPT_Wformat_security = 679,                /* -Wformat-security */
  OPT_Wformat_signedness = 680,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 681, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 682,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 683,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 684,             /* -Wformat-zero-length */
  OPT_Wformat_ = 685,                        /* -Wformat= */
  OPT_Wframe_address = 686,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 687,             /* -Wframe-larger-than= */
  OPT_Wfree_labels = 688,                    /* -Wfree-labels */
  OPT_Wfree_nonheap_object = 689,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 690,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 691,           /* -Wfunction-elimination */
  OPT_Wglobal_module = 692,                  /* -Wglobal-module */
  OPT_Whardened = 693,                       /* -Whardened */
  OPT_Wheader_guard = 694,                   /* -Wheader-guard */
  /* OPT_Whsa = 695, */                      /* -Whsa */
  OPT_Wif_not_aligned = 696,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 697,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 698,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 699,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 700, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 701,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 702,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 703,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 704,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 705,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 706, */                   /* -Wimport */
  OPT_Winaccessible_base = 707,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 708,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 709,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 710,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 711,             /* -Winit-list-lifetime */
  OPT_Winit_self = 712,                      /* -Winit-self */
  OPT_Winline = 713,                         /* -Winline */
  OPT_Wint_conversion = 714,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 715,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 716,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 717,               /* -Winteger-division */
  OPT_Winterference_size = 718,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 719,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 720,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 721,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 722,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 723,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 724,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 725,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 726,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 727,               /* -Wjump-misses-init */
  OPT_Wkeyword_macro = 728,                  /* -Wkeyword-macro */
  OPT_Wl_ = 729,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 730, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 731,                   /* -Wlarger-than= */
  OPT_Wleading_whitespace_ = 732,            /* -Wleading-whitespace= */
  OPT_Wline_truncation = 733,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 734,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 735,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 736,                     /* -Wlogical-op */
  OPT_Wlong_long = 737,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 738,              /* -Wlto-type-mismatch */
  OPT_Wmain = 739,                           /* -Wmain */
  OPT_Wmaybe_musttail_local_addr = 740,      /* -Wmaybe-musttail-local-addr */
  OPT_Wmaybe_uninitialized = 741,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 742,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 743,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 744,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 745,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 746,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 747,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 748,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 749,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 750,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 751,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 752,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 753, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 754,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 755, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_name = 756,         /* -Wmissing-parameter-name */
  OPT_Wmissing_parameter_type = 757,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 758,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 759,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 760,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 761,       /* -Wmissing-template-keyword */
  OPT_Wmissing_variable_declarations = 762,  /* -Wmissing-variable-declarations */
  OPT_Wmudflap = 763,                        /* -Wmudflap */
  OPT_Wmultichar = 764,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 765,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 766,          /* -Wmultistatement-macros */
  OPT_Wmusttail_local_addr = 767,            /* -Wmusttail-local-addr */
  OPT_Wnamespaces = 768,                     /* -Wnamespaces */
  OPT_Wnarrowing = 769,                      /* -Wnarrowing */
  OPT_Wnested_externs = 770,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 771, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 772, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 773, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 774, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 775, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 776, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 777,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 778,                  /* -Wnoexcept-type */
  OPT_Wnon_c_typedef_for_linkage = 779,      /* -Wnon-c-typedef-for-linkage */
  OPT_Wnon_template_friend = 780,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 781,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 782,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 783,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 784, */               /* -Wnormalized */
  OPT_Wnormalized_ = 785,                    /* -Wnormalized= */
  OPT_Wnrvo = 786,                           /* -Wnrvo */
  OPT_Wnull_dereference = 787,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 788,                /* -Wobjc-root-class */
  OPT_Wodr = 789,                            /* -Wodr */
  OPT_Wold_style_cast = 790,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 791,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 792,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 793,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 794,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 795,                    /* -Wopenmp-simd */
  OPT_Woverflow = 796,                       /* -Woverflow */
  OPT_Woverlength_strings = 797,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 798, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 799,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 800,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 801,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 802,            /* -Woverwrite-recursive */
  OPT_Wp_ = 803,                             /* -Wp, */
  OPT_Wpacked = 804,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 805,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 806,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 807,                         /* -Wpadded */
  OPT_Wparentheses = 808,                    /* -Wparentheses */
  OPT_Wpedantic = 809,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 810,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 811,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 812,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 813, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 814,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 815,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 816,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 817,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 818,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 819,            /* -Wpointer-to-int-cast */
  OPT_Wpragma_once_outside_header = 820,     /* -Wpragma-once-outside-header */
  OPT_Wpragmas = 821,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 822,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 823,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 824,                       /* -Wprotocol */
  OPT_Wpsabi = 825,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 826,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 827,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 828,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 829,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 830,                /* -Wredundant-decls */
  OPT_Wredundant_move = 831,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 832,                 /* -Wredundant-tags */
  OPT_Wregister = 833,                       /* -Wregister */
  OPT_Wreorder = 834,                        /* -Wreorder */
  OPT_Wrestrict = 835,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 836,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 837,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 838,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 839,           /* -Wscalar-storage-order */
  OPT_Wselector = 840,                       /* -Wselector */
  OPT_Wself_move = 841,                      /* -Wself-move */
  OPT_Wsequence_point = 842,                 /* -Wsequence-point */
  /* OPT_Wsfinae_incomplete = 843, */        /* -Wsfinae-incomplete */
  OPT_Wsfinae_incomplete_ = 844,             /* -Wsfinae-incomplete= */
  OPT_Wshadow = 845,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 846, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 847,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 848, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 849,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 850, */            /* -Wshadow=global */
  OPT_Wshadow_local = 851,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 852,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 853,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 854,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 855, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 856,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 857,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 858,                /* -Wsign-conversion */
  OPT_Wsign_promo = 859,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 860,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 861,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 862,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 863,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 864,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 865,                    /* -Wspeculative */
  OPT_Wstack_protector = 866,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 867,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 868,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 869,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 870,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 871,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 872,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 873,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 874,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 875,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 876,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 877, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 878,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 879,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 880,            /* -Wstringop-truncation */
  OPT_Wstyle = 881,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 882,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 883,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 884,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 885,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 886,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 887,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 888,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 889,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 890,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 891,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 892,               /* -Wsuggest-override */
  OPT_Wsurprising = 893,                     /* -Wsurprising */
  OPT_Wswitch = 894,                         /* -Wswitch */
  OPT_Wswitch_bool = 895,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 896,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 897,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 898,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 899,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 900,                      /* -Wsync-nand */
  OPT_Wsynth = 901,                          /* -Wsynth */
  OPT_Wsystem_headers = 902,                 /* -Wsystem-headers */
  OPT_Wtabs = 903,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 904,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 905,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 906,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 907,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplate_names_tu_local = 908,        /* -Wtemplate-names-tu-local */
  OPT_Wtemplates = 909,                      /* -Wtemplates */
  OPT_Wterminate = 910,                      /* -Wterminate */
  OPT_Wtraditional = 911,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 912,         /* -Wtraditional-conversion */
  /* OPT_Wtrailing_whitespace = 913, */      /* -Wtrailing-whitespace */
  OPT_Wtrailing_whitespace_ = 914,           /* -Wtrailing-whitespace= */
  OPT_Wtrampolines = 915,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 916,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 917,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 918,                           /* -Wtsan */
  OPT_Wtype_limits = 919,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 920,            /* -Wundeclared-selector */
  OPT_Wundef = 921,                          /* -Wundef */
  OPT_Wundefined_do_loop = 922,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 923,                      /* -Wunderflow */
  OPT_Wunicode = 924,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 925,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 926,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 927,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 928,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 929, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 930, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 931,     /* -Wunsuffixed-float-constants */
  OPT_Wunterminated_string_initialization = 932,/* -Wunterminated-string-initialization */
  OPT_Wunused = 933,                         /* -Wunused */
  /* OPT_Wunused_but_set_parameter = 934, */ /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_parameter_ = 935,      /* -Wunused-but-set-parameter= */
  /* OPT_Wunused_but_set_variable = 936, */  /* -Wunused-but-set-variable */
  OPT_Wunused_but_set_variable_ = 937,       /* -Wunused-but-set-variable= */
  /* OPT_Wunused_const_variable = 938, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 939,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 940,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 941,                /* -Wunused-function */
  OPT_Wunused_label = 942,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 943,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 944,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 945,               /* -Wunused-parameter */
  OPT_Wunused_result = 946,                  /* -Wunused-result */
  OPT_Wunused_value = 947,                   /* -Wunused-value */
  OPT_Wunused_variable = 948,                /* -Wunused-variable */
  OPT_Wuse_after_free = 949,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 950,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 951,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 952,                   /* -Wuseless-cast */
  OPT_Wvarargs = 953,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 954,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 955,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 956,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 957,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 958,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 959,            /* -Wvirtual-move-assign */
  OPT_Wvla = 960,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 961,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 962,                  /* -Wvla-parameter */
  OPT_Wvolatile = 963,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 964,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 965,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 966,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 967,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 968,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 969,                       /* -Wzerotrip */
  OPT_X = 970,                               /* -X */
  OPT_Xassembler = 971,                      /* -Xassembler */
  OPT_Xf = 972,                              /* -Xf */
  OPT_Xlinker = 973,                         /* -Xlinker */
  OPT_Xpreprocessor = 974,                   /* -Xpreprocessor */
  OPT_Z = 975,                               /* -Z */
  OPT_ansi = 976,                            /* -ansi */
  OPT_aux_info = 977,                        /* -aux-info */
  /* OPT_aux_info_ = 978, */                 /* -aux-info= */
  OPT_c = 979,                               /* -c */
  OPT_callgraph = 980,                       /* -callgraph */
  OPT_copyext = 981,                         /* -copyext */
  OPT_coverage = 982,                        /* -coverage */
  OPT_cpp = 983,                             /* -cpp */
  OPT_cpp_ = 984,                            /* -cpp= */
  OPT_d = 985,                               /* -d */
  OPT_debuglib_ = 986,                       /* -debuglib= */
  OPT_defaultlib_ = 987,                     /* -defaultlib= */
  OPT_defined_only = 988,                    /* -defined-only */
  OPT_demangle = 989,                        /* -demangle */
  OPT_dialect = 990,                         /* -dialect */
  OPT_dstartfiles = 991,                     /* -dstartfiles */
  OPT_dump_body_ = 992,                      /* -dump-body= */
  OPT_dump_level_ = 993,                     /* -dump-level= */
  OPT_dumpbase = 994,                        /* -dumpbase */
  OPT_dumpbase_ext = 995,                    /* -dumpbase-ext */
  OPT_dumpdir = 996,                         /* -dumpdir */
  OPT_dumpfullversion = 997,                 /* -dumpfullversion */
  OPT_dumpmachine = 998,                     /* -dumpmachine */
  OPT_dumpspecs = 999,                       /* -dumpspecs */
  OPT_dumpversion = 1000,                    /* -dumpversion */
  OPT_e = 1001,                              /* -e */
  OPT_export_dynamic = 1002,                 /* -export-dynamic */
  OPT_fPIC = 1003,                           /* -fPIC */
  OPT_fPIE = 1004,                           /* -fPIE */
  OPT_fRTS_ = 1005,                          /* -fRTS= */
  OPT_fabi_compat_version_ = 1006,           /* -fabi-compat-version= */
  OPT_fabi_version_ = 1007,                  /* -fabi-version= */
  OPT_faccess_control = 1008,                /* -faccess-control */
  OPT_fada_spec_parent_ = 1009,              /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 1010,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 1011, /* -faggressive-loop-optimizations */
  OPT_falign_commons = 1012,                 /* -falign-commons */
  OPT_falign_functions = 1013,               /* -falign-functions */
  OPT_falign_functions_ = 1014,              /* -falign-functions= */
  OPT_falign_jumps = 1015,                   /* -falign-jumps */
  OPT_falign_jumps_ = 1016,                  /* -falign-jumps= */
  OPT_falign_labels = 1017,                  /* -falign-labels */
  OPT_falign_labels_ = 1018,                 /* -falign-labels= */
  OPT_falign_loops = 1019,                   /* -falign-loops */
  OPT_falign_loops_ = 1020,                  /* -falign-loops= */
  /* OPT_faligned_new = 1021, */             /* -faligned-new */
  OPT_faligned_new_ = 1022,                  /* -faligned-new= */
  OPT_fall_instantiations = 1023,            /* -fall-instantiations */
  OPT_fall_intrinsics = 1024,                /* -fall-intrinsics */
  OPT_fall_virtual = 1025,                   /* -fall-virtual */
  OPT_fallocation_dce = 1026,                /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 1027,       /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1028,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1029,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1030, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1031,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1032,        /* -falt-external-templates */
  OPT_fanalyzer = 1033,                      /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 1034,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1035,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1036,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1037,          /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 1038,         /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1039, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1040,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 1041,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1042,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1043,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1044,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1045,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1046,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1047,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1048,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1049, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1050, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1051, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1052, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1053,           /* -fasan-shadow-offset= */
  OPT_fasm = 1054,                           /* -fasm */
  OPT_fassert = 1055,                        /* -fassert */
  OPT_fassociative_math = 1056,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1057,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1058,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1059,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1060,                     /* -fauto-init */
  OPT_fauto_profile = 1061,                  /* -fauto-profile */
  OPT_fauto_profile_inlining = 1062,         /* -fauto-profile-inlining */
  OPT_fauto_profile_ = 1063,                 /* -fauto-profile= */
  OPT_fautomatic = 1064,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1065,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1066,                     /* -fbackslash */
  OPT_fbacktrace = 1067,                     /* -fbacktrace */
  OPT_fbit_tests = 1068,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1069,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1070,                        /* -fbounds */
  OPT_fbounds_check = 1071,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1072,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1073,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1074,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1075, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1076, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1077, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1078,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1079,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1080,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1081,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1082,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1083,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1084,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1085,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1086,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1087,                    /* -fcall-used- */
  OPT_fcaller_saves = 1088,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1089,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1090,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1091,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1092,      /* -fcanonical-system-headers */
  OPT_fcase = 1093,                          /* -fcase */
  /* OPT_fcf_protection = 1094, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1095,                /* -fcf-protection= */
  OPT_fchar8_t = 1096,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1097,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1098, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1099,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1100,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1101,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1102, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1103, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1104, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1105, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1106, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1107, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1108,                  /* -fcheckaction= */
  OPT_fchecking = 1109,                      /* -fchecking */
  OPT_fchecking_ = 1110,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1111,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1112,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1113,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1114,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1115,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1116,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1117,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1118,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1119,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1120,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1121,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1122,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1123,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1124,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1125,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1126,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1127,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1128,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1129, */                /* -fcilkplus */
  OPT_fcoarray_ = 1130,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1131,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1132,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1133,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1134,                        /* -fcommon */
  OPT_fcompare_debug = 1135,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1136,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1137,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1138,                  /* -fcompare-elim */
  OPT_fconcepts = 1139,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1140,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1141,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1142,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1143,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1144, */          /* -fconserve-space */
  OPT_fconserve_stack = 1145,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1146,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1147,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1148,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1149,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1150,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1151,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1152,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1153,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1154,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1155,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1156,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1157,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1158, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1159,                     /* -fcontracts */
  OPT_fconvert_ = 1160,                      /* -fconvert= */
  OPT_fcoroutines = 1161,                    /* -fcoroutines */
  OPT_fcpp = 1162,                           /* -fcpp */
  OPT_fcpp_begin = 1163,                     /* -fcpp-begin */
  OPT_fcpp_end = 1164,                       /* -fcpp-end */
  OPT_fcprop_registers = 1165,               /* -fcprop-registers */
  OPT_fcray_pointer = 1166,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1167,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1168,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1169, */         /* -fcse-skip-blocks */
  /* OPT_fcx_fortran_rules = 1170, */        /* -fcx-fortran-rules */
  /* OPT_fcx_limited_range = 1171, */        /* -fcx-limited-range */
  OPT_fcx_method_ = 1172,                    /* -fcx-method= */
  OPT_fd = 1173,                             /* -fd */
  OPT_fd_lines_as_code = 1174,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1175,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1176,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1177,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1178,                      /* -fdbg-cnt= */
  OPT_fdce = 1179,                           /* -fdce */
  OPT_fdebug = 1180,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1181,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1182,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1183,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1184,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1185,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1186,           /* -fdebug-types-section */
  OPT_fdebug_ = 1187,                        /* -fdebug= */
  OPT_fdec = 1188,                           /* -fdec */
  OPT_fdec_blank_format_item = 1189,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1190,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1191,           /* -fdec-format-defaults */
  OPT_fdec_include = 1192,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1193,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1194,                      /* -fdec-math */
  OPT_fdec_static = 1195,                    /* -fdec-static */
  OPT_fdec_structure = 1196,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1197,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1198, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1199,                          /* -fdef= */
  OPT_fdefault_double_8 = 1200,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1201, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1202,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1203,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1204,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1205,                /* -fdefault-real-8 */
  OPT_fdefaultbyte = 1206,                   /* -fdefaultbyte */
  OPT_fdefer_pop = 1207,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1208,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1209,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1210,    /* -fdelete-null-pointer-checks */
  OPT_fdeps_file_ = 1211,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1212,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1213,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1214,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1215,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1216,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_add_output_ = 1217,       /* -fdiagnostics-add-output= */
  OPT_fdiagnostics_all_candidates = 1218,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1219, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1220,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1221,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1222,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1223,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1224,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1225,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1226,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1227,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1228,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1229,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1230,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_set_output_ = 1231,       /* -fdiagnostics-set-output= */
  OPT_fdiagnostics_show_caret = 1232,        /* -fdiagnostics-show-caret */
  /* OPT_fdiagnostics_show_context = 1233, *//* -fdiagnostics-show-context */
  OPT_fdiagnostics_show_context_ = 1234,     /* -fdiagnostics-show-context= */
  OPT_fdiagnostics_show_cwe = 1235,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_event_links = 1236,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1237,/* -fdiagnostics-show-highlight-colors */
  OPT_fdiagnostics_show_labels = 1238,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1239, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1240,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_nesting = 1241,      /* -fdiagnostics-show-nesting */
  OPT_fdiagnostics_show_nesting_levels = 1242,/* -fdiagnostics-show-nesting-levels */
  OPT_fdiagnostics_show_nesting_locations = 1243,/* -fdiagnostics-show-nesting-locations */
  OPT_fdiagnostics_show_option = 1244,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1245,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1246,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1247,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1248, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1249,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1250,               /* -fdirectives-only */
  OPT_fdisable_ = 1251,                      /* -fdisable- */
  OPT_fdoc = 1252,                           /* -fdoc */
  OPT_fdoc_dir_ = 1253,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1254,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1255,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1256,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1257,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1258,                      /* -fdruntime */
  OPT_fdse = 1259,                           /* -fdse */
  OPT_fdump_ = 1260,                         /* -fdump- */
  OPT_fdump_ada_spec = 1261,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1262,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1263,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1264,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1265,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1266,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1267,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1268,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1269,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1270,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1271,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1272,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1273,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1274,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1275,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1276,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1277,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1278,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1279, */               /* -fdump-core */
  OPT_fdump_d_original = 1280,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1281,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1282,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1283,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1284,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1285,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1286,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1287,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1288,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1289, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1290,                   /* -fdump-passes */
  OPT_fdump_scos = 1291,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1292,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1293,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1294,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1295,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1296,                /* -fearly-inlining */
  OPT_felide_constructors = 1297,            /* -felide-constructors */
  OPT_felide_type = 1298,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1299, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1300,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1301,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1302,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1303,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1304,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1305,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1306,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1307,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1308,                /* -fenum-int-equiv */
  OPT_fexceptions = 1309,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1310,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1311,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1312,       /* -fexpensive-optimizations */
  OPT_fext_dce = 1313,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1314,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1315,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1316,               /* -fextended-opaque */
  OPT_fextern_std_ = 1317,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1318,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1319,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1320,            /* -fexternal-templates */
  OPT_ff2c = 1321,                           /* -ff2c */
  OPT_ffast_math = 1322,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1323,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1324,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1325,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1326,              /* -ffinite-math-only */
  OPT_ffixed_ = 1327,                        /* -ffixed- */
  OPT_ffixed_form = 1328,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1329,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1330,        /* -ffixed-line-length-none */
  OPT_fflex_debug = 1331,                    /* -fflex-debug */
  OPT_ffloat_store = 1332,                   /* -ffloat-store */
  OPT_ffloatvalue = 1333,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1334,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1335,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1336,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1337, */              /* -fforce-addr */
  OPT_fforward_propagate = 1338,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1339,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1340,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1341,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1342,                     /* -ffpe-trap= */
  OPT_ffree_form = 1343,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1344,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1345,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1346,                  /* -ffreestanding */
  OPT_ffriend_injection = 1347,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1348,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1349,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1350,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1351,             /* -ffunction-sections */
  OPT_fgcse = 1352,                          /* -fgcse */
  OPT_fgcse_after_reload = 1353,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1354,                      /* -fgcse-las */
  OPT_fgcse_lm = 1355,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1356,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1357,              /* -fgen-module-list= */
  OPT_fgimple = 1358,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1359,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1360,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1361,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1362,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1363,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1364,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1365,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1366,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1367,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1368,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1369,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1370,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1371,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1372,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1373,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1374,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1375,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1376,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1377,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1378,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1379,                      /* -fgraphite */
  OPT_fgraphite_identity = 1380,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1381,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1382,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1383, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1384,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1385, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1386, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1387,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1388,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1389,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1390,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1391,                      /* -fhardened */
  /* OPT_fhelp = 1392, */                    /* -fhelp */
  /* OPT_fhelp_ = 1393, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1394,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1395,                     /* -fhonor-std */
  OPT_fhosted = 1396,                        /* -fhosted */
  OPT_fhuge_objects = 1397,                  /* -fhuge-objects */
  OPT_fident = 1398,                         /* -fident */
  OPT_fif_conversion = 1399,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1400,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1401,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1402,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1403,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1404,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1405,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1406,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1407,            /* -fimplicit-templates */
  OPT_finclude_imports = 1408,               /* -finclude-imports */
  OPT_findex = 1409,                         /* -findex */
  OPT_findicator_column = 1410,              /* -findicator-column */
  OPT_findirect_inlining = 1411,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1412,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1413,               /* -finit-character= */
  OPT_finit_derived = 1414,                  /* -finit-derived */
  OPT_finit_integer_ = 1415,                 /* -finit-integer= */
  OPT_finit_local_zero = 1416,               /* -finit-local-zero */
  OPT_finit_logical_ = 1417,                 /* -finit-logical= */
  OPT_finit_real_ = 1418,                    /* -finit-real= */
  OPT_finline = 1419,                        /* -finline */
  OPT_finline_arg_packing = 1420,            /* -finline-arg-packing */
  OPT_finline_atomics = 1421,                /* -finline-atomics */
  OPT_finline_functions = 1422,              /* -finline-functions */
  OPT_finline_functions_called_once = 1423,  /* -finline-functions-called-once */
  OPT_finline_intrinsics = 1424,             /* -finline-intrinsics */
  OPT_finline_intrinsics_ = 1425,            /* -finline-intrinsics= */
  /* OPT_finline_limit_ = 1426, */           /* -finline-limit- */
  OPT_finline_limit_ = 1427,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1428,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1429,        /* -finline-small-functions */
  OPT_finline_stringops = 1430,              /* -finline-stringops */
  OPT_finline_stringops_ = 1431,             /* -finline-stringops= */
  OPT_finput_charset_ = 1432,                /* -finput-charset= */
  OPT_finstrument_functions = 1433,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1434,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1435,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1436,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1437,           /* -finteger-4-integer-8 */
  OPT_finternal_ebcdic = 1438,               /* -finternal-ebcdic */
  OPT_fintrinsic_modules_path = 1439,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1440,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1441,                    /* -finvariants */
  OPT_fipa_bit_cp = 1442,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1443,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1444, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1445,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1446,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1447,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1448,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1449, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1450,                    /* -fipa-modref */
  OPT_fipa_profile = 1451,                   /* -fipa-profile */
  OPT_fipa_pta = 1452,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1453,                /* -fipa-pure-const */
  OPT_fipa_ra = 1454,                        /* -fipa-ra */
  OPT_fipa_reference = 1455,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1456,     /* -fipa-reference-addressable */
  OPT_fipa_reorder_for_locality = 1457,      /* -fipa-reorder-for-locality */
  OPT_fipa_sra = 1458,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1459,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1460,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1461, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1462,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1463,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1464,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1465,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1466,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1467,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1468,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1469,                  /* -fira-verbose= */
  OPT_fiso = 1470,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1471,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1472,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1473,              /* -fivar-visibility= */
  OPT_fivopts = 1474,                        /* -fivopts */
  OPT_fjump_tables = 1475,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1476,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1477,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1478,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1479,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1480,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1481,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1482,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1483,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1484,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1485,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1486,         /* -flang-info-module-cmi= */
  /* OPT_flarge_source_files = 1487, */      /* -flarge-source-files */
  OPT_flate_combine_instructions = 1488,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1489,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1490,            /* -fleading-underscore */
  OPT_flibs_ = 1491,                         /* -flibs= */
  OPT_flifetime_dse = 1492,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1493,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1494,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1495,                /* -flinker-output= */
  /* OPT_flive_patching = 1496, */           /* -flive-patching */
  OPT_flive_patching_ = 1497,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1498,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1499,                   /* -flocal-ivars */
  OPT_flocation_ = 1500,                     /* -flocation= */
  /* OPT_floop_block = 1501, */              /* -floop-block */
  /* OPT_floop_flatten = 1502, */            /* -floop-flatten */
  OPT_floop_interchange = 1503,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1504,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1505, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1506,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1507, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1508,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1509,                     /* -flra-remat */
  OPT_flto = 1510,                           /* -flto */
  OPT_flto_compression_level_ = 1511,        /* -flto-compression-level= */
  OPT_flto_incremental_cache_size_ = 1512,   /* -flto-incremental-cache-size= */
  OPT_flto_incremental_ = 1513,              /* -flto-incremental= */
  /* OPT_flto_odr_type_merging = 1514, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1515,                /* -flto-partition= */
  OPT_flto_report = 1516,                    /* -flto-report */
  OPT_flto_report_wpa = 1517,                /* -flto-report-wpa */
  OPT_flto_ = 1518,                          /* -flto= */
  OPT_fltrans = 1519,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1520,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1521,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1522,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1523,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1524,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1525,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1526,                      /* -fm2-dump= */
  OPT_fm2_file_offset_bits_ = 1527,          /* -fm2-file-offset-bits= */
  OPT_fm2_g = 1528,                          /* -fm2-g */
  OPT_fm2_lower_case = 1529,                 /* -fm2-lower-case */
  OPT_fm2_pathname_root_ = 1530,             /* -fm2-pathname-root= */
  OPT_fm2_pathname_rootI_ = 1531,            /* -fm2-pathname-rootI= */
  OPT_fm2_pathname_ = 1532,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1533,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1534,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1535,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1536,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1537,                /* -fm2-strict-type */
  OPT_fm2_strict_type_reason = 1538,         /* -fm2-strict-type-reason */
  OPT_fm2_whole_program = 1539,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1540,             /* -fmacro-prefix-map= */
  OPT_fmain = 1541,                          /* -fmain */
  OPT_fmalloc_dce = 1542,                    /* -fmalloc-dce */
  OPT_fmalloc_dce_ = 1543,                   /* -fmalloc-dce= */
  OPT_fmath_errno = 1544,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1545,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1546,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1547,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1548,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1549,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1550,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1551,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1552,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1553,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1554,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1555,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1556,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1557,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1558,                          /* -fmod= */
  OPT_fmodule_file_ = 1559,                  /* -fmodule-file= */
  OPT_fmodule_header = 1560,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1561,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1562,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1563,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1564,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1565,                   /* -fmodule-only */
  OPT_fmodule_private = 1566,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1567,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1568,                    /* -fmoduleinfo */
  OPT_fmodules = 1569,                       /* -fmodules */
  /* OPT_fmodules_ts = 1570, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1571,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1572,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1573,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1574,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1575,                 /* -fms-extensions */
  OPT_fmudflap = 1576,                       /* -fmudflap */
  OPT_fmudflapir = 1577,                     /* -fmudflapir */
  OPT_fmudflapth = 1578,                     /* -fmudflapth */
  OPT_fmultiflags = 1579,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1580,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1581,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1582,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1583,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1584,                  /* -fnext-runtime */
  OPT_fnil = 1585,                           /* -fnil */
  OPT_fnil_receivers = 1586,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1587,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1588,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1589,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1590,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1591,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1592,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1593,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1594,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1595,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1596,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1597,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1598,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1599,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1600,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1601,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1602,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1603,              /* -foffload-options= */
  OPT_foffload_ = 1604,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1605,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1606,                         /* -fonly= */
  OPT_fopenacc = 1607,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1608,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1609,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1610,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1611,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1612, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1613,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1614,                /* -foperator-names */
  OPT_fopt_info = 1615,                      /* -fopt-info */
  OPT_fopt_info_ = 1616,                     /* -fopt-info- */
  OPT_foptimize_crc = 1617,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1618, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1619,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1620,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1621, */          /* -foptional-diags */
  OPT_fpack_derived = 1622,                  /* -fpack-derived */
  OPT_fpack_struct = 1623,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1624,                  /* -fpack-struct= */
  OPT_fpad_source = 1625,                    /* -fpad-source */
  OPT_fpartial_inlining = 1626,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1627,     /* -fpatchable-function-entry= */
  OPT_fpath_coverage = 1628,                 /* -fpath-coverage */
  OPT_fpath_coverage_limit_ = 1629,          /* -fpath-coverage-limit= */
  OPT_fpcc_struct_return = 1630,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1631,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1632,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1633,                    /* -fpeel-loops */
  OPT_fpeephole = 1634,                      /* -fpeephole */
  OPT_fpeephole2 = 1635,                     /* -fpeephole2 */
  OPT_fpermissive = 1636,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1637,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1638,                           /* -fpic */
  OPT_fpie = 1639,                           /* -fpie */
  OPT_fpim = 1640,                           /* -fpim */
  OPT_fpim2 = 1641,                          /* -fpim2 */
  OPT_fpim3 = 1642,                          /* -fpim3 */
  OPT_fpim4 = 1643,                          /* -fpim4 */
  OPT_fplan9_extensions = 1644,              /* -fplan9-extensions */
  OPT_fplt = 1645,                           /* -fplt */
  OPT_fplugin_arg_ = 1646,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1647,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1648,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1649,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1650,                /* -fpostconditions */
  OPT_fpre_include_ = 1651,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1652,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1653,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1654,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1655,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1656,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1657,              /* -fpretty-templates */
  OPT_fpreview_all = 1658,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1659,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1660,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1661,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1662,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1663,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1664,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1665,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1666,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1667,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1668,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1669,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1670,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_safer = 1671,                 /* -fpreview=safer */
  OPT_fpreview_systemvariables = 1672,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1673,           /* -fprintf-return-value */
  OPT_fprofile = 1674,                       /* -fprofile */
  OPT_fprofile_abs_path = 1675,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1676,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1677,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1678,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1679,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1680,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1681,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1682,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1683,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1684,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1685,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1686,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1687,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1688,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1689,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1690,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1691,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1692,               /* -fprofile-update= */
  OPT_fprofile_use = 1693,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1694,                  /* -fprofile-use= */
  OPT_fprofile_values = 1695,                /* -fprofile-values */
  OPT_fprotect_parens = 1696,                /* -fprotect-parens */
  OPT_fpthread = 1697,                       /* -fpthread */
  OPT_fq = 1698,                             /* -fq */
  OPT_frandom_seed = 1699,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1700,                  /* -frandom-seed= */
  OPT_frange = 1701,                         /* -frange */
  OPT_frange_check = 1702,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1703,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1704,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1705,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1706,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1707,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1708,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1709,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1710,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1711,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1712,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1713,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1714,               /* -frecord-marker=8 */
  OPT_frecursive = 1715,                     /* -frecursive */
  OPT_free = 1716,                           /* -free */
  /* OPT_freg_struct_return = 1717, */       /* -freg-struct-return */
  /* OPT_fregmove = 1718, */                 /* -fregmove */
  OPT_frelease = 1719,                       /* -frelease */
  OPT_frename_registers = 1720,              /* -frename-registers */
  OPT_freorder_blocks = 1721,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1722,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1723,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1724,             /* -freorder-functions */
  OPT_frepack_arrays = 1725,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1726,          /* -freplace-objc-classes */
  OPT_frepo = 1727,                          /* -frepo */
  OPT_freport_bug = 1728,                    /* -freport-bug */
  OPT_frequire_return_statement = 1729,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1730,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1731, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1732,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1733,                   /* -fresolution= */
  OPT_freturn = 1734,                        /* -freturn */
  OPT_frevert_all = 1735,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1736,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1737,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1738,             /* -frevert=intpromote */
  OPT_frounding_math = 1739,                 /* -frounding-math */
  OPT_frtti = 1740,                          /* -frtti */
  OPT_fruntime_modules_ = 1741,              /* -fruntime-modules= */
  OPT_frust_assume_builtin_offset_of = 1742, /* -frust-assume-builtin-offset-of */
  OPT_frust_borrowcheck = 1743,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1744,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1745,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1746,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1747,                   /* -frust-crate= */
  OPT_frust_debug = 1748,                    /* -frust-debug */
  OPT_frust_dump_ = 1749,                    /* -frust-dump- */
  OPT_frust_edition_ = 1750,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1751,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1752,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1753,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1754,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1755,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1756,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1757,      /* -frust-name-resolution-2.0 */
  OPT_frust_overflow_checks = 1758,          /* -frust-overflow-checks */
  OPT_frust_panic_ = 1759,                   /* -frust-panic= */
  OPT_fsanitize_address_use_after_scope = 1760,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1761,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1762,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1763,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1764,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1765,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1766,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1767, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1768,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1769,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1770,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1771,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1772,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1773,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1774,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1775,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1776, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1777,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1778,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1779,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1780,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1781,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1782,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1783,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1784,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1785,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1786,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1787,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1788,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1789,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1790,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1791,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1792,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1793, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1794,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1795,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1796,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1797,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1798,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1799,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1800,               /* -fsection-anchors */
  /* OPT_fsee = 1801, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1802,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1803,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1804,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1805,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1806,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1807,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1808,        /* -fsemantic-interposition */
  OPT_fshared = 1809,                        /* -fshared */
  OPT_fshort_enums = 1810,                   /* -fshort-enums */
  OPT_fshort_wchar = 1811,                   /* -fshort-wchar */
  OPT_fshow_column = 1812,                   /* -fshow-column */
  OPT_fshrink_wrap = 1813,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1814,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1815,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1816,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1817,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1818,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1819,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1820,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1821,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1822,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1823,                /* -fsoft-check-all */
  OPT_fsources = 1824,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1825,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1826,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1827,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1828,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1829,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1830,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1831,                      /* -fsquangle */
  OPT_fssa_backprop = 1832,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1833,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1834,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1835,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1836, */             /* -fstack-check */
  OPT_fstack_check_ = 1837,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1838,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1839,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1840,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1841,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1842,               /* -fstack-protector */
  OPT_fstack_protector_all = 1843,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1844,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1845,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1846,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1847,                   /* -fstack-usage */
  OPT_fstatic_call = 1848,                   /* -fstatic-call */
  OPT_fstats = 1849,                         /* -fstats */
  OPT_fstdarg_opt = 1850,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1851,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1852, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1853,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1854,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1855, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1856,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1857,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1858,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1859,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1860, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1861,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1862,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1863,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1864,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1865,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1866,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1867,                  /* -fstrub=strict */
  OPT_fswig = 1868,                          /* -fswig */
  OPT_fswitch_errors = 1869,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1870,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1871,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1872,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1873, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1874,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1875, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1876,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1877, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1878,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1879,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1880,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1881,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1882,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1883,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1884,                   /* -ftime-report */
  OPT_ftime_report_details = 1885,           /* -ftime-report-details */
  OPT_ftls_model_ = 1886,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1887,              /* -ftoplevel-reorder */
  OPT_ftrace_debug = 1888,                   /* -ftrace-debug */
  OPT_ftracer = 1889,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1890,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1891,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1892,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1893,                   /* -ftrampolines */
  OPT_ftransition_all = 1894,                /* -ftransition=all */
  OPT_ftransition_field = 1895,              /* -ftransition=field */
  OPT_ftransition_in = 1896,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1897,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1898,          /* -ftransition=templates */
  OPT_ftransition_tls = 1899,                /* -ftransition=tls */
  OPT_ftrapping_math = 1900,                 /* -ftrapping-math */
  OPT_ftrapv = 1901,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1902,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1903,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1904,                      /* -ftree-ccp */
  OPT_ftree_ch = 1905,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1906, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1907,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1908,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1909, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1910,                   /* -ftree-cselim */
  OPT_ftree_dce = 1911,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1912,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1913,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1914,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1915,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1916, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1917,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1918,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1919, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1920,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1921,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1922, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1923,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1924,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1925,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1926,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1927,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1928,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1929,                      /* -ftree-pre */
  OPT_ftree_pta = 1930,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1931,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1932, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1933,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1934,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1935,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1936,                     /* -ftree-slsr */
  OPT_ftree_sra = 1937,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1938, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1939, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1940,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1941,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1942,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1943, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1944,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1945, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1946,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1947,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1948,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1949,         /* -funconstrained-commons */
  OPT_funderscoring = 1950,                  /* -funderscoring */
  OPT_funit_at_a_time = 1951,                /* -funit-at-a-time */
  OPT_funittest = 1952,                      /* -funittest */
  OPT_funreachable_traps = 1953,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1954,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1955,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1956,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1957, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1958,     /* -funsafe-math-optimizations */
  OPT_funsigned = 1959,                      /* -funsigned */
  OPT_funsigned_bitfields = 1960,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1961,                 /* -funsigned-char */
  OPT_funswitch_loops = 1962,                /* -funswitch-loops */
  OPT_funwind_tables = 1963,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1964,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1965,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1966,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1967,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1968,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1969,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1970,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1971,                     /* -fuse-list= */
  OPT_fvar_tracking = 1972,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1973,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1974,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1975,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1976,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1977, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1978,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1979,                   /* -fverbose-asm */
  /* OPT_fversion = 1980, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1981,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1982,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1983,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1984,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1985,                   /* -fvisibility= */
  OPT_fvpt = 1986,                           /* -fvpt */
  OPT_fvtable_gc = 1987,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1988,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1989,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1990,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1991,                     /* -fvtv-debug */
  OPT_fweak = 1992,                          /* -fweak */
  OPT_fweak_templates = 1993,                /* -fweak-templates */
  OPT_fweb = 1994,                           /* -fweb */
  /* OPT_fwhole_file = 1995, */              /* -fwhole-file */
  OPT_fwhole_program = 1996,                 /* -fwhole-program */
  OPT_fwholediv = 1997,                      /* -fwholediv */
  OPT_fwholevalue = 1998,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1999,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 2000,             /* -fworking-directory */
  OPT_fwpa = 2001,                           /* -fwpa */
  OPT_fwpa_ = 2002,                          /* -fwpa= */
  OPT_fwrapv = 2003,                         /* -fwrapv */
  OPT_fwrapv_pointer = 2004,                 /* -fwrapv-pointer */
  OPT_fxref = 2005,                          /* -fxref */
  OPT_fyacc_debug = 2006,                    /* -fyacc-debug */
  /* OPT_fzee = 2007, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 2008,          /* -fzero-call-used-regs= */
  OPT_fzero_init_padding_bits_ = 2009,       /* -fzero-init-padding-bits= */
  OPT_fzero_initialized_in_bss = 2010,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 2011,                     /* -fzero-link */
  OPT_g = 2012,                              /* -g */
  OPT_gant = 2013,                           /* -gant */
  OPT_gas_loc_support = 2014,                /* -gas-loc-support */
  OPT_gas_locview_support = 2015,            /* -gas-locview-support */
  OPT_gbtf = 2016,                           /* -gbtf */
  OPT_gcodeview = 2017,                      /* -gcodeview */
  OPT_gcoff = 2018,                          /* -gcoff */
  OPT_gcoff1 = 2019,                         /* -gcoff1 */
  OPT_gcoff2 = 2020,                         /* -gcoff2 */
  OPT_gcoff3 = 2021,                         /* -gcoff3 */
  OPT_gcolumn_info = 2022,                   /* -gcolumn-info */
  OPT_gctf = 2023,                           /* -gctf */
  OPT_gdescribe_dies = 2024,                 /* -gdescribe-dies */
  OPT_gdwarf = 2025,                         /* -gdwarf */
  OPT_gdwarf_ = 2026,                        /* -gdwarf- */
  OPT_gdwarf32 = 2027,                       /* -gdwarf32 */
  OPT_gdwarf64 = 2028,                       /* -gdwarf64 */
  OPT_gen_decls = 2029,                      /* -gen-decls */
  OPT_ggdb = 2030,                           /* -ggdb */
  OPT_ggnu_pubnames = 2031,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 2032,                   /* -gimple-stats */
  OPT_ginline_points = 2033,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 2034, /* -ginternal-reset-location-views */
  OPT_gnat = 2035,                           /* -gnat */
  OPT_gnatO = 2036,                          /* -gnatO */
  OPT_gno_ = 2037,                           /* -gno- */
  OPT_gno_pubnames = 2038,                   /* -gno-pubnames */
  OPT_gprune_btf = 2039,                     /* -gprune-btf */
  OPT_gpubnames = 2040,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 2041,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 2042,                   /* -gsplit-dwarf */
  OPT_gstabs = 2043,                         /* -gstabs */
  OPT_gstabs_ = 2044,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 2045,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 2046,                  /* -gstrict-dwarf */
  OPT_gtoggle = 2047,                        /* -gtoggle */
  OPT_gvariable_location_views = 2048,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 2049,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 2050,                           /* -gvms */
  OPT_gxcoff = 2051,                         /* -gxcoff */
  OPT_gxcoff_ = 2052,                        /* -gxcoff+ */
  OPT_gz = 2053,                             /* -gz */
  OPT_gz_ = 2054,                            /* -gz= */
  OPT_h = 2055,                              /* -h */
  OPT_help = 2056,                           /* -help */
  OPT_idirafter = 2057,                      /* -idirafter */
  OPT_imacros = 2058,                        /* -imacros */
  OPT_imultiarch = 2059,                     /* -imultiarch */
  OPT_imultilib = 2060,                      /* -imultilib */
  OPT_include = 2061,                        /* -include */
  OPT_iplugindir_ = 2062,                    /* -iplugindir= */
  OPT_iprefix = 2063,                        /* -iprefix */
  OPT_iquote = 2064,                         /* -iquote */
  OPT_isysroot = 2065,                       /* -isysroot */
  OPT_isystem = 2066,                        /* -isystem */
  OPT_iwithprefix = 2067,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 2068,              /* -iwithprefixbefore */
  OPT_k8 = 2069,                             /* -k8 */
  OPT_l = 2070,                              /* -l */
  OPT_lang_asm = 2071,                       /* -lang-asm */
  OPT_list = 2072,                           /* -list */
  OPT_mabi_ = 2073,                          /* -mabi= */
  OPT_main = 2074,                           /* -main */
  OPT_main_ = 2075,                          /* -main= */
  OPT_march_ = 2076,                         /* -march= */
  OPT_mautovec_preference_ = 2077,           /* -mautovec-preference= */
  OPT_mbig_endian = 2078,                    /* -mbig-endian */
  OPT_mbionic = 2079,                        /* -mbionic */
  OPT_mbranch_protection_ = 2080,            /* -mbranch-protection= */
  OPT_mcmodel_ = 2081,                       /* -mcmodel= */
  OPT_mcpu_ = 2082,                          /* -mcpu= */
  OPT_mearly_ldp_fusion = 2083,              /* -mearly-ldp-fusion */
  OPT_mearly_ra_ = 2084,                     /* -mearly-ra= */
  OPT_mfix_cortex_a53_835769 = 2085,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 2086,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 2087,             /* -mgeneral-regs-only */
  OPT_mglibc = 2088,                         /* -mglibc */
  OPT_mharden_sls_ = 2089,                   /* -mharden-sls= */
  OPT_mlate_ldp_fusion = 2090,               /* -mlate-ldp-fusion */
  OPT_mlittle_endian = 2091,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 2092,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 2093,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 2094,            /* -mlow-precision-sqrt */
  OPT_mmax_vectorization = 2095,             /* -mmax-vectorization */
  OPT_mmusl = 2096,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 2097,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 2098,               /* -moutline-atomics */
  OPT_moverride_ = 2099,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 2100,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 2101,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 2102, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2103,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 2104,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 2105,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 2106,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 2107,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 2108,                     /* -mtls-size= */
  OPT_mtp_ = 2109,                           /* -mtp= */
  OPT_mtrack_speculation = 2110,             /* -mtrack-speculation */
  OPT_mtune_ = 2111,                         /* -mtune= */
  OPT_muclibc = 2112,                        /* -muclibc */
  OPT_mverbose_cost_dump = 2113,             /* -mverbose-cost-dump */
  OPT_n = 2114,                              /* -n */
  OPT_name_sort = 2115,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2116,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2117,              /* -no-integrated-cpp */
  OPT_no_pie = 2118,                         /* -no-pie */
  OPT_nocpp = 2119,                          /* -nocpp */
  OPT_nodefaultlibs = 2120,                  /* -nodefaultlibs */
  OPT_nolibc = 2121,                         /* -nolibc */
  OPT_nomain = 2122,                         /* -nomain */
  OPT_nophoboslib = 2123,                    /* -nophoboslib */
  OPT_nostartfiles = 2124,                   /* -nostartfiles */
  OPT_nostdinc = 2125,                       /* -nostdinc */
  OPT_nostdinc__ = 2126,                     /* -nostdinc++ */
  OPT_nostdlib = 2127,                       /* -nostdlib */
  OPT_nostdlib__ = 2128,                     /* -nostdlib++ */
  OPT_o = 2129,                              /* -o */
  OPT_objects = 2130,                        /* -objects */
  OPT_p = 2131,                              /* -p */
  OPT_pass_exit_codes = 2132,                /* -pass-exit-codes */
  /* OPT_pedantic = 2133, */                 /* -pedantic */
  OPT_pedantic_errors = 2134,                /* -pedantic-errors */
  OPT_pg = 2135,                             /* -pg */
  OPT_pie = 2136,                            /* -pie */
  OPT_pipe = 2137,                           /* -pipe */
  OPT_posix = 2138,                          /* -posix */
  OPT_preprocess = 2139,                     /* -preprocess */
  OPT_print_file_name_ = 2140,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2141,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2142,          /* -print-multi-directory */
  OPT_print_multi_lib = 2143,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2144,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2145,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2146,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2147,               /* -print-prog-name= */
  OPT_print_search_dirs = 2148,              /* -print-search-dirs */
  OPT_print_sysroot = 2149,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2150,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2151,                    /* -print-value */
  OPT_profile = 2152,                        /* -profile */
  OPT_pthread = 2153,                        /* -pthread */
  OPT_quiet = 2154,                          /* -quiet */
  OPT_r = 2155,                              /* -r */
  OPT_rdynamic = 2156,                       /* -rdynamic */
  OPT_remap = 2157,                          /* -remap */
  OPT_reverse_sort = 2158,                   /* -reverse-sort */
  OPT_s = 2159,                              /* -s */
  OPT_save_temps = 2160,                     /* -save-temps */
  OPT_save_temps_ = 2161,                    /* -save-temps= */
  OPT_shared = 2162,                         /* -shared */
  OPT_shared_libgcc = 2163,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2164,               /* -shared-libphobos */
  OPT_size_sort = 2165,                      /* -size-sort */
  /* OPT_specs = 2166, */                    /* -specs */
  OPT_specs_ = 2167,                         /* -specs= */
  OPT_static = 2168,                         /* -static */
  OPT_static_libasan = 2169,                 /* -static-libasan */
  OPT_static_libgcc = 2170,                  /* -static-libgcc */
  OPT_static_libgcobol = 2171,               /* -static-libgcobol */
  OPT_static_libgfortran = 2172,             /* -static-libgfortran */
  OPT_static_libgm2 = 2173,                  /* -static-libgm2 */
  OPT_static_libgo = 2174,                   /* -static-libgo */
  OPT_static_libhwasan = 2175,               /* -static-libhwasan */
  OPT_static_liblsan = 2176,                 /* -static-liblsan */
  OPT_static_libmpx = 2177,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2178,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2179,               /* -static-libphobos */
  OPT_static_libquadmath = 2180,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2181,               /* -static-libstdc++ */
  OPT_static_libtsan = 2182,                 /* -static-libtsan */
  OPT_static_libubsan = 2183,                /* -static-libubsan */
  OPT_static_pie = 2184,                     /* -static-pie */
  /* OPT_std_c__03 = 2185, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2186, */                /* -std=c++0x */
  OPT_std_c__11 = 2187,                      /* -std=c++11 */
  OPT_std_c__14 = 2188,                      /* -std=c++14 */
  OPT_std_c__17 = 2189,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2190, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2191, */                /* -std=c++1z */
  OPT_std_c__20 = 2192,                      /* -std=c++20 */
  OPT_std_c__23 = 2193,                      /* -std=c++23 */
  OPT_std_c__26 = 2194,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2195, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2196, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2197, */                /* -std=c++2c */
  OPT_std_c__98 = 2198,                      /* -std=c++98 */
  OPT_std_c11 = 2199,                        /* -std=c11 */
  OPT_std_c17 = 2200,                        /* -std=c17 */
  /* OPT_std_c18 = 2201, */                  /* -std=c18 */
  /* OPT_std_c1x = 2202, */                  /* -std=c1x */
  OPT_std_c23 = 2203,                        /* -std=c23 */
  /* OPT_std_c2x = 2204, */                  /* -std=c2x */
  OPT_std_c2y = 2205,                        /* -std=c2y */
  /* OPT_std_c89 = 2206, */                  /* -std=c89 */
  OPT_std_c90 = 2207,                        /* -std=c90 */
  OPT_std_c99 = 2208,                        /* -std=c99 */
  /* OPT_std_c9x = 2209, */                  /* -std=c9x */
  OPT_std_f2003 = 2210,                      /* -std=f2003 */
  OPT_std_f2008 = 2211,                      /* -std=f2008 */
  OPT_std_f2008ts = 2212,                    /* -std=f2008ts */
  OPT_std_f2018 = 2213,                      /* -std=f2018 */
  OPT_std_f2023 = 2214,                      /* -std=f2023 */
  OPT_std_f202y = 2215,                      /* -std=f202y */
  OPT_std_f95 = 2216,                        /* -std=f95 */
  OPT_std_gnu = 2217,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2218, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2219, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2220,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2221,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2222,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2223, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2224, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2225,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2226,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2227,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2228, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2229, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2230, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2231,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2232,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2233,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2234, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2235, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2236,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2237, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2238,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2239, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2240,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2241,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2242, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2243, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2244,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2245, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2246, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2247, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2248, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2249, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2250, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2251,                     /* -std=legacy */
  OPT_stdlib_ = 2252,                        /* -stdlib= */
  OPT_symbol_ = 2253,                        /* -symbol= */
  OPT_symbolic = 2254,                       /* -symbolic */
  OPT_t = 2255,                              /* -t */
  OPT_time = 2256,                           /* -time */
  OPT_time_ = 2257,                          /* -time= */
  OPT_traditional = 2258,                    /* -traditional */
  OPT_traditional_cpp = 2259,                /* -traditional-cpp */
  OPT_tree_stats = 2260,                     /* -tree-stats */
  OPT_trigraphs = 2261,                      /* -trigraphs */
  OPT_truncate = 2262,                       /* -truncate */
  OPT_type_stats = 2263,                     /* -type-stats */
  OPT_u = 2264,                              /* -u */
  OPT_undef = 2265,                          /* -undef */
  OPT_v = 2266,                              /* -v */
  OPT_version = 2267,                        /* -version */
  OPT_w = 2268,                              /* -w */
  OPT_wrapper = 2269,                        /* -wrapper */
  OPT_x = 2270,                              /* -x */
  OPT_z = 2271,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
