...
enum opt_code
{
  ...
  OPT_mbionic = 1895,                        /* -mbionic */
  OPT_mbranch_protection_ = 1896,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1897,                       /* -mcmodel= */
  OPT_mcpu_ = 1898,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1899,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1900,         /* -mfix-cortex-a53-843419 */
  ...
  OPT_mtrack_speculation = 1921,             /* -mtrack-speculation */
  OPT_mtune_ = 1922,                         /* -mtune= */
  OPT_muclibc = 1923,                        /* -muclibc */
  ...
  OPT_profile = 1961,                        /* -profile */
  OPT_pthread = 1962,                        /* -pthread */
  OPT_quiet = 1963,                          /* -quiet */
  OPT_r = 1964,                              /* -r */
  OPT_rdynamic = 1965,                       /* -rdynamic */
  OPT_remap = 1966,                          /* -remap */
  OPT_reverse_sort = 1967,                   /* -reverse-sort */
  OPT_s = 1968,                              /* -s */
  OPT_save_temps = 1969,                     /* -save-temps */
  OPT_save_temps_ = 1970,                    /* -save-temps= */
  OPT_shared = 1971,                         /* -shared */
  OPT_shared_libgcc = 1972,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1973,               /* -shared-libphobos */
  OPT_size_sort = 1974,                      /* -size-sort */
  /* OPT_specs = 1975, */                    /* -specs */
  OPT_specs_ = 1976,                         /* -specs= */
  OPT_static = 1977,                         /* -static */
  OPT_static_libasan = 1978,                 /* -static-libasan */
  OPT_static_libgcc = 1979,                  /* -static-libgcc */
  OPT_static_libgfortran = 1980,             /* -static-libgfortran */
  OPT_static_libgm2 = 1981,                  /* -static-libgm2 */
  OPT_static_libgo = 1982,                   /* -static-libgo */
  OPT_static_libhwasan = 1983,               /* -static-libhwasan */
  OPT_static_liblsan = 1984,                 /* -static-liblsan */
  OPT_static_libmpx = 1985,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1986,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1987,               /* -static-libphobos */
  OPT_static_libquadmath = 1988,             /* -static-libquadmath */
  OPT_static_libstdc__ = 1989,               /* -static-libstdc++ */
  OPT_static_libtsan = 1990,                 /* -static-libtsan */
  OPT_static_libubsan = 1991,                /* -static-libubsan */
  OPT_static_pie = 1992,                     /* -static-pie */
  /* OPT_std_c__03 = 1993, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1994, */                /* -std=c++0x */
  OPT_std_c__11 = 1995,                      /* -std=c++11 */
  OPT_std_c__14 = 1996,                      /* -std=c++14 */
  OPT_std_c__17 = 1997,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1998, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1999, */                /* -std=c++1z */
  OPT_std_c__20 = 2000,                      /* -std=c++20 */
  OPT_std_c__23 = 2001,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2002, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2003, */                /* -std=c++2b */
  OPT_std_c__98 = 2004,                      /* -std=c++98 */
  OPT_std_c11 = 2005,                        /* -std=c11 */
  OPT_std_c17 = 2006,                        /* -std=c17 */
  /* OPT_std_c18 = 2007, */                  /* -std=c18 */
  /* OPT_std_c1x = 2008, */                  /* -std=c1x */
  OPT_std_c2x = 2009,                        /* -std=c2x */
  /* OPT_std_c89 = 2010, */                  /* -std=c89 */
  OPT_std_c90 = 2011,                        /* -std=c90 */
  OPT_std_c99 = 2012,                        /* -std=c99 */
  /* OPT_std_c9x = 2013, */                  /* -std=c9x */
  OPT_std_f2003 = 2014,                      /* -std=f2003 */
  OPT_std_f2008 = 2015,                      /* -std=f2008 */
  OPT_std_f2008ts = 2016,                    /* -std=f2008ts */
  OPT_std_f2018 = 2017,                      /* -std=f2018 */
  OPT_std_f95 = 2018,                        /* -std=f95 */
  OPT_std_gnu = 2019,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2020, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2021, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2022,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2023,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2024,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2025, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2026, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2027,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2028,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2029, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2030, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2031,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2032,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2033,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2034, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2035, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2036,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2037, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2038,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2039,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2040, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2041, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2042,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2043, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2044, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2045, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2046, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2047, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2048,                     /* -std=legacy */
  OPT_stdlib_ = 2049,                        /* -stdlib= */
  OPT_symbol_ = 2050,                        /* -symbol= */
  OPT_symbolic = 2051,                       /* -symbolic */
  OPT_t = 2052,                              /* -t */
  OPT_time = 2053,                           /* -time */
  OPT_time_ = 2054,                          /* -time= */
  OPT_traditional = 2055,                    /* -traditional */
  OPT_traditional_cpp = 2056,                /* -traditional-cpp */
  OPT_tree_stats = 2057,                     /* -tree-stats */
  OPT_trigraphs = 2058,                      /* -trigraphs */
  OPT_type_stats = 2059,                     /* -type-stats */
  OPT_u = 2060,                              /* -u */
  OPT_undef = 2061,                          /* -undef */
  OPT_v = 2062,                              /* -v */
  OPT_version = 2063,                        /* -version */
  OPT_w = 2064,                              /* -w */
  OPT_wrapper = 2065,                        /* -wrapper */
  OPT_x = 2066,                              /* -x */
  OPT_z = 2067,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
