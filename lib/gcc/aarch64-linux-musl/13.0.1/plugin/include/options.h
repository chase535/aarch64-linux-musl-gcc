...
enum opt_code
{
  ...
  OPT_fpreview_dip25 = 1503,                 /* -fpreview=dip25 */
  ...
  OPT_frevert_dip25 = 1576,                  /* -frevert=dip25 */
  ...
  OPT_mcpu_ = 1896,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1897,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1898,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1899,             /* -mgeneral-regs-only */
  OPT_mglibc = 1900,                         /* -mglibc */
  OPT_mharden_sls_ = 1901,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1902,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1903,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1904,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1905,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1906,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1907,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1908,               /* -moutline-atomics */
  OPT_moverride_ = 1909,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1910,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1911,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1912, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1913,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1914,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1915,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1916,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1917,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1918,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1919,             /* -mtrack-speculation */
  OPT_mtune_ = 1920,                         /* -mtune= */
  OPT_muclibc = 1921,                        /* -muclibc */
  ...
  OPT_pie = 1944,                            /* -pie */
  OPT_pipe = 1945,                           /* -pipe */
  OPT_posix = 1946,                          /* -posix */
  OPT_print_file_name_ = 1947,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1948,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1949,          /* -print-multi-directory */
  OPT_print_multi_lib = 1950,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1951,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1952,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1953,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1954,               /* -print-prog-name= */
  OPT_print_search_dirs = 1955,              /* -print-search-dirs */
  OPT_print_sysroot = 1956,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1957,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1958,                    /* -print-value */
  OPT_profile = 1959,                        /* -profile */
  OPT_pthread = 1960,                        /* -pthread */
  OPT_quiet = 1961,                          /* -quiet */
  OPT_r = 1962,                              /* -r */
  OPT_rdynamic = 1963,                       /* -rdynamic */
