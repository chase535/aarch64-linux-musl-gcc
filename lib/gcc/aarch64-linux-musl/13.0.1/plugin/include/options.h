...
enum opt_code
{
  ...
  OPT_mglibc = 1896,                         /* -mglibc */
  OPT_mharden_sls_ = 1897,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1898,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1899,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1900,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1901,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1902,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1903,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1904,               /* -moutline-atomics */
  OPT_moverride_ = 1905,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1906,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1907,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1908, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1909,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1910,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1911,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1912,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1913,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1914,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1915,             /* -mtrack-speculation */
  OPT_mtune_ = 1916,                         /* -mtune= */
  OPT_muclibc = 1917,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1918,             /* -mverbose-cost-dump */
  OPT_n = 1919,                              /* -n */
