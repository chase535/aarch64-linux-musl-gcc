...
#endif
#ifdef GENERATOR_FILE
extern int warn_undefined_vars;
#else
  int x_warn_undefined_vars;
#define warn_undefined_vars global_options.x_warn_undefined_vars
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int warn_unused_intent_out;
#else
  int x_warn_unused_intent_out;
#define warn_unused_intent_out global_options.x_warn_unused_intent_out
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int warn_unused_read;
#else
  int x_warn_unused_read;
#define warn_unused_read global_options.x_warn_unused_read
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT__param_analyzer_max_constraints_ = 83, /* --param=analyzer-max-constraints= */
  OPT__param_analyzer_max_enodes_for_full_dump_ = 84,/* --param=analyzer-max-enodes-for-full-dump= */
  OPT__param_analyzer_max_enodes_per_program_point_ = 85,/* --param=analyzer-max-enodes-per-program-point= */
  OPT__param_analyzer_max_infeasible_edges_ = 86,/* --param=analyzer-max-infeasible-edges= */
  OPT__param_analyzer_max_recursion_depth_ = 87,/* --param=analyzer-max-recursion-depth= */
  OPT__param_analyzer_max_svalue_depth_ = 88,/* --param=analyzer-max-svalue-depth= */
  OPT__param_analyzer_min_snodes_for_call_summary_ = 89,/* --param=analyzer-min-snodes-for-call-summary= */
  OPT__param_analyzer_supernode_explosion_factor_ = 90,/* --param=analyzer-supernode-explosion-factor= */
  ...
  OPT__param_max_niter_dominators_walk_ = 252,/* --param=max-niter-dominators-walk= */
  OPT__param_max_partial_antic_length_ = 253,/* --param=max-partial-antic-length= */
  OPT__param_max_peel_branches_ = 254,       /* --param=max-peel-branches= */
  OPT__param_max_peel_times_ = 255,          /* --param=max-peel-times= */
  OPT__param_max_peeled_insns_ = 256,        /* --param=max-peeled-insns= */
  OPT__param_max_pending_list_length_ = 257, /* --param=max-pending-list-length= */
  OPT__param_max_pipeline_region_blocks_ = 258,/* --param=max-pipeline-region-blocks= */
  OPT__param_max_pipeline_region_insns_ = 259,/* --param=max-pipeline-region-insns= */
  OPT__param_max_pow_sqrt_depth_ = 260,      /* --param=max-pow-sqrt-depth= */
  OPT__param_max_predicted_iterations_ = 261,/* --param=max-predicted-iterations= */
  OPT__param_max_reload_search_insns_ = 262, /* --param=max-reload-search-insns= */
  OPT__param_max_rtl_if_conversion_insns_ = 263,/* --param=max-rtl-if-conversion-insns= */
  OPT__param_max_rtl_if_conversion_predictable_cost_ = 264,/* --param=max-rtl-if-conversion-predictable-cost= */
  OPT__param_max_rtl_if_conversion_unpredictable_cost_ = 265,/* --param=max-rtl-if-conversion-unpredictable-cost= */
  OPT__param_max_sched_extend_regions_iters_ = 266,/* --param=max-sched-extend-regions-iters= */
  OPT__param_max_sched_insn_conflict_delay_ = 267,/* --param=max-sched-insn-conflict-delay= */
  OPT__param_max_sched_ready_insns_ = 268,   /* --param=max-sched-ready-insns= */
  OPT__param_max_sched_region_blocks_ = 269, /* --param=max-sched-region-blocks= */
  OPT__param_max_sched_region_insns_ = 270,  /* --param=max-sched-region-insns= */
  OPT__param_max_slsr_cand_scan_ = 271,      /* --param=max-slsr-cand-scan= */
  OPT__param_max_speculative_devirt_maydefs_ = 272,/* --param=max-speculative-devirt-maydefs= */
  OPT__param_max_ssa_name_query_depth_ = 273,/* --param=max-ssa-name-query-depth= */
  OPT__param_max_store_chains_to_track_ = 274,/* --param=max-store-chains-to-track= */
  OPT__param_max_stores_to_merge_ = 275,     /* --param=max-stores-to-merge= */
  OPT__param_max_stores_to_sink_ = 276,      /* --param=max-stores-to-sink= */
  OPT__param_max_stores_to_track_ = 277,     /* --param=max-stores-to-track= */
  OPT__param_max_tail_merge_comparisons_ = 278,/* --param=max-tail-merge-comparisons= */
  OPT__param_max_tail_merge_iterations_ = 279,/* --param=max-tail-merge-iterations= */
  OPT__param_max_tracked_strlens_ = 280,     /* --param=max-tracked-strlens= */
  OPT__param_max_tree_if_conversion_phi_args_ = 281,/* --param=max-tree-if-conversion-phi-args= */
  OPT__param_max_unroll_times_ = 282,        /* --param=max-unroll-times= */
  OPT__param_max_unrolled_insns_ = 283,      /* --param=max-unrolled-insns= */
  OPT__param_max_unswitch_depth_ = 284,      /* --param=max-unswitch-depth= */
  OPT__param_max_unswitch_insns_ = 285,      /* --param=max-unswitch-insns= */
  OPT__param_max_variable_expansions_in_unroller_ = 286,/* --param=max-variable-expansions-in-unroller= */
  OPT__param_max_vartrack_expr_depth_ = 287, /* --param=max-vartrack-expr-depth= */
  OPT__param_max_vartrack_reverse_op_size_ = 288,/* --param=max-vartrack-reverse-op-size= */
  OPT__param_max_vartrack_size_ = 289,       /* --param=max-vartrack-size= */
  OPT__param_memtag_instrument_allocas_ = 290,/* --param=memtag-instrument-allocas= */
  OPT__param_memtag_instrument_mem_intrinsics_ = 291,/* --param=memtag-instrument-mem-intrinsics= */
  OPT__param_min_crossjump_insns_ = 292,     /* --param=min-crossjump-insns= */
  OPT__param_min_inline_recursive_probability_ = 293,/* --param=min-inline-recursive-probability= */
  OPT__param_min_insn_to_prefetch_ratio_ = 294,/* --param=min-insn-to-prefetch-ratio= */
  OPT__param_min_loop_cond_split_prob_ = 295,/* --param=min-loop-cond-split-prob= */
  OPT__param_min_nondebug_insn_uid_ = 296,   /* --param=min-nondebug-insn-uid= */
  OPT__param_min_pagesize_ = 297,            /* --param=min-pagesize= */
  OPT__param_min_size_for_stack_sharing_ = 298,/* --param=min-size-for-stack-sharing= */
  OPT__param_min_spec_prob_ = 299,           /* --param=min-spec-prob= */
  OPT__param_min_vect_loop_bound_ = 300,     /* --param=min-vect-loop-bound= */
  OPT__param_modref_max_accesses_ = 301,     /* --param=modref-max-accesses= */
  OPT__param_modref_max_adjustments_ = 302,  /* --param=modref-max-adjustments= */
  OPT__param_modref_max_bases_ = 303,        /* --param=modref-max-bases= */
  OPT__param_modref_max_depth_ = 304,        /* --param=modref-max-depth= */
  OPT__param_modref_max_escape_points_ = 305,/* --param=modref-max-escape-points= */
  OPT__param_modref_max_refs_ = 306,         /* --param=modref-max-refs= */
  OPT__param_modref_max_tests_ = 307,        /* --param=modref-max-tests= */
  OPT__param_openacc_kernels_ = 308,         /* --param=openacc-kernels= */
  OPT__param_openacc_privatization_ = 309,   /* --param=openacc-privatization= */
  OPT__param_parloops_chunk_size_ = 310,     /* --param=parloops-chunk-size= */
  OPT__param_parloops_min_per_thread_ = 311, /* --param=parloops-min-per-thread= */
  OPT__param_parloops_schedule_ = 312,       /* --param=parloops-schedule= */
  OPT__param_partial_inlining_entry_probability_ = 313,/* --param=partial-inlining-entry-probability= */
  OPT__param_phiopt_factor_max_stmts_live_ = 314,/* --param=phiopt-factor-max-stmts-live= */
  OPT__param_predictable_branch_outcome_ = 315,/* --param=predictable-branch-outcome= */
  OPT__param_prefetch_dynamic_strides_ = 316,/* --param=prefetch-dynamic-strides= */
  OPT__param_prefetch_latency_ = 317,        /* --param=prefetch-latency= */
  OPT__param_prefetch_min_insn_to_mem_ratio_ = 318,/* --param=prefetch-min-insn-to-mem-ratio= */
  OPT__param_prefetch_minimum_stride_ = 319, /* --param=prefetch-minimum-stride= */
  OPT__param_profile_func_internal_id_ = 320,/* --param=profile-func-internal-id= */
  OPT__param_ranger_debug_ = 321,            /* --param=ranger-debug= */
  OPT__param_ranger_logical_depth_ = 322,    /* --param=ranger-logical-depth= */
  OPT__param_ranger_recompute_depth_ = 323,  /* --param=ranger-recompute-depth= */
  OPT__param_relation_block_limit_ = 324,    /* --param=relation-block-limit= */
  OPT__param_rpo_vn_max_loop_depth_ = 325,   /* --param=rpo-vn-max-loop-depth= */
  OPT__param_sccvn_max_alias_queries_per_access_ = 326,/* --param=sccvn-max-alias-queries-per-access= */
  OPT__param_scev_max_expr_complexity_ = 327,/* --param=scev-max-expr-complexity= */
  OPT__param_scev_max_expr_size_ = 328,      /* --param=scev-max-expr-size= */
  OPT__param_sched_autopref_queue_depth_ = 329,/* --param=sched-autopref-queue-depth= */
  OPT__param_sched_mem_true_dep_cost_ = 330, /* --param=sched-mem-true-dep-cost= */
  OPT__param_sched_pressure_algorithm_ = 331,/* --param=sched-pressure-algorithm= */
  OPT__param_sched_spec_prob_cutoff_ = 332,  /* --param=sched-spec-prob-cutoff= */
  OPT__param_sched_state_edge_prob_cutoff_ = 333,/* --param=sched-state-edge-prob-cutoff= */
  OPT__param_selsched_insns_to_rename_ = 334,/* --param=selsched-insns-to-rename= */
  OPT__param_selsched_max_lookahead_ = 335,  /* --param=selsched-max-lookahead= */
  OPT__param_selsched_max_sched_times_ = 336,/* --param=selsched-max-sched-times= */
  OPT__param_simultaneous_prefetches_ = 337, /* --param=simultaneous-prefetches= */
  OPT__param_sink_frequency_threshold_ = 338,/* --param=sink-frequency-threshold= */
  OPT__param_sms_dfa_history_ = 339,         /* --param=sms-dfa-history= */
  OPT__param_sms_loop_average_count_threshold_ = 340,/* --param=sms-loop-average-count-threshold= */
  OPT__param_sms_max_ii_factor_ = 341,       /* --param=sms-max-ii-factor= */
  OPT__param_sms_min_sc_ = 342,              /* --param=sms-min-sc= */
  OPT__param_sra_max_propagations_ = 343,    /* --param=sra-max-propagations= */
  OPT__param_sra_max_scalarization_size_Osize_ = 344,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 345,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 346,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 347,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 348,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 349,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_forwarding_max_distance_ = 350,/* --param=store-forwarding-max-distance= */
  OPT__param_store_merging_allow_unaligned_ = 351,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 352,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 353,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_threader_debug_ = 354,          /* --param=threader-debug= */
  OPT__param_tm_max_aggregate_size_ = 355,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 356,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 357, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 358,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 359,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 360,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 361, /* --param=tracer-min-branch-ratio= */
  OPT__param_transitive_relations_work_bound_ = 362,/* --param=transitive-relations-work-bound= */
  OPT__param_tree_reassoc_width_ = 363,      /* --param=tree-reassoc-width= */
  OPT__param_tsan_distinguish_volatile_ = 364,/* --param=tsan-distinguish-volatile= */
  OPT__param_tsan_instrument_func_entry_exit_ = 365,/* --param=tsan-instrument-func-entry-exit= */
  OPT__param_uninit_control_dep_attempts_ = 366,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninit_max_chain_len_ = 367,    /* --param=uninit-max-chain-len= */
  OPT__param_uninit_max_num_chains_ = 368,   /* --param=uninit-max-num-chains= */
  OPT__param_uninit_max_prune_work_ = 369,   /* --param=uninit-max-prune-work= */
  OPT__param_uninlined_function_insns_ = 370,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 371, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 372,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 373,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 374,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 375,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 376,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 377,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 378,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 379,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_induction_float_ = 380,    /* --param=vect-induction-float= */
  OPT__param_vect_inner_loop_cost_factor_ = 381,/* --param=vect-inner-loop-cost-factor= */
  OPT__param_vect_max_layout_candidates_ = 382,/* --param=vect-max-layout-candidates= */
  OPT__param_vect_max_peeling_for_alignment_ = 383,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 384,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 385,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 386,/* --param=vect-partial-vector-usage= */
  OPT__param_vect_allow_possibly_not_worthwhile_vectorizations_ = 387,/* --param=vect_allow_possibly_not_worthwhile_vectorizations= */
  OPT__param_vrp_block_limit_ = 388,         /* --param=vrp-block-limit= */
  OPT__param_vrp_cstload_limit_ = 389,       /* --param=vrp-cstload-limit= */
  OPT__param_vrp_sparse_threshold_ = 390,    /* --param=vrp-sparse-threshold= */
  OPT__param_vrp_switch_limit_ = 391,        /* --param=vrp-switch-limit= */
  OPT__param_vrp_vector_threshold_ = 392,    /* --param=vrp-vector-threshold= */
  /* OPT__pass_exit_codes = 393, */          /* --pass-exit-codes */
  /* OPT__pedantic = 394, */                 /* --pedantic */
  /* OPT__pedantic_errors = 395, */          /* --pedantic-errors */
  /* OPT__pie = 396, */                      /* --pie */
  /* OPT__pipe = 397, */                     /* --pipe */
  /* OPT__prefix = 398, */                   /* --prefix */
  /* OPT__prefix_ = 399, */                  /* --prefix= */
  /* OPT__preprocess = 400, */               /* --preprocess */
  /* OPT__print_autofdo_gcov_version = 401, *//* --print-autofdo-gcov-version */
  /* OPT__print_file_name = 402, */          /* --print-file-name */
  /* OPT__print_file_name_ = 403, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 404, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 405, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 406, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 407, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 408, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 409, */          /* --print-multiarch */
  /* OPT__print_prog_name = 410, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 411, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 412, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 413, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 414, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 415, */                  /* --profile */
  /* OPT__save_temps = 416, */               /* --save-temps */
  /* OPT__shared = 417, */                   /* --shared */
  /* OPT__specs = 418, */                    /* --specs */
  /* OPT__specs_ = 419, */                   /* --specs= */
  /* OPT__static = 420, */                   /* --static */
  /* OPT__static_pie = 421, */               /* --static-pie */
  /* OPT__symbolic = 422, */                 /* --symbolic */
  /* OPT__sysroot = 423, */                  /* --sysroot */
  OPT__sysroot_ = 424,                       /* --sysroot= */
  OPT__target_help = 425,                    /* --target-help */
  /* OPT__time = 426, */                     /* --time */
  /* OPT__trace_includes = 427, */           /* --trace-includes */
  /* OPT__traditional = 428, */              /* --traditional */
  /* OPT__traditional_cpp = 429, */          /* --traditional-cpp */
  /* OPT__trigraphs = 430, */                /* --trigraphs */
  /* OPT__undefine_macro = 431, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 432, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 433, */        /* --user-dependencies */
  /* OPT__verbose = 434, */                  /* --verbose */
  OPT__version = 435,                        /* --version */
  /* OPT__write_dependencies = 436, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 437, */  /* --write-user-dependencies */
  OPT_A = 438,                               /* -A */
  OPT_B = 439,                               /* -B */
  OPT_C = 440,                               /* -C */
  OPT_CC = 441,                              /* -CC */
  ...
  OPT_MQ = 458,                              /* -MQ */
  OPT_MT = 459,                              /* -MT */
  OPT_Mmodules = 460,                        /* -Mmodules */
  OPT_Mno_modules = 461,                     /* -Mno-modules */
  OPT_N = 462,                               /* -N */
  OPT_O = 463,                               /* -O */
  OPT_Ofast = 464,                           /* -Ofast */
  OPT_Og = 465,                              /* -Og */
  ...
  OPT_Tbss_ = 476,                           /* -Tbss= */
  OPT_Tdata = 477,                           /* -Tdata */
  OPT_Tdata_ = 478,                          /* -Tdata= */
  OPT_Ttext = 479,                           /* -Ttext */
  OPT_Ttext_ = 480,                          /* -Ttext= */
  OPT_U = 481,                               /* -U */
  /* OPT_W = 482, */                         /* -W */
  OPT_WNSObject_attribute = 483,             /* -WNSObject-attribute */
  OPT_Wa_ = 484,                             /* -Wa, */
  OPT_Wabbreviated_auto_in_template_arg = 485,/* -Wabbreviated-auto-in-template-arg */
  OPT_Wabi = 486,                            /* -Wabi */
  OPT_Wabi_tag = 487,                        /* -Wabi-tag */
  OPT_Wabi_ = 488,                           /* -Wabi= */
  OPT_Wabsolute_value = 489,                 /* -Wabsolute-value */
  OPT_Waddress = 490,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 491,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 492,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 493,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 494,                       /* -Waliasing */
  OPT_Walign_commons = 495,                  /* -Walign-commons */
  /* OPT_Waligned_new = 496, */              /* -Waligned-new */
  OPT_Waligned_new_ = 497,                   /* -Waligned-new= */
  OPT_Wall = 498,                            /* -Wall */
  OPT_Walloc_size = 499,                     /* -Walloc-size */
  OPT_Walloc_size_larger_than_ = 500,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 501,                     /* -Walloc-zero */
  OPT_Walloca = 502,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 503,            /* -Walloca-larger-than= */
  OPT_Wampersand = 504,                      /* -Wampersand */
  OPT_Wanalyzer_allocation_size = 505,       /* -Wanalyzer-allocation-size */
  OPT_Wanalyzer_deref_before_check = 506,    /* -Wanalyzer-deref-before-check */
  OPT_Wanalyzer_div_by_zero = 507,           /* -Wanalyzer-div-by-zero */
  OPT_Wanalyzer_double_fclose = 508,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 509,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 510,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_exposure_through_uninit_copy = 511,/* -Wanalyzer-exposure-through-uninit-copy */
  OPT_Wanalyzer_fd_access_mode_mismatch = 512,/* -Wanalyzer-fd-access-mode-mismatch */
  OPT_Wanalyzer_fd_double_close = 513,       /* -Wanalyzer-fd-double-close */
  OPT_Wanalyzer_fd_leak = 514,               /* -Wanalyzer-fd-leak */
  OPT_Wanalyzer_fd_phase_mismatch = 515,     /* -Wanalyzer-fd-phase-mismatch */
  OPT_Wanalyzer_fd_type_mismatch = 516,      /* -Wanalyzer-fd-type-mismatch */
  OPT_Wanalyzer_fd_use_after_close = 517,    /* -Wanalyzer-fd-use-after-close */
  OPT_Wanalyzer_fd_use_without_check = 518,  /* -Wanalyzer-fd-use-without-check */
  OPT_Wanalyzer_file_leak = 519,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 520,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_imprecise_fp_arithmetic = 521,/* -Wanalyzer-imprecise-fp-arithmetic */
  OPT_Wanalyzer_infinite_loop = 522,         /* -Wanalyzer-infinite-loop */
  OPT_Wanalyzer_infinite_recursion = 523,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 524,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 525,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 526,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_mkostemp_redundant_flags = 527,/* -Wanalyzer-mkostemp-redundant-flags */
  OPT_Wanalyzer_mktemp_missing_placeholder = 528,/* -Wanalyzer-mktemp-missing-placeholder */
  OPT_Wanalyzer_mktemp_of_string_literal = 529,/* -Wanalyzer-mktemp-of-string-literal */
  OPT_Wanalyzer_null_argument = 530,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 531,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 532,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_overlapping_buffers = 533,   /* -Wanalyzer-overlapping-buffers */
  OPT_Wanalyzer_possible_null_argument = 534,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 535,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 536,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 537,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 538,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 539,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_symbol_too_complex = 540,    /* -Wanalyzer-symbol-too-complex */
  OPT_Wanalyzer_tainted_allocation_size = 541,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 542,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_assertion = 543,     /* -Wanalyzer-tainted-assertion */
  OPT_Wanalyzer_tainted_divisor = 544,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 545,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 546,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_throw_of_unexpected_type = 547,/* -Wanalyzer-throw-of-unexpected-type */
  OPT_Wanalyzer_too_complex = 548,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_undefined_behavior_ptrdiff = 549,/* -Wanalyzer-undefined-behavior-ptrdiff */
  OPT_Wanalyzer_undefined_behavior_strtok = 550,/* -Wanalyzer-undefined-behavior-strtok */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 551,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 552,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 553,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 554,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 555,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 556,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 557,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 558,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 559,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 560,/* -Wanalyzer-write-to-string-literal */
  OPT_Wany_length = 561,                     /* -Wany-length */
  OPT_Wapply_commit = 562,                   /* -Wapply-commit */
  OPT_Wargument_mismatch = 563,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 564,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 565, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 566,                  /* -Warray-bounds= */
  OPT_Warray_compare = 567,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 568, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 569,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 570,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 571,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 572, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 573,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 574,              /* -Wattribute-warning */
  OPT_Wattributes = 575,                     /* -Wattributes */
  OPT_Wattributes_ = 576,                    /* -Wattributes= */
  OPT_Wauto_profile = 577,                   /* -Wauto-profile */
  OPT_Wbad_function_cast = 578,              /* -Wbad-function-cast */
  OPT_Wbad_line_directive = 579,             /* -Wbad-line-directive */
  OPT_Wbad_numeric = 580,                    /* -Wbad-numeric */
  /* OPT_Wbidi_chars = 581, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 582,                    /* -Wbidi-chars= */
  OPT_Wbinary_long_long = 583,               /* -Wbinary-long-long */
  OPT_Wbool_compare = 584,                   /* -Wbool-compare */
  OPT_Wbool_operation = 585,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 586,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 587,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 588,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 589, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 590,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 591,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 592,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 593,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 594,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 595,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 596, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 597,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 598,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 599,               /* -Wc++23-extensions */
  OPT_Wc__26_compat = 600,                   /* -Wc++26-compat */
  OPT_Wc__26_extensions = 601,               /* -Wc++26-extensions */
  /* OPT_Wc__2a_compat = 602, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 603,                 /* -Wc-binding-type */
  OPT_Wc11_c23_compat = 604,                 /* -Wc11-c23-compat */
  /* OPT_Wc11_c2x_compat = 605, */           /* -Wc11-c2x-compat */
  OPT_Wc23_c2y_compat = 606,                 /* -Wc23-c2y-compat */
  OPT_Wc90_c99_compat = 607,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 608,                 /* -Wc99-c11-compat */
  OPT_Wcall_giving = 609,                    /* -Wcall-giving */
  OPT_Wcall_literal = 610,                   /* -Wcall-literal */
  OPT_Wcalloc_transposed_args = 611,         /* -Wcalloc-transposed-args */
  OPT_Wcannot_profile = 612,                 /* -Wcannot-profile */
  OPT_Wcase_enum = 613,                      /* -Wcase-enum */
  OPT_Wcast_align = 614,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 615,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 616,             /* -Wcast-function-type */
  OPT_Wcast_qual = 617,                      /* -Wcast-qual */
  OPT_Wcast_result = 618,                    /* -Wcast-result */
  OPT_Wcast_user_defined = 619,              /* -Wcast-user-defined */
  /* OPT_Wcatch_value = 620, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 621,                   /* -Wcatch-value= */
  OPT_Wcdf_dollar = 622,                     /* -Wcdf-dollar */
  OPT_Wcdf_invalid_parameter = 623,          /* -Wcdf-invalid-parameter */
  OPT_Wcdf_name_not_found = 624,             /* -Wcdf-name-not-found */
  OPT_Wchanges_meaning = 625,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 626,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 627,           /* -Wcharacter-truncation */
  OPT_Wchkp = 628,                           /* -Wchkp */
  OPT_Wclass_conversion = 629,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 630,                /* -Wclass-memaccess */
  OPT_Wclobbered = 631,                      /* -Wclobbered */
  OPT_Wcobol_eject = 632,                    /* -Wcobol-eject */
  OPT_Wcobol_resume = 633,                   /* -Wcobol-resume */
  OPT_Wcobol_volatile = 634,                 /* -Wcobol-volatile */
  OPT_Wcomma_subscript = 635,                /* -Wcomma-subscript */
  OPT_Wcomment = 636,                        /* -Wcomment */
  /* OPT_Wcomments = 637, */                 /* -Wcomments */
  OPT_Wcomp_6 = 638,                         /* -Wcomp-6 */
  OPT_Wcomp_x = 639,                         /* -Wcomp-x */
  OPT_Wcompare_distinct_pointer_types = 640, /* -Wcompare-distinct-pointer-types */
  OPT_Wcompare_reals = 641,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 642,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 643,        /* -Wconditionally-supported */
  OPT_Wconstant_logical_operand = 644,       /* -Wconstant-logical-operand */
  OPT_Wconversion = 645,                     /* -Wconversion */
  OPT_Wconversion_extra = 646,               /* -Wconversion-extra */
  OPT_Wconversion_null = 647,                /* -Wconversion-null */
  OPT_Wcopybook_found = 648,                 /* -Wcopybook-found */
  OPT_Wcoverage_invalid_line_number = 649,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 650,              /* -Wcoverage-mismatch */
  OPT_Wcoverage_too_many_conditions = 651,   /* -Wcoverage-too-many-conditions */
  OPT_Wcoverage_too_many_paths = 652,        /* -Wcoverage-too-many-paths */
  OPT_Wcpp = 653,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 654,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 655,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 656,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 657, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 658,              /* -Wdangling-pointer= */
  OPT_Wdangling_reference = 659,             /* -Wdangling-reference */
  OPT_Wdate_time = 660,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 661,    /* -Wdeclaration-after-statement */
  OPT_Wdeclaration_missing_parameter_type = 662,/* -Wdeclaration-missing-parameter-type */
  OPT_Wdefaulted_function_deleted = 663,     /* -Wdefaulted-function-deleted */
  OPT_Wdelete_incomplete = 664,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 665,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 666,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 667,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 668,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 669,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 670,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 671,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdeprecated_literal_operator = 672,    /* -Wdeprecated-literal-operator */
  OPT_Wdeprecated_non_prototype = 673,       /* -Wdeprecated-non-prototype */
  OPT_Wdeprecated_openmp = 674,              /* -Wdeprecated-openmp */
  OPT_Wdeprecated_variadic_comma_omission = 675,/* -Wdeprecated-variadic-comma-omission */
  OPT_Wdesignated_init = 676,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 677,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 678,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 679,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 680,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 681,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 682,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 683,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 684,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 685,                /* -Wduplicated-cond */
  OPT_Wec_unknown = 686,                     /* -Wec-unknown */
  OPT_Weffc__ = 687,                         /* -Weffc++ */
  OPT_Welaborated_enum_base = 688,           /* -Welaborated-enum-base */
  OPT_Wempty_body = 689,                     /* -Wempty-body */
  OPT_Wendif_labels = 690,                   /* -Wendif-labels */
  OPT_Wentry_convention = 691,               /* -Wentry-convention */
  OPT_Wenum_compare = 692,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 693,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 694,              /* -Wenum-int-mismatch */
  OPT_Wequal_assign = 695,                   /* -Wequal-assign */
  OPT_Werror = 696,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 697, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 698,                         /* -Werror= */
  OPT_Wexceptions = 699,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 700,           /* -Wexpansion-to-defined */
  OPT_Wexperimental_fmv_target = 701,        /* -Wexperimental-fmv-target */
  OPT_Wexpose_global_module_tu_local = 702,  /* -Wexpose-global-module-tu-local */
  OPT_Wextensions = 703,                     /* -Wextensions */
  OPT_Wexternal_argument_mismatch = 704,     /* -Wexternal-argument-mismatch */
  OPT_Wexternal_tu_local = 705,              /* -Wexternal-tu-local */
  OPT_Wextra = 706,                          /* -Wextra */
  OPT_Wextra_semi = 707,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 708,                   /* -Wfatal-errors */
  OPT_Wfile_code_set = 709,                  /* -Wfile-code-set */
  OPT_Wflex_array_member_not_at_end = 710,   /* -Wflex-array-member-not-at-end */
  OPT_Wfloat_conversion = 711,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 712,                    /* -Wfloat-equal */
  /* OPT_Wformat = 713, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 714,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 715,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 716,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 717,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 718, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 719,               /* -Wformat-overflow= */
  OPT_Wformat_security = 720,                /* -Wformat-security */
  OPT_Wformat_signedness = 721,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 722, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 723,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 724,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 725,             /* -Wformat-zero-length */
  OPT_Wformat_ = 726,                        /* -Wformat= */
  OPT_Wframe_address = 727,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 728,             /* -Wframe-larger-than= */
  OPT_Wfree_labels = 729,                    /* -Wfree-labels */
  OPT_Wfree_nonheap_object = 730,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 731,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 732,           /* -Wfunction-elimination */
  OPT_Wglobal_module = 733,                  /* -Wglobal-module */
  OPT_Whardened = 734,                       /* -Whardened */
  OPT_Wheader_guard = 735,                   /* -Wheader-guard */
  /* OPT_Whidden_declarations = 736, */      /* -Whidden-declarations */
  OPT_Whidden_declarations_ = 737,           /* -Whidden-declarations= */
  OPT_Whigh_order_bit = 738,                 /* -Whigh-order-bit */
  /* OPT_Whsa = 739, */                      /* -Whsa */
  OPT_Wiconv_error = 740,                    /* -Wiconv-error */
  OPT_Wif_not_aligned = 741,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 742,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 743,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 744,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 745, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 746,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 747,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 748,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 749,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 750,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 751, */                   /* -Wimport */
  OPT_Winaccessible_base = 752,              /* -Winaccessible-base */
  OPT_Winclude_file_found = 753,             /* -Winclude-file-found */
  OPT_Winclude_file_not_found = 754,         /* -Winclude-file-not-found */
  OPT_Wincompatible_pointer_types = 755,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 756,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 757,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 758,             /* -Winit-list-lifetime */
  OPT_Winit_self = 759,                      /* -Winit-self */
  OPT_Winline = 760,                         /* -Winline */
  OPT_Winspect_trailing = 761,               /* -Winspect-trailing */
  OPT_Wint_conversion = 762,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 763,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 764,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 765,               /* -Winteger-division */
  OPT_Winterference_size = 766,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 767,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 768,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 769,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 770,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 771,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 772,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 773,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 774,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 775,               /* -Wjump-misses-init */
  OPT_Wkeyword_macro = 776,                  /* -Wkeyword-macro */
  OPT_Wl_ = 777,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 778, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 779,                   /* -Wlarger-than= */
  OPT_Wleading_whitespace_ = 780,            /* -Wleading-whitespace= */
  OPT_Wlength_of = 781,                      /* -Wlength-of */
  OPT_Wlevel_1_occurs = 782,                 /* -Wlevel-1-occurs */
  OPT_Wlevel_78 = 783,                       /* -Wlevel-78 */
  OPT_Wlevel_78_defined = 784,               /* -Wlevel-78-defined */
  OPT_Wline_truncation = 785,                /* -Wline-truncation */
  OPT_Wliteral_concat = 786,                 /* -Wliteral-concat */
  OPT_Wliteral_suffix = 787,                 /* -Wliteral-suffix */
  OPT_Wlocale_error = 788,                   /* -Wlocale-error */
  OPT_Wlogical_not_parentheses = 789,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 790,                     /* -Wlogical-op */
  OPT_Wlong_long = 791,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 792,              /* -Wlto-type-mismatch */
  OPT_Wmain = 793,                           /* -Wmain */
  OPT_Wmaybe_musttail_local_addr = 794,      /* -Wmaybe-musttail-local-addr */
  OPT_Wmaybe_uninitialized = 795,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 796,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 797,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 798,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 799,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 800,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 801,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 802,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 803,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 804,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 805,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 806,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 807, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 808,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 809, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_name = 810,         /* -Wmissing-parameter-name */
  OPT_Wmissing_parameter_type = 811,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 812,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 813,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 814,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 815,       /* -Wmissing-template-keyword */
  OPT_Wmissing_variable_declarations = 816,  /* -Wmissing-variable-declarations */
  OPT_Wmove_corresponding = 817,             /* -Wmove-corresponding */
  OPT_Wmove_index = 818,                     /* -Wmove-index */
  OPT_Wmove_pointer = 819,                   /* -Wmove-pointer */
  OPT_Wmudflap = 820,                        /* -Wmudflap */
  OPT_Wmultichar = 821,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 822,           /* -Wmultiple-inheritance */
  OPT_Wmultiple_parameter_fwd_decl_lists = 823,/* -Wmultiple-parameter-fwd-decl-lists */
  OPT_Wmultistatement_macros = 824,          /* -Wmultistatement-macros */
  OPT_Wmusttail_local_addr = 825,            /* -Wmusttail-local-addr */
  OPT_Wnamespaces = 826,                     /* -Wnamespaces */
  OPT_Wnarrowing = 827,                      /* -Wnarrowing */
  OPT_Wnested_externs = 828,                 /* -Wnested-externs */
  OPT_Wnllanginfo_error = 829,               /* -Wnllanginfo-error */
  /* OPT_Wno_alloc_size_larger_than = 830, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 831, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 832, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 833, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 834, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 835, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 836,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 837,                  /* -Wnoexcept-type */
  OPT_Wnon_c_typedef_for_linkage = 838,      /* -Wnon-c-typedef-for-linkage */
  OPT_Wnon_template_friend = 839,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 840,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 841,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 842,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 843, */               /* -Wnormalized */
  OPT_Wnormalized_ = 844,                    /* -Wnormalized= */
  OPT_Wnrvo = 845,                           /* -Wnrvo */
  OPT_Wnull_dereference = 846,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 847,                /* -Wobjc-root-class */
  OPT_Wodr = 848,                            /* -Wodr */
  OPT_Wold_style_cast = 849,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 850,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 851,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 852,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 853,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 854,                    /* -Wopenmp-simd */
  OPT_Woperator_space = 855,                 /* -Woperator-space */
  OPT_Woverflow = 856,                       /* -Woverflow */
  OPT_Woverlength_strings = 857,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 858, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 859,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 860,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 861,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 862,            /* -Woverwrite-recursive */
  OPT_Wp_ = 863,                             /* -Wp, */
  OPT_Wpacked = 864,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 865,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 866,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 867,                         /* -Wpadded */
  OPT_Wparentheses = 868,                    /* -Wparentheses */
  OPT_Wpedantic = 869,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 870,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 871,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 872,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 873, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 874,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 875,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 876,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 877,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 878,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 879,            /* -Wpointer-to-int-cast */
  OPT_Wpragma_once_outside_header = 880,     /* -Wpragma-once-outside-header */
  OPT_Wpragmas = 881,                        /* -Wpragmas */
  OPT_Wpreprocessor_error = 882,             /* -Wpreprocessor-error */
  OPT_Wprio_ctor_dtor = 883,                 /* -Wprio-ctor-dtor */
  OPT_Wprocedure_not_found = 884,            /* -Wprocedure-not-found */
  OPT_Wprocedure_pointer = 885,              /* -Wprocedure-pointer */
  OPT_Wproperty_assign_default = 886,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 887,                       /* -Wprotocol */
  OPT_Wpsabi = 888,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 889,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 890,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 891,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 892,                /* -Wrealloc-lhs-all */
  OPT_Wrecording_mode = 893,                 /* -Wrecording-mode */
  OPT_Wredundant_decls = 894,                /* -Wredundant-decls */
  OPT_Wredundant_move = 895,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 896,                 /* -Wredundant-tags */
  OPT_Wregister = 897,                       /* -Wregister */
  OPT_Wreorder = 898,                        /* -Wreorder */
  OPT_Wreplace_error = 899,                  /* -Wreplace-error */
  OPT_Wrestrict = 900,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 901,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 902,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 903,                    /* -Wreturn-type */
  OPT_Wreturning_number = 904,               /* -Wreturning-number */
  OPT_Wscalar_storage_order = 905,           /* -Wscalar-storage-order */
  OPT_Wscope = 906,                          /* -Wscope */
  OPT_Wsegment = 907,                        /* -Wsegment */
  OPT_Wsegment_error = 908,                  /* -Wsegment-error */
  OPT_Wsegment_negative = 909,               /* -Wsegment-negative */
  OPT_Wselector = 910,                       /* -Wselector */
  OPT_Wself_move = 911,                      /* -Wself-move */
  OPT_Wsequence_point = 912,                 /* -Wsequence-point */
  OPT_Wset_locale_to = 913,                  /* -Wset-locale-to */
  OPT_Wset_to_locale = 914,                  /* -Wset-to-locale */
  /* OPT_Wsfinae_incomplete = 915, */        /* -Wsfinae-incomplete */
  OPT_Wsfinae_incomplete_ = 916,             /* -Wsfinae-incomplete= */
  OPT_Wshadow = 917,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 918, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 919,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 920, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 921,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 922, */            /* -Wshadow=global */
  OPT_Wshadow_local = 923,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 924,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 925,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 926,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 927, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 928,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 929,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 930,                /* -Wsign-conversion */
  OPT_Wsign_promo = 931,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 932,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 933,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 934,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 935,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 936,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 937,                    /* -Wspeculative */
  OPT_Wstack_protector = 938,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 939,                   /* -Wstack-usage= */
  OPT_Wstop_number = 940,                    /* -Wstop-number */
  OPT_Wstray_indicator = 941,                /* -Wstray-indicator */
  OPT_Wstrict_aliasing = 942,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 943,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 944,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 945,           /* -Wstrict-null-sentinel */
  /* OPT_Wstrict_overflow = 946, */          /* -Wstrict-overflow */
  /* OPT_Wstrict_overflow_ = 947, */         /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 948,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 949,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 950,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 951, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 952,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 953,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 954,            /* -Wstringop-truncation */
  OPT_Wstyle = 955,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 956,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 957,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 958,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 959,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 960,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 961,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 962,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 963,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 964,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 965,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 966,               /* -Wsuggest-override */
  OPT_Wsurprising = 967,                     /* -Wsurprising */
  OPT_Wswitch = 968,                         /* -Wswitch */
  OPT_Wswitch_bool = 969,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 970,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 971,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 972,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 973,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 974,                      /* -Wsync-nand */
  /* OPT_Wsynth = 975, */                    /* -Wsynth */
  OPT_Wsystem_headers = 976,                 /* -Wsystem-headers */
  OPT_Wtabs = 977,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 978,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 979,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 980,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 981,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplate_names_tu_local = 982,        /* -Wtemplate-names-tu-local */
  OPT_Wtemplates = 983,                      /* -Wtemplates */
  OPT_Wterminate = 984,                      /* -Wterminate */
  OPT_Wtraditional = 985,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 986,         /* -Wtraditional-conversion */
  /* OPT_Wtrailing_whitespace = 987, */      /* -Wtrailing-whitespace */
  OPT_Wtrailing_whitespace_ = 988,           /* -Wtrailing-whitespace= */
  OPT_Wtrampolines = 989,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 990,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 991,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 992,                           /* -Wtsan */
  OPT_Wtype_limits = 993,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 994,            /* -Wundeclared-selector */
  OPT_Wundef = 995,                          /* -Wundef */
  OPT_Wundefined_do_loop = 996,              /* -Wundefined-do-loop */
  OPT_Wundefined_vars = 997,                 /* -Wundefined-vars */
  OPT_Wunderflow = 998,                      /* -Wunderflow */
  OPT_Wunicode = 999,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 1000,      /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 1001,     /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 1002,                 /* -Wuninitialized */
  OPT_Wunknown_pragmas = 1003,               /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 1004, */        /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 1005, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 1006,    /* -Wunsuffixed-float-constants */
  OPT_Wunterminated_string_initialization = 1007,/* -Wunterminated-string-initialization */
  OPT_Wunused = 1008,                        /* -Wunused */
  /* OPT_Wunused_but_set_parameter = 1009, *//* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_parameter_ = 1010,     /* -Wunused-but-set-parameter= */
  /* OPT_Wunused_but_set_variable = 1011, */ /* -Wunused-but-set-variable */
  OPT_Wunused_but_set_variable_ = 1012,      /* -Wunused-but-set-variable= */
  /* OPT_Wunused_const_variable = 1013, */   /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 1014,        /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 1015,         /* -Wunused-dummy-argument */
  OPT_Wunused_function = 1016,               /* -Wunused-function */
  OPT_Wunused_intent_out = 1017,             /* -Wunused-intent-out */
  OPT_Wunused_label = 1018,                  /* -Wunused-label */
  OPT_Wunused_local_typedefs = 1019,         /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 1020,                 /* -Wunused-macros */
  OPT_Wunused_parameter = 1021,              /* -Wunused-parameter */
  OPT_Wunused_read = 1022,                   /* -Wunused-read */
  OPT_Wunused_result = 1023,                 /* -Wunused-result */
  OPT_Wunused_value = 1024,                  /* -Wunused-value */
  OPT_Wunused_variable = 1025,               /* -Wunused-variable */
  OPT_Wusage_typename = 1026,                /* -Wusage-typename */
  OPT_Wuse_after_free = 1027,                /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 1028,               /* -Wuse-after-free= */
  OPT_Wuse_without_only = 1029,              /* -Wuse-without-only */
  OPT_Wuseless_cast = 1030,                  /* -Wuseless-cast */
  OPT_Wvarargs = 1031,                       /* -Wvarargs */
  OPT_Wvariadic_macros = 1032,               /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 1033,  /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 1034,             /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 1035,                  /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 1036,           /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 1037,           /* -Wvirtual-move-assign */
  OPT_Wvla = 1038,                           /* -Wvla */
  OPT_Wvla_larger_than_ = 1039,              /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 1040,                 /* -Wvla-parameter */
  OPT_Wvoiding = 1041,                       /* -Wvoiding */
  OPT_Wvolatile = 1042,                      /* -Wvolatile */
  OPT_Wvolatile_register_var = 1043,         /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 1044,                 /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 1045,               /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 1046, /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_init_padding_bits_ = 1047,       /* -Wzero-init-padding-bits= */
  OPT_Wzero_length_bounds = 1048,            /* -Wzero-length-bounds */
  OPT_Wzerotrip = 1049,                      /* -Wzerotrip */
  OPT_X = 1050,                              /* -X */
  OPT_Xassembler = 1051,                     /* -Xassembler */
  OPT_Xf = 1052,                             /* -Xf */
  OPT_Xlinker = 1053,                        /* -Xlinker */
  OPT_Xpreprocessor = 1054,                  /* -Xpreprocessor */
  OPT_Z = 1055,                              /* -Z */
  OPT_ansi = 1056,                           /* -ansi */
  OPT_aux_info = 1057,                       /* -aux-info */
  /* OPT_aux_info_ = 1058, */                /* -aux-info= */
  OPT_c = 1059,                              /* -c */
  OPT_callgraph = 1060,                      /* -callgraph */
  OPT_copyext = 1061,                        /* -copyext */
  OPT_coverage = 1062,                       /* -coverage */
  OPT_cpp = 1063,                            /* -cpp */
  OPT_cpp_ = 1064,                           /* -cpp= */
  OPT_d = 1065,                              /* -d */
  OPT_debuglib_ = 1066,                      /* -debuglib= */
  OPT_defaultlib_ = 1067,                    /* -defaultlib= */
  OPT_defined_only = 1068,                   /* -defined-only */
  OPT_demangle = 1069,                       /* -demangle */
  OPT_dialect = 1070,                        /* -dialect */
  OPT_dstartfiles = 1071,                    /* -dstartfiles */
  OPT_dump_body_ = 1072,                     /* -dump-body= */
  OPT_dump_level_ = 1073,                    /* -dump-level= */
  OPT_dumpbase = 1074,                       /* -dumpbase */
  OPT_dumpbase_ext = 1075,                   /* -dumpbase-ext */
  OPT_dumpdir = 1076,                        /* -dumpdir */
  OPT_dumpfullversion = 1077,                /* -dumpfullversion */
  OPT_dumpmachine = 1078,                    /* -dumpmachine */
  OPT_dumpspecs = 1079,                      /* -dumpspecs */
  OPT_dumpversion = 1080,                    /* -dumpversion */
  OPT_e = 1081,                              /* -e */
  OPT_export_dynamic = 1082,                 /* -export-dynamic */
  OPT_fPIC = 1083,                           /* -fPIC */
  OPT_fPIE = 1084,                           /* -fPIE */
  OPT_fRTS_ = 1085,                          /* -fRTS= */
  OPT_fa68_dump_ast = 1086,                  /* -fa68-dump-ast */
  OPT_fa68_dump_modes = 1087,                /* -fa68-dump-modes */
  OPT_fa68_dump_module_interfaces = 1088,    /* -fa68-dump-module-interfaces */
  OPT_fabi_compat_version_ = 1089,           /* -fabi-compat-version= */
  OPT_fabi_version_ = 1090,                  /* -fabi-version= */
  OPT_faccess_control = 1091,                /* -faccess-control */
  OPT_fada_spec_parent_ = 1092,              /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 1093,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 1094, /* -faggressive-loop-optimizations */
  OPT_falign_commons = 1095,                 /* -falign-commons */
  OPT_falign_functions = 1096,               /* -falign-functions */
  OPT_falign_functions_ = 1097,              /* -falign-functions= */
  OPT_falign_jumps = 1098,                   /* -falign-jumps */
  OPT_falign_jumps_ = 1099,                  /* -falign-jumps= */
  OPT_falign_labels = 1100,                  /* -falign-labels */
  OPT_falign_labels_ = 1101,                 /* -falign-labels= */
  OPT_falign_loops = 1102,                   /* -falign-loops */
  OPT_falign_loops_ = 1103,                  /* -falign-loops= */
  /* OPT_faligned_new = 1104, */             /* -faligned-new */
  OPT_faligned_new_ = 1105,                  /* -faligned-new= */
  OPT_fall_instantiations = 1106,            /* -fall-instantiations */
  OPT_fall_intrinsics = 1107,                /* -fall-intrinsics */
  OPT_fall_virtual = 1108,                   /* -fall-virtual */
  OPT_fallocation_dce = 1109,                /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 1110,       /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1111,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1112,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1113, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1114,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1115,        /* -falt-external-templates */
  OPT_fanalyzer = 1116,                      /* -fanalyzer */
  OPT_fanalyzer_assume_nothrow = 1117,       /* -fanalyzer-assume-nothrow */
  OPT_fanalyzer_call_summaries = 1118,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1119,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1120,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1121,          /* -fanalyzer-feasibility */
  /* OPT_fanalyzer_fine_grained = 1122, */   /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1123, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1124,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_simplify_supergraph = 1125,  /* -fanalyzer-simplify-supergraph */
  OPT_fanalyzer_state_merge = 1126,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1127,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1128,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1129,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1130,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1131,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1132,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1133,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1134, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1135, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1136, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1137, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1138,           /* -fasan-shadow-offset= */
  OPT_fasm = 1139,                           /* -fasm */
  OPT_fassert = 1140,                        /* -fassert */
  OPT_fassociative_math = 1141,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1142,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1143,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1144,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1145,                     /* -fauto-init */
  OPT_fauto_profile = 1146,                  /* -fauto-profile */
  OPT_fauto_profile_inlining = 1147,         /* -fauto-profile-inlining */
  OPT_fauto_profile_ = 1148,                 /* -fauto-profile= */
  OPT_fautomatic = 1149,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1150,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1151,                     /* -fbackslash */
  OPT_fbacktrace = 1152,                     /* -fbacktrace */
  OPT_fbit_tests = 1153,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1154,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1155,                        /* -fbounds */
  OPT_fbounds_check = 1156,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1157,                 /* -fbounds-check= */
  OPT_fbrackets = 1158,                      /* -fbrackets */
  OPT_fbranch_count_reg = 1159,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1160,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1161, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1162, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1163, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libga68 = 1164,              /* -fbuilding-libga68 */
  OPT_fbuilding_libgcc = 1165,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1166,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1167,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1168,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1169,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1170,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1171,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1172,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1173,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1174,                    /* -fcall-used- */
  OPT_fcaller_saves = 1175,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1176,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1177,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1178,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1179,      /* -fcanonical-system-headers */
  OPT_fcase = 1180,                          /* -fcase */
  /* OPT_fcf_protection = 1181, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1182,                /* -fcf-protection= */
  OPT_fchar8_t = 1183,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1184,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1185, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1186,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1187,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1188,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1189, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1190, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1191, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1192, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1193, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1194, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1195,                  /* -fcheckaction= */
  OPT_fchecking = 1196,                      /* -fchecking */
  OPT_fchecking_ = 1197,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1198,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1199,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1200,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1201,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1202,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1203,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1204,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1205,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1206,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1207,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1208,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1209,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1210,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1211,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1212,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1213,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1214,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1215,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1216, */                /* -fcilkplus */
  OPT_fcoarray_ = 1217,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1218,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1219,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1220,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1221,                        /* -fcommon */
  OPT_fcompare_debug = 1222,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1223,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1224,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1225,                  /* -fcompare-elim */
  OPT_fconcepts = 1226,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1227,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1228,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1229,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1230,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1231, */          /* -fconserve-space */
  OPT_fconserve_stack = 1232,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1233,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1234,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1235,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1236,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1237,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1238,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_checks_outlined = 1239,      /* -fcontract-checks-outlined */
  OPT_fcontract_disable_optimized_checks = 1240,/* -fcontract-disable-optimized-checks */
  OPT_fcontract_evaluation_semantic_ = 1241, /* -fcontract-evaluation-semantic= */
  OPT_fcontracts = 1242,                     /* -fcontracts */
  OPT_fcontracts_client_check_ = 1243,       /* -fcontracts-client-check= */
  OPT_fcontracts_conservative_ipa = 1244,    /* -fcontracts-conservative-ipa */
  OPT_fcontracts_definition_check_ = 1245,   /* -fcontracts-definition-check= */
  OPT_fconvert_ = 1246,                      /* -fconvert= */
  OPT_fcoroutines = 1247,                    /* -fcoroutines */
  OPT_fcpp = 1248,                           /* -fcpp */
  OPT_fcpp_begin = 1249,                     /* -fcpp-begin */
  OPT_fcpp_end = 1250,                       /* -fcpp-end */
  OPT_fcprop_registers = 1251,               /* -fcprop-registers */
  OPT_fcray_pointer = 1252,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1253,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1254,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1255, */         /* -fcse-skip-blocks */
  /* OPT_fcx_fortran_rules = 1256, */        /* -fcx-fortran-rules */
  /* OPT_fcx_limited_range = 1257, */        /* -fcx-limited-range */
  OPT_fcx_method_ = 1258,                    /* -fcx-method= */
  OPT_fd = 1259,                             /* -fd */
  OPT_fd_lines_as_code = 1260,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1261,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1262,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1263,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1264,                      /* -fdbg-cnt= */
  OPT_fdce = 1265,                           /* -fdce */
  OPT_fdebug = 1266,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1267,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1268,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1269,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1270,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1271,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1272,           /* -fdebug-types-section */
  OPT_fdebug_ = 1273,                        /* -fdebug= */
  OPT_fdec = 1274,                           /* -fdec */
  OPT_fdec_blank_format_item = 1275,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1276,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1277,           /* -fdec-format-defaults */
  OPT_fdec_include = 1278,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1279,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1280,                      /* -fdec-math */
  OPT_fdec_static = 1281,                    /* -fdec-static */
  OPT_fdec_structure = 1282,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1283,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1284, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1285,                          /* -fdef= */
  OPT_fdefault_double_8 = 1286,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1287, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1288,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1289,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1290,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1291,                /* -fdefault-real-8 */
  OPT_fdefaultbyte = 1292,                   /* -fdefaultbyte */
  OPT_fdefer_pop = 1293,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1294,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1295,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1296,    /* -fdelete-null-pointer-checks */
  OPT_fdep_fusion = 1297,                    /* -fdep-fusion */
  OPT_fdeps_file_ = 1298,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1299,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1300,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1301,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1302,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1303,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_add_output_ = 1304,       /* -fdiagnostics-add-output= */
  OPT_fdiagnostics_all_candidates = 1305,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1306, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1307,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1308,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1309,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1310,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1311,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1312,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1313,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1314,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1315,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1316,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1317,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_set_output_ = 1318,       /* -fdiagnostics-set-output= */
  OPT_fdiagnostics_show_caret = 1319,        /* -fdiagnostics-show-caret */
  /* OPT_fdiagnostics_show_context = 1320, *//* -fdiagnostics-show-context */
  OPT_fdiagnostics_show_context_ = 1321,     /* -fdiagnostics-show-context= */
  OPT_fdiagnostics_show_cwe = 1322,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_event_links = 1323,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1324,/* -fdiagnostics-show-highlight-colors */
  OPT_fdiagnostics_show_labels = 1325,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1326, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1327,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_nesting = 1328,      /* -fdiagnostics-show-nesting */
  OPT_fdiagnostics_show_nesting_levels = 1329,/* -fdiagnostics-show-nesting-levels */
  OPT_fdiagnostics_show_nesting_locations = 1330,/* -fdiagnostics-show-nesting-locations */
  OPT_fdiagnostics_show_option = 1331,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1332,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1333,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1334,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1335, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1336,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1337,               /* -fdirectives-only */
  OPT_fdisable_ = 1338,                      /* -fdisable- */
  OPT_fdoc = 1339,                           /* -fdoc */
  OPT_fdoc_dir_ = 1340,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1341,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1342,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1343,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1344,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1345,                      /* -fdruntime */
  OPT_fdse = 1346,                           /* -fdse */
  OPT_fdump_ = 1347,                         /* -fdump- */
  OPT_fdump_ada_spec = 1348,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1349,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1350,                 /* -fdump-analyzer */
  /* OPT_fdump_analyzer_callgraph = 1351, */ /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1352,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1353,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1354,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1355,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1356,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1357,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1358,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1359,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1360,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1361,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1362,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1363,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1364,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1365,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1366, */               /* -fdump-core */
  OPT_fdump_d_original = 1367,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1368,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1369,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1370,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1371,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1372,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1373,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1374,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1375,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1376, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1377,                   /* -fdump-passes */
  OPT_fdump_scos = 1378,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1379,           /* -fdump-system-exports */
  OPT_fdump_tuning_model_ = 1380,            /* -fdump-tuning-model= */
  OPT_fdump_unnumbered = 1381,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1382,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1383,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1384,                /* -fearly-inlining */
  OPT_felide_constructors = 1385,            /* -felide-constructors */
  OPT_felide_type = 1386,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1387, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1388,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1389,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1390,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1391,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1392,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1393,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1394,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1395,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1396,                /* -fenum-int-equiv */
  OPT_fexceptions = 1397,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1398,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1399,                 /* -fexec-charset= */
  OPT_fexec_national_charset_ = 1400,        /* -fexec-national-charset= */
  OPT_fexpensive_optimizations = 1401,       /* -fexpensive-optimizations */
  OPT_fext_dce = 1402,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1403,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1404,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1405,               /* -fextended-opaque */
  OPT_fextern_std_ = 1406,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1407,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1408,                 /* -fexternal-blas */
  OPT_fexternal_blas64 = 1409,               /* -fexternal-blas64 */
  OPT_fexternal_templates = 1410,            /* -fexternal-templates */
  OPT_ff2c = 1411,                           /* -ff2c */
  OPT_ffast_math = 1412,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1413,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1414,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1415,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1416,              /* -ffinite-math-only */
  OPT_ffixed_ = 1417,                        /* -ffixed- */
  OPT_ffixed_form = 1418,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1419,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1420,        /* -ffixed-line-length-none */
  OPT_fflex_debug = 1421,                    /* -fflex-debug */
  OPT_ffloat_store = 1422,                   /* -ffloat-store */
  OPT_ffloatvalue = 1423,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1424,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1425,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1426,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1427, */              /* -fforce-addr */
  OPT_fforward_propagate = 1428,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1429,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1430,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1431,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1432,                     /* -ffpe-trap= */
  OPT_ffree_form = 1433,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1434,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1435,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1436,                  /* -ffreestanding */
  OPT_ffriend_injection = 1437,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1438,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1439,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1440,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1441,             /* -ffunction-sections */
  OPT_ffuse_ops_with_volatile_access = 1442, /* -ffuse-ops-with-volatile-access */
  OPT_fgcse = 1443,                          /* -fgcse */
  OPT_fgcse_after_reload = 1444,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1445,                      /* -fgcse-las */
  OPT_fgcse_lm = 1446,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1447,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1448,              /* -fgen-module-list= */
  OPT_fgimple = 1449,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1450,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1451,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1452,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1453,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1454,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1455,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1456,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1457,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1458,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1459,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1460,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1461,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1462,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1463,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1464,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1465,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1466,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1467,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1468,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1469,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1470,                      /* -fgraphite */
  OPT_fgraphite_identity = 1471,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1472,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1473,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1474, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1475,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1476, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1477, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1478,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1479,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1480,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1481,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1482,                      /* -fhardened */
  /* OPT_fhelp = 1483, */                    /* -fhelp */
  /* OPT_fhelp_ = 1484, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1485,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1486,                     /* -fhonor-std */
  OPT_fhosted = 1487,                        /* -fhosted */
  OPT_fhuge_objects = 1488,                  /* -fhuge-objects */
  OPT_fident = 1489,                         /* -fident */
  OPT_fif_conversion = 1490,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1491,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1492,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1493,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1494,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1495,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1496,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1497,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1498,            /* -fimplicit-templates */
  OPT_finclude_imports = 1499,               /* -finclude-imports */
  OPT_findex = 1500,                         /* -findex */
  OPT_findicator_column = 1501,              /* -findicator-column */
  OPT_findirect_inlining = 1502,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1503,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1504,               /* -finit-character= */
  OPT_finit_derived = 1505,                  /* -finit-derived */
  OPT_finit_integer_ = 1506,                 /* -finit-integer= */
  OPT_finit_local_zero = 1507,               /* -finit-local-zero */
  OPT_finit_logical_ = 1508,                 /* -finit-logical= */
  OPT_finit_real_ = 1509,                    /* -finit-real= */
  OPT_finline = 1510,                        /* -finline */
  OPT_finline_arg_packing = 1511,            /* -finline-arg-packing */
  OPT_finline_atomics = 1512,                /* -finline-atomics */
  OPT_finline_functions = 1513,              /* -finline-functions */
  OPT_finline_functions_called_once = 1514,  /* -finline-functions-called-once */
  OPT_finline_intrinsics = 1515,             /* -finline-intrinsics */
  OPT_finline_intrinsics_ = 1516,            /* -finline-intrinsics= */
  /* OPT_finline_limit_ = 1517, */           /* -finline-limit- */
  OPT_finline_limit_ = 1518,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1519,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1520,        /* -finline-small-functions */
  OPT_finline_stringops = 1521,              /* -finline-stringops */
  OPT_finline_stringops_ = 1522,             /* -finline-stringops= */
  OPT_finput_charset_ = 1523,                /* -finput-charset= */
  OPT_finstrument_functions = 1524,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1525,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1526,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1527,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1528,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1529,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1530,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1531,                    /* -finvariants */
  OPT_fipa_bit_cp = 1532,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1533,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1534, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1535,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1536,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1537,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1538,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1539, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1540,                    /* -fipa-modref */
  OPT_fipa_profile = 1541,                   /* -fipa-profile */
  OPT_fipa_pta = 1542,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1543,                /* -fipa-pure-const */
  OPT_fipa_ra = 1544,                        /* -fipa-ra */
  OPT_fipa_reference = 1545,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1546,     /* -fipa-reference-addressable */
  OPT_fipa_reorder_for_locality = 1547,      /* -fipa-reorder-for-locality */
  OPT_fipa_sra = 1548,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1549,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1550,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1551, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1552,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1553,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1554,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1555,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1556,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1557,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1558,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1559,                  /* -fira-verbose= */
  OPT_fiso = 1560,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1561,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1562,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1563,              /* -fivar-visibility= */
  OPT_fivopts = 1564,                        /* -fivopts */
  OPT_fjump_tables = 1565,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1566,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1567,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1568,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1569,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1570,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1571,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1572,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1573,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1574,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1575,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1576,         /* -flang-info-module-cmi= */
  /* OPT_flarge_source_files = 1577, */      /* -flarge-source-files */
  OPT_flate_combine_instructions = 1578,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1579,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1580,            /* -fleading-underscore */
  OPT_flibs_ = 1581,                         /* -flibs= */
  OPT_flifetime_dse = 1582,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1583,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1584,      /* -flimit-function-alignment */
  OPT_flink_libatomic = 1585,                /* -flink-libatomic */
  OPT_flinker_output_ = 1586,                /* -flinker-output= */
  /* OPT_flive_patching = 1587, */           /* -flive-patching */
  OPT_flive_patching_ = 1588,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1589,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1590,                   /* -flocal-ivars */
  OPT_flocation_ = 1591,                     /* -flocation= */
  /* OPT_floop_block = 1592, */              /* -floop-block */
  /* OPT_floop_flatten = 1593, */            /* -floop-flatten */
  OPT_floop_interchange = 1594,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1595,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1596, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1597,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1598, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1599,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1600,                     /* -flra-remat */
  OPT_flto = 1601,                           /* -flto */
  OPT_flto_compression_level_ = 1602,        /* -flto-compression-level= */
  OPT_flto_incremental_cache_size_ = 1603,   /* -flto-incremental-cache-size= */
  OPT_flto_incremental_ = 1604,              /* -flto-incremental= */
  /* OPT_flto_odr_type_merging = 1605, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1606,                /* -flto-partition= */
  OPT_flto_report = 1607,                    /* -flto-report */
  OPT_flto_report_wpa = 1608,                /* -flto-report-wpa */
  OPT_flto_toplevel_asm_heuristics = 1609,   /* -flto-toplevel-asm-heuristics */
  OPT_flto_ = 1610,                          /* -flto= */
  OPT_fltrans = 1611,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1612,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1613,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1614,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1615,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1616,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1617,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1618,                      /* -fm2-dump= */
  OPT_fm2_file_offset_bits_ = 1619,          /* -fm2-file-offset-bits= */
  OPT_fm2_g = 1620,                          /* -fm2-g */
  OPT_fm2_lower_case = 1621,                 /* -fm2-lower-case */
  OPT_fm2_pathname_root_ = 1622,             /* -fm2-pathname-root= */
  OPT_fm2_pathname_rootI_ = 1623,            /* -fm2-pathname-rootI= */
  OPT_fm2_pathname_ = 1624,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1625,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1626,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1627,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1628,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1629,                /* -fm2-strict-type */
  OPT_fm2_strict_type_reason = 1630,         /* -fm2-strict-type-reason */
  OPT_fm2_whole_program = 1631,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1632,             /* -fmacro-prefix-map= */
  OPT_fmain = 1633,                          /* -fmain */
  OPT_fmalloc_dce = 1634,                    /* -fmalloc-dce */
  OPT_fmalloc_dce_ = 1635,                   /* -fmalloc-dce= */
  OPT_fmath_errno = 1636,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1637,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1638,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1639,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1640,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1641,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1642,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1643,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1644,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1645,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1646,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1647,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1648,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1649,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1650,                          /* -fmod= */
  OPT_fmodule_file_ = 1651,                  /* -fmodule-file= */
  OPT_fmodule_header = 1652,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1653,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1654,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1655,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1656,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1657,                   /* -fmodule-only */
  OPT_fmodule_private = 1658,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1659,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1660,                    /* -fmoduleinfo */
  OPT_fmodules = 1661,                       /* -fmodules */
  OPT_fmodules_map = 1662,                   /* -fmodules-map */
  OPT_fmodules_map_file = 1663,              /* -fmodules-map-file */
  OPT_fmodules_map_file_ = 1664,             /* -fmodules-map-file= */
  OPT_fmodules_map_ = 1665,                  /* -fmodules-map= */
  /* OPT_fmodules_ts = 1666, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1667,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1668,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1669,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1670,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1671,                 /* -fms-extensions */
  OPT_fmudflap = 1672,                       /* -fmudflap */
  OPT_fmudflapir = 1673,                     /* -fmudflapir */
  OPT_fmudflapth = 1674,                     /* -fmudflapth */
  OPT_fmultiflags = 1675,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1676,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1677,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1678,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1679,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1680,                  /* -fnext-runtime */
  OPT_fnil = 1681,                           /* -fnil */
  OPT_fnil_receivers = 1682,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1683,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1684,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1685,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1686,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1687,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1688,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1689,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1690,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1691,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1692,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1693,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1694,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1695,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1696,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1697,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1698,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1699,              /* -foffload-options= */
  OPT_foffload_ = 1700,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1701,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1702,                         /* -fonly= */
  OPT_fopenacc = 1703,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1704,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1705,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1706,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1707,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1708, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1709,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1710,                /* -foperator-names */
  OPT_fopt_info = 1711,                      /* -fopt-info */
  OPT_fopt_info_ = 1712,                     /* -fopt-info- */
  OPT_foptimize_crc = 1713,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1714, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1715,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1716,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1717, */          /* -foptional-diags */
  OPT_fpack_derived = 1718,                  /* -fpack-derived */
  OPT_fpack_struct = 1719,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1720,                  /* -fpack-struct= */
  OPT_fpad_source = 1721,                    /* -fpad-source */
  OPT_fpartial_inlining = 1722,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1723,     /* -fpatchable-function-entry= */
  OPT_fpath_coverage = 1724,                 /* -fpath-coverage */
  OPT_fpath_coverage_limit_ = 1725,          /* -fpath-coverage-limit= */
  OPT_fpcc_struct_return = 1726,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1727,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1728,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1729,                    /* -fpeel-loops */
  OPT_fpeephole = 1730,                      /* -fpeephole */
  OPT_fpeephole2 = 1731,                     /* -fpeephole2 */
  OPT_fpermissive = 1732,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1733,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1734,                           /* -fpic */
  OPT_fpie = 1735,                           /* -fpie */
  OPT_fpim = 1736,                           /* -fpim */
  OPT_fpim2 = 1737,                          /* -fpim2 */
  OPT_fpim3 = 1738,                          /* -fpim3 */
  OPT_fpim4 = 1739,                          /* -fpim4 */
  OPT_fplan9_extensions = 1740,              /* -fplan9-extensions */
  OPT_fplt = 1741,                           /* -fplt */
  OPT_fplugin_arg_ = 1742,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1743,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1744,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1745,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1746,                /* -fpostconditions */
  OPT_fpre_include_ = 1747,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1748,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1749,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1750,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1751,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1752,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1753,              /* -fpretty-templates */
  OPT_fpreview_all = 1754,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1755,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1756,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1757,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1758,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1759,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1760,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1761,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1762,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1763,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1764,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1765,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1766,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_safer = 1767,                 /* -fpreview=safer */
  OPT_fpreview_systemvariables = 1768,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1769,           /* -fprintf-return-value */
  OPT_fprofile = 1770,                       /* -fprofile */
  OPT_fprofile_abs_path = 1771,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1772,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1773,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1774,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1775,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1776,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1777,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1778,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1779,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1780,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1781,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1782,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1783,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1784,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1785,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1786,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1787,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1788,               /* -fprofile-update= */
  OPT_fprofile_use = 1789,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1790,                  /* -fprofile-use= */
  OPT_fprofile_values = 1791,                /* -fprofile-values */
  OPT_fprotect_parens = 1792,                /* -fprotect-parens */
  OPT_fpthread = 1793,                       /* -fpthread */
  OPT_fq = 1794,                             /* -fq */
  OPT_frandom_seed = 1795,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1796,                  /* -frandom-seed= */
  OPT_frange = 1797,                         /* -frange */
  OPT_frange_check = 1798,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1799,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1800,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1801,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1802,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1803,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1804,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1805,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1806,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1807,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1808,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1809,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1810,               /* -frecord-marker=8 */
  OPT_frecursive = 1811,                     /* -frecursive */
  OPT_free = 1812,                           /* -free */
  OPT_freflection = 1813,                    /* -freflection */
  /* OPT_freg_struct_return = 1814, */       /* -freg-struct-return */
  /* OPT_fregmove = 1815, */                 /* -fregmove */
  OPT_frelease = 1816,                       /* -frelease */
  OPT_frename_registers = 1817,              /* -frename-registers */
  OPT_freorder_blocks = 1818,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1819,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1820,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1821,             /* -freorder-functions */
  OPT_frepack_arrays = 1822,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1823,          /* -freplace-objc-classes */
  OPT_frepo = 1824,                          /* -frepo */
  OPT_freport_bug = 1825,                    /* -freport-bug */
  OPT_frequire_return_statement = 1826,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1827,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1828, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1829,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1830,                   /* -fresolution= */
  OPT_freturn = 1831,                        /* -freturn */
  OPT_frevert_all = 1832,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1833,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1834,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1835,             /* -frevert=intpromote */
  OPT_frounding_math = 1836,                 /* -frounding-math */
  OPT_frtti = 1837,                          /* -frtti */
  OPT_fruntime_modules_ = 1838,              /* -fruntime-modules= */
  OPT_frust_assume_builtin_offset_of = 1839, /* -frust-assume-builtin-offset-of */
  OPT_frust_borrowcheck = 1840,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1841,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1842,           /* -frust-compile-until= */
  OPT_frust_crate_attr_ = 1843,              /* -frust-crate-attr= */
  OPT_frust_crate_type_ = 1844,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1845,                   /* -frust-crate= */
  OPT_frust_debug = 1846,                    /* -frust-debug */
  OPT_frust_dump_ = 1847,                    /* -frust-dump- */
  OPT_frust_edition_ = 1848,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1849,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1850,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1851,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1852,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1853,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1854,         /* -frust-metadata-output= */
  OPT_frust_overflow_checks = 1855,          /* -frust-overflow-checks */
  OPT_frust_panic_ = 1856,                   /* -frust-panic= */
  OPT_frust_unused_check_2_0 = 1857,         /* -frust-unused-check-2.0 */
  OPT_fsanitize_address_use_after_scope = 1858,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1859,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1860,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1861,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1862,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1863,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1864,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1865, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1866,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1867,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1868,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1869,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1870,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1871,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1872,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1873,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1874, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1875,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1876,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1877,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1878,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1879,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1880,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1881,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1882,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1883,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1884,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1885,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1886,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1887,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1888,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1889,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1890,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1891, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1892,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1893,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1894,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1895,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1896,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1897,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1898,               /* -fsection-anchors */
  /* OPT_fsee = 1899, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1900,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1901,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1902,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1903,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1904,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1905,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1906,        /* -fsemantic-interposition */
  OPT_fshared = 1907,                        /* -fshared */
  OPT_fshort_enums = 1908,                   /* -fshort-enums */
  OPT_fshort_wchar = 1909,                   /* -fshort-wchar */
  OPT_fshow_column = 1910,                   /* -fshow-column */
  OPT_fshrink_wrap = 1911,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1912,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1913,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1914,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1915,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1916,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1917,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1918,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1919,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1920,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1921,                /* -fsoft-check-all */
  OPT_fsources = 1922,                       /* -fsources */
  OPT_fspeculatively_call_stored_functions = 1923,/* -fspeculatively-call-stored-functions */
  OPT_fsplit_ivs_in_unroller = 1924,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1925,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1926,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1927,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1928,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1929,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1930,                      /* -fsquangle */
  OPT_fssa_backprop = 1931,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1932,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1933,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1934,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1935, */             /* -fstack-check */
  OPT_fstack_check_ = 1936,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1937,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1938,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1939,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1940,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1941,               /* -fstack-protector */
  OPT_fstack_protector_all = 1942,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1943,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1944,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1945,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1946,                   /* -fstack-usage */
  OPT_fstatic_call = 1947,                   /* -fstatic-call */
  OPT_fstats = 1948,                         /* -fstats */
  OPT_fstdarg_opt = 1949,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1950,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1951, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1952,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1953,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1954, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1955,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1956,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1957,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1958,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1959, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1960,            /* -fstrong-eval-order= */
  OPT_fstropping_ = 1961,                    /* -fstropping= */
  OPT_fstrub_all = 1962,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1963,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1964,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1965,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1966,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1967,                  /* -fstrub=strict */
  OPT_fswig = 1968,                          /* -fswig */
  OPT_fswitch_errors = 1969,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1970,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1971,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1972,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1973, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1974,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1975, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1976,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1977, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1978,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1979,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1980,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1981,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1982,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1983,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1984,                   /* -ftime-report */
  OPT_ftime_report_details = 1985,           /* -ftime-report-details */
  OPT_ftls_model_ = 1986,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1987,              /* -ftoplevel-reorder */
  OPT_ftrace_debug = 1988,                   /* -ftrace-debug */
  OPT_ftracer = 1989,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1990,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1991,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1992,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1993,                   /* -ftrampolines */
  OPT_ftransition_all = 1994,                /* -ftransition=all */
  OPT_ftransition_field = 1995,              /* -ftransition=field */
  OPT_ftransition_in = 1996,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1997,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1998,          /* -ftransition=templates */
  OPT_ftransition_tls = 1999,                /* -ftransition=tls */
  OPT_ftrapping_math = 2000,                 /* -ftrapping-math */
  OPT_ftrapv = 2001,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 2002,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 2003,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 2004,                      /* -ftree-ccp */
  OPT_ftree_ch = 2005,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 2006, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 2007,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 2008,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 2009, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 2010,                   /* -ftree-cselim */
  OPT_ftree_dce = 2011,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 2012,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 2013,                      /* -ftree-dse */
  OPT_ftree_forwprop = 2014,                 /* -ftree-forwprop */
  OPT_ftree_fre = 2015,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 2016, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 2017,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 2018,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 2019, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 2020,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 2021,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 2022, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 2023,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 2024,           /* -ftree-loop-vectorize */
  /* OPT_ftree_lrs = 2025, */                /* -ftree-lrs */
  /* OPT_ftree_parallelize_loops = 2026, */  /* -ftree-parallelize-loops */
  OPT_ftree_parallelize_loops_ = 2027,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 2028,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 2029,                  /* -ftree-phiprop */
  OPT_ftree_pre = 2030,                      /* -ftree-pre */
  OPT_ftree_pta = 2031,                      /* -ftree-pta */
  OPT_ftree_reassoc = 2032,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 2033, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 2034,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 2035,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 2036,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 2037,                     /* -ftree-slsr */
  OPT_ftree_sra = 2038,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 2039, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 2040, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 2041,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 2042,               /* -ftree-tail-merge */
  OPT_ftree_ter = 2043,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 2044, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 2045,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 2046, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 2047,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 2048,        /* -ftrivial-auto-var-init= */
  OPT_ftrunc = 2049,                         /* -ftrunc */
  OPT_funbounded_by_reference = 2050,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 2051,         /* -funconstrained-commons */
  OPT_funderscoring = 2052,                  /* -funderscoring */
  OPT_funit_at_a_time = 2053,                /* -funit-at-a-time */
  OPT_funittest = 2054,                      /* -funittest */
  OPT_funreachable_traps = 2055,             /* -funreachable-traps */
  OPT_funroll_all_loops = 2056,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 2057,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 2058,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 2059, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 2060,     /* -funsafe-math-optimizations */
  OPT_funsigned = 2061,                      /* -funsigned */
  OPT_funsigned_bitfields = 2062,            /* -funsigned-bitfields */
  OPT_funsigned_char = 2063,                 /* -funsigned-char */
  OPT_funswitch_loops = 2064,                /* -funswitch-loops */
  OPT_funwind_tables = 2065,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 2066,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 2067,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 2068,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 2069,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 2070,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 2071,                   /* -fuse-ld=mold */
  OPT_fuse_ld_wild = 2072,                   /* -fuse-ld=wild */
  OPT_fuse_linker_plugin = 2073,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 2074,                     /* -fuse-list= */
  OPT_fvar_tracking = 2075,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 2076,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 2077,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 2078,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 2079,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 2080, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 2081,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 2082,                   /* -fverbose-asm */
  /* OPT_fversion = 2083, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 2084,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 2085,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 2086,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 2087,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 2088,                   /* -fvisibility= */
  OPT_fvpt = 2089,                           /* -fvpt */
  OPT_fvtable_gc = 2090,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 2091,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 2092,                /* -fvtable-verify= */
  OPT_fvtv_counts = 2093,                    /* -fvtv-counts */
  OPT_fvtv_debug = 2094,                     /* -fvtv-debug */
  OPT_fweak = 2095,                          /* -fweak */
  OPT_fweak_templates = 2096,                /* -fweak-templates */
  OPT_fweb = 2097,                           /* -fweb */
  /* OPT_fwhole_file = 2098, */              /* -fwhole-file */
  OPT_fwhole_program = 2099,                 /* -fwhole-program */
  OPT_fwholediv = 2100,                      /* -fwholediv */
  OPT_fwholevalue = 2101,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 2102,            /* -fwide-exec-charset= */
  OPT_fwideset = 2103,                       /* -fwideset */
  OPT_fworking_directory = 2104,             /* -fworking-directory */
  OPT_fwpa = 2105,                           /* -fwpa */
  OPT_fwpa_ = 2106,                          /* -fwpa= */
  OPT_fwrapv = 2107,                         /* -fwrapv */
  OPT_fwrapv_pointer = 2108,                 /* -fwrapv-pointer */
  OPT_fxref = 2109,                          /* -fxref */
  OPT_fyacc_debug = 2110,                    /* -fyacc-debug */
  /* OPT_fzee = 2111, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 2112,          /* -fzero-call-used-regs= */
  OPT_fzero_init_padding_bits_ = 2113,       /* -fzero-init-padding-bits= */
  OPT_fzero_initialized_in_bss = 2114,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 2115,                     /* -fzero-link */
  OPT_g = 2116,                              /* -g */
  OPT_gant = 2117,                           /* -gant */
  OPT_gas_loc_support = 2118,                /* -gas-loc-support */
  OPT_gas_locview_support = 2119,            /* -gas-locview-support */
  OPT_gbtf = 2120,                           /* -gbtf */
  OPT_gcodeview = 2121,                      /* -gcodeview */
  OPT_gcoff = 2122,                          /* -gcoff */
  OPT_gcoff1 = 2123,                         /* -gcoff1 */
  OPT_gcoff2 = 2124,                         /* -gcoff2 */
  OPT_gcoff3 = 2125,                         /* -gcoff3 */
  OPT_gcolumn_info = 2126,                   /* -gcolumn-info */
  OPT_gctf = 2127,                           /* -gctf */
  OPT_gdescribe_dies = 2128,                 /* -gdescribe-dies */
  OPT_gdwarf = 2129,                         /* -gdwarf */
  OPT_gdwarf_ = 2130,                        /* -gdwarf- */
  OPT_gdwarf32 = 2131,                       /* -gdwarf32 */
  OPT_gdwarf64 = 2132,                       /* -gdwarf64 */
  OPT_gen_decls = 2133,                      /* -gen-decls */
  OPT_ggdb = 2134,                           /* -ggdb */
  OPT_ggnu_pubnames = 2135,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 2136,                   /* -gimple-stats */
  OPT_ginline_points = 2137,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 2138, /* -ginternal-reset-location-views */
  OPT_gnat = 2139,                           /* -gnat */
  OPT_gnatO = 2140,                          /* -gnatO */
  OPT_gno_ = 2141,                           /* -gno- */
  OPT_gno_pubnames = 2142,                   /* -gno-pubnames */
  OPT_gprune_btf = 2143,                     /* -gprune-btf */
  OPT_gpubnames = 2144,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 2145,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 2146,                   /* -gsplit-dwarf */
  OPT_gstabs = 2147,                         /* -gstabs */
  OPT_gstabs_ = 2148,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 2149,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 2150,                  /* -gstrict-dwarf */
  OPT_gtoggle = 2151,                        /* -gtoggle */
  OPT_gvariable_location_views = 2152,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 2153,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 2154,                           /* -gvms */
  OPT_gxcoff = 2155,                         /* -gxcoff */
  OPT_gxcoff_ = 2156,                        /* -gxcoff+ */
  OPT_gz = 2157,                             /* -gz */
  OPT_gz_ = 2158,                            /* -gz= */
  OPT_h = 2159,                              /* -h */
  OPT_help = 2160,                           /* -help */
  OPT_idirafter = 2161,                      /* -idirafter */
  OPT_imacros = 2162,                        /* -imacros */
  OPT_imultiarch = 2163,                     /* -imultiarch */
  OPT_imultilib = 2164,                      /* -imultilib */
  OPT_include = 2165,                        /* -include */
  OPT_iplugindir_ = 2166,                    /* -iplugindir= */
  OPT_iprefix = 2167,                        /* -iprefix */
  OPT_iquote = 2168,                         /* -iquote */
  OPT_isysroot = 2169,                       /* -isysroot */
  OPT_isystem = 2170,                        /* -isystem */
  OPT_iwithprefix = 2171,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 2172,              /* -iwithprefixbefore */
  OPT_k8 = 2173,                             /* -k8 */
  OPT_l = 2174,                              /* -l */
  OPT_lang_asm = 2175,                       /* -lang-asm */
  OPT_list = 2176,                           /* -list */
  OPT_mabi_ = 2177,                          /* -mabi= */
  OPT_main = 2178,                           /* -main */
  OPT_main_ = 2179,                          /* -main= */
  OPT_march_ = 2180,                         /* -march= */
  OPT_mautovec_preference_ = 2181,           /* -mautovec-preference= */
  OPT_mbig_endian = 2182,                    /* -mbig-endian */
  OPT_mbionic = 2183,                        /* -mbionic */
  OPT_mbranch_protection_ = 2184,            /* -mbranch-protection= */
  OPT_mcmodel_ = 2185,                       /* -mcmodel= */
  OPT_mcpu_ = 2186,                          /* -mcpu= */
  OPT_mearly_ldp_fusion = 2187,              /* -mearly-ldp-fusion */
  OPT_mearly_ra_ = 2188,                     /* -mearly-ra= */
  OPT_menable_sysreg_checking = 2189,        /* -menable-sysreg-checking */
  OPT_mfix_cortex_a53_835769 = 2190,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 2191,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 2192,             /* -mgeneral-regs-only */
  OPT_mglibc = 2193,                         /* -mglibc */
  OPT_mharden_sls_ = 2194,                   /* -mharden-sls= */
  OPT_mlate_ldp_fusion = 2195,               /* -mlate-ldp-fusion */
  OPT_mlittle_endian = 2196,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 2197,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 2198,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 2199,            /* -mlow-precision-sqrt */
  OPT_mmax_vectorization = 2200,             /* -mmax-vectorization */
  OPT_mmusl = 2201,                          /* -mmusl */
  OPT_mnarrow_gp_writes = 2202,              /* -mnarrow-gp-writes */
  OPT_momit_leaf_frame_pointer = 2203,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 2204,               /* -moutline-atomics */
  OPT_moverride_ = 2205,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 2206,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 2207,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 2208, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2209,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 2210,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 2211,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 2212,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 2213,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 2214,                     /* -mtls-size= */
  OPT_mtp_ = 2215,                           /* -mtp= */
  OPT_mtrack_speculation = 2216,             /* -mtrack-speculation */
  OPT_mtune_ = 2217,                         /* -mtune= */
  OPT_muclibc = 2218,                        /* -muclibc */
  OPT_muser_provided_CPU_ = 2219,            /* -muser-provided-CPU= */
  OPT_mverbose_cost_dump = 2220,             /* -mverbose-cost-dump */
  OPT_n = 2221,                              /* -n */
  OPT_name_sort = 2222,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2223,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2224,              /* -no-integrated-cpp */
  OPT_no_pie = 2225,                         /* -no-pie */
  OPT_nocpp = 2226,                          /* -nocpp */
  OPT_nodefaultlibs = 2227,                  /* -nodefaultlibs */
  OPT_nolibc = 2228,                         /* -nolibc */
  OPT_nomain = 2229,                         /* -nomain */
  OPT_nophoboslib = 2230,                    /* -nophoboslib */
  OPT_nostartfiles = 2231,                   /* -nostartfiles */
  OPT_nostdinc = 2232,                       /* -nostdinc */
  OPT_nostdinc__ = 2233,                     /* -nostdinc++ */
  OPT_nostdlib = 2234,                       /* -nostdlib */
  OPT_nostdlib__ = 2235,                     /* -nostdlib++ */
  OPT_o = 2236,                              /* -o */
  OPT_objects = 2237,                        /* -objects */
  OPT_p = 2238,                              /* -p */
  OPT_pass_exit_codes = 2239,                /* -pass-exit-codes */
  /* OPT_pedantic = 2240, */                 /* -pedantic */
  OPT_pedantic_errors = 2241,                /* -pedantic-errors */
  OPT_pg = 2242,                             /* -pg */
  OPT_pie = 2243,                            /* -pie */
  OPT_pipe = 2244,                           /* -pipe */
  OPT_posix = 2245,                          /* -posix */
  OPT_preprocess = 2246,                     /* -preprocess */
  OPT_print_autofdo_gcov_version = 2247,     /* -print-autofdo-gcov-version */
  OPT_print_file_name_ = 2248,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2249,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2250,          /* -print-multi-directory */
  OPT_print_multi_lib = 2251,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2252,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2253,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2254,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2255,               /* -print-prog-name= */
  OPT_print_search_dirs = 2256,              /* -print-search-dirs */
  OPT_print_sysroot = 2257,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2258,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2259,                    /* -print-value */
  OPT_profile = 2260,                        /* -profile */
  OPT_pthread = 2261,                        /* -pthread */
  OPT_quiet = 2262,                          /* -quiet */
  OPT_r = 2263,                              /* -r */
  OPT_rdynamic = 2264,                       /* -rdynamic */
  OPT_remap = 2265,                          /* -remap */
  OPT_reverse_sort = 2266,                   /* -reverse-sort */
  OPT_s = 2267,                              /* -s */
  OPT_save_temps = 2268,                     /* -save-temps */
  OPT_save_temps_ = 2269,                    /* -save-temps= */
  OPT_shared = 2270,                         /* -shared */
  OPT_shared_libga68 = 2271,                 /* -shared-libga68 */
  OPT_shared_libgcc = 2272,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2273,               /* -shared-libphobos */
  OPT_size_sort = 2274,                      /* -size-sort */
  /* OPT_specs = 2275, */                    /* -specs */
  OPT_specs_ = 2276,                         /* -specs= */
  OPT_static = 2277,                         /* -static */
  OPT_static_libasan = 2278,                 /* -static-libasan */
  OPT_static_libga68 = 2279,                 /* -static-libga68 */
  OPT_static_libgcc = 2280,                  /* -static-libgcc */
  OPT_static_libgcobol = 2281,               /* -static-libgcobol */
  OPT_static_libgfortran = 2282,             /* -static-libgfortran */
  OPT_static_libgm2 = 2283,                  /* -static-libgm2 */
  OPT_static_libgo = 2284,                   /* -static-libgo */
  OPT_static_libhwasan = 2285,               /* -static-libhwasan */
  OPT_static_liblsan = 2286,                 /* -static-liblsan */
  OPT_static_libmpx = 2287,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2288,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2289,               /* -static-libphobos */
  OPT_static_libquadmath = 2290,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2291,               /* -static-libstdc++ */
  OPT_static_libtsan = 2292,                 /* -static-libtsan */
  OPT_static_libubsan = 2293,                /* -static-libubsan */
  OPT_static_pie = 2294,                     /* -static-pie */
  OPT_std_algol68 = 2295,                    /* -std=algol68 */
  /* OPT_std_c__03 = 2296, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2297, */                /* -std=c++0x */
  OPT_std_c__11 = 2298,                      /* -std=c++11 */
  OPT_std_c__14 = 2299,                      /* -std=c++14 */
  OPT_std_c__17 = 2300,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2301, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2302, */                /* -std=c++1z */
  OPT_std_c__20 = 2303,                      /* -std=c++20 */
  OPT_std_c__23 = 2304,                      /* -std=c++23 */
  OPT_std_c__26 = 2305,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2306, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2307, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2308, */                /* -std=c++2c */
  OPT_std_c__98 = 2309,                      /* -std=c++98 */
  OPT_std_c11 = 2310,                        /* -std=c11 */
  OPT_std_c17 = 2311,                        /* -std=c17 */
  /* OPT_std_c18 = 2312, */                  /* -std=c18 */
  /* OPT_std_c1x = 2313, */                  /* -std=c1x */
  OPT_std_c23 = 2314,                        /* -std=c23 */
  /* OPT_std_c2x = 2315, */                  /* -std=c2x */
  OPT_std_c2y = 2316,                        /* -std=c2y */
  /* OPT_std_c89 = 2317, */                  /* -std=c89 */
  OPT_std_c90 = 2318,                        /* -std=c90 */
  OPT_std_c99 = 2319,                        /* -std=c99 */
  /* OPT_std_c9x = 2320, */                  /* -std=c9x */
  OPT_std_d2024 = 2321,                      /* -std=d2024 */
  OPT_std_d202y = 2322,                      /* -std=d202y */
  OPT_std_f2003 = 2323,                      /* -std=f2003 */
  OPT_std_f2008 = 2324,                      /* -std=f2008 */
  OPT_std_f2008ts = 2325,                    /* -std=f2008ts */
  OPT_std_f2018 = 2326,                      /* -std=f2018 */
  OPT_std_f2023 = 2327,                      /* -std=f2023 */
  OPT_std_f202y = 2328,                      /* -std=f202y */
  OPT_std_f95 = 2329,                        /* -std=f95 */
  OPT_std_gnu = 2330,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2331, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2332, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2333,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2334,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2335,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2336, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2337, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2338,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2339,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2340,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2341, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2342, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2343, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2344,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2345,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2346,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2347, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2348, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2349,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2350, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2351,                      /* -std=gnu2y */
  OPT_std_gnu68 = 2352,                      /* -std=gnu68 */
  /* OPT_std_gnu89 = 2353, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2354,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2355,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2356, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2357, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2358,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2359, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2360, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2361, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2362, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2363, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2364, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2365,                     /* -std=legacy */
  OPT_stdlib_ = 2366,                        /* -stdlib= */
  OPT_symbol_ = 2367,                        /* -symbol= */
  OPT_symbolic = 2368,                       /* -symbolic */
  OPT_t = 2369,                              /* -t */
  OPT_time = 2370,                           /* -time */
  OPT_time_ = 2371,                          /* -time= */
  OPT_traditional = 2372,                    /* -traditional */
  OPT_traditional_cpp = 2373,                /* -traditional-cpp */
  OPT_tree_stats = 2374,                     /* -tree-stats */
  OPT_trigraphs = 2375,                      /* -trigraphs */
  OPT_truncate = 2376,                       /* -truncate */
  OPT_type_stats = 2377,                     /* -type-stats */
  OPT_u = 2378,                              /* -u */
  OPT_undef = 2379,                          /* -undef */
  OPT_v = 2380,                              /* -v */
  OPT_version = 2381,                        /* -version */
  OPT_w = 2382,                              /* -w */
  OPT_wrapper = 2383,                        /* -wrapper */
  OPT_x = 2384,                              /* -x */
  OPT_z = 2385,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
