...
enum opt_code
{
  ...
  OPT_mbionic = 1900,                        /* -mbionic */
  OPT_mbranch_protection_ = 1901,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1902,                       /* -mcmodel= */
  OPT_mcpu_ = 1903,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1904,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1905,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1906,             /* -mgeneral-regs-only */
  OPT_mglibc = 1907,                         /* -mglibc */
  OPT_mharden_sls_ = 1908,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1909,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1910,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1911,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1912,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1913,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1914,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1915,               /* -moutline-atomics */
  OPT_moverride_ = 1916,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1917,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1918,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1919, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1920,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1921,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1922,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1923,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1924,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1925,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1926,             /* -mtrack-speculation */
  OPT_mtune_ = 1927,                         /* -mtune= */
  OPT_muclibc = 1928,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1929,             /* -mverbose-cost-dump */
  OPT_n = 1930,                              /* -n */
  OPT_name_sort = 1931,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1932,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1933,              /* -no-integrated-cpp */
  OPT_no_pie = 1934,                         /* -no-pie */
  OPT_nocpp = 1935,                          /* -nocpp */
  OPT_nodefaultlibs = 1936,                  /* -nodefaultlibs */
  OPT_nolibc = 1937,                         /* -nolibc */
  OPT_nophoboslib = 1938,                    /* -nophoboslib */
  OPT_nostartfiles = 1939,                   /* -nostartfiles */
  OPT_nostdinc = 1940,                       /* -nostdinc */
  OPT_nostdinc__ = 1941,                     /* -nostdinc++ */
  OPT_nostdlib = 1942,                       /* -nostdlib */
  OPT_nostdlib__ = 1943,                     /* -nostdlib++ */
  OPT_o = 1944,                              /* -o */
  OPT_objects = 1945,                        /* -objects */
  OPT_p = 1946,                              /* -p */
  OPT_pass_exit_codes = 1947,                /* -pass-exit-codes */
  /* OPT_pedantic = 1948, */                 /* -pedantic */
  OPT_pedantic_errors = 1949,                /* -pedantic-errors */
  OPT_pg = 1950,                             /* -pg */
  OPT_pie = 1951,                            /* -pie */
  OPT_pipe = 1952,                           /* -pipe */
  OPT_posix = 1953,                          /* -posix */
  OPT_print_file_name_ = 1954,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1955,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1956,          /* -print-multi-directory */
  OPT_print_multi_lib = 1957,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1958,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1959,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1960,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1961,               /* -print-prog-name= */
  OPT_print_search_dirs = 1962,              /* -print-search-dirs */
  OPT_print_sysroot = 1963,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1964,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1965,                    /* -print-value */
  OPT_profile = 1966,                        /* -profile */
  OPT_pthread = 1967,                        /* -pthread */
  OPT_quiet = 1968,                          /* -quiet */
  OPT_r = 1969,                              /* -r */
  OPT_rdynamic = 1970,                       /* -rdynamic */
