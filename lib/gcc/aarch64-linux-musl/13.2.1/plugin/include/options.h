...
enum opt_code
{
  ...
  OPT_list = 1898,                           /* -list */
  OPT_mabi_ = 1899,                          /* -mabi= */
  OPT_march_ = 1900,                         /* -march= */
  OPT_mbig_endian = 1901,                    /* -mbig-endian */
  OPT_mbionic = 1902,                        /* -mbionic */
  OPT_mbranch_protection_ = 1903,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1904,                       /* -mcmodel= */
  OPT_mcpu_ = 1905,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1906,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1907,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1908,             /* -mgeneral-regs-only */
  OPT_mglibc = 1909,                         /* -mglibc */
  OPT_mharden_sls_ = 1910,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1911,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1912,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1913,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1914,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1915,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1916,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1917,               /* -moutline-atomics */
  OPT_moverride_ = 1918,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1919,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1920,          /* -msign-return-address= */
  ...
  OPT_mstrict_align = 1924,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1925,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1926,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1927,                     /* -mtls-size= */
