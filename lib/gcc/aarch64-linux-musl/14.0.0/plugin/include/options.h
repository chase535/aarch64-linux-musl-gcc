...
enum opt_code
{
  ...
  OPT_mbionic = 1907,                        /* -mbionic */
  OPT_mbranch_protection_ = 1908,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1909,                       /* -mcmodel= */
  OPT_mcpu_ = 1910,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1911,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1912,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1913,             /* -mgeneral-regs-only */
  OPT_mglibc = 1914,                         /* -mglibc */
  OPT_mharden_sls_ = 1915,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1916,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1917,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1918,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1919,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1920,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1921,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1922,               /* -moutline-atomics */
  OPT_moverride_ = 1923,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1924,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1925,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1926, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1927,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1928,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1929,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1930,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1931,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1932,                     /* -mtls-size= */
  OPT_mtp_ = 1933,                           /* -mtp= */
  OPT_mtrack_speculation = 1934,             /* -mtrack-speculation */
  OPT_mtune_ = 1935,                         /* -mtune= */
  OPT_muclibc = 1936,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1937,             /* -mverbose-cost-dump */
  OPT_n = 1938,                              /* -n */
  OPT_name_sort = 1939,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1940,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1941,              /* -no-integrated-cpp */
  OPT_no_pie = 1942,                         /* -no-pie */
  OPT_nocpp = 1943,                          /* -nocpp */
  OPT_nodefaultlibs = 1944,                  /* -nodefaultlibs */
  OPT_nolibc = 1945,                         /* -nolibc */
  OPT_nophoboslib = 1946,                    /* -nophoboslib */
  OPT_nostartfiles = 1947,                   /* -nostartfiles */
  OPT_nostdinc = 1948,                       /* -nostdinc */
  OPT_nostdinc__ = 1949,                     /* -nostdinc++ */
  OPT_nostdlib = 1950,                       /* -nostdlib */
  OPT_nostdlib__ = 1951,                     /* -nostdlib++ */
  OPT_o = 1952,                              /* -o */
  OPT_objects = 1953,                        /* -objects */
  OPT_p = 1954,                              /* -p */
  OPT_pass_exit_codes = 1955,                /* -pass-exit-codes */
  /* OPT_pedantic = 1956, */                 /* -pedantic */
  OPT_pedantic_errors = 1957,                /* -pedantic-errors */
  OPT_pg = 1958,                             /* -pg */
  OPT_pie = 1959,                            /* -pie */
  OPT_pipe = 1960,                           /* -pipe */
  OPT_posix = 1961,                          /* -posix */
  ...
  OPT_profile = 1974,                        /* -profile */
  OPT_pthread = 1975,                        /* -pthread */
  OPT_quiet = 1976,                          /* -quiet */
  OPT_r = 1977,                              /* -r */
  OPT_rdynamic = 1978,                       /* -rdynamic */
