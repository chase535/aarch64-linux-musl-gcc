...
enum opt_code
{
  ...
  OPT_mtp_ = 1926,                           /* -mtp= */
  OPT_mtrack_speculation = 1927,             /* -mtrack-speculation */
  OPT_mtune_ = 1928,                         /* -mtune= */
  OPT_muclibc = 1929,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1930,             /* -mverbose-cost-dump */
  OPT_n = 1931,                              /* -n */
  OPT_name_sort = 1932,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1933,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1934,              /* -no-integrated-cpp */
  OPT_no_pie = 1935,                         /* -no-pie */
  OPT_nocpp = 1936,                          /* -nocpp */
  OPT_nodefaultlibs = 1937,                  /* -nodefaultlibs */
  OPT_nolibc = 1938,                         /* -nolibc */
  OPT_nophoboslib = 1939,                    /* -nophoboslib */
  OPT_nostartfiles = 1940,                   /* -nostartfiles */
  OPT_nostdinc = 1941,                       /* -nostdinc */
  OPT_nostdinc__ = 1942,                     /* -nostdinc++ */
  OPT_nostdlib = 1943,                       /* -nostdlib */
  OPT_nostdlib__ = 1944,                     /* -nostdlib++ */
  OPT_o = 1945,                              /* -o */
  OPT_objects = 1946,                        /* -objects */
  OPT_p = 1947,                              /* -p */
  OPT_pass_exit_codes = 1948,                /* -pass-exit-codes */
  /* OPT_pedantic = 1949, */                 /* -pedantic */
  OPT_pedantic_errors = 1950,                /* -pedantic-errors */
  OPT_pg = 1951,                             /* -pg */
  OPT_pie = 1952,                            /* -pie */
  OPT_pipe = 1953,                           /* -pipe */
  OPT_posix = 1954,                          /* -posix */
  ...
  OPT_profile = 1967,                        /* -profile */
  OPT_pthread = 1968,                        /* -pthread */
  OPT_quiet = 1969,                          /* -quiet */
  OPT_r = 1970,                              /* -r */
  OPT_rdynamic = 1971,                       /* -rdynamic */
