...
enum opt_code
{
  ...
  OPT_fgo_importcfg_ = 1268,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1269,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1270,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1271,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1272,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1273,                      /* -fgraphite */
  OPT_fgraphite_identity = 1274,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1275,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1276,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1277, */       /* -fhandle-exceptions */
  OPT_fharden_compares = 1278,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1279,   /* -fharden-conditional-branches */
  /* OPT_fhelp = 1280, */                    /* -fhelp */
  /* OPT_fhelp_ = 1281, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1282,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1283,                     /* -fhonor-std */
  OPT_fhosted = 1284,                        /* -fhosted */
  OPT_fhuge_objects = 1285,                  /* -fhuge-objects */
  OPT_fident = 1286,                         /* -fident */
  OPT_fif_conversion = 1287,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1288,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1289,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1290,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1291,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1292,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1293,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1294,            /* -fimplicit-templates */
  OPT_findex = 1295,                         /* -findex */
  OPT_findirect_inlining = 1296,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1297,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1298,               /* -finit-character= */
  OPT_finit_derived = 1299,                  /* -finit-derived */
  OPT_finit_integer_ = 1300,                 /* -finit-integer= */
  OPT_finit_local_zero = 1301,               /* -finit-local-zero */
  OPT_finit_logical_ = 1302,                 /* -finit-logical= */
  OPT_finit_real_ = 1303,                    /* -finit-real= */
  OPT_finline = 1304,                        /* -finline */
  OPT_finline_arg_packing = 1305,            /* -finline-arg-packing */
  OPT_finline_atomics = 1306,                /* -finline-atomics */
  OPT_finline_functions = 1307,              /* -finline-functions */
  OPT_finline_functions_called_once = 1308,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1309, */           /* -finline-limit- */
  OPT_finline_limit_ = 1310,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1311,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1312,        /* -finline-small-functions */
  OPT_finput_charset_ = 1313,                /* -finput-charset= */
  OPT_finstrument_functions = 1314,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1315,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1316,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1317,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1318,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1319,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1320,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1321,                    /* -finvariants */
  OPT_fipa_bit_cp = 1322,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1323,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1324, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1325,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1326,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1327,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1328,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1329, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1330,                    /* -fipa-modref */
  OPT_fipa_profile = 1331,                   /* -fipa-profile */
  OPT_fipa_pta = 1332,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1333,                /* -fipa-pure-const */
  OPT_fipa_ra = 1334,                        /* -fipa-ra */
  OPT_fipa_reference = 1335,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1336,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1337,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1338,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1339,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1340, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1341,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1342,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1343,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1344,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1345,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1346,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1347,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1348,                  /* -fira-verbose= */
  OPT_fiso = 1349,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1350,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1351,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1352,              /* -fivar-visibility= */
  OPT_fivopts = 1353,                        /* -fivopts */
  OPT_fjump_tables = 1354,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1355,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1356,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1357,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1358,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1359,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1360,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1361,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1362,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1363,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1364,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1365,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1366,            /* -flarge-source-files */
  OPT_flax_vector_conversions = 1367,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1368,            /* -fleading-underscore */
  OPT_flibs_ = 1369,                         /* -flibs= */
  OPT_flifetime_dse = 1370,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1371,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1372,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1373,                /* -flinker-output= */
  /* OPT_flive_patching = 1374, */           /* -flive-patching */
  OPT_flive_patching_ = 1375,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1376,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1377,                   /* -flocal-ivars */
  OPT_flocation_ = 1378,                     /* -flocation= */
  /* OPT_floop_block = 1379, */              /* -floop-block */
  /* OPT_floop_flatten = 1380, */            /* -floop-flatten */
  OPT_floop_interchange = 1381,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1382,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1383, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1384,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1385, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1386,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1387,                     /* -flra-remat */
  OPT_flto = 1388,                           /* -flto */
  OPT_flto_compression_level_ = 1389,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1390, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1391,                /* -flto-partition= */
  OPT_flto_report = 1392,                    /* -flto-report */
  OPT_flto_report_wpa = 1393,                /* -flto-report-wpa */
  OPT_flto_ = 1394,                          /* -flto= */
  OPT_fltrans = 1395,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1396,           /* -fltrans-output-list= */
  OPT_fm2_g = 1397,                          /* -fm2-g */
  OPT_fm2_lower_case = 1398,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1399,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1400,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1401,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1402,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1403,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1404,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1405,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1406,             /* -fmacro-prefix-map= */
  OPT_fmain = 1407,                          /* -fmain */
  OPT_fmath_errno = 1408,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1409,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1410,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1411,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1412,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1413,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1414,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1415,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1416,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1417,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1418,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1419,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1420,               /* -fmessage-length= */
  OPT_fmod_ = 1421,                          /* -fmod= */
  OPT_fmodule_file_ = 1422,                  /* -fmodule-file= */
  OPT_fmodule_header = 1423,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1424,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1425,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1426,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1427,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1428,                   /* -fmodule-only */
  OPT_fmodule_private = 1429,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1430,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1431,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1432,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1433,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1434,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1435,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1436,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1437,                 /* -fms-extensions */
  OPT_fmudflap = 1438,                       /* -fmudflap */
  OPT_fmudflapir = 1439,                     /* -fmudflapir */
  OPT_fmudflapth = 1440,                     /* -fmudflapth */
  OPT_fmultiflags = 1441,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1442,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1443,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1444,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1445,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1446,                  /* -fnext-runtime */
  OPT_fnil = 1447,                           /* -fnil */
  OPT_fnil_receivers = 1448,                 /* -fnil-receivers */
  OPT_fno_modules = 1449,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1450,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1451,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1452,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1453,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1454,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1455,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1456,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1457,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1458,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1459,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1460,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1461,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1462,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1463,              /* -foffload-options= */
  OPT_foffload_ = 1464,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1465,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1466,                         /* -fonly= */
  OPT_fopenacc = 1467,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1468,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1469,                        /* -fopenmp */
  OPT_fopenmp_simd = 1470,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1471, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1472,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1473,                /* -foperator-names */
  OPT_fopt_info = 1474,                      /* -fopt-info */
  OPT_fopt_info_ = 1475,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1476, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1477,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1478,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1479, */          /* -foptional-diags */
  OPT_fpack_derived = 1480,                  /* -fpack-derived */
  OPT_fpack_struct = 1481,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1482,                  /* -fpack-struct= */
  OPT_fpad_source = 1483,                    /* -fpad-source */
  OPT_fpartial_inlining = 1484,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1485,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1486,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1487,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1488,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1489,                    /* -fpeel-loops */
  OPT_fpeephole = 1490,                      /* -fpeephole */
  OPT_fpeephole2 = 1491,                     /* -fpeephole2 */
  OPT_fpermissive = 1492,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1493,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1494,                           /* -fpic */
  OPT_fpie = 1495,                           /* -fpie */
  OPT_fpim = 1496,                           /* -fpim */
  OPT_fpim2 = 1497,                          /* -fpim2 */
  OPT_fpim3 = 1498,                          /* -fpim3 */
  OPT_fpim4 = 1499,                          /* -fpim4 */
  OPT_fplan9_extensions = 1500,              /* -fplan9-extensions */
  OPT_fplt = 1501,                           /* -fplt */
  OPT_fplugin_arg_ = 1502,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1503,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1504,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1505,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1506,                /* -fpostconditions */
  OPT_fpre_include_ = 1507,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1508,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1509,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1510,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1511,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1512,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1513,              /* -fpretty-templates */
  OPT_fpreview_all = 1514,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1515,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1516,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1517,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1518,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1519,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1520,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1521,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1522,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1523,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1524,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1525,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1526,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1527,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1528,           /* -fprintf-return-value */
  OPT_fprofile = 1529,                       /* -fprofile */
  OPT_fprofile_abs_path = 1530,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1531,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1532,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1533,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1534,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1535,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1536,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1537,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1538,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1539,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1540,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1541,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1542,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1543,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1544,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1545,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1546,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1547,               /* -fprofile-update= */
  OPT_fprofile_use = 1548,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1549,                  /* -fprofile-use= */
  OPT_fprofile_values = 1550,                /* -fprofile-values */
  OPT_fprotect_parens = 1551,                /* -fprotect-parens */
  OPT_fpthread = 1552,                       /* -fpthread */
  OPT_fq = 1553,                             /* -fq */
  OPT_frandom_seed = 1554,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1555,                  /* -frandom-seed= */
  OPT_frange = 1556,                         /* -frange */
  OPT_frange_check = 1557,                   /* -frange-check */
  OPT_freal_4_real_10 = 1558,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1559,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1560,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1561,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1562,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1563,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1564,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1565,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1566,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1567,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1568,               /* -frecord-marker=8 */
  OPT_frecursive = 1569,                     /* -frecursive */
  OPT_free = 1570,                           /* -free */
  OPT_freg_struct_return = 1571,             /* -freg-struct-return */
  /* OPT_fregmove = 1572, */                 /* -fregmove */
  OPT_frelease = 1573,                       /* -frelease */
  OPT_frename_registers = 1574,              /* -frename-registers */
  OPT_freorder_blocks = 1575,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1576,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1577,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1578,             /* -freorder-functions */
  OPT_frepack_arrays = 1579,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1580,          /* -freplace-objc-classes */
  OPT_frepo = 1581,                          /* -frepo */
  OPT_freport_bug = 1582,                    /* -freport-bug */
  OPT_frequire_return_statement = 1583,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1584,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1585, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1586,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1587,                   /* -fresolution= */
  OPT_freturn = 1588,                        /* -freturn */
  OPT_frevert_all = 1589,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1590,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1591,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1592,             /* -frevert=intpromote */
  OPT_frounding_math = 1593,                 /* -frounding-math */
  OPT_frtti = 1594,                          /* -frtti */
  OPT_fruntime_modules_ = 1595,              /* -fruntime-modules= */
  OPT_frust_cfg_ = 1596,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1597,           /* -frust-compile-until= */
  OPT_frust_crate_ = 1598,                   /* -frust-crate= */
  OPT_frust_debug = 1599,                    /* -frust-debug */
  OPT_frust_dump_ = 1600,                    /* -frust-dump- */
  OPT_frust_edition_ = 1601,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1602,           /* -frust-embed-metadata */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1603,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1604,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1605,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1606,         /* -frust-metadata-output= */
  OPT_fsanitize_address_use_after_scope = 1607,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1608,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1609,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1610,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1611,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1612,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1613,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1614, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1615,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1616,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1617,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1618,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1619,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1620,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1621,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1622,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1623, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1624,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1625,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1626,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1627,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1628,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1629,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1630,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1631,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1632,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1633,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1634,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1635,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1636,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1637,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1638,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1639,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1640, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1641,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1642,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1643,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1644,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1645,               /* -fsection-anchors */
  /* OPT_fsee = 1646, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1647,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1648,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1649,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1650,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1651,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1652,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1653,        /* -fsemantic-interposition */
  OPT_fshared = 1654,                        /* -fshared */
  OPT_fshort_enums = 1655,                   /* -fshort-enums */
  OPT_fshort_wchar = 1656,                   /* -fshort-wchar */
  OPT_fshow_column = 1657,                   /* -fshow-column */
  OPT_fshrink_wrap = 1658,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1659,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1660,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1661,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1662,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1663,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1664,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1665,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1666,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1667,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1668,                /* -fsoft-check-all */
  OPT_fsources = 1669,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1670,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1671,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1672,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1673,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1674,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1675,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1676,                      /* -fsquangle */
  OPT_fssa_backprop = 1677,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1678,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1679,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1680,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1681, */             /* -fstack-check */
  OPT_fstack_check_ = 1682,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1683,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1684,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1685,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1686,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1687,               /* -fstack-protector */
  OPT_fstack_protector_all = 1688,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1689,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1690,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1691,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1692,                   /* -fstack-usage */
  OPT_fstats = 1693,                         /* -fstats */
  OPT_fstdarg_opt = 1694,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1695,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1696, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1697,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1698,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1699, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1700,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1701,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1702,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1703,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1704, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1705,            /* -fstrong-eval-order= */
  OPT_fswig = 1706,                          /* -fswig */
  OPT_fswitch_errors = 1707,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1708,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1709,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1710,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1711, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1712,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1713, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1714,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1715, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1716,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1717,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1718,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1719,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1720,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1721,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1722,                   /* -ftime-report */
  OPT_ftime_report_details = 1723,           /* -ftime-report-details */
  OPT_ftls_model_ = 1724,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1725,              /* -ftoplevel-reorder */
  OPT_ftracer = 1726,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1727,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1728,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1729,                   /* -ftrampolines */
  OPT_ftransition_all = 1730,                /* -ftransition=all */
  OPT_ftransition_field = 1731,              /* -ftransition=field */
  OPT_ftransition_in = 1732,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1733,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1734,          /* -ftransition=templates */
  OPT_ftransition_tls = 1735,                /* -ftransition=tls */
  OPT_ftrapping_math = 1736,                 /* -ftrapping-math */
  OPT_ftrapv = 1737,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1738,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1739,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1740,                      /* -ftree-ccp */
  OPT_ftree_ch = 1741,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1742, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1743,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1744,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1745, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1746,                   /* -ftree-cselim */
  OPT_ftree_dce = 1747,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1748,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1749,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1750,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1751,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1752, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1753,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1754,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1755, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1756,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1757,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1758, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1759,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1760,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1761,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1762,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1763,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1764,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1765,                      /* -ftree-pre */
  OPT_ftree_pta = 1766,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1767,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1768, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1769,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1770,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1771,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1772,                     /* -ftree-slsr */
  OPT_ftree_sra = 1773,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1774, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1775, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1776,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1777,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1778,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1779, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1780,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1781, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1782,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1783,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1784,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1785,         /* -funconstrained-commons */
  OPT_funderscoring = 1786,                  /* -funderscoring */
  OPT_funit_at_a_time = 1787,                /* -funit-at-a-time */
  OPT_funittest = 1788,                      /* -funittest */
  OPT_funreachable_traps = 1789,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1790,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1791,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1792,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1793, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1794,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1795,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1796,                 /* -funsigned-char */
  OPT_funswitch_loops = 1797,                /* -funswitch-loops */
  OPT_funwind_tables = 1798,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1799,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1800,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1801,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1802,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1803,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1804,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1805,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1806,                     /* -fuse-list= */
  OPT_fvar_tracking = 1807,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1808,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1809,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1810,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1811,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1812, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1813,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1814,                   /* -fverbose-asm */
  /* OPT_fversion = 1815, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1816,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1817,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1818,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1819,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1820,                   /* -fvisibility= */
  OPT_fvpt = 1821,                           /* -fvpt */
  OPT_fvtable_gc = 1822,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1823,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1824,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1825,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1826,                     /* -fvtv-debug */
  OPT_fweak = 1827,                          /* -fweak */
  OPT_fweak_templates = 1828,                /* -fweak-templates */
  OPT_fweb = 1829,                           /* -fweb */
  /* OPT_fwhole_file = 1830, */              /* -fwhole-file */
  OPT_fwhole_program = 1831,                 /* -fwhole-program */
  OPT_fwholediv = 1832,                      /* -fwholediv */
  OPT_fwholevalue = 1833,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1834,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1835,             /* -fworking-directory */
  OPT_fwpa = 1836,                           /* -fwpa */
  OPT_fwpa_ = 1837,                          /* -fwpa= */
  OPT_fwrapv = 1838,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1839,                 /* -fwrapv-pointer */
  OPT_fxref = 1840,                          /* -fxref */
  /* OPT_fzee = 1841, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1842,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1843,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1844,                     /* -fzero-link */
  OPT_g = 1845,                              /* -g */
  OPT_gant = 1846,                           /* -gant */
  OPT_gas_loc_support = 1847,                /* -gas-loc-support */
  OPT_gas_locview_support = 1848,            /* -gas-locview-support */
  OPT_gbtf = 1849,                           /* -gbtf */
  OPT_gcodeview = 1850,                      /* -gcodeview */
  OPT_gcoff = 1851,                          /* -gcoff */
  OPT_gcoff1 = 1852,                         /* -gcoff1 */
  OPT_gcoff2 = 1853,                         /* -gcoff2 */
  OPT_gcoff3 = 1854,                         /* -gcoff3 */
  OPT_gcolumn_info = 1855,                   /* -gcolumn-info */
  OPT_gctf = 1856,                           /* -gctf */
  OPT_gdescribe_dies = 1857,                 /* -gdescribe-dies */
  OPT_gdwarf = 1858,                         /* -gdwarf */
  OPT_gdwarf_ = 1859,                        /* -gdwarf- */
  OPT_gdwarf32 = 1860,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1861,                       /* -gdwarf64 */
  OPT_gen_decls = 1862,                      /* -gen-decls */
  OPT_ggdb = 1863,                           /* -ggdb */
  OPT_ggnu_pubnames = 1864,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1865,                   /* -gimple-stats */
  OPT_ginline_points = 1866,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1867, /* -ginternal-reset-location-views */
  OPT_gnat = 1868,                           /* -gnat */
  OPT_gnatO = 1869,                          /* -gnatO */
  OPT_gno_ = 1870,                           /* -gno- */
  OPT_gno_pubnames = 1871,                   /* -gno-pubnames */
  OPT_gpubnames = 1872,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1873,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1874,                   /* -gsplit-dwarf */
  OPT_gstabs = 1875,                         /* -gstabs */
  OPT_gstabs_ = 1876,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1877,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1878,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1879,                        /* -gtoggle */
  OPT_gvariable_location_views = 1880,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1881,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1882,                           /* -gvms */
  OPT_gxcoff = 1883,                         /* -gxcoff */
  OPT_gxcoff_ = 1884,                        /* -gxcoff+ */
  OPT_gz = 1885,                             /* -gz */
  OPT_gz_ = 1886,                            /* -gz= */
  OPT_h = 1887,                              /* -h */
  OPT_help = 1888,                           /* -help */
  OPT_idirafter = 1889,                      /* -idirafter */
  OPT_imacros = 1890,                        /* -imacros */
  OPT_imultiarch = 1891,                     /* -imultiarch */
  OPT_imultilib = 1892,                      /* -imultilib */
  OPT_include = 1893,                        /* -include */
  OPT_iplugindir_ = 1894,                    /* -iplugindir= */
  OPT_iprefix = 1895,                        /* -iprefix */
  OPT_iquote = 1896,                         /* -iquote */
  OPT_isysroot = 1897,                       /* -isysroot */
  OPT_isystem = 1898,                        /* -isystem */
  OPT_iwithprefix = 1899,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1900,              /* -iwithprefixbefore */
  OPT_k8 = 1901,                             /* -k8 */
  OPT_l = 1902,                              /* -l */
  OPT_lang_asm = 1903,                       /* -lang-asm */
  OPT_list = 1904,                           /* -list */
  OPT_mabi_ = 1905,                          /* -mabi= */
  OPT_march_ = 1906,                         /* -march= */
  OPT_mbig_endian = 1907,                    /* -mbig-endian */
  OPT_mbionic = 1908,                        /* -mbionic */
  OPT_mbranch_protection_ = 1909,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1910,                       /* -mcmodel= */
  OPT_mcpu_ = 1911,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1912,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1913,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1914,             /* -mgeneral-regs-only */
  OPT_mglibc = 1915,                         /* -mglibc */
  OPT_mharden_sls_ = 1916,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1917,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1918,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1919,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1920,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1921,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1922,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1923,               /* -moutline-atomics */
  OPT_moverride_ = 1924,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1925,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1926,          /* -msign-return-address= */
  ...
  OPT_mstrict_align = 1930,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1931,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1932,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1933,                     /* -mtls-size= */
  OPT_mtp_ = 1934,                           /* -mtp= */
  OPT_mtrack_speculation = 1935,             /* -mtrack-speculation */
  OPT_mtune_ = 1936,                         /* -mtune= */
  OPT_muclibc = 1937,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1938,             /* -mverbose-cost-dump */
  OPT_n = 1939,                              /* -n */
  ...
  OPT_pie = 1960,                            /* -pie */
  OPT_pipe = 1961,                           /* -pipe */
  OPT_posix = 1962,                          /* -posix */
  OPT_print_file_name_ = 1963,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1964,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1965,          /* -print-multi-directory */
  OPT_print_multi_lib = 1966,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1967,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1968,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1969,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1970,               /* -print-prog-name= */
  OPT_print_search_dirs = 1971,              /* -print-search-dirs */
  OPT_print_sysroot = 1972,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1973,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1974,                    /* -print-value */
  OPT_profile = 1975,                        /* -profile */
  OPT_pthread = 1976,                        /* -pthread */
  OPT_quiet = 1977,                          /* -quiet */
  OPT_r = 1978,                              /* -r */
  OPT_rdynamic = 1979,                       /* -rdynamic */
