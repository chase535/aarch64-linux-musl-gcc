...
enum opt_code
{
  ...
  OPT_mbionic = 1962,                        /* -mbionic */
  OPT_mbranch_protection_ = 1963,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1964,                       /* -mcmodel= */
  OPT_mcpu_ = 1965,                          /* -mcpu= */
  OPT_mearly_ldp_fusion = 1966,              /* -mearly-ldp-fusion */
  OPT_mearly_ra_ = 1967,                     /* -mearly-ra= */
  OPT_mfix_cortex_a53_835769 = 1968,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1969,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1970,             /* -mgeneral-regs-only */
  OPT_mglibc = 1971,                         /* -mglibc */
  OPT_mharden_sls_ = 1972,                   /* -mharden-sls= */
  OPT_mlate_ldp_fusion = 1973,               /* -mlate-ldp-fusion */
  OPT_mlittle_endian = 1974,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1975,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1976,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1977,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1978,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1979,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1980,               /* -moutline-atomics */
  OPT_moverride_ = 1981,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1982,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1983,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1984, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1985,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1986,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1987,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1988,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1989,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1990,                     /* -mtls-size= */
  OPT_mtp_ = 1991,                           /* -mtp= */
  OPT_mtrack_speculation = 1992,             /* -mtrack-speculation */
  OPT_mtune_ = 1993,                         /* -mtune= */
  OPT_muclibc = 1994,                        /* -muclibc */
