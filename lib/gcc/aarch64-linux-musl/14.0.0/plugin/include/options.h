...
enum opt_code
{
  ...
  OPT_mglibc = 1922,                         /* -mglibc */
  OPT_mharden_sls_ = 1923,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1924,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1925,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1926,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1927,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1928,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1929,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1930,               /* -moutline-atomics */
  OPT_moverride_ = 1931,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1932,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1933,          /* -msign-return-address= */
  ...
  OPT_mstrict_align = 1937,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1938,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1939,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1940,                     /* -mtls-size= */
  OPT_mtp_ = 1941,                           /* -mtp= */
  OPT_mtrack_speculation = 1942,             /* -mtrack-speculation */
  OPT_mtune_ = 1943,                         /* -mtune= */
  OPT_muclibc = 1944,                        /* -muclibc */
  ...
  OPT_profile = 1982,                        /* -profile */
  OPT_pthread = 1983,                        /* -pthread */
  OPT_quiet = 1984,                          /* -quiet */
  OPT_r = 1985,                              /* -r */
  OPT_rdynamic = 1986,                       /* -rdynamic */
