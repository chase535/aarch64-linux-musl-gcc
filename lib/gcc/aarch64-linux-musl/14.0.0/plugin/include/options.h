...
enum opt_code
{
  ...
  OPT_mmusl = 1911,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1912,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1913,               /* -moutline-atomics */
  OPT_moverride_ = 1914,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1915,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1916,          /* -msign-return-address= */
  ...
  OPT_msve_vector_bits_ = 1921,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1922,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1923,                     /* -mtls-size= */
  OPT_mtp_ = 1924,                           /* -mtp= */
  OPT_mtrack_speculation = 1925,             /* -mtrack-speculation */
  OPT_mtune_ = 1926,                         /* -mtune= */
  OPT_muclibc = 1927,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1928,             /* -mverbose-cost-dump */
  OPT_n = 1929,                              /* -n */
  OPT_name_sort = 1930,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1931,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1932,              /* -no-integrated-cpp */
  OPT_no_pie = 1933,                         /* -no-pie */
  OPT_nocpp = 1934,                          /* -nocpp */
  OPT_nodefaultlibs = 1935,                  /* -nodefaultlibs */
  OPT_nolibc = 1936,                         /* -nolibc */
  OPT_nophoboslib = 1937,                    /* -nophoboslib */
  OPT_nostartfiles = 1938,                   /* -nostartfiles */
  OPT_nostdinc = 1939,                       /* -nostdinc */
  OPT_nostdinc__ = 1940,                     /* -nostdinc++ */
  OPT_nostdlib = 1941,                       /* -nostdlib */
  OPT_nostdlib__ = 1942,                     /* -nostdlib++ */
  OPT_o = 1943,                              /* -o */
  OPT_objects = 1944,                        /* -objects */
  OPT_p = 1945,                              /* -p */
  OPT_pass_exit_codes = 1946,                /* -pass-exit-codes */
  /* OPT_pedantic = 1947, */                 /* -pedantic */
  OPT_pedantic_errors = 1948,                /* -pedantic-errors */
  OPT_pg = 1949,                             /* -pg */
  OPT_pie = 1950,                            /* -pie */
  OPT_pipe = 1951,                           /* -pipe */
  OPT_posix = 1952,                          /* -posix */
  OPT_print_file_name_ = 1953,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1954,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1955,          /* -print-multi-directory */
  OPT_print_multi_lib = 1956,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1957,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1958,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1959,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1960,               /* -print-prog-name= */
  OPT_print_search_dirs = 1961,              /* -print-search-dirs */
  OPT_print_sysroot = 1962,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1963,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1964,                    /* -print-value */
  OPT_profile = 1965,                        /* -profile */
  OPT_pthread = 1966,                        /* -pthread */
  OPT_quiet = 1967,                          /* -quiet */
  OPT_r = 1968,                              /* -r */
  OPT_rdynamic = 1969,                       /* -rdynamic */
