...
enum opt_code
{
  ...
  OPT_Wuninitialized = 851,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 852,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 853, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 854, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 855,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 856,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 857,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 858,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 859, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 860,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 861,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 862,                /* -Wunused-function */
  OPT_Wunused_label = 863,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 864,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 865,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 866,               /* -Wunused-parameter */
  OPT_Wunused_result = 867,                  /* -Wunused-result */
  OPT_Wunused_value = 868,                   /* -Wunused-value */
  OPT_Wunused_variable = 869,                /* -Wunused-variable */
  OPT_Wuse_after_free = 870,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 871,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 872,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 873,                   /* -Wuseless-cast */
  OPT_Wvarargs = 874,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 875,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 876,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 877,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 878,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 879,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 880,            /* -Wvirtual-move-assign */
  OPT_Wvla = 881,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 882,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 883,                  /* -Wvla-parameter */
  OPT_Wvolatile = 884,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 885,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 886,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 887,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 888,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 889,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 890,                       /* -Wzerotrip */
  OPT_X = 891,                               /* -X */
  OPT_Xassembler = 892,                      /* -Xassembler */
  OPT_Xf = 893,                              /* -Xf */
  OPT_Xlinker = 894,                         /* -Xlinker */
  OPT_Xpreprocessor = 895,                   /* -Xpreprocessor */
  OPT_Z = 896,                               /* -Z */
  OPT_ansi = 897,                            /* -ansi */
  OPT_aux_info = 898,                        /* -aux-info */
  /* OPT_aux_info_ = 899, */                 /* -aux-info= */
  OPT_c = 900,                               /* -c */
  OPT_callgraph = 901,                       /* -callgraph */
  OPT_coverage = 902,                        /* -coverage */
  OPT_cpp = 903,                             /* -cpp */
  OPT_cpp_ = 904,                            /* -cpp= */
  OPT_d = 905,                               /* -d */
  OPT_debuglib_ = 906,                       /* -debuglib= */
  OPT_defaultlib_ = 907,                     /* -defaultlib= */
  OPT_defined_only = 908,                    /* -defined-only */
  OPT_demangle = 909,                        /* -demangle */
  ...
  OPT_e = 920,                               /* -e */
  OPT_export_dynamic = 921,                  /* -export-dynamic */
  OPT_fPIC = 922,                            /* -fPIC */
  OPT_fPIE = 923,                            /* -fPIE */
  OPT_fRTS_ = 924,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 925,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 926,                   /* -fabi-version= */
  OPT_faccess_control = 927,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 928,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 929,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 930,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 931,                  /* -falign-commons */
  OPT_falign_functions = 932,                /* -falign-functions */
  OPT_falign_functions_ = 933,               /* -falign-functions= */
  OPT_falign_jumps = 934,                    /* -falign-jumps */
  OPT_falign_jumps_ = 935,                   /* -falign-jumps= */
  OPT_falign_labels = 936,                   /* -falign-labels */
  OPT_falign_labels_ = 937,                  /* -falign-labels= */
  OPT_falign_loops = 938,                    /* -falign-loops */
  OPT_falign_loops_ = 939,                   /* -falign-loops= */
  /* OPT_faligned_new = 940, */              /* -faligned-new */
  OPT_faligned_new_ = 941,                   /* -faligned-new= */
  OPT_fall_instantiations = 942,             /* -fall-instantiations */
  OPT_fall_intrinsics = 943,                 /* -fall-intrinsics */
  OPT_fall_virtual = 944,                    /* -fall-virtual */
  OPT_fallocation_dce = 945,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 946,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 947,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 948,       /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 949, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 950,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 951,         /* -falt-external-templates */
  OPT_fanalyzer = 952,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 953,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 954,              /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 955,        /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 956,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 957,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 958,  /* -fanalyzer-show-duplicate-count */
  ...
  OPT_fdevirtualize = 1124,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1125,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1126,    /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 1127, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1128,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1129,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1130,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1131,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1132,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1133,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 1134,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1135,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1136,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1137,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1138,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1139,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1140,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1141, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1142,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1143,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1144,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1145,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1146,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1147, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1148,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1149,               /* -fdirectives-only */
  OPT_fdisable_ = 1150,                      /* -fdisable- */
  OPT_fdoc = 1151,                           /* -fdoc */
  OPT_fdoc_dir_ = 1152,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1153,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1154,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1155,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1156,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1157,                      /* -fdruntime */
  OPT_fdse = 1158,                           /* -fdse */
  OPT_fdump_ = 1159,                         /* -fdump- */
  OPT_fdump_ada_spec = 1160,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1161,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1162,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1163,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1164,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1165,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1166,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1167,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1168,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1169,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_json = 1170,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1171,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1172,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1173,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1174,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1175,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1176,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1177, */               /* -fdump-core */
  OPT_fdump_d_original = 1178,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1179,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1180,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1181,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1182,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1183,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1184,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1185,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1186,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1187, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1188,                   /* -fdump-passes */
  OPT_fdump_scos = 1189,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1190,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1191,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1192,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1193,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1194,                /* -fearly-inlining */
  OPT_felide_constructors = 1195,            /* -felide-constructors */
  OPT_felide_type = 1196,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1197, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1198,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1199,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1200,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1201,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1202,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1203,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1204,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1205,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1206,                /* -fenum-int-equiv */
  OPT_fexceptions = 1207,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1208,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1209,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1210,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1211,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1212,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1213,               /* -fextended-opaque */
  OPT_fextern_std_ = 1214,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1215,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1216,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1217,            /* -fexternal-templates */
  OPT_ff2c = 1218,                           /* -ff2c */
  OPT_ffast_math = 1219,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1220,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1221,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1222,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1223,              /* -ffinite-math-only */
  OPT_ffixed_ = 1224,                        /* -ffixed- */
  OPT_ffixed_form = 1225,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1226,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1227,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1228,                   /* -ffloat-store */
  OPT_ffloatvalue = 1229,                    /* -ffloatvalue */
  OPT_ffold_simple_inlines = 1230,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1231,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1232, */              /* -fforce-addr */
  OPT_fforward_propagate = 1233,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1234,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1235,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1236,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1237,                     /* -ffpe-trap= */
  OPT_ffree_form = 1238,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1239,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1240,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1241,                  /* -ffreestanding */
  OPT_ffriend_injection = 1242,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1243,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1244,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1245,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1246,             /* -ffunction-sections */
  OPT_fgcse = 1247,                          /* -fgcse */
  OPT_fgcse_after_reload = 1248,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1249,                      /* -fgcse-las */
  OPT_fgcse_lm = 1250,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1251,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1252,              /* -fgen-module-list= */
  OPT_fgimple = 1253,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1254,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1255,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1256,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1257,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1258,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1259,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1260,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1261,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1262,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1263,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1264,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1265,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1266,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1267,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1268,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1269,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1270,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1271,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1272,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1273,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1274,                      /* -fgraphite */
  OPT_fgraphite_identity = 1275,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1276,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1277,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1278, */       /* -fhandle-exceptions */
  OPT_fharden_compares = 1279,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1280,   /* -fharden-conditional-branches */
  /* OPT_fhelp = 1281, */                    /* -fhelp */
  /* OPT_fhelp_ = 1282, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1283,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1284,                     /* -fhonor-std */
  OPT_fhosted = 1285,                        /* -fhosted */
  OPT_fhuge_objects = 1286,                  /* -fhuge-objects */
  OPT_fident = 1287,                         /* -fident */
  OPT_fif_conversion = 1288,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1289,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1290,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1291,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1292,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1293,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1294,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1295,            /* -fimplicit-templates */
  OPT_findex = 1296,                         /* -findex */
  OPT_findirect_inlining = 1297,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1298,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1299,               /* -finit-character= */
  OPT_finit_derived = 1300,                  /* -finit-derived */
  OPT_finit_integer_ = 1301,                 /* -finit-integer= */
  OPT_finit_local_zero = 1302,               /* -finit-local-zero */
  OPT_finit_logical_ = 1303,                 /* -finit-logical= */
  OPT_finit_real_ = 1304,                    /* -finit-real= */
  OPT_finline = 1305,                        /* -finline */
  OPT_finline_arg_packing = 1306,            /* -finline-arg-packing */
  OPT_finline_atomics = 1307,                /* -finline-atomics */
  OPT_finline_functions = 1308,              /* -finline-functions */
  OPT_finline_functions_called_once = 1309,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1310, */           /* -finline-limit- */
  OPT_finline_limit_ = 1311,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1312,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1313,        /* -finline-small-functions */
  OPT_finput_charset_ = 1314,                /* -finput-charset= */
  OPT_finstrument_functions = 1315,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1316,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1317,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1318,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1319,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1320,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1321,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1322,                    /* -finvariants */
  OPT_fipa_bit_cp = 1323,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1324,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1325, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1326,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1327,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1328,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1329,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1330, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1331,                    /* -fipa-modref */
  OPT_fipa_profile = 1332,                   /* -fipa-profile */
  OPT_fipa_pta = 1333,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1334,                /* -fipa-pure-const */
  OPT_fipa_ra = 1335,                        /* -fipa-ra */
  OPT_fipa_reference = 1336,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1337,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1338,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1339,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1340,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1341, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1342,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1343,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1344,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1345,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1346,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1347,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1348,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1349,                  /* -fira-verbose= */
  OPT_fiso = 1350,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1351,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1352,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1353,              /* -fivar-visibility= */
  OPT_fivopts = 1354,                        /* -fivopts */
  OPT_fjump_tables = 1355,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1356,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1357,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1358,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1359,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1360,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1361,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1362,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1363,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1364,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1365,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1366,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1367,            /* -flarge-source-files */
  OPT_flax_vector_conversions = 1368,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1369,            /* -fleading-underscore */
  OPT_flibs_ = 1370,                         /* -flibs= */
  OPT_flifetime_dse = 1371,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1372,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1373,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1374,                /* -flinker-output= */
  /* OPT_flive_patching = 1375, */           /* -flive-patching */
  OPT_flive_patching_ = 1376,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1377,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1378,                   /* -flocal-ivars */
  OPT_flocation_ = 1379,                     /* -flocation= */
  /* OPT_floop_block = 1380, */              /* -floop-block */
  /* OPT_floop_flatten = 1381, */            /* -floop-flatten */
  OPT_floop_interchange = 1382,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1383,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1384, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1385,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1386, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1387,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1388,                     /* -flra-remat */
  OPT_flto = 1389,                           /* -flto */
  OPT_flto_compression_level_ = 1390,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1391, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1392,                /* -flto-partition= */
  OPT_flto_report = 1393,                    /* -flto-report */
  OPT_flto_report_wpa = 1394,                /* -flto-report-wpa */
  OPT_flto_ = 1395,                          /* -flto= */
  OPT_fltrans = 1396,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1397,           /* -fltrans-output-list= */
  OPT_fm2_g = 1398,                          /* -fm2-g */
  OPT_fm2_lower_case = 1399,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1400,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1401,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1402,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1403,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1404,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1405,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1406,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1407,             /* -fmacro-prefix-map= */
  OPT_fmain = 1408,                          /* -fmain */
  OPT_fmath_errno = 1409,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1410,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1411,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1412,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1413,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1414,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1415,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1416,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1417,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1418,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1419,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1420,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1421,               /* -fmessage-length= */
  OPT_fmod_ = 1422,                          /* -fmod= */
  OPT_fmodule_file_ = 1423,                  /* -fmodule-file= */
  OPT_fmodule_header = 1424,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1425,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1426,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1427,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1428,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1429,                   /* -fmodule-only */
  OPT_fmodule_private = 1430,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1431,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1432,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1433,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1434,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1435,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1436,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1437,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1438,                 /* -fms-extensions */
  OPT_fmudflap = 1439,                       /* -fmudflap */
  OPT_fmudflapir = 1440,                     /* -fmudflapir */
  OPT_fmudflapth = 1441,                     /* -fmudflapth */
  OPT_fmultiflags = 1442,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1443,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1444,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1445,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1446,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1447,                  /* -fnext-runtime */
  OPT_fnil = 1448,                           /* -fnil */
  OPT_fnil_receivers = 1449,                 /* -fnil-receivers */
  OPT_fno_modules = 1450,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1451,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1452,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1453,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1454,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1455,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1456,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1457,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1458,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1459,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1460,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1461,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1462,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1463,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1464,              /* -foffload-options= */
  OPT_foffload_ = 1465,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1466,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1467,                         /* -fonly= */
  OPT_fopenacc = 1468,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1469,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1470,                        /* -fopenmp */
  OPT_fopenmp_simd = 1471,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1472, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1473,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1474,                /* -foperator-names */
  OPT_fopt_info = 1475,                      /* -fopt-info */
  OPT_fopt_info_ = 1476,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1477, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1478,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1479,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1480, */          /* -foptional-diags */
  OPT_fpack_derived = 1481,                  /* -fpack-derived */
  OPT_fpack_struct = 1482,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1483,                  /* -fpack-struct= */
  OPT_fpad_source = 1484,                    /* -fpad-source */
  OPT_fpartial_inlining = 1485,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1486,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1487,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1488,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1489,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1490,                    /* -fpeel-loops */
  OPT_fpeephole = 1491,                      /* -fpeephole */
  OPT_fpeephole2 = 1492,                     /* -fpeephole2 */
  OPT_fpermissive = 1493,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1494,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1495,                           /* -fpic */
  OPT_fpie = 1496,                           /* -fpie */
  OPT_fpim = 1497,                           /* -fpim */
  OPT_fpim2 = 1498,                          /* -fpim2 */
  OPT_fpim3 = 1499,                          /* -fpim3 */
  OPT_fpim4 = 1500,                          /* -fpim4 */
  OPT_fplan9_extensions = 1501,              /* -fplan9-extensions */
  OPT_fplt = 1502,                           /* -fplt */
  OPT_fplugin_arg_ = 1503,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1504,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1505,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1506,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1507,                /* -fpostconditions */
  OPT_fpre_include_ = 1508,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1509,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1510,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1511,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1512,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1513,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1514,              /* -fpretty-templates */
  OPT_fpreview_all = 1515,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1516,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1517,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1518,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1519,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1520,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1521,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1522,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1523,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1524,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1525,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1526,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1527,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1528,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1529,           /* -fprintf-return-value */
  OPT_fprofile = 1530,                       /* -fprofile */
  OPT_fprofile_abs_path = 1531,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1532,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1533,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1534,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1535,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1536,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1537,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1538,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1539,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1540,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1541,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1542,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1543,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1544,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1545,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1546,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1547,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1548,               /* -fprofile-update= */
  OPT_fprofile_use = 1549,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1550,                  /* -fprofile-use= */
  OPT_fprofile_values = 1551,                /* -fprofile-values */
  OPT_fprotect_parens = 1552,                /* -fprotect-parens */
  OPT_fpthread = 1553,                       /* -fpthread */
  OPT_fq = 1554,                             /* -fq */
  OPT_frandom_seed = 1555,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1556,                  /* -frandom-seed= */
  OPT_frange = 1557,                         /* -frange */
  OPT_frange_check = 1558,                   /* -frange-check */
  OPT_freal_4_real_10 = 1559,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1560,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1561,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1562,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1563,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1564,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1565,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1566,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1567,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1568,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1569,               /* -frecord-marker=8 */
  OPT_frecursive = 1570,                     /* -frecursive */
  OPT_free = 1571,                           /* -free */
  OPT_freg_struct_return = 1572,             /* -freg-struct-return */
  /* OPT_fregmove = 1573, */                 /* -fregmove */
  OPT_frelease = 1574,                       /* -frelease */
  OPT_frename_registers = 1575,              /* -frename-registers */
  OPT_freorder_blocks = 1576,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1577,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1578,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1579,             /* -freorder-functions */
  OPT_frepack_arrays = 1580,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1581,          /* -freplace-objc-classes */
  OPT_frepo = 1582,                          /* -frepo */
  OPT_freport_bug = 1583,                    /* -freport-bug */
  OPT_frequire_return_statement = 1584,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1585,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1586, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1587,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1588,                   /* -fresolution= */
  OPT_freturn = 1589,                        /* -freturn */
  OPT_frevert_all = 1590,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1591,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1592,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1593,             /* -frevert=intpromote */
  OPT_frounding_math = 1594,                 /* -frounding-math */
  OPT_frtti = 1595,                          /* -frtti */
  OPT_fruntime_modules_ = 1596,              /* -fruntime-modules= */
  OPT_frust_cfg_ = 1597,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1598,           /* -frust-compile-until= */
  OPT_frust_crate_ = 1599,                   /* -frust-crate= */
  OPT_frust_debug = 1600,                    /* -frust-debug */
  OPT_frust_dump_ = 1601,                    /* -frust-dump- */
  OPT_frust_edition_ = 1602,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1603,           /* -frust-embed-metadata */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1604,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1605,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1606,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1607,         /* -frust-metadata-output= */
  OPT_fsanitize_address_use_after_scope = 1608,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1609,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1610,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1611,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1612,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1613,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1614,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1615, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1616,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1617,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1618,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1619,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1620,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1621,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1622,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1623,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1624, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1625,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1626,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1627,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1628,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1629,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1630,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1631,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1632,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1633,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1634,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1635,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1636,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1637,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1638,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1639,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1640,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1641, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1642,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1643,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1644,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1645,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1646,               /* -fsection-anchors */
  /* OPT_fsee = 1647, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1648,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1649,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1650,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1651,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1652,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1653,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1654,        /* -fsemantic-interposition */
  OPT_fshared = 1655,                        /* -fshared */
  OPT_fshort_enums = 1656,                   /* -fshort-enums */
  OPT_fshort_wchar = 1657,                   /* -fshort-wchar */
  OPT_fshow_column = 1658,                   /* -fshow-column */
  OPT_fshrink_wrap = 1659,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1660,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1661,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1662,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1663,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1664,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1665,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1666,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1667,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1668,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1669,                /* -fsoft-check-all */
  OPT_fsources = 1670,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1671,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1672,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1673,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1674,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1675,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1676,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1677,                      /* -fsquangle */
  OPT_fssa_backprop = 1678,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1679,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1680,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1681,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1682, */             /* -fstack-check */
  OPT_fstack_check_ = 1683,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1684,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1685,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1686,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1687,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1688,               /* -fstack-protector */
  OPT_fstack_protector_all = 1689,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1690,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1691,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1692,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1693,                   /* -fstack-usage */
  OPT_fstats = 1694,                         /* -fstats */
  OPT_fstdarg_opt = 1695,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1696,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1697, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1698,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1699,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1700, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1701,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1702,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1703,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1704,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1705, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1706,            /* -fstrong-eval-order= */
  OPT_fswig = 1707,                          /* -fswig */
  OPT_fswitch_errors = 1708,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1709,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1710,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1711,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1712, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1713,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1714, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1715,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1716, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1717,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1718,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1719,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1720,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1721,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1722,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1723,                   /* -ftime-report */
  OPT_ftime_report_details = 1724,           /* -ftime-report-details */
  OPT_ftls_model_ = 1725,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1726,              /* -ftoplevel-reorder */
  OPT_ftracer = 1727,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1728,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1729,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1730,                   /* -ftrampolines */
  OPT_ftransition_all = 1731,                /* -ftransition=all */
  OPT_ftransition_field = 1732,              /* -ftransition=field */
  OPT_ftransition_in = 1733,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1734,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1735,          /* -ftransition=templates */
  OPT_ftransition_tls = 1736,                /* -ftransition=tls */
  OPT_ftrapping_math = 1737,                 /* -ftrapping-math */
  OPT_ftrapv = 1738,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1739,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1740,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1741,                      /* -ftree-ccp */
  OPT_ftree_ch = 1742,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1743, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1744,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1745,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1746, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1747,                   /* -ftree-cselim */
  OPT_ftree_dce = 1748,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1749,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1750,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1751,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1752,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1753, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1754,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1755,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1756, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1757,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1758,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1759, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1760,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1761,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1762,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1763,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1764,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1765,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1766,                      /* -ftree-pre */
  OPT_ftree_pta = 1767,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1768,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1769, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1770,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1771,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1772,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1773,                     /* -ftree-slsr */
  OPT_ftree_sra = 1774,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1775, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1776, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1777,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1778,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1779,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1780, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1781,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1782, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1783,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1784,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1785,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1786,         /* -funconstrained-commons */
  OPT_funderscoring = 1787,                  /* -funderscoring */
  OPT_funit_at_a_time = 1788,                /* -funit-at-a-time */
  OPT_funittest = 1789,                      /* -funittest */
  OPT_funreachable_traps = 1790,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1791,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1792,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1793,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1794, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1795,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1796,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1797,                 /* -funsigned-char */
  OPT_funswitch_loops = 1798,                /* -funswitch-loops */
  OPT_funwind_tables = 1799,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1800,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1801,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1802,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1803,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1804,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1805,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1806,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1807,                     /* -fuse-list= */
  OPT_fvar_tracking = 1808,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1809,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1810,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1811,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1812,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1813, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1814,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1815,                   /* -fverbose-asm */
  /* OPT_fversion = 1816, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1817,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1818,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1819,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1820,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1821,                   /* -fvisibility= */
  OPT_fvpt = 1822,                           /* -fvpt */
  OPT_fvtable_gc = 1823,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1824,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1825,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1826,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1827,                     /* -fvtv-debug */
  OPT_fweak = 1828,                          /* -fweak */
  OPT_fweak_templates = 1829,                /* -fweak-templates */
  OPT_fweb = 1830,                           /* -fweb */
  /* OPT_fwhole_file = 1831, */              /* -fwhole-file */
  OPT_fwhole_program = 1832,                 /* -fwhole-program */
  OPT_fwholediv = 1833,                      /* -fwholediv */
  OPT_fwholevalue = 1834,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1835,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1836,             /* -fworking-directory */
  OPT_fwpa = 1837,                           /* -fwpa */
  OPT_fwpa_ = 1838,                          /* -fwpa= */
  OPT_fwrapv = 1839,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1840,                 /* -fwrapv-pointer */
  OPT_fxref = 1841,                          /* -fxref */
  /* OPT_fzee = 1842, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1843,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1844,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1845,                     /* -fzero-link */
  OPT_g = 1846,                              /* -g */
  OPT_gant = 1847,                           /* -gant */
  OPT_gas_loc_support = 1848,                /* -gas-loc-support */
  OPT_gas_locview_support = 1849,            /* -gas-locview-support */
  OPT_gbtf = 1850,                           /* -gbtf */
  OPT_gcodeview = 1851,                      /* -gcodeview */
  OPT_gcoff = 1852,                          /* -gcoff */
  OPT_gcoff1 = 1853,                         /* -gcoff1 */
  OPT_gcoff2 = 1854,                         /* -gcoff2 */
  OPT_gcoff3 = 1855,                         /* -gcoff3 */
  OPT_gcolumn_info = 1856,                   /* -gcolumn-info */
  OPT_gctf = 1857,                           /* -gctf */
  OPT_gdescribe_dies = 1858,                 /* -gdescribe-dies */
  OPT_gdwarf = 1859,                         /* -gdwarf */
  OPT_gdwarf_ = 1860,                        /* -gdwarf- */
  OPT_gdwarf32 = 1861,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1862,                       /* -gdwarf64 */
  OPT_gen_decls = 1863,                      /* -gen-decls */
  OPT_ggdb = 1864,                           /* -ggdb */
  OPT_ggnu_pubnames = 1865,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1866,                   /* -gimple-stats */
  OPT_ginline_points = 1867,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1868, /* -ginternal-reset-location-views */
  OPT_gnat = 1869,                           /* -gnat */
  OPT_gnatO = 1870,                          /* -gnatO */
  OPT_gno_ = 1871,                           /* -gno- */
  OPT_gno_pubnames = 1872,                   /* -gno-pubnames */
  OPT_gpubnames = 1873,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1874,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1875,                   /* -gsplit-dwarf */
  OPT_gstabs = 1876,                         /* -gstabs */
  OPT_gstabs_ = 1877,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1878,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1879,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1880,                        /* -gtoggle */
  OPT_gvariable_location_views = 1881,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1882,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1883,                           /* -gvms */
  OPT_gxcoff = 1884,                         /* -gxcoff */
  OPT_gxcoff_ = 1885,                        /* -gxcoff+ */
  OPT_gz = 1886,                             /* -gz */
  OPT_gz_ = 1887,                            /* -gz= */
  OPT_h = 1888,                              /* -h */
  OPT_help = 1889,                           /* -help */
  OPT_idirafter = 1890,                      /* -idirafter */
  OPT_imacros = 1891,                        /* -imacros */
  OPT_imultiarch = 1892,                     /* -imultiarch */
  OPT_imultilib = 1893,                      /* -imultilib */
  OPT_include = 1894,                        /* -include */
  OPT_iplugindir_ = 1895,                    /* -iplugindir= */
  OPT_iprefix = 1896,                        /* -iprefix */
  OPT_iquote = 1897,                         /* -iquote */
  OPT_isysroot = 1898,                       /* -isysroot */
  OPT_isystem = 1899,                        /* -isystem */
  OPT_iwithprefix = 1900,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1901,              /* -iwithprefixbefore */
  OPT_k8 = 1902,                             /* -k8 */
  OPT_l = 1903,                              /* -l */
  OPT_lang_asm = 1904,                       /* -lang-asm */
  OPT_list = 1905,                           /* -list */
  OPT_mabi_ = 1906,                          /* -mabi= */
  OPT_march_ = 1907,                         /* -march= */
  OPT_mbig_endian = 1908,                    /* -mbig-endian */
  OPT_mbionic = 1909,                        /* -mbionic */
  OPT_mbranch_protection_ = 1910,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1911,                       /* -mcmodel= */
  OPT_mcpu_ = 1912,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1913,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1914,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1915,             /* -mgeneral-regs-only */
  OPT_mglibc = 1916,                         /* -mglibc */
  OPT_mharden_sls_ = 1917,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1918,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1919,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1920,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1921,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1922,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1923,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1924,               /* -moutline-atomics */
  OPT_moverride_ = 1925,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1926,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1927,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1928, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1929,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1930,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1931,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1932,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1933,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1934,                     /* -mtls-size= */
  OPT_mtp_ = 1935,                           /* -mtp= */
  OPT_mtrack_speculation = 1936,             /* -mtrack-speculation */
  OPT_mtune_ = 1937,                         /* -mtune= */
  OPT_muclibc = 1938,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1939,             /* -mverbose-cost-dump */
  OPT_n = 1940,                              /* -n */
  OPT_name_sort = 1941,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1942,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1943,              /* -no-integrated-cpp */
  OPT_no_pie = 1944,                         /* -no-pie */
  OPT_nocpp = 1945,                          /* -nocpp */
  OPT_nodefaultlibs = 1946,                  /* -nodefaultlibs */
  OPT_nolibc = 1947,                         /* -nolibc */
  OPT_nophoboslib = 1948,                    /* -nophoboslib */
  OPT_nostartfiles = 1949,                   /* -nostartfiles */
  OPT_nostdinc = 1950,                       /* -nostdinc */
  OPT_nostdinc__ = 1951,                     /* -nostdinc++ */
  OPT_nostdlib = 1952,                       /* -nostdlib */
  OPT_nostdlib__ = 1953,                     /* -nostdlib++ */
  OPT_o = 1954,                              /* -o */
  OPT_objects = 1955,                        /* -objects */
  OPT_p = 1956,                              /* -p */
  OPT_pass_exit_codes = 1957,                /* -pass-exit-codes */
  /* OPT_pedantic = 1958, */                 /* -pedantic */
  OPT_pedantic_errors = 1959,                /* -pedantic-errors */
  OPT_pg = 1960,                             /* -pg */
  OPT_pie = 1961,                            /* -pie */
  OPT_pipe = 1962,                           /* -pipe */
  OPT_posix = 1963,                          /* -posix */
  ...
  OPT_profile = 1976,                        /* -profile */
  OPT_pthread = 1977,                        /* -pthread */
  OPT_quiet = 1978,                          /* -quiet */
  OPT_r = 1979,                              /* -r */
  OPT_rdynamic = 1980,                       /* -rdynamic */
  ...
  OPT_std_c__26 = 2017,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2018, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2019, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2020, */                /* -std=c++2c */
  ...
  OPT_std_gnu__26 = 2046,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2047, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2048, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2049, */              /* -std=gnu++2c */
