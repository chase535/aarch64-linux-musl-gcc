...
enum opt_code
{
  ...
  OPT_mtp_ = 1923,                           /* -mtp= */
  OPT_mtrack_speculation = 1924,             /* -mtrack-speculation */
  OPT_mtune_ = 1925,                         /* -mtune= */
  OPT_muclibc = 1926,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1927,             /* -mverbose-cost-dump */
  OPT_n = 1928,                              /* -n */
  OPT_name_sort = 1929,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1930,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1931,              /* -no-integrated-cpp */
  OPT_no_pie = 1932,                         /* -no-pie */
  OPT_nocpp = 1933,                          /* -nocpp */
  OPT_nodefaultlibs = 1934,                  /* -nodefaultlibs */
  OPT_nolibc = 1935,                         /* -nolibc */
  OPT_nophoboslib = 1936,                    /* -nophoboslib */
  OPT_nostartfiles = 1937,                   /* -nostartfiles */
  OPT_nostdinc = 1938,                       /* -nostdinc */
  OPT_nostdinc__ = 1939,                     /* -nostdinc++ */
  OPT_nostdlib = 1940,                       /* -nostdlib */
  OPT_nostdlib__ = 1941,                     /* -nostdlib++ */
  OPT_o = 1942,                              /* -o */
  OPT_objects = 1943,                        /* -objects */
  OPT_p = 1944,                              /* -p */
  OPT_pass_exit_codes = 1945,                /* -pass-exit-codes */
  /* OPT_pedantic = 1946, */                 /* -pedantic */
  OPT_pedantic_errors = 1947,                /* -pedantic-errors */
  OPT_pg = 1948,                             /* -pg */
  OPT_pie = 1949,                            /* -pie */
  OPT_pipe = 1950,                           /* -pipe */
  OPT_posix = 1951,                          /* -posix */
  OPT_print_file_name_ = 1952,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1953,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1954,          /* -print-multi-directory */
  OPT_print_multi_lib = 1955,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1956,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1957,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1958,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1959,               /* -print-prog-name= */
  OPT_print_search_dirs = 1960,              /* -print-search-dirs */
  OPT_print_sysroot = 1961,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1962,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1963,                    /* -print-value */
  OPT_profile = 1964,                        /* -profile */
  OPT_pthread = 1965,                        /* -pthread */
  OPT_quiet = 1966,                          /* -quiet */
  OPT_r = 1967,                              /* -r */
  OPT_rdynamic = 1968,                       /* -rdynamic */
