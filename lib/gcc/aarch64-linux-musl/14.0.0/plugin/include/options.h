...
enum opt_code
{
  ...
  OPT_mbionic = 1921,                        /* -mbionic */
  OPT_mbranch_protection_ = 1922,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1923,                       /* -mcmodel= */
  OPT_mcpu_ = 1924,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1925,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1926,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1927,             /* -mgeneral-regs-only */
  OPT_mglibc = 1928,                         /* -mglibc */
  ...
  OPT_nostdlib__ = 1965,                     /* -nostdlib++ */
  OPT_o = 1966,                              /* -o */
  OPT_objects = 1967,                        /* -objects */
  OPT_p = 1968,                              /* -p */
  OPT_pass_exit_codes = 1969,                /* -pass-exit-codes */
  /* OPT_pedantic = 1970, */                 /* -pedantic */
  OPT_pedantic_errors = 1971,                /* -pedantic-errors */
  OPT_pg = 1972,                             /* -pg */
  OPT_pie = 1973,                            /* -pie */
  OPT_pipe = 1974,                           /* -pipe */
  OPT_posix = 1975,                          /* -posix */
  ...
  OPT_profile = 1988,                        /* -profile */
  OPT_pthread = 1989,                        /* -pthread */
  OPT_quiet = 1990,                          /* -quiet */
  OPT_r = 1991,                              /* -r */
  OPT_rdynamic = 1992,                       /* -rdynamic */
  OPT_remap = 1993,                          /* -remap */
  OPT_reverse_sort = 1994,                   /* -reverse-sort */
  OPT_s = 1995,                              /* -s */
  OPT_save_temps = 1996,                     /* -save-temps */
  OPT_save_temps_ = 1997,                    /* -save-temps= */
  OPT_shared = 1998,                         /* -shared */
  OPT_shared_libgcc = 1999,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2000,               /* -shared-libphobos */
  OPT_size_sort = 2001,                      /* -size-sort */
  /* OPT_specs = 2002, */                    /* -specs */
  OPT_specs_ = 2003,                         /* -specs= */
  OPT_static = 2004,                         /* -static */
  OPT_static_libasan = 2005,                 /* -static-libasan */
  OPT_static_libgcc = 2006,                  /* -static-libgcc */
  OPT_static_libgfortran = 2007,             /* -static-libgfortran */
  OPT_static_libgm2 = 2008,                  /* -static-libgm2 */
  OPT_static_libgo = 2009,                   /* -static-libgo */
  OPT_static_libhwasan = 2010,               /* -static-libhwasan */
  OPT_static_liblsan = 2011,                 /* -static-liblsan */
  OPT_static_libmpx = 2012,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2013,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2014,               /* -static-libphobos */
  OPT_static_libquadmath = 2015,             /* -static-libquadmath */
  ...
  OPT_std_c__26 = 2029,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2030, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2031, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2032, */                /* -std=c++2c */
  ...
  OPT_std_gnu__26 = 2058,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2059, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2060, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2061, */              /* -std=gnu++2c */
