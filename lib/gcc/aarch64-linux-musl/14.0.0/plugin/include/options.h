...
enum opt_code
{
  ...
  OPT_mglibc = 1930,                         /* -mglibc */
  OPT_mharden_sls_ = 1931,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1932,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1933,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1934,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1935,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1936,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1937,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1938,               /* -moutline-atomics */
  OPT_moverride_ = 1939,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1940,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1941,          /* -msign-return-address= */
  ...
  OPT_mstrict_align = 1945,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1946,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1947,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1948,                     /* -mtls-size= */
  OPT_mtp_ = 1949,                           /* -mtp= */
  OPT_mtrack_speculation = 1950,             /* -mtrack-speculation */
  OPT_mtune_ = 1951,                         /* -mtune= */
  OPT_muclibc = 1952,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1953,             /* -mverbose-cost-dump */
  OPT_n = 1954,                              /* -n */
  ...
  OPT_nostdlib__ = 1967,                     /* -nostdlib++ */
  OPT_o = 1968,                              /* -o */
  OPT_objects = 1969,                        /* -objects */
  OPT_p = 1970,                              /* -p */
  OPT_pass_exit_codes = 1971,                /* -pass-exit-codes */
  /* OPT_pedantic = 1972, */                 /* -pedantic */
  OPT_pedantic_errors = 1973,                /* -pedantic-errors */
  OPT_pg = 1974,                             /* -pg */
  OPT_pie = 1975,                            /* -pie */
  OPT_pipe = 1976,                           /* -pipe */
  OPT_posix = 1977,                          /* -posix */
  OPT_print_file_name_ = 1978,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1979,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1980,          /* -print-multi-directory */
  OPT_print_multi_lib = 1981,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1982,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1983,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1984,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1985,               /* -print-prog-name= */
  OPT_print_search_dirs = 1986,              /* -print-search-dirs */
  OPT_print_sysroot = 1987,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1988,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1989,                    /* -print-value */
  OPT_profile = 1990,                        /* -profile */
  OPT_pthread = 1991,                        /* -pthread */
  OPT_quiet = 1992,                          /* -quiet */
  OPT_r = 1993,                              /* -r */
  OPT_rdynamic = 1994,                       /* -rdynamic */
