...
enum opt_code
{
  ...
  OPT_mbionic = 1916,                        /* -mbionic */
  OPT_mbranch_protection_ = 1917,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1918,                       /* -mcmodel= */
  OPT_mcpu_ = 1919,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1920,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1921,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1922,             /* -mgeneral-regs-only */
  OPT_mglibc = 1923,                         /* -mglibc */
  OPT_mharden_sls_ = 1924,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1925,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1926,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1927,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1928,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1929,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1930,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1931,               /* -moutline-atomics */
  OPT_moverride_ = 1932,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1933,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1934,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1935, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1936,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1937,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1938,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1939,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1940,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1941,                     /* -mtls-size= */
  OPT_mtp_ = 1942,                           /* -mtp= */
  OPT_mtrack_speculation = 1943,             /* -mtrack-speculation */
