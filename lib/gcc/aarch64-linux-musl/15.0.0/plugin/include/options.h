...
enum opt_code
{
  ...
  OPT__param_store_forwarding_max_distance_ = 332,/* --param=store-forwarding-max-distance= */
  OPT__param_store_merging_allow_unaligned_ = 333,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 334,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 335,/* --param=switch-conversion-max-branch-ratio= */
  ...
  OPT__param_uninlined_function_insns_ = 351,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 352, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 353,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 354,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 355,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 356,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 357,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 358,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 359,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 360,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_force_slp_ = 361,          /* --param=vect-force-slp= */
  OPT__param_vect_induction_float_ = 362,    /* --param=vect-induction-float= */
  OPT__param_vect_inner_loop_cost_factor_ = 363,/* --param=vect-inner-loop-cost-factor= */
  OPT__param_vect_max_layout_candidates_ = 364,/* --param=vect-max-layout-candidates= */
  OPT__param_vect_max_peeling_for_alignment_ = 365,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 366,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 367,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 368,/* --param=vect-partial-vector-usage= */
  OPT__param_vrp_block_limit_ = 369,         /* --param=vrp-block-limit= */
  OPT__param_vrp_sparse_threshold_ = 370,    /* --param=vrp-sparse-threshold= */
  OPT__param_vrp_switch_limit_ = 371,        /* --param=vrp-switch-limit= */
  OPT__param_vrp_vector_threshold_ = 372,    /* --param=vrp-vector-threshold= */
  ...
  OPT_coverage = 956,                        /* -coverage */
  OPT_cpp = 957,                             /* -cpp */
  OPT_cpp_ = 958,                            /* -cpp= */
  OPT_d = 959,                               /* -d */
  OPT_debuglib_ = 960,                       /* -debuglib= */
  OPT_defaultlib_ = 961,                     /* -defaultlib= */
  OPT_defined_only = 962,                    /* -defined-only */
  OPT_demangle = 963,                        /* -demangle */
  OPT_dstartfiles = 964,                     /* -dstartfiles */
  OPT_dump_body_ = 965,                      /* -dump-body= */
  OPT_dump_level_ = 966,                     /* -dump-level= */
  OPT_dumpbase = 967,                        /* -dumpbase */
  OPT_dumpbase_ext = 968,                    /* -dumpbase-ext */
  OPT_dumpdir = 969,                         /* -dumpdir */
  OPT_dumpfullversion = 970,                 /* -dumpfullversion */
  OPT_dumpmachine = 971,                     /* -dumpmachine */
  OPT_dumpspecs = 972,                       /* -dumpspecs */
  OPT_dumpversion = 973,                     /* -dumpversion */
  OPT_e = 974,                               /* -e */
  OPT_export_dynamic = 975,                  /* -export-dynamic */
  OPT_fPIC = 976,                            /* -fPIC */
  OPT_fPIE = 977,                            /* -fPIE */
  OPT_fRTS_ = 978,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 979,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 980,                   /* -fabi-version= */
  OPT_faccess_control = 981,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 982,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 983,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 984,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 985,                  /* -falign-commons */
  OPT_falign_functions = 986,                /* -falign-functions */
  OPT_falign_functions_ = 987,               /* -falign-functions= */
  OPT_falign_jumps = 988,                    /* -falign-jumps */
  OPT_falign_jumps_ = 989,                   /* -falign-jumps= */
  OPT_falign_labels = 990,                   /* -falign-labels */
  OPT_falign_labels_ = 991,                  /* -falign-labels= */
  OPT_falign_loops = 992,                    /* -falign-loops */
  OPT_falign_loops_ = 993,                   /* -falign-loops= */
  /* OPT_faligned_new = 994, */              /* -faligned-new */
  OPT_faligned_new_ = 995,                   /* -faligned-new= */
  OPT_fall_instantiations = 996,             /* -fall-instantiations */
  OPT_fall_intrinsics = 997,                 /* -fall-intrinsics */
  OPT_fall_virtual = 998,                    /* -fall-virtual */
  OPT_fallocation_dce = 999,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 1000,       /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1001,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1002,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1003, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1004,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1005,        /* -falt-external-templates */
  OPT_fanalyzer = 1006,                      /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 1007,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1008,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1009,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1010,          /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 1011,         /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1012, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1013,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 1014,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1015,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1016,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1017,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1018,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1019,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1020,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1021,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1022, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1023, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1024, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1025, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1026,           /* -fasan-shadow-offset= */
  OPT_fasm = 1027,                           /* -fasm */
  OPT_fassert = 1028,                        /* -fassert */
  OPT_fassociative_math = 1029,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1030,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1031,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1032,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1033,                     /* -fauto-init */
  OPT_fauto_profile = 1034,                  /* -fauto-profile */
  OPT_fauto_profile_ = 1035,                 /* -fauto-profile= */
  OPT_fautomatic = 1036,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1037,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1038,                     /* -fbackslash */
  OPT_fbacktrace = 1039,                     /* -fbacktrace */
  OPT_fbit_tests = 1040,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1041,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1042,                        /* -fbounds */
  OPT_fbounds_check = 1043,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1044,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1045,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1046,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1047, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1048, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1049, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1050,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1051,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1052,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1053,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1054,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1055,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1056,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1057,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1058,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1059,                    /* -fcall-used- */
  OPT_fcaller_saves = 1060,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1061,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1062,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1063,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1064,      /* -fcanonical-system-headers */
  OPT_fcase = 1065,                          /* -fcase */
  /* OPT_fcf_protection = 1066, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1067,                /* -fcf-protection= */
  OPT_fchar8_t = 1068,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1069,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1070, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1071,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1072,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1073,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1074, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1075, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1076, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1077, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1078, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1079, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1080,                  /* -fcheckaction= */
  OPT_fchecking = 1081,                      /* -fchecking */
  OPT_fchecking_ = 1082,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1083,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1084,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1085,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1086,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1087,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1088,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1089,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1090,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1091,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1092,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1093,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1094,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1095,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1096,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1097,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1098,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1099,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1100,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1101, */                /* -fcilkplus */
  OPT_fcoarray_ = 1102,                      /* -fcoarray= */
  ...
  OPT_ffloat_store = 1295,                   /* -ffloat-store */
  OPT_ffloatvalue = 1296,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1297,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1298,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1299,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1300, */              /* -fforce-addr */
  OPT_fforward_propagate = 1301,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1302,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1303,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1304,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1305,                     /* -ffpe-trap= */
  OPT_ffree_form = 1306,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1307,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1308,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1309,                  /* -ffreestanding */
  OPT_ffriend_injection = 1310,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1311,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1312,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1313,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1314,             /* -ffunction-sections */
  OPT_fgcse = 1315,                          /* -fgcse */
  OPT_fgcse_after_reload = 1316,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1317,                      /* -fgcse-las */
  OPT_fgcse_lm = 1318,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1319,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1320,              /* -fgen-module-list= */
  OPT_fgimple = 1321,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1322,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1323,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1324,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1325,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1326,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1327,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1328,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1329,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1330,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1331,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1332,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1333,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1334,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1335,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1336,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1337,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1338,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1339,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1340,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1341,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1342,                      /* -fgraphite */
  OPT_fgraphite_identity = 1343,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1344,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1345,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1346, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1347,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1348, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1349, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1350,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1351,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1352,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1353,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1354,                      /* -fhardened */
  /* OPT_fhelp = 1355, */                    /* -fhelp */
  /* OPT_fhelp_ = 1356, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1357,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1358,                     /* -fhonor-std */
  OPT_fhosted = 1359,                        /* -fhosted */
  OPT_fhuge_objects = 1360,                  /* -fhuge-objects */
  OPT_fident = 1361,                         /* -fident */
  OPT_fif_conversion = 1362,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1363,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1364,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1365,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1366,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1367,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1368,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1369,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1370,            /* -fimplicit-templates */
  OPT_findex = 1371,                         /* -findex */
  ...
  /* OPT_flto_odr_type_merging = 1471, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1472,                /* -flto-partition= */
  OPT_flto_report = 1473,                    /* -flto-report */
  OPT_flto_report_wpa = 1474,                /* -flto-report-wpa */
  OPT_flto_ = 1475,                          /* -flto= */
  OPT_fltrans = 1476,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1477,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1478,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1479,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1480,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1481,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1482,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1483,                      /* -fm2-dump= */
  OPT_fm2_g = 1484,                          /* -fm2-g */
  OPT_fm2_lower_case = 1485,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1486,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1487,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1488,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1489,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1490,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1491,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1492,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1493,             /* -fmacro-prefix-map= */
  OPT_fmain = 1494,                          /* -fmain */
  OPT_fmalloc_dce = 1495,                    /* -fmalloc-dce */
  OPT_fmalloc_dce_ = 1496,                   /* -fmalloc-dce= */
  OPT_fmath_errno = 1497,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1498,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1499,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1500,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1501,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1502,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1503,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1504,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1505,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1506,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1507,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1508,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1509,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1510,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1511,                          /* -fmod= */
  OPT_fmodule_file_ = 1512,                  /* -fmodule-file= */
  OPT_fmodule_header = 1513,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1514,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1515,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1516,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1517,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1518,                   /* -fmodule-only */
  OPT_fmodule_private = 1519,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1520,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1521,                    /* -fmoduleinfo */
  OPT_fmodules = 1522,                       /* -fmodules */
  /* OPT_fmodules_ts = 1523, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1524,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1525,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1526,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1527,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1528,                 /* -fms-extensions */
  OPT_fmudflap = 1529,                       /* -fmudflap */
  OPT_fmudflapir = 1530,                     /* -fmudflapir */
  OPT_fmudflapth = 1531,                     /* -fmudflapth */
  OPT_fmultiflags = 1532,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1533,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1534,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1535,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1536,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1537,                  /* -fnext-runtime */
  OPT_fnil = 1538,                           /* -fnil */
  OPT_fnil_receivers = 1539,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1540,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1541,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1542,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1543,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1544,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1545,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1546,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1547,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1548,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1549,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1550,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1551,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1552,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1553,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1554,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1555,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1556,              /* -foffload-options= */
  OPT_foffload_ = 1557,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1558,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1559,                         /* -fonly= */
  OPT_fopenacc = 1560,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1561,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1562,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1563,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1564,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1565, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1566,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1567,                /* -foperator-names */
  OPT_fopt_info = 1568,                      /* -fopt-info */
  OPT_fopt_info_ = 1569,                     /* -fopt-info- */
  OPT_foptimize_crc = 1570,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1571, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1572,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1573,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1574, */          /* -foptional-diags */
  OPT_fpack_derived = 1575,                  /* -fpack-derived */
  OPT_fpack_struct = 1576,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1577,                  /* -fpack-struct= */
  OPT_fpad_source = 1578,                    /* -fpad-source */
  OPT_fpartial_inlining = 1579,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1580,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1581,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1582,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1583,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1584,                    /* -fpeel-loops */
  OPT_fpeephole = 1585,                      /* -fpeephole */
  OPT_fpeephole2 = 1586,                     /* -fpeephole2 */
  OPT_fpermissive = 1587,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1588,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1589,                           /* -fpic */
  OPT_fpie = 1590,                           /* -fpie */
  OPT_fpim = 1591,                           /* -fpim */
  OPT_fpim2 = 1592,                          /* -fpim2 */
  OPT_fpim3 = 1593,                          /* -fpim3 */
  OPT_fpim4 = 1594,                          /* -fpim4 */
  OPT_fplan9_extensions = 1595,              /* -fplan9-extensions */
  OPT_fplt = 1596,                           /* -fplt */
  OPT_fplugin_arg_ = 1597,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1598,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1599,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1600,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1601,                /* -fpostconditions */
  OPT_fpre_include_ = 1602,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1603,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1604,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1605,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1606,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1607,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1608,              /* -fpretty-templates */
  OPT_fpreview_all = 1609,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1610,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1611,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1612,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1613,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1614,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1615,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1616,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1617,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1618,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1619,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1620,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1621,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1622,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1623,           /* -fprintf-return-value */
  OPT_fprofile = 1624,                       /* -fprofile */
  OPT_fprofile_abs_path = 1625,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1626,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1627,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1628,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1629,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1630,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1631,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1632,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1633,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1634,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1635,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1636,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1637,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1638,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1639,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1640,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1641,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1642,               /* -fprofile-update= */
  OPT_fprofile_use = 1643,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1644,                  /* -fprofile-use= */
  OPT_fprofile_values = 1645,                /* -fprofile-values */
  OPT_fprotect_parens = 1646,                /* -fprotect-parens */
  OPT_fpthread = 1647,                       /* -fpthread */
  OPT_fq = 1648,                             /* -fq */
  OPT_frandom_seed = 1649,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1650,                  /* -frandom-seed= */
  OPT_frange = 1651,                         /* -frange */
  OPT_frange_check = 1652,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1653,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1654,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1655,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1656,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1657,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1658,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1659,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1660,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1661,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1662,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1663,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1664,               /* -frecord-marker=8 */
  OPT_frecursive = 1665,                     /* -frecursive */
  OPT_free = 1666,                           /* -free */
  /* OPT_freg_struct_return = 1667, */       /* -freg-struct-return */
  /* OPT_fregmove = 1668, */                 /* -fregmove */
  OPT_frelease = 1669,                       /* -frelease */
  OPT_frename_registers = 1670,              /* -frename-registers */
  OPT_freorder_blocks = 1671,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1672,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1673,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1674,             /* -freorder-functions */
  OPT_frepack_arrays = 1675,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1676,          /* -freplace-objc-classes */
  OPT_frepo = 1677,                          /* -frepo */
  OPT_freport_bug = 1678,                    /* -freport-bug */
  OPT_frequire_return_statement = 1679,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1680,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1681, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1682,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1683,                   /* -fresolution= */
  OPT_freturn = 1684,                        /* -freturn */
  OPT_frevert_all = 1685,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1686,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1687,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1688,             /* -frevert=intpromote */
  OPT_frounding_math = 1689,                 /* -frounding-math */
  OPT_frtti = 1690,                          /* -frtti */
  OPT_fruntime_modules_ = 1691,              /* -fruntime-modules= */
  OPT_frust_borrowcheck = 1692,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1693,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1694,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1695,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1696,                   /* -frust-crate= */
  OPT_frust_debug = 1697,                    /* -frust-debug */
  OPT_frust_dump_ = 1698,                    /* -frust-dump- */
  OPT_frust_edition_ = 1699,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1700,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1701,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1702,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1703,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1704,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1705,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1706,      /* -frust-name-resolution-2.0 */
  OPT_fsanitize_address_use_after_scope = 1707,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1708,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1709,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1710,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1711,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1712,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1713,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1714, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1715,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1716,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1717,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1718,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1719,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1720,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1721,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1722,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1723, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1724,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1725,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1726,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1727,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1728,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1729,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1730,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1731,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1732,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1733,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1734,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1735,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1736,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1737,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1738,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1739,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1740, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1741,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1742,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1743,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1744,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1745,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1746,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1747,               /* -fsection-anchors */
  /* OPT_fsee = 1748, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1749,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1750,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1751,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1752,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1753,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1754,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1755,        /* -fsemantic-interposition */
  OPT_fshared = 1756,                        /* -fshared */
  OPT_fshort_enums = 1757,                   /* -fshort-enums */
  OPT_fshort_wchar = 1758,                   /* -fshort-wchar */
  OPT_fshow_column = 1759,                   /* -fshow-column */
  OPT_fshrink_wrap = 1760,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1761,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1762,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1763,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1764,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1765,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1766,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1767,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1768,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1769,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1770,                /* -fsoft-check-all */
  OPT_fsources = 1771,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1772,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1773,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1774,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1775,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1776,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1777,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1778,                      /* -fsquangle */
  OPT_fssa_backprop = 1779,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1780,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1781,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1782,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1783, */             /* -fstack-check */
  OPT_fstack_check_ = 1784,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1785,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1786,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1787,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1788,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1789,               /* -fstack-protector */
  OPT_fstack_protector_all = 1790,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1791,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1792,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1793,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1794,                   /* -fstack-usage */
  OPT_fstats = 1795,                         /* -fstats */
  OPT_fstdarg_opt = 1796,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1797,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1798, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1799,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1800,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1801, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1802,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1803,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1804,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1805,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1806, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1807,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1808,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1809,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1810,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1811,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1812,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1813,                  /* -fstrub=strict */
  OPT_fswig = 1814,                          /* -fswig */
  OPT_fswitch_errors = 1815,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1816,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1817,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1818,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1819, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1820,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1821, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1822,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1823, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1824,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1825,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1826,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1827,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1828,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1829,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1830,                   /* -ftime-report */
  OPT_ftime_report_details = 1831,           /* -ftime-report-details */
  OPT_ftls_model_ = 1832,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1833,              /* -ftoplevel-reorder */
  OPT_ftracer = 1834,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1835,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1836,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1837,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1838,                   /* -ftrampolines */
  OPT_ftransition_all = 1839,                /* -ftransition=all */
  OPT_ftransition_field = 1840,              /* -ftransition=field */
  OPT_ftransition_in = 1841,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1842,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1843,          /* -ftransition=templates */
  OPT_ftransition_tls = 1844,                /* -ftransition=tls */
  OPT_ftrapping_math = 1845,                 /* -ftrapping-math */
  OPT_ftrapv = 1846,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1847,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1848,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1849,                      /* -ftree-ccp */
  OPT_ftree_ch = 1850,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1851, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1852,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1853,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1854, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1855,                   /* -ftree-cselim */
  OPT_ftree_dce = 1856,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1857,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1858,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1859,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1860,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1861, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1862,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1863,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1864, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1865,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1866,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1867, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1868,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1869,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1870,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1871,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1872,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1873,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1874,                      /* -ftree-pre */
  OPT_ftree_pta = 1875,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1876,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1877, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1878,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1879,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1880,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1881,                     /* -ftree-slsr */
  OPT_ftree_sra = 1882,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1883, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1884, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1885,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1886,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1887,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1888, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1889,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1890, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1891,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1892,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1893,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1894,         /* -funconstrained-commons */
  OPT_funderscoring = 1895,                  /* -funderscoring */
  OPT_funit_at_a_time = 1896,                /* -funit-at-a-time */
  OPT_funittest = 1897,                      /* -funittest */
  OPT_funreachable_traps = 1898,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1899,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1900,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1901,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1902, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1903,     /* -funsafe-math-optimizations */
  OPT_funsigned = 1904,                      /* -funsigned */
  OPT_funsigned_bitfields = 1905,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1906,                 /* -funsigned-char */
  OPT_funswitch_loops = 1907,                /* -funswitch-loops */
  OPT_funwind_tables = 1908,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1909,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1910,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1911,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1912,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1913,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1914,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1915,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1916,                     /* -fuse-list= */
  OPT_fvar_tracking = 1917,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1918,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1919,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1920,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1921,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1922, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1923,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1924,                   /* -fverbose-asm */
  /* OPT_fversion = 1925, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1926,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1927,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1928,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1929,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1930,                   /* -fvisibility= */
  OPT_fvpt = 1931,                           /* -fvpt */
  OPT_fvtable_gc = 1932,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1933,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1934,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1935,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1936,                     /* -fvtv-debug */
  OPT_fweak = 1937,                          /* -fweak */
  OPT_fweak_templates = 1938,                /* -fweak-templates */
  OPT_fweb = 1939,                           /* -fweb */
  /* OPT_fwhole_file = 1940, */              /* -fwhole-file */
  OPT_fwhole_program = 1941,                 /* -fwhole-program */
  OPT_fwholediv = 1942,                      /* -fwholediv */
  OPT_fwholevalue = 1943,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1944,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1945,             /* -fworking-directory */
  OPT_fwpa = 1946,                           /* -fwpa */
  OPT_fwpa_ = 1947,                          /* -fwpa= */
  OPT_fwrapv = 1948,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1949,                 /* -fwrapv-pointer */
  OPT_fxref = 1950,                          /* -fxref */
  /* OPT_fzee = 1951, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1952,          /* -fzero-call-used-regs= */
  OPT_fzero_init_padding_bits_ = 1953,       /* -fzero-init-padding-bits= */
  OPT_fzero_initialized_in_bss = 1954,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1955,                     /* -fzero-link */
  OPT_g = 1956,                              /* -g */
  OPT_gant = 1957,                           /* -gant */
  OPT_gas_loc_support = 1958,                /* -gas-loc-support */
  OPT_gas_locview_support = 1959,            /* -gas-locview-support */
  OPT_gbtf = 1960,                           /* -gbtf */
  OPT_gcodeview = 1961,                      /* -gcodeview */
  OPT_gcoff = 1962,                          /* -gcoff */
  OPT_gcoff1 = 1963,                         /* -gcoff1 */
  OPT_gcoff2 = 1964,                         /* -gcoff2 */
  OPT_gcoff3 = 1965,                         /* -gcoff3 */
  OPT_gcolumn_info = 1966,                   /* -gcolumn-info */
  OPT_gctf = 1967,                           /* -gctf */
  OPT_gdescribe_dies = 1968,                 /* -gdescribe-dies */
  OPT_gdwarf = 1969,                         /* -gdwarf */
  OPT_gdwarf_ = 1970,                        /* -gdwarf- */
  OPT_gdwarf32 = 1971,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1972,                       /* -gdwarf64 */
  OPT_gen_decls = 1973,                      /* -gen-decls */
  OPT_ggdb = 1974,                           /* -ggdb */
  OPT_ggnu_pubnames = 1975,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1976,                   /* -gimple-stats */
  OPT_ginline_points = 1977,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1978, /* -ginternal-reset-location-views */
  OPT_gnat = 1979,                           /* -gnat */
  OPT_gnatO = 1980,                          /* -gnatO */
  OPT_gno_ = 1981,                           /* -gno- */
  OPT_gno_pubnames = 1982,                   /* -gno-pubnames */
  OPT_gprune_btf = 1983,                     /* -gprune-btf */
  OPT_gpubnames = 1984,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1985,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1986,                   /* -gsplit-dwarf */
  OPT_gstabs = 1987,                         /* -gstabs */
  OPT_gstabs_ = 1988,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1989,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1990,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1991,                        /* -gtoggle */
  OPT_gvariable_location_views = 1992,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1993,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1994,                           /* -gvms */
  OPT_gxcoff = 1995,                         /* -gxcoff */
  OPT_gxcoff_ = 1996,                        /* -gxcoff+ */
  OPT_gz = 1997,                             /* -gz */
  OPT_gz_ = 1998,                            /* -gz= */
  OPT_h = 1999,                              /* -h */
  OPT_help = 2000,                           /* -help */
  OPT_idirafter = 2001,                      /* -idirafter */
  OPT_imacros = 2002,                        /* -imacros */
  OPT_imultiarch = 2003,                     /* -imultiarch */
  OPT_imultilib = 2004,                      /* -imultilib */
  OPT_include = 2005,                        /* -include */
  OPT_iplugindir_ = 2006,                    /* -iplugindir= */
  OPT_iprefix = 2007,                        /* -iprefix */
  OPT_iquote = 2008,                         /* -iquote */
  OPT_isysroot = 2009,                       /* -isysroot */
  OPT_isystem = 2010,                        /* -isystem */
  OPT_iwithprefix = 2011,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 2012,              /* -iwithprefixbefore */
  OPT_k8 = 2013,                             /* -k8 */
  OPT_l = 2014,                              /* -l */
  OPT_lang_asm = 2015,                       /* -lang-asm */
  OPT_list = 2016,                           /* -list */
  OPT_mabi_ = 2017,                          /* -mabi= */
  OPT_march_ = 2018,                         /* -march= */
  OPT_mbig_endian = 2019,                    /* -mbig-endian */
  OPT_mbionic = 2020,                        /* -mbionic */
  OPT_mbranch_protection_ = 2021,            /* -mbranch-protection= */
  OPT_mcmodel_ = 2022,                       /* -mcmodel= */
  OPT_mcpu_ = 2023,                          /* -mcpu= */
  OPT_mearly_ldp_fusion = 2024,              /* -mearly-ldp-fusion */
  OPT_mearly_ra_ = 2025,                     /* -mearly-ra= */
  OPT_mfix_cortex_a53_835769 = 2026,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 2027,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 2028,             /* -mgeneral-regs-only */
  OPT_mglibc = 2029,                         /* -mglibc */
  OPT_mharden_sls_ = 2030,                   /* -mharden-sls= */
  OPT_mlate_ldp_fusion = 2031,               /* -mlate-ldp-fusion */
  OPT_mlittle_endian = 2032,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 2033,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 2034,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 2035,            /* -mlow-precision-sqrt */
  OPT_mmusl = 2036,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 2037,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 2038,               /* -moutline-atomics */
  OPT_moverride_ = 2039,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 2040,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 2041,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 2042, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2043,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 2044,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 2045,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 2046,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 2047,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 2048,                     /* -mtls-size= */
  OPT_mtp_ = 2049,                           /* -mtp= */
  OPT_mtrack_speculation = 2050,             /* -mtrack-speculation */
  OPT_mtune_ = 2051,                         /* -mtune= */
  OPT_muclibc = 2052,                        /* -muclibc */
  OPT_mverbose_cost_dump = 2053,             /* -mverbose-cost-dump */
  OPT_n = 2054,                              /* -n */
  OPT_name_sort = 2055,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2056,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2057,              /* -no-integrated-cpp */
  OPT_no_pie = 2058,                         /* -no-pie */
  OPT_nocpp = 2059,                          /* -nocpp */
  OPT_nodefaultlibs = 2060,                  /* -nodefaultlibs */
  OPT_nolibc = 2061,                         /* -nolibc */
  OPT_nophoboslib = 2062,                    /* -nophoboslib */
  OPT_nostartfiles = 2063,                   /* -nostartfiles */
  OPT_nostdinc = 2064,                       /* -nostdinc */
  OPT_nostdinc__ = 2065,                     /* -nostdinc++ */
  OPT_nostdlib = 2066,                       /* -nostdlib */
  OPT_nostdlib__ = 2067,                     /* -nostdlib++ */
  OPT_o = 2068,                              /* -o */
  OPT_objects = 2069,                        /* -objects */
  OPT_p = 2070,                              /* -p */
  OPT_pass_exit_codes = 2071,                /* -pass-exit-codes */
  /* OPT_pedantic = 2072, */                 /* -pedantic */
  OPT_pedantic_errors = 2073,                /* -pedantic-errors */
  OPT_pg = 2074,                             /* -pg */
  OPT_pie = 2075,                            /* -pie */
  OPT_pipe = 2076,                           /* -pipe */
  OPT_posix = 2077,                          /* -posix */
  OPT_print_file_name_ = 2078,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2079,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2080,          /* -print-multi-directory */
  OPT_print_multi_lib = 2081,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2082,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2083,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2084,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2085,               /* -print-prog-name= */
  OPT_print_search_dirs = 2086,              /* -print-search-dirs */
  OPT_print_sysroot = 2087,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2088,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2089,                    /* -print-value */
  OPT_profile = 2090,                        /* -profile */
  OPT_pthread = 2091,                        /* -pthread */
  OPT_quiet = 2092,                          /* -quiet */
  OPT_r = 2093,                              /* -r */
  OPT_rdynamic = 2094,                       /* -rdynamic */
  OPT_remap = 2095,                          /* -remap */
  OPT_reverse_sort = 2096,                   /* -reverse-sort */
  OPT_s = 2097,                              /* -s */
  OPT_save_temps = 2098,                     /* -save-temps */
  OPT_save_temps_ = 2099,                    /* -save-temps= */
  OPT_shared = 2100,                         /* -shared */
  OPT_shared_libgcc = 2101,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2102,               /* -shared-libphobos */
  OPT_size_sort = 2103,                      /* -size-sort */
  /* OPT_specs = 2104, */                    /* -specs */
  OPT_specs_ = 2105,                         /* -specs= */
  OPT_static = 2106,                         /* -static */
  OPT_static_libasan = 2107,                 /* -static-libasan */
  OPT_static_libgcc = 2108,                  /* -static-libgcc */
  OPT_static_libgfortran = 2109,             /* -static-libgfortran */
  OPT_static_libgm2 = 2110,                  /* -static-libgm2 */
  OPT_static_libgo = 2111,                   /* -static-libgo */
  OPT_static_libhwasan = 2112,               /* -static-libhwasan */
  OPT_static_liblsan = 2113,                 /* -static-liblsan */
  OPT_static_libmpx = 2114,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2115,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2116,               /* -static-libphobos */
  OPT_static_libquadmath = 2117,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2118,               /* -static-libstdc++ */
  OPT_static_libtsan = 2119,                 /* -static-libtsan */
  OPT_static_libubsan = 2120,                /* -static-libubsan */
  OPT_static_pie = 2121,                     /* -static-pie */
  /* OPT_std_c__03 = 2122, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2123, */                /* -std=c++0x */
  OPT_std_c__11 = 2124,                      /* -std=c++11 */
  OPT_std_c__14 = 2125,                      /* -std=c++14 */
  OPT_std_c__17 = 2126,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2127, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2128, */                /* -std=c++1z */
  OPT_std_c__20 = 2129,                      /* -std=c++20 */
  OPT_std_c__23 = 2130,                      /* -std=c++23 */
  OPT_std_c__26 = 2131,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2132, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2133, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2134, */                /* -std=c++2c */
  OPT_std_c__98 = 2135,                      /* -std=c++98 */
  OPT_std_c11 = 2136,                        /* -std=c11 */
  OPT_std_c17 = 2137,                        /* -std=c17 */
  /* OPT_std_c18 = 2138, */                  /* -std=c18 */
  /* OPT_std_c1x = 2139, */                  /* -std=c1x */
  OPT_std_c23 = 2140,                        /* -std=c23 */
  /* OPT_std_c2x = 2141, */                  /* -std=c2x */
  OPT_std_c2y = 2142,                        /* -std=c2y */
  /* OPT_std_c89 = 2143, */                  /* -std=c89 */
  OPT_std_c90 = 2144,                        /* -std=c90 */
  OPT_std_c99 = 2145,                        /* -std=c99 */
  /* OPT_std_c9x = 2146, */                  /* -std=c9x */
  OPT_std_f2003 = 2147,                      /* -std=f2003 */
  OPT_std_f2008 = 2148,                      /* -std=f2008 */
  OPT_std_f2008ts = 2149,                    /* -std=f2008ts */
  OPT_std_f2018 = 2150,                      /* -std=f2018 */
  OPT_std_f2023 = 2151,                      /* -std=f2023 */
  OPT_std_f202y = 2152,                      /* -std=f202y */
  OPT_std_f95 = 2153,                        /* -std=f95 */
  OPT_std_gnu = 2154,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2155, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2156, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2157,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2158,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2159,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2160, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2161, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2162,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2163,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2164,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2165, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2166, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2167, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2168,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2169,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2170,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2171, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2172, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2173,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2174, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2175,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2176, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2177,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2178,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2179, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2180, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2181,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2182, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2183, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2184, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2185, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2186, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2187, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2188,                     /* -std=legacy */
  OPT_stdlib_ = 2189,                        /* -stdlib= */
  OPT_symbol_ = 2190,                        /* -symbol= */
  OPT_symbolic = 2191,                       /* -symbolic */
  OPT_t = 2192,                              /* -t */
  OPT_time = 2193,                           /* -time */
  OPT_time_ = 2194,                          /* -time= */
  OPT_traditional = 2195,                    /* -traditional */
  OPT_traditional_cpp = 2196,                /* -traditional-cpp */
  OPT_tree_stats = 2197,                     /* -tree-stats */
  OPT_trigraphs = 2198,                      /* -trigraphs */
  OPT_truncate = 2199,                       /* -truncate */
