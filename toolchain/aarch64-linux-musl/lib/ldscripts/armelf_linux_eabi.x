...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/runner/work/aarch64-linux-musl/aarch64-linux-musl/output/toolchain/aarch64-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
